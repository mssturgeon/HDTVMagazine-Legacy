...
html .email_share_link {padding:2px 0 0 25px; height:16px; background:url(/images/email.gif) no-repeat top left;}
...
html .rss_share_link {padding:2px 0 0 20px; height:16px; background:url(/images/livemark.png) no-repeat top left;}
html .twitter_share_link {padding:2px 0 0 20px; height:16px; background:url(/images/twitter.png) no-repeat top left;}
...
#body_container h1 {background:url(/images/bg_h1.gif) repeat; border-top:3px solid #<?=PRIMARY_COLOR?>; border-bottom:1px solid #<?=PRIMARY_COLOR?>; font-size:2em; font-weight:bold; padding:3px;}
/*
#body_container li {list-style-image:url(/images/square-brown_5.gif); margin-left:-20px; padding:.25em 0}
*/
...
#article_container h1 {background:url(/images/bg_h1.gif) repeat; border-top:3px solid #<?=PRIMARY_COLOR?>; border-bottom:1px solid #<?=PRIMARY_COLOR?>; font-size:2em; font-weight:bold; padding:3px;}
#article_container h2 {margin-top:1.5em;}
#article_container li {list-style-image:url(<?=BASE_IMG_URL?>/images/square-brown_5.gif); margin-left:-20px; padding:.25em 0}
...
div.autocomplete {background-color:white; border:1px solid #<?=BORDER_COLOR?>; margin:10px; overflow:auto; padding:0; position:absolute; width:25em; height:200px; z-index:1;}
div.autocomplete ul {list-style-type:none; margin:0; padding:0;}
div.autocomplete ul li {list-style-type:none; display:block; margin:0; padding:2px; cursor:pointer;}
div.autocomplete ul li.selected {border-width:0; background-color:#CEDFEF; margin:0; padding:2px}

#bulletin_container {font:1.1em/1.2em verdana, sans-serif; margin:5px 0}
#bulletin_container li {list-style-image:url(<?=BASE_IMG_URL?>/images/square-brown_5.gif); margin-left:-20px; padding:.25em 0}
...
.item li {border-bottom:1px solid white; list-style-image:url(<?=BASE_IMG_URL?>/images/square-brown_5.gif); margin-left:-20px; padding:.25em 0}
...
#tabs a {float:left; background:url(/images/tableft.gif) no-repeat left top; margin:0; padding:0 0 0 5px; text-decoration:none;}
#tabs a span {float:left; display:block; background:url(/images/tabright.gif) no-repeat right top; padding:5px 15px 4px 6px; color:#24618E;}
...
form {margin:0;}
/*
h1 {background:url(/images/bg_h1.gif) repeat; border-top:3px solid #<?=PRIMARY_COLOR?>; border-bottom:1px solid #<?=PRIMARY_COLOR?>; font-size:14pt; font-weight:bold; padding:3px;}
...
ul.brownsquare > li {list-style-image:url(<?=BASE_IMG_URL?>/images/square-brown_5.gif); margin-left:-20px; padding:.25em 0}
...
/*
#body_container {}
#body_container > h1 {background:url(/images/bg_h1.gif) repeat; border-top:3px solid #<?=PRIMARY_COLOR?>; border-bottom:1px solid #<?=PRIMARY_COLOR?>; font-size:14pt; font-weight:bold; padding:3px;}
...
.article_title {background:url(/images/bg_h1.gif) repeat; border:1px solid #<?=BORDER_COLOR?>; color:#<?=PRIMARY_COLOR?>; font:bold 14pt arial,sans-serif; padding:7px; vertical-align:top; width:100%;}
...
td.btn-left {background:url(/images/btn-left.gif) 0 0 no-repeat; padding:0}
td.btn-back {background:url(/images/btn-back.gif) repeat-x; color:white; font-weight:bold; padding:5px; height:36px;}
...
td.btn-right {background:url(/images/btn-right.gif) no-repeat;}
...
span.corners-top {background-image: url(/forum/templates/HDTVMagazine4/theme/images/corners_left.png);}
span.corners-top span {background-image: url("/forum/templates/HDTVMagazine4/theme/images/corners_right.png");}
span.corners-bottom {background-image: url("/forum/templates/HDTVMagazine4/theme/images/corners_left.png");}
span.corners-bottom span {background-image: url("/forum/templates/HDTVMagazine4/theme/images/corners_right.png");}
...
.inputButton {background:url(/images/bg-button.gif) repeat-x; border:1px solid #<?=BORDER_COLOR?>; cursor:pointer; font:8pt Arial,sans-serif; height:21px;}
...
td.activeTab {background:url(/images/bg-activetab.jpg) repeat-x; border:1px solid #<?=BORDER_COLOR?>; border-bottom:0px; font-weight:bold; padding: 5px 10px; text-align:center;}
td.inactiveTab {background:url(/images/bg-inactivetab.gif); border:1px solid #<?=BORDER_COLOR?>; padding:5px 10px; text-align:center;}
td.tabActive {background:url(/images/bg-activetab.jpg) repeat-x; border:1px solid #<?=BORDER_COLOR?>; border-bottom:0px; font-weight:bold; padding: 5px 10px; text-align:center;}
td.tabInactive {background:url(/images/bg-inactivetab.gif); border:1px solid #<?=BORDER_COLOR?>; padding:5px 10px; text-align:center;}
...
table.simple {border:1px solid #<?=BORDER_COLOR?>; border-collapse:collapse}
table.simple td {border:1px solid #<?=BORDER_COLOR?>; padding:2px; vertical-align:middle}
table.simple .header td {background-color:#<?=BG_COLOR?>; color:#<?=LINK_COLOR?>; font-weight:bold; padding:2px 3px; vertical-align:top;}
...
#menu {background:#<?=PRIMARY_COLOR?> url(/images/menu-back.png) no-repeat 0 0; border:0; clear:both; height:40px; margin:0.1em 0; padding-left:10px;}
#menu div {background:url(/images/menu-back.png) no-repeat 100% 0; height:36px; overflow:hidden; padding-top:4px;}
