<?
	...
	# DO NOT EDIT >>> USE css/email.css FROM NOW ON
?>

/* html .email_share_link {padding:2px 0 0 25px; height:16px; background:url(<?=$base_url?>/images/email.gif) no-repeat top left;} */
...
html .rss_share_link {padding:2px 0 0 20px; height:16px; background:url(<?=$base_url?>/images/livemark.png) no-repeat top left;}
html .twitter_share_link {padding:2px 0 0 20px; height:16px; background:url(<?=$base_url?>/images/twitter.png) no-repeat top left;}
...
form {margin:0;}
h2 {color:#<?=SECONDARY_COLOR?>; font:1.5em Arial, sans serif; font-weight:bold; height:31px; margin:0;}
...
span.corners-top {background-image: url(<?=$base_url?>/forum/styles/HDTVMagazine4/theme/images/corners_left.png);}
span.corners-top span {background-image: url(<?=$base_url?>/forum/styles/HDTVMagazine4/theme/images/corners_right.png);}
span.corners-bottom {background-image: url(<?=$base_url?>/forum/styles/HDTVMagazine4/theme/images/corners_left.png);}
span.corners-bottom span {background-image: url(<?=$base_url?>/forum/styles/HDTVMagazine4/theme/images/corners_right.png);}

#email_container {margin:10px; width:748px}
#email_container ul {margin:0}

#date {font-size:2em; font-weight:bold; margin:0; text-align:right}
#heading {color:#995905; color:red; font-family:verdana; font-size:15pt; font-weight:bold; text-align:right;}
.keyimg {float:left; padding: 0 5px 5px 0;}
#search {margin-top:20px; text-align:right}
#viewonline {font-size:.9em; text-align:right}

/* AD - Only used for ad backgrounds, currently displayed in a "light grey" scheme */
.ad {background-color:#F5F7FA; font-size:1em; margin:10px 0; padding:0 10px;}
...
.important {background-color:#ECD5D8; margin:10px 0; padding:0 10px;}
...
.item {background-color:#CEDFEF; margin:10px 0; padding:0 10px;}
.item h3 {color:#<?=PRIMARY_COLOR?>; font:1em Arial, sans serif; font-weight:bold; margin:0;}
.item h3 > a {text-decoration:none;}
.item h3 > a:hover {text-decoration:underline;}
.item h4 {color:#808080; font:.8em Arial, sans serif; margin:0; text-transform:uppercase;}
.item > .label {color:#<?=PRIMARY_COLOR?>; float:left; font-weight:bold; padding-right:5px}
.item > .label a {color:#<?=PRIMARY_COLOR?>}
.item ul {list-style:disc outside url(<?=$base_url?>/images/square-brown_5.gif); margin:0; padding:0}
.item li {border-bottom:1px solid white; clear:both; margin-left:20px; padding:.25em 0;}
...
.entry h2 {color:#<?=PRIMARY_COLOR?>; display:inline; font:2em Times New Roman, serif; font-weight:bold; margin:0;}
...
.item_odd {background-color:#ecf3f7; margin:10px 0; padding:0 10px;}
.item_odd h3 {color:#<?=PRIMARY_COLOR?>; font:1em Arial, sans serif; font-weight:bold; margin:0;}
.item_odd h3 > a {text-decoration:none;}
.item_odd h3 > a:hover {text-decoration:underline;}
.item_odd h4 {color:#808080; font:.8em Arial, sans serif; margin:0; text-transform:uppercase;}
.item_odd ul {list-style:disc outside url(<?=$base_url?>/images/square-brown_5.gif); margin:0; padding:0}
.item_odd li {border-bottom:1px solid white; margin-left:20px; padding:.25em 0;}
...
/* MENU classes */
div.menu {background-color:#<?=PRIMARY_COLOR?>; margin-bottom:10px; padding:0 10px;}
div.menu span.corners-top, div.menu span.corners-bottom {margin:0 -10px;}
ul.menu {float:left; font-weight:bold; margin:0; padding:0; width:100%;}
ul.menu li {display: inline;}
ul.menu li a {border-left:1px solid white; float:left; padding:3px 7px}
