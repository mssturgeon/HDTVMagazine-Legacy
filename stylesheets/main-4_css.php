...
#article_container li {list-style-image:url(<?=BASE_IMG_HOST?>/images/square-brown_5.gif); margin-left:-20px; padding:.25em 0}
...
#accountBar {float:right; text-align:right; vertical-align:top; width:480px}
