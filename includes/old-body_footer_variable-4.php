...
EOT;
	...
	# Google +1 Button
	$body_footer_output .= '<script type="text/javascript" src="https://apis.google.com/js/plusone.js"></script>';

	# Facebook SDK
	$body_footer_output .= '<script src="http://connect.facebook.net/en_US/all.js#appId=222776463019&amp;xfbml=1"></script>';

	$body_footer_output .= '<script type="text/javascript" src="'. BASE_IMG_HOST .'/min/?f=js/common.js"></script>';
?>