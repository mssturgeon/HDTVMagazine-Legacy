<!-- nSphere block -->
<div class="item" align="left" style="margin-top:10px; clear:both"><span class="corners-top"><span></span></span>
	<h2>Local Guides</h2>
	<div class="local_info !important"><ul>
...
<?
	if ($user->data['hide_banner_ads'] !== true) {
		...
		?><div id="ad_links"><div align="center"><script type="text/javascript"><!--
			google_ad_client = "pub-2099480674594177";
			/* Main Links (No Channel) */
			google_ad_slot = "8224991526";
			google_ad_width = 468;
			google_ad_height = 15;
...
<!-- Not sure why Twitter and Facebook API's were added ... commenting out until we know if it is needed -->
<!-- Facebook SDK -->
<!--script src="http://connect.facebook.net/en_US/all.js#appId=222776463019&amp;xfbml=1"></script-->
...
<!-- begin zdbb --><script type="text/javascript" src="http://cdn.static.zdtag.com/js/t0C0zEtsEeGk4RIxOSbhOA.js"></script><!-- end zdbb -->

<!-- Google +1 button -->
<script type="text/javascript" src="https://apis.google.com/js/plusone.js"></script>

<!-- Common js functions -->
<script type="text/javascript" src="<?=BASE_IMG_HOST?>/min/?f=js/common.js"></script>
<!--script type="text/javascript" src="<?=BASE_IMG_HOST?>/js/jquery-1.7.1.min.js"></script-->
<script type="text/javascript" src="<?=BASE_IMG_HOST?>/js/jquery-1.9.0.min.js"></script>
<!--script type="text/javascript" src="<?=BASE_IMG_HOST?>/js/jquery-ui-1.8.17.custom.min.js"></script-->
<script type="text/javascript" src="<?=BASE_IMG_HOST?>/js/jquery-ui-1.10.0.custom.min.js"></script>
<!--script type="text/javascript" src="<?=BASE_IMG_HOST?>/min/?b=js&f=common.js,jquery-1.7.1.min.js,jquery-ui-1.8.17.custom.min.js"></script-->

<!-- Lijit Tag -->
<!--script type="text/javascript" src="http://www.lijit.com/blog_wijits?json=0&amp;id=trakr&amp;uri=http%3A%2F%2Fwww.lijit.com%2Fusers%2Fmssturgeon&amp;js=1"></script-->
<script type="text/javascript" src="http://www.lijit.com/blog_wijits?json=0&amp;id=trakr&amp;uri=http%3A%2F%2Fwww.lijit.com%2Fusers%2Fhdtv&amp;js=1"></script>

<!-- Viglink tag -->
<script type="text/javascript">
	<?
		# Default to PRIMARY Source
		$viglink_source = ($viglink_source == '') ? '62eb9f2b16731c651a3e563fe9f82826' : $viglink_source;
	?>
	var vglnk = { api_url: '//api.viglink.com/api', key: '<?=$viglink_source?>' };
...
<!-- Apture Tag -->
<!--script id="aptureScript" type="text/javascript" src="http://www.apture.com/js/apture.js?siteToken=kwQEuu6" charset="utf-8"></script-->