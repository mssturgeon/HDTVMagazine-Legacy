...
<head>
	...
	<meta name="keywords" content="color space, ultra hdtv, front right, naming conventions, digital cinema, front, image, left, right, top, centre, audio, dci, bits, per, khz, back, resolution, required, itu, hdtv, part, bit, format, color" />
...
Part 5 will cover..." />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/test/2012/12/living-with-4k-part-4-which-4k-dci-4k-ultrahdtv-ultrahd-quadfullhd.php" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4951', 340, 125);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2012/12/living-with-4k-part-4-which-4k-dci-4k-ultrahdtv-ultrahd-quadfullhd.php">Living with 4K (Part 4) - Which 4K ... DCI 4K, Ultra-HDTV, Ultra-HD, Quad-Full-HD?</a></td>
						</tr><tr>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 4951)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2012/12/living-with-4k-part-4-which-4k-dci-4k-ultrahdtv-ultrahd-quadfullhd.php" type="text/javascript" charset="utf-8"></script>
