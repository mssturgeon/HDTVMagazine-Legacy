...
<head>
	...
	<meta name="keywords" content="ultra hdtv, aspect ratio, digital cinema, horizontal resolution, vertical resolution, hdtv, resolution, ultra, horizontal, dci, digital, aspect, cinema, called, ratio, term, naming, pixels, content, using, actually, level, vertical, recorded, cea" />
...
The short answer is..." />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/test/2012/12/living-with-4k-part-3-which-4k-dci-4k-ultrahdtv-ultrahd-quadfullhd.php" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4950', 340, 125);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2012/12/living-with-4k-part-3-which-4k-dci-4k-ultrahdtv-ultrahd-quadfullhd.php">Living with 4K (Part 3) - Which 4K ... DCI 4K, Ultra-HDTV, Ultra-HD, Quad-Full-HD?</a></td>
						</tr><tr>
...
<tr><td>Consumer Electronics Association (CEA)</td><td>3840 x 2160</td><td>8,294,400</td><td>Progressive</td><td>Newly named U(ltra) HD, Initially called 4K</td><td>3.75K [3840/1024]</td></tr>
</tbody></table> <p>The following parts 4 and 5 of this “Living with 4K” series will provide details of the naming conventions as defined by the various organizations (ITU, EBU, CEA, and DCI). Part 6 wraps the subject of naming conventions and provides a historic perspective of similar naming decisions taken by the CEA with DTV.  
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>December  5, 2012  1:07 PM</b>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 4950)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2012/12/living-with-4k-part-3-which-4k-dci-4k-ultrahdtv-ultrahd-quadfullhd.php" type="text/javascript" charset="utf-8"></script>
