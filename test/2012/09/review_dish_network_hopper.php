...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/test/2012/09/review-dish-network-hopper.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
...
None of the other publications said a word about the subject of Dish’s image quality, they rather concentrated in admiring the Hopper’s impressive feature set and functionality, which, do not take me wrong, I fully concur with the reviews in that area, the features are great, but to me the image quality should be the main requirement of any video service contract/package, not just a sophisticated set-top-box or a mile-long channel lineup." />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/test/2012/09/review-dish-network-hopper.php" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4912', 340, 125);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2012/09/review-dish-network-hopper.php">Review: Dish Network Hopper</a></td>
						</tr><tr>
...
<tr><td><b>HD Movie channels comparison: 5 cable vs. 23 Dish</b></td> <td style="background-color:#FFFF00"> <p><b>Cable Service: (only) 5 HD Movie channels for additional $41</b></td><td style="background-color:#FFFF00"><b>Dish: 23 HD Movie channels for $35 (w/Amer 250), or $44 (w/Amer 120, or Amer 200, or Family packages)</b></td><td><b>Dish SD Movie channels Included in American 250</b></td></tr>
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>September 30, 2012  6:43 PM</b>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 4912)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2012/09/review-dish-network-hopper.php" type="text/javascript" charset="utf-8"></script>
