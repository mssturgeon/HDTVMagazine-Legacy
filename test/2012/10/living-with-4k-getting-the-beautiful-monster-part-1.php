...
<head>
	...
	<meta name="keywords" content="horizontal pixels, venue projector, large venue, available consumers, times detailed, again, dtv, image, resolution, projector, content, pixels, “, display, sony, million, whole, horizontal, home, times, part, ”, video, even, consumers" />
...
Why? Perhaps because..." />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/test/2012/10/living-with-4k-getting-the-beautiful-monster-part-1.php" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4922', 340, 125);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2012/10/living-with-4k-getting-the-beautiful-monster-part-1.php">Living with 4K: Getting the Beautiful Monster (Part 1)</a></td>
						</tr><tr>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 4922)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2012/10/living-with-4k-getting-the-beautiful-monster-part-1.php" type="text/javascript" charset="utf-8"></script>
