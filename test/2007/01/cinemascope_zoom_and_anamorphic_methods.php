...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 533 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/test/2007/01/cinemascope-zoom-and-anamorphic-methods.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (6) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 533";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Cinemascope - Zoom and Anamorphic Methods" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Cinemascope - Zoom and Anamorphic Methods" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Cinemascope - Zoom and Anamorphic Methods" />
...
<html>
<head>
	<title>HDTV Magazine - Cinemascope - Zoom and Anamorphic Methods</title>
	<meta name="keywords" content="light output, black bars, anamorphic lens, home theater, viewing distance, screen, anamorphic, lens, zoom, light, projector, using, approach, output, cinemascope, image, viewing, pixel, system, black, another, bars, theater, home, pixels" />
	<meta name="description" content="This is an exciting time for home theater and one I have been waiting for; the ability to properly display CinemaScope content in its native aspect ratio, duplicating the experience of your local film theater where CinemaScope content is larger, growing left to right as the side curtains are pulled back to reveal more screen for a larger image. 

Check the A/V and videophile magazines for this year. Odds are quite high that they had..." />
	<meta name="title" content="Cinemascope - Zoom and Anamorphic Methods" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Cinemascope - Zoom and Anamorphic Methods" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/test/2007/01/cinemascope-zoom-and-anamorphic-methods.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="This is an exciting time for home theater and one I have been waiting for; the ability to properly display CinemaScope content in its native aspect ratio, duplicating the experience of your local film theater where CinemaScope content is larger, growing left to right as the side curtains are pulled back to reveal more screen for a larger image. 
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=533', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2007/01/cinemascope-zoom-and-anamorphic-methods.php">Cinemascope - Zoom and Anamorphic Methods</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Richard Fisher</b> on <b>January 28, 2007</b>
			...
			<div id="<?=$container?>">
				...
				<!--?=$v_buttons?-->
				<p>This is an exciting time for home theater and one I have been waiting for; the ability to properly display CinemaScope content in its native aspect ratio, duplicating the experience of your local film theater where CinemaScope content is larger, growing left to right as the side curtains are pulled back to reveal more screen for a larger image. </p>

<p>Check the A/V and videophile magazines for this year. Odds are quite high that they had advertising for cinemascope screens, lens or compatible projectors. A new term has appeared in front projection reviews and specs called "Panamorph lens compatible/capable", which was also supported by the <a href="/reviews/2007/07/benq_w10000_108.php">BenQ projector</a> I reviewed earlier this year. Welcome to the new buzz words for home theater enthusiasts, specialty retailers and installers: CinemaScope, CineWide and Scope. What is rarely discussed, if ever, in these same magazines is another method for achieving the same outcome; using the existing zoom of a front projector along with the videophile and purist benefits that this can provide over the Panamorph lens approach. Let's take a look at the imaging science that is being used to support the anamorphic approach, imaging science for the zoom approach as well as how to implement the zoom method for CinemaScope. </p>

<p>Earlier this year colleague Rodolfo La Maestra wrote a series of articles on <a href="/articles/2007/01/cinemascope_hdh.php">CinemaScope HD Home Theater</a>, where he detailed his approach to using the now popular anamorphic lens that stretches the image left to right while a scaler stretches it top to bottom so 2.35 content fills out the screen. Today a number of manufacturers are releasing compatible projectors and lenses with Runco having led the way with the first turnkey CinemaScope home theater system displayed at CES in January 2003. All of these add thousands of dollars and additional installation effort. With the right projector and setup you can do this now for a lot less providing potentially better imaging science results for less than $1000 by replacing your 1.78 (16:9) screen with a 2.35 screen.</p>

<p><br />
<img alt="1.78 Aspect Ratio Comparison" src="/images/articles/aspect-ratio-comparison-1.78.jpg" align="right" /><br />
<strong>Original Aspect Ratio</strong></p>

<p>For the most part movie content is provided in 1.78, 1.85 and 2.35 aspect ratios but there are many exceptions, some well known such as Ben Hur in 2.76 or Grand Prix and Lawrence of Arabia in 2.20. Using a screen shot from my gaming PC, I edited the image size for 1.33 (4:3), 1.78 (16:9), 1.85, 2.20, 2.35 and 2.76. The first group shows how those same aspects are displayed on a native HDTV 1.78 screen with 0% overscan. The second group shows how all those aspects appear using the zoom of your front projector to maintain constant height within a native 2.35 screen. Note with 2.76 you finally have black bars top and bottom as well, yet with the zoom approach you retain the ability to crop the sides and maintain constant height. Being the original aspect ratio (OAR) purist that I am, I would live with the bars. Both groups use the exact same vertical height and the only difference is the width. I did not provide a set of images for anamorphic 2.35 since most buyers of such a system are likely to use aspect settings that will fill out the screen with all content. If OAR is a concern, the anamorphic 2.35 system does support native 4:3 and 16:9 aspect ratios with side bars.</p>

<p><br />
<strong>Anamorphic 2.35 Pros and Cons</strong><br />
<ul><li>There are various recipes depending on your application and desired level of quality. These range from $2,200 to $23,000, not including the projector</li><li>If you hate black bars they can be removed most of the time but may reappear depending on your source (such as 4:3 commercials during an HDTV program). What ever primary content you are watching your screen can nearly always be filled out and there are exceptions.</li><li>Fully automated for the market that prefers simplicity at the touch of a button.<br />
</li><li>It is not artifact-free for videophiles seeking the best performance. Nonetheless, most viewers are perfectly satisfied, if not blown away, by the CinemaScope experience</li><li>A 2.35 source setup for your 2.35 screen will remove on screen graphics from your system that appear in the black bars above or below. This can include sub-titles.</li></ul></p>

<p>The anamorphic system presents artifact-inducing concerns starting with an additional piece of glass, the anamorphic lens. Glass is not 100% efficient creating small losses in light output and reducing intra-field contrast ratios. Such lenses can also suffer from chromatic errors which cause a separation of the red, green and blue primaries appearing as convergence errors on screen, poor focus uniformity and pin cushioning errors. These errors will be directly related to the quality of manufacturing which is why they can be so expensive. Some lenses require a special curved screen while some use the far more common flat screen. In most cases greater attention to precision projector mounting is required, an additional mount and potential precision alignment for the anamorphic lens assembly and additional wiring for automation.</p>
...
<p>This typically can't be automated with a few buttons on your remote. It is a manual process that may require handling the projector's zoom lens, focus and shift adjustment like the Samsung SP-H710AE which will also require rock solid mounting. Using the <a href="/reviews/2007/05/panasonic_pt-ae.php">Panasonic PT-AE1000U</a> with motorized zoom/focus and vertical centering in place of shift allows you to perform the adjustments without ever touching the projector by using your remote instead making 2.35 zoom a breeze. As far as I can tell there is no memory preset support for these functions in the projection market unlike picture settings in the user menu. </p>

<p>One topic of debate over using the zoom lens deals with increasing optical artifacts. The accepted practice is to use minimum zoom when possible. This produces the smallest image passing through the lens using as little of the lens surface area as possible to minimize optical artifacts from using the edges while providing the best intra field contrast ratio. The con for this mode is it also minimizes potential light output because optics are not 100% efficient. When you zoom you make the image passing through the optics larger. Since more optical area of the lens is being used you get greater efficiency and an increase in light output but now your image is using more of the edge and that can create chromatic errors, separation of red, green, blue and linearity, lines start curving, and focus uniformity, center to edge focus is not equal or in the same plane. While you are getting more light through the lens by using more surface area that is also more area to create refractions; the light that didn't pass through the lens that gets reflected back into the optics reducing intra-field contrast ratio, the difference in level between black and white that occurs when refracted light from bright areas ends up in the dark areas of the image washing them out reducing their dynamic range. The argument here is that by using the zoom for 2.35 you have introduced optical artifacts that otherwise would not be there. True, but let's put this in perspective. The requirement is a 1.3x zoom range and that amount adds to up to a small hill of beans. Projectors with 2.0x zoom range can show significant differences in artifacts and light output yet for this application the required 1.3x adds only marginal errors. Regardless of which method you use for 2.35 CinemaScope you will have to change optical properties via some method. The anamorphic lens is going to suffer from uncontrolled refractions, light being reflected not only back into the projector lens but also reflecting off the lens housing and projector housing back into that anamorphic lens reducing the intra-field contrast ratio of both the anamorphic lens and projector lens. It could be argued that refractions from the zoom method stand a better chance of yielding a higher intra-field contrast ratio because this has been taken into account in its design from optical coatings to lens chamber design. One thing is for sure; the anamorphic lens adds yet another optical element to the system but unlike the lens assembly that came with your projector, it is optional.</p>

<p>This is a controversial article. Imaging professionals like myself have stated their dissatisfaction with the anamorphic approach in conversation especially now with 1080p projectors on the market. Many have themselves chosen the zoom approach over anamorphic for their own systems while supporting the turn key anamorphic approach for their clients. I have not put forth a ton of effort to prove some areas of the zoom approach and there are other areas that would show marginal differences or be difficult to measure properly. There is also the future which could make an automated turn key zoom approach viable or improve the performance of anamorphic. The arguments for and against either approach are easier to prove with equipment and imaging science than perceived with the naked eye. We have hands on videophiles here and performance is an attribute we hold in high regard along with the ability to explain why. I am providing some imaging science data to support both the approach of zoom and the possible advantages over anamorphic for the hands on performance enthusiast and front projection manufacturer. In the end let your pocket book, home theater vision, operational convenience and performance level lead you as it may at this time.</p>

<p><br />
<strong>Pulling it Altogether</strong></p>

<p>Earlier this year, sales engineer for Runco, John Bishop, writing an article for Widescreen Review, Scope Format Cinema For the Home - Part III, remarked that the most common of client requests is "make it as big as you can and get rid of those stupid black bars!"</p>

<p>The anamorphic approach was driven by 720p projection and 2.35 OAR, original aspect ratio, enthusiasts for the most part over the last number of years and with the 720p pixel matrix one can easily say required. 1080p changes all of that. You can bypass the anamorphic approach altogether and get great if not better imaging results by maintaining source signal integrity, 1:1 pixel mapping and original aspect ratios for the hands on videophile purist and OAR enthusiast. The market is not purist driven and even rarer, hands on, so the anamorphic method remains the best mass market approach to achieve an automated turn key native 2.35 system unless projection manufacturers implement motorized optics, a manual iris and memorized settings specifically for the zoom method. OAR enthusiasts are unfortunately rare and another desire of the mass market that cannot be denied is filling out that screen and getting rid of black bars regardless of its shape or that of the source; just get 'er filled! No doubt the Cinemascope 2.35 screen yields a more exciting presentation regardless of your stance on OAR as it fits better into our human world where size and expanse for the most part is perceived horizontally rather than vertically.</p>

<p>The best news of all? Whether you are a purist/OAR enthusiast or not the native 2.35 Cinemascope experience is available now at $1000 or less for just a screen via the zoom method. A starter system for anamorphic is the $1000 screen plus another $3000 for an anamorphic lens and another $1000 for an external scaler if the projector does not have a built in scaling feature for anamorphic applications. Going anamorphic at this level is still hands on so add another $3000 for the anamorphic automatic sled as well as your time or paying a professional to setup a home theater remote to automate the system. Runco's automated anamorphic turnkey system runs less than $30,000 for screen, projector and anamorphic lens. If anamorphic is your preference by all means check out the <a href="/articles/2007/01/cinemascope_hdh.php">CinemaScope HDHT series of articles </a>from Rodolfo covering the myriad of options, details and far lower prices for anamorphic 2.35 from other manufacturers for your CinemaScope home theater system!</p>

<p>One word of caution: Large screens and close viewing distances can induce motion sickness for some folks. Definitely take your family to a few cinemaplex outings and select seating that will be comparable to your eye filling home theater dream for testing. Take that experience and plan your home theater space, screen size and seating accordingly. It can be a sad day to find out that your wonderful big screen experience is preventing some members of your family from joining in the fun or that you and your spouse end up watching movies apart, in different rows, rather than side by side.                                                                                                                                                                                                 </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Richard Fisher</b>, <b>January 28, 2007  2:46 PM</b>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Richard Fisher', 533)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2007/01/cinemascope-zoom-and-anamorphic-methods.php" type="text/javascript" charset="utf-8"></script>
