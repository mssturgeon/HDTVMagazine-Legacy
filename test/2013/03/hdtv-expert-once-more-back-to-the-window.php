...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 5078 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/test/2013/03/hdtv-expert-once-more-back-to-the-window.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (6) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 5078";
...
<head>
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/test/2013/03/hdtv-expert-once-more-back-to-the-window.php" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=5078', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2013/03/hdtv-expert-once-more-back-to-the-window.php">HDTV Expert - Once More, Back to the &ndash;  Window??</a></td>
						</tr><tr>
...
<p>Most importantly, keep in mind that you don&#8217;t need to spend a lot of money to get reliable indoor TV reception. My best performers in the passive category were all under $50, and some were under $40. Check TV reception sites first (TVFool.com is one of the best) to get an idea of how strong signals may be at your location before you buy.</p>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Pete Putman', 5078)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2013/03/hdtv-expert-once-more-back-to-the-window.php" type="text/javascript" charset="utf-8"></script>
