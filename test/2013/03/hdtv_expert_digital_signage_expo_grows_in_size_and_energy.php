...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 5065 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/test/2013/03/hdtv-expert-digital-signage-expo-grows-in-size-and-energy.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (6) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 5065";
...
<head>
	...
	<meta name="keywords" content="ken werner, photo ken, digital signage, gorilla glass, show floor, display, signage, inch, displays, lcd, ken, sign, christie, signs, werner, showed, photo, digital, large, year, curved, panels, panel, sharp, glass" />
	<meta name="description" content="Digital Signage Expo (DSE), running from February 26 to 28 this year in Las Vegas, had 10% more exhibitors this year than last, but the growth felt larger than that and the high energy level was palpable. Exhibitors I questioned were pleased with their booth traffic, with some &amp;amp;#8220;complaining&amp;amp;#8221; of being too busy. One exhibitor [...]" />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/test/2013/03/hdtv-expert-digital-signage-expo-grows-in-size-and-energy.php" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=5065', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2013/03/hdtv-expert-digital-signage-expo-grows-in-size-and-energy.php">HDTV Expert - Digital Signage Expo Grows in Size and Energy</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Pete Putman</b> on <b>March  4, 2013</b>
...
<div id="attachment_2932" class="wp-caption alignleft" style="width: 410px"><a href="http://www.hdtvexpert.com/?attachment_id=2932" rel="attachment wp-att-2932"><img class=" wp-image-2932 " alt="Panasonic lo-res" src="http://www.hdtvexpert.com/wp-content/uploads/2013/03/Panasonic-lo-res.jpg" width="400" height="236" /></a><p class="wp-caption-text">Panasonic&#8217;s 85-inch plasma &#8220;white&#8221; board with sophisticated communications capabilities and SLOT2.0 for convenient embedding of PC functions. (Photo: Ken Werner)Panasonic showed an impressive 85-inch plasma touch screen with sophisticated communication capabilities for distance collaboration. A line or signature drawn on the screen tracked the stylus precisely and without lag.</p></div>
...
<p>The most interesting, though,  was from Bi-Search International (BSI), which showed a 26-inch LCD that was not only resized to 1366&#215;384 pixels, but was also curved!  Lots of interest from beverage companies, said BSI Account Sales Manager Jason Lee.  The LCD panel came from LG Display, and was then resized by Tovis (Korea) under the Tannas patent.  (Tannas Electronic Displays, which was also exhibiting, distributed a press release announcing that Tannas&#8217;s lawyers at filed a new complaint against Luxell Technologies for breach of a previous agreement that had settled a patent infringement suit.)  After resizing the LGD display, Tovis heated the LCD prior to bending it and placing it in its curved bezel, said Tovis&#8217;s In Ho Cho.  BSI also showed a 47-inch half-cut and curved display with 1920&#215;480 pixels.</p>
...
<p>Although digital signs seem ubiquitous, penetration is still quite low and the current double-digit annual growth can be sustained for years to come. That energy and optimism was reflected in this year&#8217;s DSE.</p>
<p>&nbsp;</p>
...
<div id="attachment_2939" class="wp-caption aligncenter" style="width: 410px"><a href="http://www.hdtvexpert.com/?attachment_id=2939" rel="attachment wp-att-2939"><img class="size-full wp-image-2939 " alt="Best Buy lores" src="http://www.hdtvexpert.com/wp-content/uploads/2013/03/Best-Buy-lores.jpg" width="400" height="604" /></a><p class="wp-caption-text">Best Buy will field-test this kiosk/vending machine with transparent LCD in the door to see if it produces better sell-through than its 1500 conventional kiosks. (Photo: Ken Werner)</p></div>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Pete Putman', 5065)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2013/03/hdtv-expert-digital-signage-expo-grows-in-size-and-energy.php" type="text/javascript" charset="utf-8"></script>
