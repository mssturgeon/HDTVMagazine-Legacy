	...
	switch (6) {
		...
		case 9: # Podcasts
			...
			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Living with 4K &ndash; The REDRAY 4K Digital Cinema Player" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Living with 4K &ndash; The REDRAY 4K Digital Cinema Player" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Living with 4K &ndash; The REDRAY 4K Digital Cinema Player" />
...
<html>
<head>
	<title>HDTV Magazine - Living with 4K &ndash; The REDRAY 4K Digital Cinema Player</title>
	<meta name="keywords" content="redray player, blu ray, next article, disc end, file format, player, redray, red, hdmi, media, content, new, sony, digital, bit, review, audio, output, blu, ray, players, khz, fps, consumer, –" />
...
I also plan to review the 4K media server Sony lends to new owners of new Sony 4K panels to display some 4K movies until the consumer market can supply it (see further below); I just got the 4K Sony server this week.  The server is configured as a Dell computer CPU with recorded 4K movies, it comes in a big box with a bunch of accessories, including a tablet, 16-feet HDMI high-speed cable, etc.  I will compare both media players using my 4K Sony projector. 

The Redray player is not..." />
	<meta name="title" content="Living with 4K &amp;ndash; The REDRAY 4K Digital Cinema Player" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Living with 4K &amp;ndash; The REDRAY 4K Digital Cinema Player" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/test/2013/01/living-with-4k-the-redray-4k-digital-cinema-player.php" />
...
<body onload="init();"><div id="body_container">
	...
	<table class="bare" cellpadding="0" cellspacing="0"><tr>
		<td id="left">
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2013/01/living-with-4k-the-redray-4k-digital-cinema-player.php">Living with 4K &ndash; The REDRAY 4K Digital Cinema Player</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>" class="<?=$viglink_suppress?>">
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Rodolfo La Maestra</b>, <b>January 23, 2013  9:43 PM</b>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Rodolfo La Maestra', 5010)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2013/01/living-with-4k-the-redray-4k-digital-cinema-player.php" type="text/javascript" charset="utf-8"></script>
