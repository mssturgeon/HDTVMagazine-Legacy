...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/test/2011/06/3dtv-the-battle-of-passive-vs-active-methods.php&amp;title=3DTV - The Battle of Passive vs. Active Methods">
		<span style="display:none">As you may be aware there is a battle of concepts going on in the 3DTV market for home panels. The price of the glasses has been one main difference for consumers looking for low cost solutions for 3D group viewing, but that is only part of the story.
...
Manufacturers of passive polarized 3DTVs claim...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
<div id="dd_right"><ul>
	...
	<!--li class="li_horizontal"><fb:like href="http://www.hdtvmagazine.com/test/2011/06/3dtv-the-battle-of-passive-vs-active-methods.php" layout="button_count" show_faces="false" width="100"></fb:like></li-->
	<!--li class="li_horizontal"><a name="fb_share" type="button_count" href="http://www.facebook.com/sharer.php"></a></li-->
</ul></div>
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/test/2011/06/3dtv-the-battle-of-passive-vs-active-methods.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
...
Manufacturers of passive polarized 3DTVs claim..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/test/2011/06/3dtv-the-battle-of-passive-vs-active-methods.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4421', 340, 125);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2011/06/3dtv-the-battle-of-passive-vs-active-methods.php">3DTV - The Battle of Passive vs. Active Methods</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>June 30, 2011</b>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 4421)?>
...
<!-- FM Medium Rectangle Zone -->
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2011/06/3dtv-the-battle-of-passive-vs-active-methods.php" type="text/javascript" charset="utf-8"></script>
