...
Watching these films on Blu-ray..." />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/test/2011/10/bluray-review-star-wars-episodes-iv-vi.php" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4540', 340, 125);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2011/10/bluray-review-star-wars-episodes-iv-vi.php">Blu-ray Review: Star Wars (Episodes IV - VI)</a></td>
						</tr><tr>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 4540)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2011/10/bluray-review-star-wars-episodes-iv-vi.php" type="text/javascript" charset="utf-8"></script>
