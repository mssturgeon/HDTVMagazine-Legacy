...
The battle of words, ads, and press releases has become..." />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/test/2011/10/passive-3dtv-brain-perception-an-excuse-for-technical-limitations.php" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4552', 340, 125);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2011/10/passive-3dtv-brain-perception-an-excuse-for-technical-limitations.php">Passive 3DTV Brain Perception - An Excuse for Technical Limitations?</a></td>
						</tr><tr>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 4552)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2011/10/passive-3dtv-brain-perception-an-excuse-for-technical-limitations.php" type="text/javascript" charset="utf-8"></script>
