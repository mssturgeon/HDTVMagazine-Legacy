...
Imagine spending your Saturday visiting new car dealers..." />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/test/2011/10/perception-of-passive-3dtv-a-nobrainer-analogy.php" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4558', 340, 125);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2011/10/perception-of-passive-3dtv-a-nobrainer-analogy.php">Perception of Passive 3DTV - A No-Brainer Analogy</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>October 24, 2011  9:09 PM</b>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 4558)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2011/10/perception-of-passive-3dtv-a-nobrainer-analogy.php" type="text/javascript" charset="utf-8"></script>
