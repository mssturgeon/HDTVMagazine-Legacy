...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/test/2011/04/one-installers-opinion-another-terrys-top-ten.php&amp;title=One Installer’s Opinion – (another) Terry’s Top Ten">
		<span style="display:none">Before we get to the meat, let me first thank this readership for putting up with my rants and occasional insight all this time. It's been a genuine labor of love, I promise you.
...
As they say on DWTS, &quot;In no particular order...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
<div id="dd_right"><ul>
	...
	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/test/2011/04/one-installers-opinion-another-terrys-top-ten.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	<!--li class="li_horizontal"><fb:like href="http://www.hdtvmagazine.com/test/2011/04/one-installers-opinion-another-terrys-top-ten.php" layout="button_count" show_faces="false" width="100"></fb:like></li-->
...
As they say on DWTS, &quot;In no particular order..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/test/2011/04/one-installers-opinion-another-terrys-top-ten.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4300', 340, 125);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2011/04/one-installers-opinion-another-terrys-top-ten.php">One Installer’s Opinion – (another) Terry’s Top Ten</a></td>
						</tr><tr>
			...
			<!-- Main Article Body -->
			<div id="<?=$container?>">
				<?=getReviewHeader(4300, $amazon_tracking_id)?>
				<!--?=$v_buttons?-->
				<p class="editorial">The following article originally appeared in Wide Screen Review (WSR) magazine and is being republished courtesy of it's author, Terry Paullin.</p><p>...Hmmm ... Issue #150 ... hmmm... should be a retrospective, for sure. Seems like just yesterday that I penned my first column in issue #38, but the truth is that "yesterday" was actually more than ten years ago.
...
 </p><p style="text-align: justify"><span style="font-family:Comic Sans MS; font-size:14pt">
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>April 13, 2011  8:23 PM</b>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 4300)?>
...
<!-- FM Medium Rectangle Zone -->
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2011/04/one-installers-opinion-another-terrys-top-ten.php" type="text/javascript" charset="utf-8"></script>
