...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/test/2011/05/3d-technology-damaging-hd-viewing.php&amp;title=3D Technology Damaging HD Viewing">
		<span style="display:none">Two months ago I cautioned consumers about the possibility that some new passive 3DTVs could affect the quality of 3D side-by-side images but also the quality of HD viewing, which is what most viewers would still watch because most content is not available in 3D.
...
Recent events that happened when several 3D public theaters projected 2D movies may bring to surface the potential of possibly affecting 2D viewing on some 3DTVs at home...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
<div id="dd_right"><ul>
	...
	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/test/2011/05/3d-technology-damaging-hd-viewing.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	<!--li class="li_horizontal"><fb:like href="http://www.hdtvmagazine.com/test/2011/05/3d-technology-damaging-hd-viewing.php" layout="button_count" show_faces="false" width="100"></fb:like></li-->
...
Recent events that happened when several 3D public theaters projected 2D movies may bring to surface the potential of possibly affecting 2D viewing on some 3DTVs at home..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/test/2011/05/3d-technology-damaging-hd-viewing.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4369', 340, 125);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2011/05/3d-technology-damaging-hd-viewing.php">3D Technology Damaging HD Viewing</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>May 29, 2011 12:50 PM</b>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 4369)?>
...
<!-- FM Medium Rectangle Zone -->
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2011/05/3d-technology-damaging-hd-viewing.php" type="text/javascript" charset="utf-8"></script>
