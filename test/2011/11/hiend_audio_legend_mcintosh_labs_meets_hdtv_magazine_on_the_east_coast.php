...
McIntosh was and still is up there among the few American companies that still work very hard to continue producing quality audio products. They still have their traditional metered displays and blue-hued backlighting and unique knobs. Audio quality and elegant appearance made McIntosh so special to many for decades." />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/test/2011/11/hiend-audio-legend-mcintosh-labs-meets-hdtv-magazine-on-the-east-coast.php" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4578', 340, 125);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/test/2011/11/hiend-audio-legend-mcintosh-labs-meets-hdtv-magazine-on-the-east-coast.php">Hi-End Audio Legend McIntosh Labs Meets HDTV Magazine on the East Coast</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>November 29, 2011  8:46 PM</b>
			...
			<? if (6 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 4578)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/test/2011/11/hiend-audio-legend-mcintosh-labs-meets-hdtv-magazine-on-the-east-coast.php" type="text/javascript" charset="utf-8"></script>
