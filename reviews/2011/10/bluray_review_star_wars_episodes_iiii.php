...
If the original trilogy never existed, and all we had were the prequels, I think they would be considered good movies. However, they will always live in the shadow of Luke, Leia, and Han. Episodes I – III lack the charisma and fun of the original trilogy, the plot is..." />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/reviews/2011/10/bluray-review-star-wars-episodes-iiii.php" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4538', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/reviews/2011/10/bluray-review-star-wars-episodes-iiii.php">Blu-ray Review: Star Wars (Episodes I-III)</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>October 25, 2011</b>
			...
			<? if (8 != 7) echo getBoxMoreFromAuthor('The HT Guys', 4538)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/reviews/2011/10/bluray-review-star-wars-episodes-iiii.php" type="text/javascript" charset="utf-8"></script>
