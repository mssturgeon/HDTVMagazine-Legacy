...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=BenQ W10000 1080p DLP Front Projector&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/reviews/2007/07/benq-w10000-1080p-dlp-front-projector.php&amp;title=BenQ W10000 1080p DLP Front Projector">
		<span style="display:none">1080p DLP front projection is slowly starting to dribble into the market but pricing has been high. BenQ is providing the W10000 for the street price of just under $6000, providing a full 1920x1080 DLP Dark Chip3 DMD far closer in price range with other recently released 1080p technology at $5k and below.

As noted, this is a full 1920x1080 chip and does not use wobulation. The advantage here is the potential for a pixel perfect response. Bear in mind this also means pixels are going to be more visible but whether or not that is a problem is a matter of viewing distance. This is a single chip display utilizing an 8 segment color wheel...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
As noted, this is a full 1920x1080 chip and does not use wobulation. The advantage here is the potential for a pixel perfect response. Bear in mind this also means pixels are going to be more visible but whether or not that is a problem is a matter of viewing distance. This is a single chip display utilizing an 8 segment color wheel..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/reviews/2007/07/benq-w10000-1080p-dlp-front-projector.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=628', 340, 125);">Add ASIN</a>
