...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/reviews/2007/03/lg-bh100-universal-hd-dvdbluray-player.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="LG BH100 Universal HD DVD/Blu-ray Player" />
...
<head>
	...
	<meta property="og:title" content="LG BH100 Universal HD DVD/Blu-ray Player" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/reviews/2007/03/lg-bh100-universal-hd-dvdbluray-player.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="One of the biggest complaints with the Blu-ray and HD DVD disc format war is the need to buy separate players for each format. If HD and film is your passion you have a difficult choice because not all movies will be released in both formats. A large portion of the potential &quot;high definition disc&quot; consumers are waiting for one of two things before investing their hard-earned dollars in another format: 1) a clear winner in the format war, or 2) a universal player.  When LG unveiled their universal player at the 2007 Consumer Electronics Show (CES)..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=558', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
