...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/reviews/2007/05/panasonic-th50pz700u.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (8) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 606";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Panasonic  TH-50PZ700U" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Panasonic  TH-50PZ700U" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Panasonic  TH-50PZ700U" />
...
<html>
<head>
	<title>HDTV Magazine - Panasonic  TH-50PZ700U</title>
	<meta name="keywords" content="price buy, any better, street price, looked good, overly compressed, content, our, buy, review, model, best, set, any, great, watching, looked, bad, really, well, look, ray, still, much, panasonic, black" />
	...
	<meta name="title" content="Panasonic  TH-50PZ700U" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Panasonic  TH-50PZ700U" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/reviews/2007/05/panasonic-th50pz700u.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="We just reviewed the Panasonic TH-50PX75U, which comes with a street price of $2100 a few shows ago.  We loved the TV, but it's still a 720p model.  We got a ton of email asking why we were living in the past, why we would have anything to do with a 720p plasma when the new 1080p model, the TH-50PZ700U, is already available.  To be perfectly honest, we didn't have much luck getting our hands on one of the 1080p sets, so we went ahead with the 720p.  Add on the fact that we still really like the 720p set, and our minds were made up.  But not to turn a deaf ear to our loyal listeners, we tried our best to find a way to review the 1080p model.  By the way, the extra pixels add up to a street price of $2900." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=606', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/reviews/2007/05/panasonic-th50pz700u.php">Panasonic  TH-50PZ700U</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>May 30, 2007</b>
...
Overall we believe the TH-50PZ700U is excellent for watching movies, or any content with very high quality compression, so maybe we should say movies and Discovery HD Theater (buy now).  But if you watch a lot of overly compressed HD content, or a lot of standard definition shows, our advice would be to save a thousand dollars or so and get a 720p model (buy now).  You might be missing some of the wow factor with 1080p content, but will enjoy the other stuff a lot more.<br />
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>May 30, 2007  8:52 AM</b>
			...
			<? if (8 != 7) echo getBoxMoreFromAuthor('The HT Guys', 606)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/reviews/2007/05/panasonic-th50pz700u.php" type="text/javascript" charset="utf-8"></script>
