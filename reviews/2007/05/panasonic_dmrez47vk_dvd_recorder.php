...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/reviews/2007/05/panasonic-dmrez47vk-dvd-recorder.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Panasonic DMR-EZ47VK DVD Recorder" />
...
" />
	...
	<meta property="og:title" content="Panasonic DMR-EZ47VK DVD Recorder" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/reviews/2007/05/panasonic-dmrez47vk-dvd-recorder.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="The Panasonic DMR-EZ47VK can be thought of as a digital video Swiss Army knife. It has a built in ATSC tuner, DVD recording capability, VHS Playback and dubbing, and its an upconverting DVD player (up to 1080p via HDMI) to boot. So with all this capability we were excited when the unit showed up at the home offices of the HT Guys. On paper this device was too good to be true. So how did  it fare in the real world?
" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=588', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
