...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Panasonic TH-50PX75U 50 Inch Plasma TV&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/reviews/2007/05/panasonic-th50px75u-50-inch-plasma-tv.php&amp;title=Panasonic TH-50PX75U 50 Inch Plasma TV">
		<span style="display:none">Back in January of this year we reviewed the Panasonic TH-50PX60U and were impressed with what we saw. At that time we had three things we didn't like about the TV. Today we take a look at Panasonic's new 50 inch 720p plasma, the TH-50PX75U, which comes with a street price of $2100 and addresses the three nit picks we had with the earlier model. This is a 720p TV with a resolution of 1366 x 768, a 10,000:1 contrast ratio, two HDMI inputs, and an SD card reader. One of the issues we (mainly Ara) had with its predecessor was its silver bezel. The 50PX75U comes with a thin black bezel that hides the speakers very well and looks quite good even when its off. Rounding out the features, the TV come with built-in ATSC/QAM/NTSC Tuners. Build quality is quite good. The product dimensions are 47.7 x 3.8 x 31.3 inches and it weighs 89.8 pounds which is almost identical to the previous model.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (8) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 602";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Panasonic TH-50PX75U 50 Inch Plasma TV" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Panasonic TH-50PX75U 50 Inch Plasma TV" />
...
<html>
<head>
	<title>HDTV Magazine - Panasonic TH-50PX75U 50 Inch Plasma TV</title>
	<meta name="keywords" content="recommend leaving, calibration settings, quite good, our, review, black, color, recommend, good, settings, plasma, issues, picture, buy, time, pleased, panasonic, found, well, leaving, job, bezel, analog, great, january" />
	...
	<meta name="title" content="Panasonic TH-50PX75U 50 Inch Plasma TV" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/reviews/2007/05/panasonic-th50px75u-50-inch-plasma-tv.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=602', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/reviews/2007/05/panasonic-th50px75u-50-inch-plasma-tv.php">Panasonic TH-50PX75U 50 Inch Plasma TV</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>May 22, 2007</b>
...
Black Level: Light</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>May 22, 2007  7:00 AM</b>
			...
			<? if (8 != 7) echo getBoxMoreFromAuthor('The HT Guys', 602)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/reviews/2007/05/panasonic-th50px75u-50-inch-plasma-tv.php" type="text/javascript" charset="utf-8"></script>
