...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=The Oppo DV-980H 1080p Up-Converting DVD Player&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/reviews/2007/08/the-oppo-dv980h-1080p-upconverting-dvd-player.php&amp;title=The Oppo DV-980H 1080p Up-Converting DVD Player">
		<span style="display:none">It is no secret that the HT Guys like and recommend Oppo Digital upconverting DVD players. We have reviewed the current lineup of DV-970HD, OPDV971H, and DV-981HD players in the past. Today we take a look at the new Oppo Digital DV-980H. Essentially the 980 is the same as a 970 but with 1080p and better audio capability for just $20 more. This review will not be as detailed as previous Oppo reviews because we found that the performance was similar to the 970. We'll concentrate on what is new or what has improved.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (8) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 660";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download The Oppo DV-980H 1080p Up-Converting DVD Player" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="The Oppo DV-980H 1080p Up-Converting DVD Player" />
...
<html>
<head>
	<title>HDTV Magazine - The Oppo DV-980H 1080p Up-Converting DVD Player</title>
	<meta name="keywords" content="oppo digital, dvd player, upconverting dvd, good job, dvd players, audio, dvd, player, oppo, digital, video, job, high, found, our, upconverting, players, good, universal, divx, resolution, better, analog, bit, remote" />
	...
	<meta name="title" content="The Oppo DV-980H 1080p Up-Converting DVD Player" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/reviews/2007/08/the-oppo-dv980h-1080p-upconverting-dvd-player.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=660', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/reviews/2007/08/the-oppo-dv980h-1080p-upconverting-dvd-player.php">The Oppo DV-980H 1080p Up-Converting DVD Player</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>August  2, 2007</b>
...
At $170 you can to buy a cheaper DVD player but not one that will support more audio and video formats. The Oppo Digital DV-980H will elevate the viewing experience of your current DVD library. If you want to ride out the next generation DVD format war, this product will help you do it.<br />
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>August  2, 2007  8:10 AM</b>
			...
			<? if (8 != 7) echo getBoxMoreFromAuthor('The HT Guys', 660)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/reviews/2007/08/the-oppo-dv980h-1080p-upconverting-dvd-player.php" type="text/javascript" charset="utf-8"></script>
