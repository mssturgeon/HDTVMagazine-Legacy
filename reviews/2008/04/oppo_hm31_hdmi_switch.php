...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/reviews/2008/04/oppo-hm31-hdmi-switch.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="OPPO HM-31 HDMI Switch" />
...
<head>
	...
	<meta property="og:title" content="OPPO HM-31 HDMI Switch" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/reviews/2008/04/oppo-hm31-hdmi-switch.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="It's just a switcher; there is nothing to set up so installation is a newbie breeze. The power supply wall wart is offset to the side to avoid taking up two outlets. That seems like a great feature but that will depend on the orientation of your outlets. Oddly enough for me my outlets and strips made that the most difficult part of this installation. It supports hot plug and play and auto switching as evidenced when I hooked it up. I simply inserted the HM-31 in between a Toshiba HD-A35 HD DVD player and a Denon AVR-3808Ci receiver while in the midst of a movie. I looked up at the screen and within a few moments there was Phantom of the Opera in 1080p24 with sound. A quick look at the receiver confirmed my bitstream DTS True HD was still engaged. From there I connected..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1322', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
