...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Sony KDL-46XBR4 46 inch LCD HDTV&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/reviews/2008/05/sony-kdl46xbr4-46-inch-lcd-hdtv.php&amp;title=Sony KDL-46XBR4 46 inch LCD HDTV">
		<span style="display:none">The TV looks visually appealing and has a high build quality. There is a clear plastic frame that goes around the TV. The TV weighs 84 pounds (38 Kg) with the pedestal and measures 49.7&quot; (126 cm) wide by 31.3&quot; (79.5 cm) high by 17.7&quot; (32 cm) deep (4.8&quot; (12 cm) without the pedestal). We immediately took the TV off the default setting and changed it to cinema. Cox cable looked very bad. So bad that we recommended switching to satellite. Braden has Cox as one of his sources so his impression was that Cox does not look that bad on his TVs. It could be that this TV does not do well with compressed sources. OTA HD looked much better. In general OTA digital channels looked better than the SD coming from the Cox cable box.

We then popped in a Blu-ray disc...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (8) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1399";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Sony KDL-46XBR4 46 inch LCD HDTV" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Sony KDL-46XBR4 46 inch LCD HDTV" />
...
<html>
<head>
	<title>HDTV Magazine - Sony KDL-46XBR4 46 inch LCD HDTV</title>
	<meta name="keywords" content="blu ray, kdl xbr, cox cable, sony kdl, our friend, picture, looked, settings, our, blu, ray, good, color, sony, enhancer, better, cox, calibration, friend, see, cinema, cable, bit, ota, improved" />
...
We then popped in a Blu-ray disc..." />
	<meta name="title" content="Sony KDL-46XBR4 46 inch LCD HDTV" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/reviews/2008/05/sony-kdl46xbr4-46-inch-lcd-hdtv.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1399', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/reviews/2008/05/sony-kdl46xbr4-46-inch-lcd-hdtv.php">Sony KDL-46XBR4 46 inch LCD HDTV</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>May 20, 2008  9:23 AM</b>
			...
			<? if (8 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1399)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/reviews/2008/05/sony-kdl46xbr4-46-inch-lcd-hdtv.php" type="text/javascript" charset="utf-8"></script>
