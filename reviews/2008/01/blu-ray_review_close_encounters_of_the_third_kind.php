...
<head>
	...
	<meta name="keywords" content="close encounters, blu ray, special features, third kind, encounters third, movie, audio, special, encounters, scenes, review, Close, Encounters, close, blu, ray, Blu, sound, features, disc, scene, Special, Ara, still, kind" />
	...
	<title>HDTV Magazine Reviews - Blu-ray Review: Close Encounters of the Third Kind</title>
...
<body><div id="body_container">
	<?
		...
		$base_url = strleftback(PHP_SELF, '/') . '/blu-ray_review_close_encounters_of_the_third_kind';
		$print_url = $base_url .'-print.php';
		$save_url = $base_url .'-save.php';
		$title_encoded = rawurlencode(addslashes('Blu-ray Review: Close Encounters of the Third Kind'));
		$email_url = "mailto:?subject=HDTV Magazine: $title_encoded&amp;body=http://www.hdtvmagazine.com/reviews/2008/01/blu-ray_review_close_encounters_of_the_third_kind.php";
		if ($author[img] != '' && 8 != 7) {
	...
	<table class="bare" cellpadding="0" cellspacing="0" style="width:100%;">
		<tr>
			...
			<td class="article_title" colspan="2">Blu-ray Review: Close Encounters of the Third Kind</td>
		</tr><tr>
			<td id="article_byline" nowrap="nowrap">
				...
				<!--span><img src="/images/digg.png" alt="Digg Article" align="absmiddle" /><a target="_blank" href="http://digg.com/submit?url=http://www.hdtvmagazine.com/reviews/2008/01/blu-ray_review_close_encounters_of_the_third_kind.php&amp;phase=2">Digg</a></span-->
				<span><img src="/images/newsvine.gif" alt="Add to Newsvine" align="absmiddle" /><a href="javascript:addToNewsvine('http://www.hdtvmagazine.com/reviews/2008/01/blu-ray_review_close_encounters_of_the_third_kind.php', '<?=$title_encoded?>')">Newsvine</a></span>
				<span><img src="/images/delicious.gif" alt="Add to Del.icio.us" align="absmiddle" /><a target="_blank" href="http://del.icio.us/post?url=http://www.hdtvmagazine.com/reviews/2008/01/blu-ray_review_close_encounters_of_the_third_kind.php&amp;title=<?=$title_encoded?>">Del.icio.us</a></span>
...
<p><strong>Final Grade</strong> - A solid B! But still a great movie. It's just not what you'll use to show off your Home Theater.</p>
  ...
  <td id="left"><!-- Comments -->
	...
	?>
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/reviews/2008/01/blu-ray_review_close_encounters_of_the_third_kind.php" type="text/javascript" charset="utf-8"></script>
</div></body>
</html>
