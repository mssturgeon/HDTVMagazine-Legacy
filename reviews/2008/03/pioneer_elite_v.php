...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Pioneer Elite VSX-94TXH 7.1 Channel A/V Receiver&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/reviews/2008/03/pioneer-elite-vsx94txh-71-channel-av-receiver.php&amp;title=Pioneer Elite VSX-94TXH 7.1 Channel A/V Receiver">
		<span style="display:none">Last month Ara picked up an Apple TV for use in his media room. That became the fourth HDMI device which was one device too many for his Yamaha RX-V2700 receiver. So he contacted Pioneer to see if he could review the Pioneer VSX-94TXH 7.1 A/V Receiver. In actuality, Ara was auditioning the receiver for his own personal use. Within a few days the receiver showed up and it's not going back! Just so everyone is clear, Ara has to pay for the receiver to keep it. </span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (8) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1294";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Pioneer Elite VSX-94TXH 7.1 Channel A/V Receiver" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Pioneer Elite VSX-94TXH 7.1 Channel A/V Receiver" />
...
<html>
<head>
	<title>HDTV Magazine - Pioneer Elite VSX-94TXH 7.1 Channel A/V Receiver</title>
	<meta name="keywords" content="auto calibration, vsx txh, pioneer elite, dts master, music cds, receiver, sound, hdmi, pioneer, txh, video, audio, inputs, calibration, music, power, cable, remote, get, dolby, ara, receivers, via, find, any" />
	...
	<meta name="title" content="Pioneer Elite VSX-94TXH 7.1 Channel A/V Receiver" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/reviews/2008/03/pioneer-elite-vsx94txh-71-channel-av-receiver.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1294', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/reviews/2008/03/pioneer-elite-vsx94txh-71-channel-av-receiver.php">Pioneer Elite VSX-94TXH 7.1 Channel A/V Receiver</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>March 14, 2008</b>
			...
			<div id="<?=$container?>">
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>March 14, 2008  9:17 AM</b>
			...
			<? if (8 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1294)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/reviews/2008/03/pioneer-elite-vsx94txh-71-channel-av-receiver.php" type="text/javascript" charset="utf-8"></script>
