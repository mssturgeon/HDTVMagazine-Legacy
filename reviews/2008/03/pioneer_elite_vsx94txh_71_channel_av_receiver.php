...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/reviews/2008/03/pioneer-elite-vsx94txh-71-channel-av-receiver.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Pioneer Elite VSX-94TXH 7.1 Channel A/V Receiver" />
...
<head>
	...
	<meta property="og:title" content="Pioneer Elite VSX-94TXH 7.1 Channel A/V Receiver" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/reviews/2008/03/pioneer-elite-vsx94txh-71-channel-av-receiver.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Last month Ara picked up an Apple TV for use in his media room. That became the fourth HDMI device which was one device too many for his Yamaha RX-V2700 receiver. So he contacted Pioneer to see if he could review the Pioneer VSX-94TXH 7.1 A/V Receiver. In actuality, Ara was auditioning the receiver for his own personal use. Within a few days the receiver showed up and it's not going back! Just so everyone is clear, Ara has to pay for the receiver to keep it. " />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1294', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
