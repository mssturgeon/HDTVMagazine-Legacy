...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/reviews/2008/02/sony-playstation-3-ps3-as-a-bluray-player.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (8) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1282";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Sony PlayStation 3 (PS3) as a Blu-ray Player" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Sony PlayStation 3 (PS3) as a Blu-ray Player" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Sony PlayStation 3 (PS3) as a Blu-ray Player" />
...
<html>
<head>
	<title>HDTV Magazine - Sony PlayStation 3 (PS3) as a Blu-ray Player</title>
	<meta name="keywords" content="blu ray, ray player, high definition, home theater, stream network, blu, ray, player, network, support, video, really, audio, playback, need, buy, players, well, any, first, remote, internet, control, market, content" />
	...
	<meta name="title" content="Sony PlayStation 3 (PS3) as a Blu-ray Player" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Sony PlayStation 3 (PS3) as a Blu-ray Player" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/reviews/2008/02/sony-playstation-3-ps3-as-a-bluray-player.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="It's pretty clear by now that Blu-ray won the high definition video disk war.  By the end of this year HD DVD will be a distant memory and those who want to watch High Definition movies will need a Blu-ray player.  There are a bunch of options out there for those in the market, and the Sony PlayStation 3 has been talked about as the most capable player available.  For a long time it was the least expensive way to get a Blu-ray player.  That isn't true anymore, but it's still close.  It's currently available in two models, a 40 GB model for $399.99 and an 80 GB model for $499.99.  Today we'll ignore the gaming side for the most part and look at how the device performs as a home theater device..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1282', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/reviews/2008/02/sony-playstation-3-ps3-as-a-bluray-player.php">Sony PlayStation 3 (PS3) as a Blu-ray Player</a></td>
						</tr><tr>
...
<p>The PS3 works well as a network player, but the interface isn't all that sexy.&nbsp; It gets the job done, but without the "wow" factor.&nbsp; It will playback audio, as MP3 or WMV, photos, and MPEG-4 videos including support for DIVX.&nbsp; Many DLNA servers will actually transcode video on the fly to match what the PS3 needs, but not all of them, so you may need to do some re-encoding.&nbsp; We watched I Am ... not going to tell you what we watched, but we did watch a few movies over the network and they looked and sounded fine.&nbsp; Obviously the better the compression the better they'll look.&nbsp; As a network based audio/video player, it works.&nbsp; But don't buy it specifically for that.&nbsp; Downloaded movie trailers looked absolutely amazing, so the PS3 is certainly capable of some awe inspiring video playback.&nbsp; There is the option to install another OS on the PS3, but we haven't gotten that deep into it yet to comment on how well it works.&nbsp; There are differing reports on the internet about it.</p><p>Overall the PS3 is a great Blu-ray player and upconverting DVD player, does a solid job playing network content, and is actually a really good game platform as well, if anyone is still interested in that.&nbsp; For $399 it really makes a lot of sense because of the upgradability and future-proof nature of the architecture.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>February 29, 2008  8:08 AM</b>
			...
			<? if (8 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1282)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/reviews/2008/02/sony-playstation-3-ps3-as-a-bluray-player.php" type="text/javascript" charset="utf-8"></script>
