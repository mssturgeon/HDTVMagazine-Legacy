...
However, you should give this little box a chance and see the results by yourself. Although I am warning you, when you do that it is almost guaranteed that you would never turn this processor off. You can adjust the effect to your preferred level of image realism and depth, and play with the settings for every content, and once you do that, there will not be a comeback to using your system without this box, you will be hooked." />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/reviews/2012/12/review-darbeevision-visual-presence-dvp-5000-darblet.php" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4954', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/reviews/2012/12/review-darbeevision-visual-presence-dvp-5000-darblet.php">Review: DarbeeVision Visual Presence DVP 5000 (Darblet)</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Rodolfo La Maestra</b> on <b>December 28, 2012</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=531&category=Digital Video Processors">Digital Video Processors</a></b>
							</td>
						</tr><tr colspan="2">
...
<tr><td>RGB 0-255</td><td>RGB PC Range</td><td>RGB 0-255</td></tr>
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Rodolfo La Maestra</b>, <b>December 28, 2012  7:52 AM</b>
			...
			<? if (8 != 7) echo getBoxMoreFromAuthor('Rodolfo La Maestra', 4954)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/reviews/2012/12/review-darbeevision-visual-presence-dvp-5000-darblet.php" type="text/javascript" charset="utf-8"></script>
