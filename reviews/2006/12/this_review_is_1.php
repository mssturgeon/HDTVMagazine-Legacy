...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 491 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=The Mvix MX-760HD Multimedia Player&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/reviews/2006/12/the-mvix-mx760hd-multimedia-player.php&amp;title=The Mvix MX-760HD Multimedia Player">
		<span style="display:none">If you remember back in March of this year (Episode 76), we reviewed the Mvix 5000U multimedia player.  We really liked it, but were hoping for the release of a wireless version.  Well wait no longer, the wireless version has arrived.  But not only is it wireless, it also fully supports high definition, so it's right up our alley...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (8) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 491";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download The Mvix MX-760HD Multimedia Player" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="The Mvix MX-760HD Multimedia Player" />
...
<html>
<head>
	<title>HDTV Magazine - The Mvix MX-760HD Multimedia Player</title>
	<meta name="keywords" content="hard drive, wireless network, external usb, upgrade future, wired network, wireless, network, drive, well, usb, files, wired, mvix, wmv, dvd, hard, really, device, connected, isn, back, firmware, simple, external, connect" />
	<meta name="description" content="If you remember back in March of this year (Episode 76), we reviewed the Mvix 5000U multimedia player.  We really liked it, but were hoping for the release of a wireless version.  Well wait no longer, the wireless version has arrived.  But not only is it wireless, it also fully supports high definition, so it's right up our alley..." />
	<meta name="title" content="The Mvix MX-760HD Multimedia Player" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/reviews/2006/12/the-mvix-mx760hd-multimedia-player.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=491', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/reviews/2006/12/the-mvix-mx760hd-multimedia-player.php">The Mvix MX-760HD Multimedia Player</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>December 17, 2006</b>
...
<p>Overall the Mvix MX-760HD was a smashing success.  We can't wait to get the new firmware and try it out as a NAS device.  That should also allow us to update the files on the device itself without having to USB cable it to a computer.  Very cool feature.  With that enabled, one of these may work really well in the car as a mobile entertainment center.  It's really like a home theater Swiss army knife, and would fit well in just about anyone's stocking. </p>
			...
			<? if (8 != 7) echo getBoxMoreFromAuthor('The HT Guys', 491)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/reviews/2006/12/the-mvix-mx760hd-multimedia-player.php" type="text/javascript" charset="utf-8"></script>
