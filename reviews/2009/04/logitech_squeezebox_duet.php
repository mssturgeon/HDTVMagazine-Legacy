...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/reviews/2009/04/logitech-squeezebox-duet.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Logitech Squeezebox Duet" />
...
According to the Logitech Website, the Squeezebox Duet lets you..." />
	...
	<meta property="og:title" content="Logitech Squeezebox Duet" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/reviews/2009/04/logitech-squeezebox-duet.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="There are quite a few solutions on the market for wireless digital audio. When Logitech acquired Slim Devices a couple years ago, they jumped into the fray with the Squeezebox line of products. Logitech quickly turned out their own twist on the product line, the Squeezebox Duet. We've had one in the HT Guys lab for quite a while and recently got the chance to plug it in, power it on and give it a listen.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1706', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
