...
As with past models..." />
	<title>HDTV Magazine Reviews - OPPO DV-983H Upconverting DVD Player</title>
...
<body><div id="body_container">
	<?
		...
		$base_url = strleftback(PHP_SELF, '/') . '/oppo_dv-983h_upconverting_dvd_player';
		$print_url = $base_url .'-print.php';
		$save_url = $base_url .'-save.php';
		$title_encoded = rawurlencode(addslashes('OPPO DV-983H Upconverting DVD Player'));
		$email_url = "mailto:?subject=HDTV Magazine: $title_encoded&amp;body=http://www.hdtvmagazine.com/reviews/2009/01/oppo_dv-983h_upconverting_dvd_player.php";
		if ($author[img] != '' && 8 != 7) {
	...
	<table class="bare" cellpadding="0" cellspacing="0" style="width:100%;">
		<tr>
			...
			<td class="article_title" colspan="2">OPPO DV-983H Upconverting DVD Player</td>
		</tr><tr>
			<td id="article_byline" nowrap="nowrap">
				...
				<!--span><img src="/images/digg.png" alt="Digg Article" align="absmiddle" /><a target="_blank" href="http://digg.com/submit?url=http://www.hdtvmagazine.com/reviews/2009/01/oppo_dv-983h_upconverting_dvd_player.php&amp;phase=2">Digg</a></span-->
				<span><img src="/images/newsvine.gif" alt="Add to Newsvine" align="absmiddle" /><a href="javascript:addToNewsvine('http://www.hdtvmagazine.com/reviews/2009/01/oppo_dv-983h_upconverting_dvd_player.php', '<?=$title_encoded?>')">Newsvine</a></span>
				<span><img src="/images/delicious.gif" alt="Add to Del.icio.us" align="absmiddle" /><a target="_blank" href="http://del.icio.us/post?url=http://www.hdtvmagazine.com/reviews/2009/01/oppo_dv-983h_upconverting_dvd_player.php&amp;title=<?=$title_encoded?>">Del.icio.us</a></span>
  ...
  <td id="left"><!-- Comments -->
	...
	?>
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/reviews/2009/01/oppo_dv-983h_upconverting_dvd_player.php" type="text/javascript" charset="utf-8"></script>
</div></body>
</html>
