...
<head>
	...
	<!-- ilovehdtv.com --><meta name="google-site-verification" content="YRpRHmXI8uwb3cUqXQ4-BPbmrlhVY2BI4TDjCHOkwsc" />
	<!-- web-star.com --><meta name="google-site-verification" content="bAUgu1qEQMFs2y8SFr8Lkgp9al_hk6q8OCwnfRHy-EA" />
...
//			return ajax_makeRequest('qqsubmit.php', 'question='+escape(question)+'&email_address='+escape(email_address)+'&ip_address='+escape(ip_address));
			return ajaxSendRequest('qqsubmit.php?question='+escape(question)+'&email_address='+escape(email_address)+'&ip_address='+escape(ip_address), 'submitReturn');
}
