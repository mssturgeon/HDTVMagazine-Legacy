...
*/
		...
		<div class="item" style="clear:both"><span class="corners-top"><span></span></span>
			...
			<ul><?
				...
				FROM mt_entry e, mt_author a, mt_category c, mt_placement p, aux_mt_entry aux, phpbb_topics t
...
#					"$row[category_label]</h4></li>\n";
		...
		<div class="item"><span class="corners-top"><span></span></span>
			...
			<ul><?
				...
				FROM phpbb_topics t, phpbb_users u, phpbb_posts p, phpbb_forums f, aux_phpbb_forums af
				WHERE
