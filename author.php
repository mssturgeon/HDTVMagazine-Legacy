<?
	...
	if ($id == '' && $author == '') js_back();

	require(BASE_DIR .'/includes/doctype.php');
?>
<html>
<head>
	<title>HDTV Magazine - <?=$author?> Articles</title>
	<?
		if ($id == 1) echo '<meta name="microid" content="b2a16b1ec40b67553a9d995d41a561e4ceaee096" />';
	?>
	<meta name="description" content="Find the latest HDTV Magazine content by <?=$author?>. Articles, columns, bulletins, reviews and more." />
	<meta name="keywords" content="<?=$author?>,forum,review,hdtv,hdtv articles,hdtv products,hdtv help,hdtv satellite,hdtv cable,hdtv broadcast" />
		...
		<td id="left">
			<?
				...
				WHERE entry_author_id = author_id
					...
					AND e.entry_blog_id IN (". INCLUDE_BLOGS_NO_BULLETINS .")
