<?
	...
	$charts = array(
		30711947 => array(type => 'FC_2_3_Pie3D', width => 125, height => 125, height_adjust => -80, order_by => 'num DESC'),
		30925705 => array(type => 'FC_2_3_Pie3D', width => 125, height => 125, height_adjust => -40, order_by => 'num DESC'),
		30926348 => array(type => 'FC_2_3_Bar2D', width => 400, height => 200, height_adjust => 0, order_by => 'num DESC'),
		30926420 => array(type => 'FC_2_3_Bar2D', width => 400, height => 200, height_adjust => 0, order_by => 'OptionID'),
		30928488 => array(type => 'FC_2_3_Bar2D', width => 400, height => 175, height_adjust => -50, order_by => 'num DESC', has_text => ''),
		30928311 => array(type => 'FC_2_3_Pie3D', width => 250, height => 125, height_adjust => -75, order_by => 'num DESC'),
#		31217602 => array(type => 'FC_2_3_Bar2D', width => 400, height => 175, height_adjust => -40, order_by => 'num DESC'),
		...
		31220019 => array(type => 'FC_2_3_Bar2D', width => 400, height => 175, height_adjust => -40, order_by => 'OptionID', has_text => ''),
		30926686 => array(type => 'FC_2_3_Pie3D', width => 200, height => 125, height_adjust => -50, order_by => 'num DESC'),
		30927954 => array(type => 'FC_2_3_Pie3D', width => 125, height => 100, height_adjust => -50, order_by => 'num DESC'),
		30678608 => array(type => 'FC_2_3_Pie3D', width => 175, height => 225, height_adjust => -50, order_by => 'num DESC'),
		30678643 => array(type => 'FC_2_3_Pie3D', width => 175, height => 225, height_adjust => -50, order_by => 'num DESC'),
		30678655 => array(type => 'FC_2_3_Pie3D', width => 175, height => 190, height_adjust => -50, order_by => 'num DESC'),
		30678656 => array(type => 'FC_2_3_Pie3D', width => 190, height => 225, height_adjust => -50, order_by => 'num DESC'),
		31218024 => array(type => 'FC_2_3_Pie3D', width => 125, height => 125, height_adjust => -50, order_by => 'num DESC'),
		31217160 => array(type => 'FC_2_3_Pie3D', width => 175, height => 225, height_adjust => -50, order_by => 'num DESC'),
		31221468 => array(type => 'FC_2_3_Pie3D', width => 250, height => 125, height_adjust => -50, order_by => 'num DESC'),
		31224566 => array(type => 'FC_2_3_Pie3D', width => 175, height => 150, height_adjust => -50, order_by => 'num DESC'),
		30678790 => array(type => 'FC_2_3_Pie3D', width => 200, height => 200, height_adjust => -50, order_by => 'num DESC'),
		...
		30678510 => array(type => 'FC_2_3_Pie3D', width => 125, height => 175, height_adjust => -50, order_by => 'num DESC'),
		30678512 => array(type => 'FC_2_3_Pie3D', width => 175, height => 150, height_adjust => -50, order_by => 'num DESC'),
		30678515 => array(type => 'FC_2_3_Pie3D', width => 210, height => 140, height_adjust => -50, order_by => 'num DESC'),
		30678517 => array(type => 'FC_2_3_Pie3D', width => 250, height => 250, height_adjust => -50, order_by => 'num DESC'),
		30678516 => array(type => 'FC_2_3_Pie3D', width => 175, height => 225, height_adjust => -50, order_by => 'num DESC')
	);
		...
		while ($row = $db->sql_fetchrow($result)) {
			if (array_key_exists($row[QID], $charts)) {
				...
				if (access(ACCESS_ADMIN_ANY)) {
					echo '</td><td class="grid"><textarea style="height:'. ($height*2 + $height_adjust) .'px" onfocus="select()" readonly>'. getChart($row[QID]) .'</textarea></td>';
				}
				echo '	</tr>'.
				'</table><br />'."\n";
			}
