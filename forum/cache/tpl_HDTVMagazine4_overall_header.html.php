...
<!--
	phpBB style name: HDTVMagazine
	Based on style:   prosilver (this is the default phpBB3 style)
	Original author:  Tom Beddard ( http://www.subBlue.com/ )
	Modified by: Shane Sturgeon ( http://www.sturgeonconsulting.com/ )
...
<table width="100%" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top; padding-right:10px">
		...
		<div class="navbar">
			...
			<ul class="linklist" style="border-bottom: 1px solid #FFFFFF;">
				<li class="icon-ucp">
