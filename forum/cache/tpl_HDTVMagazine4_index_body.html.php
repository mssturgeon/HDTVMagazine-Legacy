...
<div class="rules">
	<div class="inner"><span class="corners-top"><span></span></span>
		...
		<span style="font-weight: bold;">READ: <a href="/forum/viewtopic.php?t=5503" class="postlink"><?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?> User Guidelines</a></span>
		<span class="corners-bottom"><span></span></span>
	</div>
</div>
<div align="center">
	<img src="<?php echo (isset($this->_rootref['BASE_IMG_HOST'])) ? $this->_rootref['BASE_IMG_HOST'] : ''; ?>/images/hd-library-forum.jpg" alt="HD Library &amp; Forum" style="padding-right:50px" width="150" height="75" />
	<a href="/forum/viewtopic.php?t=4450"><img src="<?php echo (isset($this->_rootref['BASE_IMG_HOST'])) ? $this->_rootref['BASE_IMG_HOST'] : ''; ?>/images/forum/isfhaa.jpg" alt="ISF/HAA - The Expression of Art using Science" width="150" height="75" /></a>
</div>
...
<table width="100%"><tr><td style="vertical-align:top; padding-right:10px">
...
<br />
<?php 
	include(BASE_DIR .'/ads/skyscraper2.php');
 ?>
</td></tr></table>
