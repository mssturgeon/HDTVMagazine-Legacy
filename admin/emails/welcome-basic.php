<?
	...
	$qry = "SELECT username, password, user_id, user_actkey FROM ". USERS_TABLE ." pu, user u WHERE u.bb_id = pu.user_id AND id = '$id'";
	$result = mQuery($qry);
...
Your no-cost Basic Membership includes:
...
While we are confident that you will enjoy your Basic Membership, our Premium Membership has even more to offer, and you can get more details here:
<?=FULL_URL_SUBSCRIBE?>


If you experience any problems or have any recommendations for improving our services please use our convenient feedback form (<?=FULL_URL_HELP_FEEDBACK?>).
