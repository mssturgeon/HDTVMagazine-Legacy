<?
	...
	$qry = "SELECT vote_text caption, CONCAT(vote_option_id, '. ') name, vote_result value FROM phpbb_vote_results r, phpbb_vote_desc d WHERE r.vote_id = d.vote_id AND r.vote_id = $vote_id ORDER BY vote_option_id";
	$result = mQuery($qry);
