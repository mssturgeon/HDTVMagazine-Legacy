...
// include lastRSS
include "../includes/lastRSS.php"; //path to lastRSS.php on your server from this script ("bridge.php")
...
function outputRSS_XML($url) {
	...
	if ($rs = $rss->get($url)) {
		...
		echo "</channel></rss>";
		if ($rs['items_count'] <= 0) { echo "There is a temporary error with the news feed. Please check our <a href=\"/news/index.php\">news page</a> for the latest."; }
	}
	else {
