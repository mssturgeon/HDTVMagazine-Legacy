...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/05/the-ellen-degeneres-show-to-be-broadcast-in-high-definition.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content=""The Ellen Degeneres Show" to be Broadcast in High Definition" />
...
The one-hour series, renewed through the 2010-2011 season, will now..." />
	...
	<meta property="og:title" content="&quot;The Ellen Degeneres Show&quot; to be Broadcast in High Definition" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/05/the-ellen-degeneres-show-to-be-broadcast-in-high-definition.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Emmy&amp;reg;-winning talk show host Ellen DeGeneres will go Hi Def this fall when &quot;The Ellen DeGeneres Show&quot; begins its sixth season on Monday, September 8, and is produced and broadcast in High Definition (HD) after moving its production operations to a newly constructed, state-of-the-art facility on the Warner Bros. Studios lot. The announcement was made today by Hilary Estey McLoughlin, President, Telepictures Productions, and Jon Gilbert, President, Warner Bros. Studio Facilities.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1385', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
