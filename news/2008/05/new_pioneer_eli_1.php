...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=New Pioneer Elite A/V Receivers Deliver Unprecedented Sound Experiences to the Home Theater&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/05/new-pioneer-elite-av-receivers-deliver-unprecedented-sound-experiences-to-the-home-theater.php&amp;title=New Pioneer Elite A/V Receivers Deliver Unprecedented Sound Experiences to the Home Theater">
		<span style="display:none">Pioneer Electronics (USA) Inc. today introduces four new A/V receivers delivering high-definition (HD) audio and video experiences for emerging home theaters - the Elite&amp;reg; SC-07, SC-05, VSX-03TXH and VSX-01TXH. Acting as the HD control center, Pioneer&amp;reg;'s full line of A/V receivers work seamlessly with Pioneer's 2008 KURO displays and Blu-ray Disc&amp;reg; players to deliver the ultimate HD picture and sound performance for a truly emotional response in the living room.

Pioneer's flagship A/V receiver, code named &quot;Susano,&quot; has set the industry standard for home theater performance and its 2008 top-of-the-line receivers, the SC-07 and SC-05, continue to incorporate...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
Pioneer's flagship A/V receiver, code named &quot;Susano,&quot; has set the industry standard for home theater performance and its 2008 top-of-the-line receivers, the SC-07 and SC-05, continue to incorporate..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/05/new-pioneer-elite-av-receivers-deliver-unprecedented-sound-experiences-to-the-home-theater.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1381', 340, 125);">Add ASIN</a>
