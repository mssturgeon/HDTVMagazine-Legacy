...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/05/the-lcd-tv-association-launches-greentv-program.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="The LCD TV Association Launches GreenTV Program" />
...
The first step in the LCD TV Association's GreenTV Program is to work with major TV vendors to implement and promote..." />
	...
	<meta property="og:title" content="The LCD TV Association Launches GreenTV Program" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/05/the-lcd-tv-association-launches-greentv-program.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="The LCD TV Association, a global, not-for-profit, marketing trade association formed to help the entire LCD supply chain, retail channel and consumers, recently launched its GreenTV logo program to help focus LCD TV manufacturers and brands on reducing the power consumption of LCD TVs and raising consumer awareness.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1378', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
