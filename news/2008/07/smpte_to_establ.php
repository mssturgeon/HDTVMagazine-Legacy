...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=SMPTE to Establish 3-D Home Entertainment Task Force Committee to Define Parameters of Stereoscopic 3-D Mastering Standard for Home Display&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
WHITE PLAINS, NY - July 21, 2008 -- The Society of Motion Picture and Television Engineers (SMPTE) is establishing a task force to define the parameters of a stereoscopic 3-D mastering standard for content viewed in the home. Called 3-D Home Display Formats Task Force, the project promises to propel the 3-D home entertainment industry forward by setting the stage for a standard that will..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/07/smpte-to-establish-3d-home-entertainment-task-force-committee-to-define-parameters-of-stereoscopic-3d-mastering-standard-for-home-display.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1473', 340, 125);">Add ASIN</a>
