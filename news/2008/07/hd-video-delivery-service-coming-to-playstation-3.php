...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/07/hd-video-delivery-service-coming-to-playstation-3.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HD Video Delivery Service Coming to Playstation 3" />
...
Sony Computer Entertainment Inc. (SCEI) will initially make available..." />
	...
	<meta property="og:title" content="HD Video Delivery Service Coming to Playstation 3" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/07/hd-video-delivery-service-coming-to-playstation-3.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Sony Computer Entertainment America (SCEA) today launches the company's new video delivery service on PLAYSTATION(R)Store for PLAYSTATION(R)3 (PS3(TM)) and PSP(R) (PlayStation(R)Portable) systems in the United States. Consumers will have the ability to download full-length movies, television shows, and original programming accessible through the PLAYSTATION Store on PLAYSTATION(R)Network. With nearly 300 full length movies and more than 1,200 TV episodes, many available in both standard-definition (SD) and high-definition (HD), PLAYSTATION Network's video delivery service makes PS3 the ultimate entertainment platform and enhances PSP's status as a portable entertainment marvel. PLAYSTATION Network's video delivery service will become available later this evening.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1468', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
