...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=RCA Multi-Directional Flat Antenna Designed for Pinpoint Pickup of Free Over-the-Air Digital TV Signals&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/07/rca-multidirectional-flat-antenna-designed-for-pinpoint-pickup-of-free-overtheair-digital-tv-signals.php&amp;title=RCA Multi-Directional Flat Antenna Designed for Pinpoint Pickup of Free Over-the-Air Digital TV Signals">
		<span style="display:none">Viewers looking for an alternative to soaring subscription TV bills should consider pairing a digital TV with a new RCA Flat Antenna designed to pick up more channels than a traditional &quot;rabbit ears&quot; antenna. Local broadcasters are now sending multiple digital TV channels to supplement their main programs, including informational and live radar and weather forecasts available at the touch of a button - for free!

In addition to receiving pristine uncompressed digital TV signals...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1461";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download RCA Multi-Directional Flat Antenna Designed for Pinpoint Pickup of Free Over-the-Air Digital TV Signals" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="RCA Multi-Directional Flat Antenna Designed for Pinpoint Pickup of Free Over-the-Air Digital TV Signals" />
...
<html>
<head>
	<title>HDTV Magazine - RCA Multi-Directional Flat Antenna Designed for Pinpoint Pickup of Free Over-the-Air Digital TV Signals</title>
	<meta name="keywords" content="consumer electronics, flat antenna, multi directional, rabbit ears, looking statements, antenna, digital, products, new, flat, reception, rca, electronics, audiovox, consumer, our, may, directional, ant, statements, company, multi, signals, looking, designed" />
...
In addition to receiving pristine uncompressed digital TV signals..." />
	<meta name="title" content="RCA Multi-Directional Flat Antenna Designed for Pinpoint Pickup of Free Over-the-Air Digital TV Signals" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/07/rca-multidirectional-flat-antenna-designed-for-pinpoint-pickup-of-free-overtheair-digital-tv-signals.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1461', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/07/rca-multidirectional-flat-antenna-designed-for-pinpoint-pickup-of-free-overtheair-digital-tv-signals.php">RCA Multi-Directional Flat Antenna Designed for Pinpoint Pickup of Free Over-the-Air Digital TV Signals</a></td>
						</tr><tr>
...
<p>Except for historical information contained herein, statements made in this release that would constitute forward-looking statements may involve certain risks and uncertainties. All forward-looking statements made in this release are based on currently available information and the Company assumes no responsibility to update any such forward-looking statements. The following factors, among others, may cause actual results to differ materially from the results suggested in the forward-looking statements. The factors include, but are not limited to, risks that may result from changes in the Company's business operations; our ability to keep pace with technological advances; significant competition in the mobile and consumer electronics businesses; our relationships with key suppliers and customers; quality and consumer acceptance of newly introduced products; market volatility; non-availability of product; excess inventory; price and product competition; new product introductions; the possibility that the review of our prior filings by the SEC may result in changes to our financial statements; and the possibility that stockholders or regulatory authorities may initiate proceedings against Audiovox and/or our officers and directors as a result of any restatements. Risk factors associated with our business, including some of the facts set forth herein, are detailed in the Company's Form 10-K for the fiscal year ended February 28, 2007.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>July 10, 2008 12:00 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1461)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/07/rca-multidirectional-flat-antenna-designed-for-pinpoint-pickup-of-free-overtheair-digital-tv-signals.php" type="text/javascript" charset="utf-8"></script>
