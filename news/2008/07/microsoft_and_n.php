...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1465 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Microsoft and Netflix Unveil Partnership to Instantly Stream Movies and TV Episodes to the TV via Xbox LIVE&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/07/microsoft-and-netflix-unveil-partnership-to-instantly-stream-movies-and-tv-episodes-to-the-tv-via-xbox-live.php&amp;title=Microsoft and Netflix Unveil Partnership to Instantly Stream Movies and TV Episodes to the TV via Xbox LIVE">
		<span style="display:none">An exciting new home theater experience is coming to living rooms this holiday season. At the E3 Media and Business Summit, Microsoft Corp. (NASDAQ:MSFT) and Netflix, Inc. (NASDAQ:NFLX) , the world's largest online movie rental service, today unveiled an exclusive partnership to offer consumers the ability to instantly stream movies and TV episodes from Netflix to the television via the Xbox 360 video game and entertainment system. Xbox 360 will be the only game system that lets users instantly watch movies and TV episodes streamed from Netflix. This movie watching innovation will be available to Xbox LIVE Gold members who are also Netflix subscribers and will let those users enjoy streaming movies from Netflix on Xbox LIVE at no additional cost.

A growing library of more than 10,000 movies and TV episodes will be available from Netflix when it launches on...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1465";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Microsoft and Netflix Unveil Partnership to Instantly Stream Movies and TV Episodes to the TV via Xbox LIVE" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Microsoft and Netflix Unveil Partnership to Instantly Stream Movies and TV Episodes to the TV via Xbox LIVE" />
...
<html>
<head>
	<title>HDTV Magazine - Microsoft and Netflix Unveil Partnership to Instantly Stream Movies and TV Episodes to the TV via Xbox LIVE</title>
	<meta name="keywords" content="xbox live, via xbox, instantly stream, stream movies, netflix xbox, xbox, netflix, movies, live, entertainment, instantly, episodes, members, games, experience, microsoft, online, game, available, system, video, new, via, shows, content" />
	<meta name="description" content="An exciting new home theater experience is coming to living rooms this holiday season. At the E3 Media and Business Summit, Microsoft Corp. (NASDAQ:MSFT) and Netflix, Inc. (NASDAQ:NFLX) , the world's largest online movie rental service, today unveiled an exclusive partnership to offer consumers the ability to instantly stream movies and TV episodes from Netflix to the television via the Xbox 360 video game and entertainment system. Xbox 360 will be the only game system that lets users instantly watch movies and TV episodes streamed from Netflix. This movie watching innovation will be available to Xbox LIVE Gold members who are also Netflix subscribers and will let those users enjoy streaming movies from Netflix on Xbox LIVE at no additional cost.

A growing library of more than 10,000 movies and TV episodes will be available from Netflix when it launches on..." />
	<meta name="title" content="Microsoft and Netflix Unveil Partnership to Instantly Stream Movies and TV Episodes to the TV via Xbox LIVE" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/07/microsoft-and-netflix-unveil-partnership-to-instantly-stream-movies-and-tv-episodes-to-the-tv-via-xbox-live.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1465', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/07/microsoft-and-netflix-unveil-partnership-to-instantly-stream-movies-and-tv-episodes-to-the-tv-via-xbox-live.php">Microsoft and Netflix Unveil Partnership to Instantly Stream Movies and TV Episodes to the TV via Xbox LIVE</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>July 14, 2008</b>
...
<p>Source: Microsoft Corp.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>July 14, 2008  7:49 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1465)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/07/microsoft-and-netflix-unveil-partnership-to-instantly-stream-movies-and-tv-episodes-to-the-tv-via-xbox-live.php" type="text/javascript" charset="utf-8"></script>
