...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Syntax-Brillian Showcases 120Hz and Full-HD Technology on New LCD HDTV Demonstration Units at CES 2008&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/01/syntaxbrillian-showcases-120hz-and-fullhd-technology-on-new-lcd-hdtv-demonstration-units-at-ces-2008.php&amp;title=Syntax-Brillian Showcases 120Hz and Full-HD Technology on New LCD HDTV Demonstration Units at CES 2008">
...
At the Olevia&amp;trade; booth, visitors can experience...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 838";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Syntax-Brillian Showcases 120Hz and Full-HD Technology on New LCD HDTV Demonstration Units at CES 2008" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Syntax-Brillian Showcases 120Hz and Full-HD Technology on New LCD HDTV Demonstration Units at CES 2008" />
...
<html>
<head>
	<title>HDTV Magazine - Syntax-Brillian Showcases 120Hz and Full-HD Technology on New LCD HDTV Demonstration Units at CES 2008</title>
	<meta name="keywords" content="syntax brillian, new olevia, lcd hdtvs, olevia lcd, olevia booth, olevia, new, lcd, brillian, syntax, products, technology, hdtvs, hdmi, company, tilt, type, booth, statements, digital, home, units, display, theater, universal" />
	<meta name="description" content="Syntax-Brillian Corporation (Nasdaq:BRLC) today announced that at CES 2008 it will be exhibiting a diverse range of new Olevia&amp;trade; LCD HDTVs featuring the latest in display technology hardware and feature enhancements combining 120Hz Motion Estimation/Motion Compensation (ME/MC) technology with full-HD 1080p resolution, new industrial designs and firmware upgradeability via USB. These new technology demonstration units will be on exhibit from January 7 - 10, 2008 in the Olevia&amp;trade; booth #20401, Las Vegas Convention Center, South Hall.

At the Olevia&amp;trade; booth, visitors can experience..." />
	<meta name="title" content="Syntax-Brillian Showcases 120Hz and Full-HD Technology on New LCD HDTV Demonstration Units at CES 2008" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/01/syntaxbrillian-showcases-120hz-and-fullhd-technology-on-new-lcd-hdtv-demonstration-units-at-ces-2008.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=838', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/01/syntaxbrillian-showcases-120hz-and-fullhd-technology-on-new-lcd-hdtv-demonstration-units-at-ces-2008.php">Syntax-Brillian Showcases 120Hz and Full-HD Technology on New LCD HDTV Demonstration Units at CES 2008</a></td>
						</tr><tr>
...
<p>Source: Syntax-Brillian</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  3, 2008  6:55 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 838)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/01/syntaxbrillian-showcases-120hz-and-fullhd-technology-on-new-lcd-hdtv-demonstration-units-at-ces-2008.php" type="text/javascript" charset="utf-8"></script>
