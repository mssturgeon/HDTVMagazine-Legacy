...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 858 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/01/toshiba-third-generation-players-deliver-on-the-promise-of-the-hd-dvd-format.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 858";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Toshiba Third Generation Players Deliver on the Promise of the HD DVD Format" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Toshiba Third Generation Players Deliver on the Promise of the HD DVD Format" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Toshiba Third Generation Players Deliver on the Promise of the HD DVD Format" />
...
<html>
<head>
	<title>HDTV Magazine - Toshiba Third Generation Players Deliver on the Promise of the HD DVD Format</title>
	<meta name="keywords" content="third generation, dvd players, dvd player, web enabled, toshiba america, dvd, toshiba, players, generation, products, consumer, third, player, content, new, experience, format, hdmi, america, consumers, features, high, may, enabled, available" />
	<meta name="description" content="Demonstrating strong consumer acceptance for the HD DVD format, Toshiba America Consumer Products L.L.C. (&quot;Toshiba&quot;) today announced that the rollout of its third generation HD DVD players has been the most successful to date. With their unrivaled performance including real-world Web-enabled networking capabilities, consumers have chosen Toshiba's third generation HD DVD players for their ultimate high def entertainment experience, resulting in the strongest quarter of unit sales to date and solidifying Toshiba's market share leadership position.

As it has become established in the market, HD DVD has delivered on the promise of..." />
	<meta name="title" content="Toshiba Third Generation Players Deliver on the Promise of the HD DVD Format" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Toshiba Third Generation Players Deliver on the Promise of the HD DVD Format" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/01/toshiba-third-generation-players-deliver-on-the-promise-of-the-hd-dvd-format.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Demonstrating strong consumer acceptance for the HD DVD format, Toshiba America Consumer Products L.L.C. (&quot;Toshiba&quot;) today announced that the rollout of its third generation HD DVD players has been the most successful to date. With their unrivaled performance including real-world Web-enabled networking capabilities, consumers have chosen Toshiba's third generation HD DVD players for their ultimate high def entertainment experience, resulting in the strongest quarter of unit sales to date and solidifying Toshiba's market share leadership position.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=858', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/01/toshiba-third-generation-players-deliver-on-the-promise-of-the-hd-dvd-format.php">Toshiba Third Generation Players Deliver on the Promise of the HD DVD Format</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<!--?=$v_buttons?-->
				<p class="prtitle">Toshiba Third Generation Players Deliver on the Promise of the HD DVD Format</p>

<center><i>State-of-the-Art Performance, Successful Promotions and Affordable Pricing Result in Strong Consumer Acceptance of Third Generation Players</i></center><br />
<br />

<p><B>LAS VEGAS, Jan. 6 /PRNewswire/</B> -- CES -- Demonstrating strong consumer acceptance for the HD DVD format, Toshiba America Consumer Products L.L.C. ("Toshiba") today announced that the rollout of its third generation HD DVD players has been the most successful to date. With their unrivaled performance including real-world Web-enabled networking capabilities, consumers have chosen Toshiba's third generation HD DVD players for their ultimate high def entertainment experience, resulting in the strongest quarter of unit sales to date and solidifying Toshiba's market share leadership position.</p>
...
<p><br />
<B>Fulfilling the promise of HD DVD</B></p>
...
<p><br />
<B>Toshiba delivers a richer interactive experience-now</B></p>
...
<p><br />
<B>About Toshiba HD DVD Players and Third Generation Line</B></p>
...
<p><br />
<B>HD DVD's Commitment to Green</B></p>
...
<p>HD-A3 ($299.99, Available Now)<br />
HD-A30 ($399.99, Available Now)<br />
HD-A35 ($499.99, Available Now)<br />
HD-XA2 ($799.99, Available Now)</p>
...
<p>Source: Toshiba America Consumer Products, L.L.C.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  6, 2008 11:58 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 858)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/01/toshiba-third-generation-players-deliver-on-the-promise-of-the-hd-dvd-format.php" type="text/javascript" charset="utf-8"></script>
