...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Dell Lounge Immerses CES Attendees in the Next Wave of High-Def Living&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/01/dell-lounge-immerses-ces-attendees-in-the-next-wave-of-highdef-living.php&amp;title=Dell Lounge Immerses CES Attendees in the Next Wave of High-Def Living">
		<span style="display:none">Consumer Electronics Show attendees can preview the next wave in digital entertainment, gaming and home networking through an array of innovative concepts, conversations and technology demonstrations at the Dell Lounge. Those not making the annual trek to Las Vegas can tune into www.delllounge.com/ces, where Dell will post webcasts of entertainment events and product demos.

Featured displays include a premium 16-inch concept laptop with a picture-perfect full HD 16:9 aspect ratio and a preview of a mainstream XPS&amp;trade; gaming desktop that will offer performance approaching purpose-built gaming systems. Dell will also demo a high-definition...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 861";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Dell Lounge Immerses CES Attendees in the Next Wave of High-Def Living" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Dell Lounge Immerses CES Attendees in the Next Wave of High-Def Living" />
...
<html>
<head>
	<title>HDTV Magazine - Dell Lounge Immerses CES Attendees in the Next Wave of High-Def Living</title>
	<meta name="keywords" content="dell lounge, media center, digital home, ces dell, inch display, dell, digital, lounge, ces, xps, display, gaming, inch, home, entertainment, attendees, desktop, laptop, technology, eye, product, notebook, ratio, new, concept" />
...
Featured displays include a premium 16-inch concept laptop with a picture-perfect full HD 16:9 aspect ratio and a preview of a mainstream XPS&amp;trade; gaming desktop that will offer performance approaching purpose-built gaming systems. Dell will also demo a high-definition..." />
	<meta name="title" content="Dell Lounge Immerses CES Attendees in the Next Wave of High-Def Living" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/01/dell-lounge-immerses-ces-attendees-in-the-next-wave-of-highdef-living.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=861', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/01/dell-lounge-immerses-ces-attendees-in-the-next-wave-of-highdef-living.php">Dell Lounge Immerses CES Attendees in the Next Wave of High-Def Living</a></td>
						</tr><tr>
 ...
 * CES Straight Talk - The Official Blog of the International CES</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  6, 2008  3:08 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 861)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/01/dell-lounge-immerses-ces-attendees-in-the-next-wave-of-highdef-living.php" type="text/javascript" charset="utf-8"></script>
