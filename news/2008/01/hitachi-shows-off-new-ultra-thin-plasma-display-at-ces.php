...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/01/hitachi-shows-off-new-ultra-thin-plasma-display-at-ces.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Hitachi Shows off New Ultra Thin Plasma Display at CES" />
...
This new Ultra Thin plasma display will be the centerpiece of Hitachi's Innovations Showcase here at CES, which also features..." />
	...
	<meta property="og:title" content="Hitachi Shows off New Ultra Thin Plasma Display at CES" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/01/hitachi-shows-off-new-ultra-thin-plasma-display-at-ces.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Hitachi has developed an Ultra Thin plasma display panel (PDP) that is a mere 1.5-inches in depth. Having shaved more than one third of the thickness off of today's comparable plasma displays, this new product represents an engineering achievement of significant importance from Hitachi.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=845', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
