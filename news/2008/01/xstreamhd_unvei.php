...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=XStreamHD&trade; Unveils First-Ever Transport Network to Deliver High-Definition Movies, Music, and More Directly to the Home at CES 2008&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/01/xstreamhd-unveils-firstever-transport-network-to-deliver-highdefinition-movies-music-and-more-directly-to-the-home-at-ces-2008.php&amp;title=XStreamHD&amp;trade; Unveils First-Ever Transport Network to Deliver High-Definition Movies, Music, and More Directly to the Home at CES 2008">
		<span style="display:none">XStreamHD, revolutionizing the delivery and distribution of Full HD entertainment to the home, today unveiled at CES 2008 (Sands Booth #71838) the first-ever transport network to deliver movies, TV, music, electronic games, and more in Full HD (1080p) video and 7.1 channels of DTS-HD Master Audio&amp;trade;, directly to consumers, via satellite.

XStreamHD is leading the Full HD revolution with the first transport network to bring...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 893";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download XStreamHD&trade; Unveils First-Ever Transport Network to Deliver High-Definition Movies, Music, and More Directly to the Home at CES 2008" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="XStreamHD&trade; Unveils First-Ever Transport Network to Deliver High-Definition Movies, Music, and More Directly to the Home at CES 2008" />
...
<html>
<head>
	<title>HDTV Magazine - XStreamHD&trade; Unveils First-Ever Transport Network to Deliver High-Definition Movies, Music, and More Directly to the Home at CES 2008</title>
	<meta name="keywords" content="transport network, directly home, sands booth, audio directly, network deliver, xstreamhd, home, full, video, satellite, network, media, content, audio, consumers, ces, first, channels, booth, directly, titles, quality, movies, solution, entertainment" />
...
XStreamHD is leading the Full HD revolution with the first transport network to bring..." />
	<meta name="title" content="XStreamHD&amp;trade; Unveils First-Ever Transport Network to Deliver High-Definition Movies, Music, and More Directly to the Home at CES 2008" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/01/xstreamhd-unveils-firstever-transport-network-to-deliver-highdefinition-movies-music-and-more-directly-to-the-home-at-ces-2008.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=893', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/01/xstreamhd-unveils-firstever-transport-network-to-deliver-highdefinition-movies-music-and-more-directly-to-the-home-at-ces-2008.php">XStreamHD&trade; Unveils First-Ever Transport Network to Deliver High-Definition Movies, Music, and More Directly to the Home at CES 2008</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>January  8, 2008</b>
...
<p>XStreamHD is leading an HD revolution, setting a new standard for the delivery and distribution of Full HD entertainment throughout the home. Privately funded and five years in the making, XStreamHD is led by George Gonzalez, a recognized pioneer in broadband and satellite communications. XStreamHD's executive team and board of directors include veterans of the Fortune 500 who have been instrumental in shaping the television, entertainment, telecom, and consumer markets. For more information, visit www.XStreamHD.com or call +1 (703) 852-1300.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  8, 2008  9:23 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 893)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/01/xstreamhd-unveils-firstever-transport-network-to-deliver-highdefinition-movies-music-and-more-directly-to-the-home-at-ces-2008.php" type="text/javascript" charset="utf-8"></script>
