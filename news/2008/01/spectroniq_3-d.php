...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=SPECTRONIQ 3-D, Inc. Introduces 3-D HD LCD TVs - Retail Launch Slated for Summer \'08&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/01/spectroniq-3d-inc-introduces-3d-hd-lcd-tvs-retail-launch-slated-for-summer-08.php&amp;title=SPECTRONIQ 3-D, Inc. Introduces 3-D HD LCD TVs - Retail Launch Slated for Summer '08">
		<span style="display:none">Southern California-based consumer electronics innovator SPECTRONIQ(R) 3-D Inc. (&quot;SPECTRONIQ 3-D&quot;), will unveil its inaugural stereoscopic 3-D HD LCD TVs in Las Vegas as the focal point of the company's presentation during CES, January 7-10. Already a leader in the realm of high-end HD LCD televisions, SPECTRONIQ 3-D is ramping up for a groundbreaking summer 2008 nationwide retail launch for the 46&quot; 3-D TVs under the SPECTRONIQ(R) brand, the first mass market consumer roll-out of its kind.

At the vanguard of setting a new industry standard for...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 884";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download SPECTRONIQ 3-D, Inc. Introduces 3-D HD LCD TVs - Retail Launch Slated for Summer \'08" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="SPECTRONIQ 3-D, Inc. Introduces 3-D HD LCD TVs - Retail Launch Slated for Summer \'08" />
...
<html>
<head>
	<title>HDTV Magazine - SPECTRONIQ 3-D, Inc. Introduces 3-D HD LCD TVs - Retail Launch Slated for Summer '08</title>
	<meta name="keywords" content="lcd tvs, sensio technologies, kerner optical, consumer electronics, technologies inc, spectroniq, technology, technologies, sensio, inc, tvs, kord, lcd, trademark, company, development, california, consumer, ilm, both, stereoscopic, raisingsun, chen, launch, kerner" />
...
At the vanguard of setting a new industry standard for..." />
	<meta name="title" content="SPECTRONIQ 3-D, Inc. Introduces 3-D HD LCD TVs - Retail Launch Slated for Summer '08" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/01/spectroniq-3d-inc-introduces-3d-hd-lcd-tvs-retail-launch-slated-for-summer-08.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=884', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/01/spectroniq-3d-inc-introduces-3d-hd-lcd-tvs-retail-launch-slated-for-summer-08.php">SPECTRONIQ 3-D, Inc. Introduces 3-D HD LCD TVs - Retail Launch Slated for Summer '08</a></td>
						</tr><tr>
...
<p>Source: SPECTRONIQ 3-D, Inc.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  7, 2008  8:05 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 884)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/01/spectroniq-3d-inc-introduces-3d-hd-lcd-tvs-retail-launch-slated-for-summer-08.php" type="text/javascript" charset="utf-8"></script>
