...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/01/verbatim-showcases-expanding-line-of-bluray-media-at-ces.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Verbatim Showcases Expanding Line of Blu-Ray Media at CES" />
...
The market for BD blank media is being driven by the growing demand for..." />
	...
	<meta property="og:title" content="Verbatim Showcases Expanding Line of Blu-Ray Media at CES" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/01/verbatim-showcases-expanding-line-of-bluray-media-at-ces.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Verbatim&amp;reg; Americas, LLC announced today that it has extended its support for Blu-ray Disc (BD) technology and will feature its expanded line of Blu-ray media at Booth #S4-36249 in the South Hall during CES this week. In addition to the 2x BD recordable (BD-R) and BD rewritable (BD-RE) media which are available now, Verbatim will showcase six new BD products scheduled to begin shipping in the first half of 2008. The new products include 4x BD-R discs, Single-sided Double-layer (DL) 2x BD-R and BD-RE discs, Mini BD-R and BD-RE discs and 1-2x BD-R LTH TYPE discs.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=891', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
