...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/01/panasonic-unveils-two-new-fullhigh-definition-camcorders.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Panasonic Unveils Two New Full-High Definition Camcorders" />
...
The Panasonic HDC-SD9 and HDC-HS9 offer..." />
	...
	<meta property="og:title" content="Panasonic Unveils Two New Full-High Definition Camcorders" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/01/panasonic-unveils-two-new-fullhigh-definition-camcorders.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Panasonic, a leader in High Definition and digital video technologies, today announces two new full-High Definition 3CCD camcorders, the HDC-HS9, a hybrid model that can record to either an SD (or SDHC) Memory Card or its built-in 60-GB hard disk and the HDC-SD9, the world's smallest and lightest* SD card High Definition camcorder, weighing in at just 0.606 pounds. Both the SD9 and HS9, which feature new Panasonic camcorder technologies, Face Detection and Intelligent Shooting Guide, will be displayed at the 2008 International CES in Las Vegas from January 7-10 at the Panasonic booth #9405.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=870', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
