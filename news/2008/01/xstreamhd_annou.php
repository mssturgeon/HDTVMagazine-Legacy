...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=XStreamHD&trade; Announces Strategic Partnerships with High-Definition Audio Pioneer, DTS, Inc., and Worldwide Storage Leader, Seagate Technology&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/01/xstreamhd-announces-strategic-partnerships-with-highdefinition-audio-pioneer-dts-inc-and-worldwide-storage-leader-seagate-technology.php&amp;title=XStreamHD&amp;trade; Announces Strategic Partnerships with High-Definition Audio Pioneer, DTS, Inc., and Worldwide Storage Leader, Seagate Technology">
		<span style="display:none">XStreamHD, setting a new standard for the delivery and distribution of Full HD entertainment to the home, today announced strategic partnerships with two recognized pioneers of high-definition technology, DTS, Inc. (DTS) and Seagate Technology&amp;reg; (NYSE: STX). XStreamHD will provide the first-ever transport network to deliver high-definition movies and music directly to the home - offering up to 7.1 channels of DTS-HD Master Audio&amp;trade;, and featuring Seagate's purpose-built DB35 Series&amp;trade; hard drives with up to an incredible one terabyte (TB) of storage, allowing consumers to use up to 2TB of storage in one solution. The XStreamHD solution will be unveiled for the first time at the Consumer Electronics Show in Las Vegas, January 7-10.

XStreamHD will offer affordable access to...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 881";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download XStreamHD&trade; Announces Strategic Partnerships with High-Definition Audio Pioneer, DTS, Inc., and Worldwide Storage Leader, Seagate Technology" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="XStreamHD&trade; Announces Strategic Partnerships with High-Definition Audio Pioneer, DTS, Inc., and Worldwide Storage Leader, Seagate Technology" />
...
<html>
<head>
	<title>HDTV Magazine - XStreamHD&trade; Announces Strategic Partnerships with High-Definition Audio Pioneer, DTS, Inc., and Worldwide Storage Leader, Seagate Technology</title>
	<meta name="keywords" content="master audio, seagate technology, high definition, dts inc, consumer electronics, dts, xstreamhd, seagate, audio, technology, master, storage, home, high, consumer, definition, bit, capacity, products, worldwide, inc, solution, standard, entertainment, delivery" />
...
XStreamHD will offer affordable access to..." />
	<meta name="title" content="XStreamHD&amp;trade; Announces Strategic Partnerships with High-Definition Audio Pioneer, DTS, Inc., and Worldwide Storage Leader, Seagate Technology" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/01/xstreamhd-announces-strategic-partnerships-with-highdefinition-audio-pioneer-dts-inc-and-worldwide-storage-leader-seagate-technology.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=881', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/01/xstreamhd-announces-strategic-partnerships-with-highdefinition-audio-pioneer-dts-inc-and-worldwide-storage-leader-seagate-technology.php">XStreamHD&trade; Announces Strategic Partnerships with High-Definition Audio Pioneer, DTS, Inc., and Worldwide Storage Leader, Seagate Technology</a></td>
						</tr><tr>
...
<p>Seagate, Seagate Technology and the Wave logo are registered trademarks of Seagate Technology LLC in the United States and/or other countries. DB35 Series is either a trademark or registered trademark of Seagate Technology LLC or one of its affiliated companies in the United States and/or other countries. All other trademarks or registered trademarks are the property of their respective owners. When referring to hard drive capacity, one gigabyte, or GB, equals one billion bytes and one terabyte, or TB, equals one trillion bytes. Your computer's operating system may use a different standard of measurement and report a lower capacity. In addition, some of the listed capacity is used for formatting and other functions, and thus will not be available for data storage. Quantitative usage examples for various applications are for illustrative purposes. Actual quantities will vary based on various factors, including file size, file format, features and application software. Seagate reserves the right to change, without notice, product offerings or specifications.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  7, 2008  7:42 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 881)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/01/xstreamhd-announces-strategic-partnerships-with-highdefinition-audio-pioneer-dts-inc-and-worldwide-storage-leader-seagate-technology.php" type="text/javascript" charset="utf-8"></script>
