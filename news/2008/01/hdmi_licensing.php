...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 851 AND placement_is_primary = 1";
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 851";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDMI Licensing Launches Programs for Home Theater Installers" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDMI Licensing Launches Programs for Home Theater Installers" />
...
<html>
<head>
	<title>HDTV Magazine - HDMI Licensing Launches Programs for Home Theater Installers</title>
	<meta name="keywords" content="hdmi licensing, installer community, home theater, looking statements, licensing llc, hdmi, licensing, installers, installer, new, community, programs, information, theater, looking, digital, home, technology, provide, educational, statements, president, installation, help, base" />
	<meta name="description" content="At the 2008 International Consumer Electronics Show (CES), HDMI Licensing, LLC, the agent responsible for licensing the High-Definition Multimedia Interface(TM) (HDMI(TM)) specification, today announced the launch of a suite of tools and educational programs specifically designed to help the installer community more effectively install home theater systems that are connected with HDMI. The new tools and programs include a dedicated web-based installer area on the HDMI Licensing website, featuring new webinars hosted by HDMI Licensing developed specifically for installers, and a new, easily accessible Knowledge Base that provides installers with tips and answers to help solve installation issues and questions. The new installer section can be found at..." />
	<meta name="title" content="HDMI Licensing Launches Programs for Home Theater Installers" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/01/hdmi-licensing-launches-programs-for-home-theater-installers.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=851', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/01/hdmi-licensing-launches-programs-for-home-theater-installers.php">HDMI Licensing Launches Programs for Home Theater Installers</a></td>
						</tr><tr>
...
<p>Source: HDMI Licensing, LLC</p>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 851)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/01/hdmi-licensing-launches-programs-for-home-theater-installers.php" type="text/javascript" charset="utf-8"></script>
