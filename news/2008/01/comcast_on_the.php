...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Comcast On The March&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/01/comcast-on-the-march.php&amp;title=Comcast On The March">
		<span style="display:none">Comcast distributed three powerhouse press releases(see below)that will punctuate Comcast Chairman, Brian Roberts key note speech scheduled for 9:00 am this morning at the 2009 CES in Las Vegas. For a webcast of Robert's address go to www.comcast.com/ces. While most newsreleases are felt as little quakes at best these announcements from ferociously shake the ground and raise a Tsunami. _Dale
</span></a>
	</li>
</ul></div>
EOT;
...
" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/01/comcast-on-the-march.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=892', 340, 125);">Add ASIN</a>
