...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/01/lg-electronics-2008-lcd-hdtv-line-includes-eight-series-focus-on-design-superior-performance.php&amp;title=LG Electronics' 2008 LCD HDTV Line Includes Eight Series, Focus on Design, Superior Performance">
		<span style="display:none">LG Electronics today unveiled its stylish 2008 LCD HDTV line -- eight series, 24 models, 17 with &quot;Full HD&quot; 1080p display capability -- with screen sizes ranging from 19- to 52-inches. The line features multiple design and technological innovations, including a stunningly designed 1.7-inch thin LCD, a unique wireless HDTV and a model with LED backlighting technology.

A new invisible speaker system tuned by...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
A new invisible speaker system tuned by..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/01/lg-electronics-2008-lcd-hdtv-line-includes-eight-series-focus-on-design-superior-performance.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=856', 340, 125);">Add ASIN</a>
