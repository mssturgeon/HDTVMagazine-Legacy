...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 891";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Verbatim Showcases Expanding Line of Blu-Ray Media at CES" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Verbatim Showcases Expanding Line of Blu-Ray Media at CES" />
...
<html>
<head>
	<title>HDTV Magazine - Verbatim Showcases Expanding Line of Blu-Ray Media at CES</title>
	<meta name="keywords" content="blu ray, lth type, recording layer, type media, line blu, verbatim, media, recording, disc, layer, discs, blu, ray, type, lth, new, production, video, mkm, technology, dvd, surface, coating, quality, company" />
...
The market for BD blank media is being driven by the growing demand for..." />
	<meta name="title" content="Verbatim Showcases Expanding Line of Blu-Ray Media at CES" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/01/verbatim-showcases-expanding-line-of-bluray-media-at-ces.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=891', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/01/verbatim-showcases-expanding-line-of-bluray-media-at-ces.php">Verbatim Showcases Expanding Line of Blu-Ray Media at CES</a></td>
						</tr><tr>
...
<p>Verbatim is a registered trademark of Verbatim Americas, LLC. Other company and product names contained herein are trademarks of their respective companies. Specifications subject to change without notice.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  8, 2008 12:01 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 891)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/01/verbatim-showcases-expanding-line-of-bluray-media-at-ces.php" type="text/javascript" charset="utf-8"></script>
