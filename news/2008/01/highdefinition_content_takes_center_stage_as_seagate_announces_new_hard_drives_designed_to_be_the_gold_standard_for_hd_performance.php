...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/01/highdefinition-content-takes-center-stage-as-seagate-announces-new-hard-drives-designed-to-be-the-gold-standard-for-hd-performance.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="High-Definition Content Takes Center Stage as Seagate Announces New Hard Drives Designed to be the Gold Standard for HD Performance" />
...
The new PipelineHD Series hard drives not only increase the amount of content which can be stored but also..." />
	...
	<meta property="og:title" content="High-Definition Content Takes Center Stage as Seagate Announces New Hard Drives Designed to be the Gold Standard for HD Performance" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/01/highdefinition-content-takes-center-stage-as-seagate-announces-new-hard-drives-designed-to-be-the-gold-standard-for-hd-performance.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Seagate Technology (NYSE:STX) today announced its PipelineHD(TM) Series Hard Disc Drives, a new family of purpose-built HDDs for Digital Video Recorders (DVRs) with initial capacities planned up to 1TB, allowing DVRs to capture up to 200 hours of exciting high-definition (HD) television or 1,000 hours of Standard Definition television. Fueling the need for these large capacity options is the ever- increasing demand for high-definition content from consumers all around the world.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=872', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
