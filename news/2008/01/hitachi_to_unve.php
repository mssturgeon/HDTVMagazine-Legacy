...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 844 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Hitachi to Unveil New Line of Ultra Thin LCDs at CES&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/01/hitachi-to-unveil-new-line-of-ultra-thin-lcds-at-ces.php&amp;title=Hitachi to Unveil New Line of Ultra Thin LCDs at CES">
		<span style="display:none">As the advertising around Las Vegas have been hinting for days, &quot;1.5 Is Coming...&quot; and, after much anticipation, it's now here. For the first time in the U.S., Hitachi is officially unveiling its new line of Ultra Thin LCDs. Having already received overwhelmingly favorable response in sneak previews to overseas audiences last Fall, the new line called &quot;1.5&quot; - in reference to its 1.5-inch depth - is now expected to be among the hottest items being announced and displayed at this year's International CES.

These slim, stylish LCDs from Hitachi represent an important new category of product that is being called Ultra Thin Displays. The Hitachi Ultra Thin 1.5 series have been available in Japan since December of last year and will be available for U.S. consumers in...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 844";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Hitachi to Unveil New Line of Ultra Thin LCDs at CES" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Hitachi to Unveil New Line of Ultra Thin LCDs at CES" />
...
<html>
<head>
	<title>HDTV Magazine - Hitachi to Unveil New Line of Ultra Thin LCDs at CES</title>
	<meta name="keywords" content="ultra thin, new line, thin displays, please visit, line ultra, hitachi, new, ultra, thin, displays, design, consumers, line, high, products, images, series, ltd, ces, our, display, systems, product, picture, inch" />
	<meta name="description" content="As the advertising around Las Vegas have been hinting for days, &quot;1.5 Is Coming...&quot; and, after much anticipation, it's now here. For the first time in the U.S., Hitachi is officially unveiling its new line of Ultra Thin LCDs. Having already received overwhelmingly favorable response in sneak previews to overseas audiences last Fall, the new line called &quot;1.5&quot; - in reference to its 1.5-inch depth - is now expected to be among the hottest items being announced and displayed at this year's International CES.
...
These slim, stylish LCDs from Hitachi represent an important new category of product that is being called Ultra Thin Displays. The Hitachi Ultra Thin 1.5 series have been available in Japan since December of last year and will be available for U.S. consumers in..." />
	<meta name="title" content="Hitachi to Unveil New Line of Ultra Thin LCDs at CES" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/01/hitachi-to-unveil-new-line-of-ultra-thin-lcds-at-ces.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=844', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/01/hitachi-to-unveil-new-line-of-ultra-thin-lcds-at-ces.php">Hitachi to Unveil New Line of Ultra Thin LCDs at CES</a></td>
						</tr><tr>
...
<p>Hitachi has a unique position in the marketplace by manufacturing and developing its own core technologies to provide consumers and businesses with optimal product performance in each of Hitachi's product categories. For consumer products, please visit www.hitachi.us/tv. For business products, please visit www.hitachi.us/digitalmedia. For more information about interactive whiteboards and Starboard software, please visit Hitachi Software at www.hitachi-soft.com.</p>
...
<p>&copy; 2008, Hitachi, Ltd. All trademarks are property of their respective owners.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  6, 2008  6:57 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 844)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/01/hitachi-to-unveil-new-line-of-ultra-thin-lcds-at-ces.php" type="text/javascript" charset="utf-8"></script>
