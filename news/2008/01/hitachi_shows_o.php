...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 845 AND placement_is_primary = 1";
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/01/hitachi-shows-off-new-ultra-thin-plasma-display-at-ces.php&amp;title=Hitachi Shows off New Ultra Thin Plasma Display at CES">
		<span style="display:none">Hitachi has developed an Ultra Thin plasma display panel (PDP) that is a mere 1.5-inches in depth. Having shaved more than one third of the thickness off of today's comparable plasma displays, this new product represents an engineering achievement of significant importance from Hitachi.

This new Ultra Thin plasma display will be the centerpiece of Hitachi's Innovations Showcase here at CES, which also features...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 845";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Hitachi Shows off New Ultra Thin Plasma Display at CES" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Hitachi Shows off New Ultra Thin Plasma Display at CES" />
...
<html>
<head>
	<title>HDTV Magazine - Hitachi Shows off New Ultra Thin Plasma Display at CES</title>
	<meta name="keywords" content="ultra thin, plasma display, thin plasma, please visit, thin lcd, hitachi, thin, ultra, content, video, plasma, display, new, home, system, lcd, products, ces, image, product, ltd, first, technology, systems, user" />
	<meta name="description" content="Hitachi has developed an Ultra Thin plasma display panel (PDP) that is a mere 1.5-inches in depth. Having shaved more than one third of the thickness off of today's comparable plasma displays, this new product represents an engineering achievement of significant importance from Hitachi.
...
This new Ultra Thin plasma display will be the centerpiece of Hitachi's Innovations Showcase here at CES, which also features..." />
	<meta name="title" content="Hitachi Shows off New Ultra Thin Plasma Display at CES" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/01/hitachi-shows-off-new-ultra-thin-plasma-display-at-ces.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=845', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/01/hitachi-shows-off-new-ultra-thin-plasma-display-at-ces.php">Hitachi Shows off New Ultra Thin Plasma Display at CES</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">Hitachi Shows off New Ultra Thin Plasma Display at CES</p>

<center><i>Just 1.5-inches Thin, Hitachi's New Plasma Display is Centerpiece of "Innovations Showcase" at Its CES Booth</i></center><br />
<br />

<p>2008 International CES<br />
Booth: Central 11906</p>

<p><B>LAS VEGAS--(BUSINESS WIRE)</B>--Hitachi has developed an Ultra Thin plasma display panel (PDP) that is a mere 1.5-inches in depth. Having shaved more than one third of the thickness off of today's comparable plasma displays, this new product represents an engineering achievement of significant importance from Hitachi.</p>

<p>This new Ultra Thin plasma display will be the centerpiece of Hitachi's Innovations Showcase here at CES, which also features:</p>

<p> * A "super" Ultra Thin LCD at just .75 inches in depth<br />
...
<p>@copy; 2008, Hitachi, Ltd. All trademarks are property of their respective owners.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  6, 2008  7:03 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 845)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/01/hitachi-shows-off-new-ultra-thin-plasma-display-at-ces.php" type="text/javascript" charset="utf-8"></script>
