...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=High-Definition Content Takes Center Stage as Seagate Announces New Hard Drives Designed to be the Gold Standard for HD Performance&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/01/highdefinition-content-takes-center-stage-as-seagate-announces-new-hard-drives-designed-to-be-the-gold-standard-for-hd-performance.php&amp;title=High-Definition Content Takes Center Stage as Seagate Announces New Hard Drives Designed to be the Gold Standard for HD Performance">
		<span style="display:none">Seagate Technology (NYSE:STX) today announced its PipelineHD(TM) Series Hard Disc Drives, a new family of purpose-built HDDs for Digital Video Recorders (DVRs) with initial capacities planned up to 1TB, allowing DVRs to capture up to 200 hours of exciting high-definition (HD) television or 1,000 hours of Standard Definition television. Fueling the need for these large capacity options is the ever- increasing demand for high-definition content from consumers all around the world.

The new PipelineHD Series hard drives not only increase the amount of content which can be stored but also...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 872";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download High-Definition Content Takes Center Stage as Seagate Announces New Hard Drives Designed to be the Gold Standard for HD Performance" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="High-Definition Content Takes Center Stage as Seagate Announces New Hard Drives Designed to be the Gold Standard for HD Performance" />
...
<html>
<head>
	<title>HDTV Magazine - High-Definition Content Takes Center Stage as Seagate Announces New Hard Drives Designed to be the Gold Standard for HD Performance</title>
	<meta name="keywords" content="high definition, pipelinehd series, hard drives, series hard, hard drive, seagate, hard, drives, content, pipelinehd, definition, high, series, dvr, drive, storage, new, capacity, performance, digital, technology, consumer, dvrs, system, consumers" />
...
The new PipelineHD Series hard drives not only increase the amount of content which can be stored but also..." />
	<meta name="title" content="High-Definition Content Takes Center Stage as Seagate Announces New Hard Drives Designed to be the Gold Standard for HD Performance" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/01/highdefinition-content-takes-center-stage-as-seagate-announces-new-hard-drives-designed-to-be-the-gold-standard-for-hd-performance.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=872', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/01/highdefinition-content-takes-center-stage-as-seagate-announces-new-hard-drives-designed-to-be-the-gold-standard-for-hd-performance.php">High-Definition Content Takes Center Stage as Seagate Announces New Hard Drives Designed to be the Gold Standard for HD Performance</a></td>
						</tr><tr>
...
<p>Source: Seagate Technology</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  6, 2008 11:47 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 872)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/01/highdefinition-content-takes-center-stage-as-seagate-announces-new-hard-drives-designed-to-be-the-gold-standard-for-hd-performance.php" type="text/javascript" charset="utf-8"></script>
