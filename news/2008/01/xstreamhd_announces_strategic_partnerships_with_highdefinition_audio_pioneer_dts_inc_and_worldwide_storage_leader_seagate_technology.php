...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/01/xstreamhd-announces-strategic-partnerships-with-highdefinition-audio-pioneer-dts-inc-and-worldwide-storage-leader-seagate-technology.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="XStreamHD&trade; Announces Strategic Partnerships with High-Definition Audio Pioneer, DTS, Inc., and Worldwide Storage Leader, Seagate Technology" />
...
XStreamHD will offer affordable access to..." />
	...
	<meta property="og:title" content="XStreamHD&amp;trade; Announces Strategic Partnerships with High-Definition Audio Pioneer, DTS, Inc., and Worldwide Storage Leader, Seagate Technology" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/01/xstreamhd-announces-strategic-partnerships-with-highdefinition-audio-pioneer-dts-inc-and-worldwide-storage-leader-seagate-technology.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="XStreamHD, setting a new standard for the delivery and distribution of Full HD entertainment to the home, today announced strategic partnerships with two recognized pioneers of high-definition technology, DTS, Inc. (DTS) and Seagate Technology&amp;reg; (NYSE: STX). XStreamHD will provide the first-ever transport network to deliver high-definition movies and music directly to the home - offering up to 7.1 channels of DTS-HD Master Audio&amp;trade;, and featuring Seagate's purpose-built DB35 Series&amp;trade; hard drives with up to an incredible one terabyte (TB) of storage, allowing consumers to use up to 2TB of storage in one solution. The XStreamHD solution will be unveiled for the first time at the Consumer Electronics Show in Las Vegas, January 7-10.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=881', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
