...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/03/playstationr3-to-support-new-interactive-bluray-movie-features-bdlive-with-upcoming-system-software-update.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1306";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download PLAYSTATION(R)3 To Support New Interactive Blu-ray Movie Features (BD-LIVE) With Upcoming System Software Update" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="PLAYSTATION(R)3 To Support New Interactive Blu-ray Movie Features (BD-LIVE) With Upcoming System Software Update" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="PLAYSTATION(R)3 To Support New Interactive Blu-ray Movie Features (BD-LIVE) With Upcoming System Software Update" />
...
<html>
<head>
	<title>HDTV Magazine - PLAYSTATION(R)3 To Support New Interactive Blu-ray Movie Features (BD-LIVE) With Upcoming System Software Update</title>
	<meta name="keywords" content="computer entertainment, system software, blu ray, sony computer, entertainment system, system, entertainment, psp, playstation, computer, software, new, blu, ray, update, sony, live, movie, features, inc, disc, america, updates, content, interactive" />
...
BD Profile 2.0 requires..." />
	<meta name="title" content="PLAYSTATION(R)3 To Support New Interactive Blu-ray Movie Features (BD-LIVE) With Upcoming System Software Update" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="PLAYSTATION(R)3 To Support New Interactive Blu-ray Movie Features (BD-LIVE) With Upcoming System Software Update" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/03/playstationr3-to-support-new-interactive-bluray-movie-features-bdlive-with-upcoming-system-software-update.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Sony Computer Entertainment America (SCEA) today announced that the next system software update for PLAYSTATION(R)3 (PS3(TM)) computer entertainment system, slated for release in late March, will add Blu-ray Disc(TM) (BD) Profile 2.0 or BD-LIVE, enabling PS3 owners to experience interactive features, such as downloadable video content, ringtones, games, and more. In addition to BD-LIVE, the system software update (v. 2.20) will enable photo and music playlists on PS3 to be copied to PSP(R)(PlayStation(R)Portable) handheld entertainment system, among other new features. These updates demonstrate how PS3 continues to evolve as a home entertainment hub with the flexibility to deliver the newest technology innovations that benefit PS3 owners.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1306', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/03/playstationr3-to-support-new-interactive-bluray-movie-features-bdlive-with-upcoming-system-software-update.php">PLAYSTATION(R)3 To Support New Interactive Blu-ray Movie Features (BD-LIVE) With Upcoming System Software Update</a></td>
						</tr><tr>
...
<p>Source: Sony Computer Entertainment America Inc.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>March 20, 2008  5:23 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1306)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/03/playstationr3-to-support-new-interactive-bluray-movie-features-bdlive-with-upcoming-system-software-update.php" type="text/javascript" charset="utf-8"></script>
