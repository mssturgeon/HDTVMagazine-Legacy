...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=PLAYSTATION(R)3 To Support New Interactive Blu-ray Movie Features (BD-LIVE) With Upcoming System Software Update&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/03/playstationr3-to-support-new-interactive-bluray-movie-features-bdlive-with-upcoming-system-software-update.php&amp;title=PLAYSTATION(R)3 To Support New Interactive Blu-ray Movie Features (BD-LIVE) With Upcoming System Software Update">
		<span style="display:none">Sony Computer Entertainment America (SCEA) today announced that the next system software update for PLAYSTATION(R)3 (PS3(TM)) computer entertainment system, slated for release in late March, will add Blu-ray Disc(TM) (BD) Profile 2.0 or BD-LIVE, enabling PS3 owners to experience interactive features, such as downloadable video content, ringtones, games, and more. In addition to BD-LIVE, the system software update (v. 2.20) will enable photo and music playlists on PS3 to be copied to PSP(R)(PlayStation(R)Portable) handheld entertainment system, among other new features. These updates demonstrate how PS3 continues to evolve as a home entertainment hub with the flexibility to deliver the newest technology innovations that benefit PS3 owners.

BD Profile 2.0 requires...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
BD Profile 2.0 requires..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/03/playstationr3-to-support-new-interactive-bluray-movie-features-bdlive-with-upcoming-system-software-update.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1306', 340, 125);">Add ASIN</a>
