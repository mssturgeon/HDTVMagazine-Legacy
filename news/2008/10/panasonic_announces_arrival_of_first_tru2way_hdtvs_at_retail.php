...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/10/panasonic-announces-arrival-of-first-tru2way-hdtvs-at-retail.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1519";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Panasonic Announces Arrival of First Tru2Way HDTVs at Retail" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Panasonic Announces Arrival of First Tru2Way HDTVs at Retail" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Panasonic Announces Arrival of First Tru2Way HDTVs at Retail" />
...
<html>
<head>
	<title>HDTV Magazine - Panasonic Announces Arrival of First Tru2Way HDTVs at Retail</title>
	<meta name="keywords" content="tru way, way technology, first tru, digital cable, way hdtvs, panasonic, comcast, way, tru, cable, hdtvs, first, viera, electronics, technology, digital, corporation, products, development, consumer, cablelabs, video, customers, television, chicago" />
	<meta name="description" content="Panasonic (NYSE: PC), the consumer electronics industry leader in the development and application of tru2way technology, and Comcast Corporation (NASDAQ: CMCSA, CMCSK), the nation's leading provider of entertainment, information and communications today announced the arrival of the first tru2way VIERA HDTVs at Abt Electronics in Glenview, IL and officially declared the tru2way platform active in Chicago and Denver. 

Tru2way technology is being used to create..." />
	<meta name="title" content="Panasonic Announces Arrival of First Tru2Way HDTVs at Retail" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Panasonic Announces Arrival of First Tru2Way HDTVs at Retail" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/10/panasonic-announces-arrival-of-first-tru2way-hdtvs-at-retail.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Panasonic (NYSE: PC), the consumer electronics industry leader in the development and application of tru2way technology, and Comcast Corporation (NASDAQ: CMCSA, CMCSK), the nation's leading provider of entertainment, information and communications today announced the arrival of the first tru2way VIERA HDTVs at Abt Electronics in Glenview, IL and officially declared the tru2way platform active in Chicago and Denver. 
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1519', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/10/panasonic-announces-arrival-of-first-tru2way-hdtvs-at-retail.php">Panasonic Announces Arrival of First Tru2Way HDTVs at Retail</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<!--?=$v_buttons?-->
				<p class="prtitle">PANASONIC ANNOUNCES ARRIVAL OF FIRST TRU2WAY&trade; HDTVs AT RETAIL</p>

<center><i>Consumers In Chicago And Denver Will Be First To Experience Comcast's Video On Demand Without A Set-Top Box

<p>Panasonic Tru2way-Enabled VIERA Plasma HDTVs To Go On Sale In Late October At Abt Electronics, Ultimate Electronics and Circuit City Stores</i></center><br /><br />
<br /></p>

<p><B>CHICAGO, IL (October 15, 2008)</B> - Panasonic (NYSE: PC), the consumer electronics industry leader in the development and application of tru2way technology, and Comcast Corporation (NASDAQ: CMCSA, CMCSK), the nation's leading provider of entertainment, information and communications today announced the arrival of the first tru2way VIERA HDTVs at Abt Electronics in Glenview, IL and officially declared the tru2way platform active in Chicago and Denver. </p>
...
<p>Panasonic's first tru2way enabled VIERA Plasma HDTVs will be offered in 42-inch class and 50-inch class sizes with integrated tru2way cable receiver capability within the set's chassis. </p>

<p>The TH-42PZ80Q and TH-50PZ80Q will be extensions of Panasonic's critically acclaimed VIERA PZ80 series of 1080p Plasma HDTVs.  The TH-42PZ80Q will have an SRP of $1,599.95 and the TH-50PZ80Q will have an SRP of $2,299.95.  These tru2way HDTVs will allow consumers to access all digital cable services such as electronic program guides and the full range of interactive and video-on-demand programming - all accessible directly via the television's remote control - without the costs or clutter associated with a traditional external cable set-top box. </p>
...
<p>Founded in 1988 by cable operating companies, Cable Television Laboratories, Inc. (CableLabs&reg;) is a non-profit research and development consortium that is dedicated to pursuing new cable telecommunications technologies and to helping its cable operator members integrate those technical advancements into their business objectives.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>October 15, 2008  6:52 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1519)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/10/panasonic-announces-arrival-of-first-tru2way-hdtvs-at-retail.php" type="text/javascript" charset="utf-8"></script>
