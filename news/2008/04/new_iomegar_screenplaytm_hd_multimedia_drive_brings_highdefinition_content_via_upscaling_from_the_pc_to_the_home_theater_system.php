...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/04/new-iomegar-screenplaytm-hd-multimedia-drive-brings-highdefinition-content-via-upscaling-from-the-pc-to-the-home-theater-system.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1364";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download New Iomega(R) ScreenPlay(TM) HD Multimedia Drive Brings High-Definition Content, via Upscaling, From the PC to the Home Theater System" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="New Iomega(R) ScreenPlay(TM) HD Multimedia Drive Brings High-Definition Content, via Upscaling, From the PC to the Home Theater System" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="New Iomega(R) ScreenPlay(TM) HD Multimedia Drive Brings High-Definition Content, via Upscaling, From the PC to the Home Theater System" />
...
<html>
<head>
	<title>HDTV Magazine - New Iomega(R) ScreenPlay(TM) HD Multimedia Drive Brings High-Definition Content, via Upscaling, From the PC to the Home Theater System</title>
	<meta name="keywords" content="multimedia drive, iomega corporation, iomega screenplay, high definition, looking statements, iomega, screenplay, drive, multimedia, video, corporation, product, storage, media, photos, high, component, content, new, statements, today, digital, home, system, mpeg" />
...
The Iomega ScreenPlay HD Multimedia Drive is a 500GB* drive with the storage capacity to hold up to..." />
	<meta name="title" content="New Iomega(R) ScreenPlay(TM) HD Multimedia Drive Brings High-Definition Content, via Upscaling, From the PC to the Home Theater System" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="New Iomega(R) ScreenPlay(TM) HD Multimedia Drive Brings High-Definition Content, via Upscaling, From the PC to the Home Theater System" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/04/new-iomegar-screenplaytm-hd-multimedia-drive-brings-highdefinition-content-via-upscaling-from-the-pc-to-the-home-theater-system.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Iomega Corporation (NYSE:IOM) , a global leader in data protection and security, today announced the new Iomega(R) ScreenPlay(TM) HD Multimedia Drive, a portable external hard drive that leaves the PC behind, delivering multimedia content to high-definition televisions and home theater systems.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1364', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/04/new-iomegar-screenplaytm-hd-multimedia-drive-brings-highdefinition-content-via-upscaling-from-the-pc-to-the-home-theater-system.php">New Iomega(R) ScreenPlay(TM) HD Multimedia Drive Brings High-Definition Content, via Upscaling, From the PC to the Home Theater System</a></td>
						</tr><tr>
...
<p>Source: Iomega Corporation</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>April 23, 2008  9:07 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1364)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/04/new-iomegar-screenplaytm-hd-multimedia-drive-brings-highdefinition-content-via-upscaling-from-the-pc-to-the-home-theater-system.php" type="text/javascript" charset="utf-8"></script>
