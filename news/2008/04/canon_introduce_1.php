...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/04/canon-introduces-new-xl-h1s-and-xl-h1a-hd-camcorders-at-nab.php&amp;title=Canon Introduces New XL H1S and XL H1A HD Camcorders at NAB">
		<span style="display:none">Building on the success of its acclaimed XL H1 High Definition (HD) camcorder, Canon U.S.A., Inc., a leader in digital imaging technology, has introduced the new shoulder mount XL H1S and XL H1A HD camcorders, which include new advanced features requested by professional users for improved operation and image control.

Canon's new XL H1S and XL H1A camcorders, which will be on display at the 2008 NAB Show (Booth #SU3020), feature an updated Canon 20x HD Video Lens with three independent manual adjustment rings (focus, zoom and iris), as well as enhanced manual focus and zoom control. Additionally, the XL H1S and XL H1A incorporate...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
Canon's new XL H1S and XL H1A camcorders, which will be on display at the 2008 NAB Show (Booth #SU3020), feature an updated Canon 20x HD Video Lens with three independent manual adjustment rings (focus, zoom and iris), as well as enhanced manual focus and zoom control. Additionally, the XL H1S and XL H1A incorporate..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/04/canon-introduces-new-xl-h1s-and-xl-h1a-hd-camcorders-at-nab.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1337', 340, 125);">Add ASIN</a>
