...
The wallet-sized USB-powered 160GB* Media Xporter Drive utilizes the USB 2.0 ports on the Xbox 360 or the PlayStation 3 to..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/04/iomega-announces-new-media-xporter-drive-for-use-with-todays-popular-game-consoles.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1348', 340, 125);">Add ASIN</a>
