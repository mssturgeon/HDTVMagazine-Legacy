...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=New Iomega(R) ScreenPlay(TM) HD Multimedia Drive Brings High-Definition Content, via Upscaling, From the PC to the Home Theater System&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/04/new-iomegar-screenplaytm-hd-multimedia-drive-brings-highdefinition-content-via-upscaling-from-the-pc-to-the-home-theater-system.php&amp;title=New Iomega(R) ScreenPlay(TM) HD Multimedia Drive Brings High-Definition Content, via Upscaling, From the PC to the Home Theater System">
		<span style="display:none">Iomega Corporation (NYSE:IOM) , a global leader in data protection and security, today announced the new Iomega(R) ScreenPlay(TM) HD Multimedia Drive, a portable external hard drive that leaves the PC behind, delivering multimedia content to high-definition televisions and home theater systems.

The Iomega ScreenPlay HD Multimedia Drive is a 500GB* drive with the storage capacity to hold up to...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
The Iomega ScreenPlay HD Multimedia Drive is a 500GB* drive with the storage capacity to hold up to..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/04/new-iomegar-screenplaytm-hd-multimedia-drive-brings-highdefinition-content-via-upscaling-from-the-pc-to-the-home-theater-system.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1364', 340, 125);">Add ASIN</a>
