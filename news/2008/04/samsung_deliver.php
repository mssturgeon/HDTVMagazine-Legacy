...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Samsung Delivers its Fourth Generation Blu-ray Player&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/04/samsung-delivers-its-fourth-generation-bluray-player.php&amp;title=Samsung Delivers its Fourth Generation Blu-ray Player">
		<span style="display:none">Samsung Electronics, a market leader and award-winning innovator in consumer electronics, continues to expand its lineup of Blu-ray format A/V products with its fourth-generation Blu-ray player. Featuring the latest in Blu-ray technology as well as advanced connectivity for use with other digital devices, it offers consumers exceptional functionality, compact design and remarkable viewing quality.

As the first company to introduce a stand-alone Blu-ray player, Samsung reinforces its support of the Blu-ray format with the next generation, full HD, BD-P1500. An ideal player for anyone who enjoys Blu-ray, DVDs or CDs in their home, this groundbreaking model significantly...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
As the first company to introduce a stand-alone Blu-ray player, Samsung reinforces its support of the Blu-ray format with the next generation, full HD, BD-P1500. An ideal player for anyone who enjoys Blu-ray, DVDs or CDs in their home, this groundbreaking model significantly..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/04/samsung-delivers-its-fourth-generation-bluray-player.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1363', 340, 125);">Add ASIN</a>
