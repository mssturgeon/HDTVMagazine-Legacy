<?
	...
	$sql = "SELECT digg_url FROM aux_mt_entry WHERE entry_id = 1551";
	$result = mQuery($sql);
	...
	# Get category ID
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1551 AND placement_is_primary = 1";
...
<body><div id="body_container">
	<?
		...
		$base_url = strleftback(PHP_SELF, '/') . '/onkyo_introduces_two_top-end_thx_ultra2_plus_receivers';
		$print_url = $base_url .'-print.php';
		$save_url = $base_url .'-save.php';
		$title_encoded = rawurlencode(addslashes('Onkyo Introduces Two Top-End THX Ultra2 Plus Receivers'));
		$email_url = "mailto:?subject=HDTV Magazine: $title_encoded&amp;body=http://www.hdtvmagazine.com/news/2008/09/onkyo_introduces_two_top-end_thx_ultra2_plus_receivers.php";
		if ($author[img] != '' && 7 != 7) {
	...
	<table class="bare" cellpadding="0" cellspacing="0" style="width:100%;">
		<tr>
			...
			<td class="article_title" colspan="2">Onkyo Introduces Two Top-End THX Ultra2 Plus Receivers</td>
		</tr><tr>
			<td id="article_byline" nowrap="nowrap">
				By <b>Shane Sturgeon</b><br />
				<?=$author_title?>
				Posted on <b>September 15, 2008</b><br />
				Category: <b><a href="/category.php?id=<?=$category_id?>&category=Products & Equipment">Products & Equipment</a></b><br />
			</td><td id="article_links">
				<!--span><img src="/images/digg.png" alt="Digg Article" align="absmiddle" /><a target="_blank" href="http://digg.com/submit?url=http://www.hdtvmagazine.com/news/2008/09/onkyo_introduces_two_top-end_thx_ultra2_plus_receivers.php&amp;phase=2">Digg</a></span-->
				<span><img src="/images/newsvine.gif" alt="Add to Newsvine" align="absmiddle" /><a href="javascript:addToNewsvine('http://www.hdtvmagazine.com/news/2008/09/onkyo_introduces_two_top-end_thx_ultra2_plus_receivers.php', '<?=$title_encoded?>')">Newsvine</a></span>
				<span><img src="/images/delicious.gif" alt="Add to Del.icio.us" align="absmiddle" /><a target="_blank" href="http://del.icio.us/post?url=http://www.hdtvmagazine.com/news/2008/09/onkyo_introduces_two_top-end_thx_ultra2_plus_receivers.php&amp;title=<?=$title_encoded?>">Del.icio.us</a></span>
	...
	<div>
		<div style="float:left; margin:0 5px 5px 0;"><?
			if ($digg_url == '') {
				echo '<a target="_blank" href="http://digg.com/submit?url=http://www.hdtvmagazine.com/news/2008/09/onkyo_introduces_two_top-end_thx_ultra2_plus_receivers.php&amp;phase=2&amp;title=Onkyo%20Introduces%20Two%20Top-End%20THX%20Ultra2%20Plus%20Receivers&amp;bodytext=Onkyo%20USA%20has%20introduced%20two%20new%20top-of-the-line%20THX%20Ultra2%20Plus%20certified%207.1-channel%20A%2FV%20receivers%2C%20the%20TX-SR876%20and%20TX-NR906%2C%20which%20deliver%20superior%20performance%20and%20comprehensive%20features%20to%20easily%20surpass%20more%20expensive%20models%20from%20other%20brands.%20Both%20provide%20state-of-the-art%20HDMI%20repeaters%20for%20four%20high%20definition%20video%20sources%2C%20the%20new%20THX%20Loudness%20Plus%20processing%2C%20Audyssey%27s%20new%20Dynamic%20EQ%20and%20Dynamic%20Volume%20technologies%2C%20HQV%20Reon-VX%20video%20upscaling%20to%201080p%2C%20plus%20powerful%20amplifiers%2C%20multi-room%20features%2C%20HD%20Radio%2C%20and%2C%20on%20the%20TX-NR906%2C%20advanced%20networked%20audio%20capabilities.%0A%0ABesides%20assuring%20the%20highest%20level%20of%20performance...&amp;topic=television"><img src="/images/digg-this.gif" alt="Digg This" style="padding:0"></a>';
			} else {
		...
		<div id="<?=$container?>">
			<p class="prtitle">Onkyo Introduces Two Top-End THX Ultra2 Plus Receivers</p>

<center><i>Onkyo TX-NR906 (left) and TX-SR876 (right) THX Ultra2 Plus A/V receivers.Both models are available in black or silver finishes.</i></center><br />
<br />

<p><B>UPPER SADDLE RIVER, NJ (9/15/08)</B> -- Onkyo USA has introduced two new top-of-the-line THX Ultra2 Plus certified 7.1-channel A/V receivers, the TX-SR876 and TX-NR906, which deliver superior performance and comprehensive features to easily surpass more expensive models from other brands. Both provide state-of-the-art HDMI repeaters for four high definition video sources, the new THX Loudness Plus processing, Audyssey's new Dynamic EQ and Dynamic Volume technologies, HQV Reon-VX video upscaling to 1080p, plus powerful amplifiers, multi-room features, HD Radio, and, on the TX-NR906, advanced networked audio capabilities.</p>
...
<p>Onkyo, which takes its name from the Japanese "On" meaning 'sound' and "Kyo" meaning 'harmony,' has been producing precision audio components for over a half-century. The company's philosophy is to deliver products that are superbly designed and built to a consistently outstanding standard of excellence. Today, Onkyo is at the forefront of the home theater and digital revolutions. For more information about this and other fine Onkyo products, visit www.onkyousa.com or call 800-229-1687.</p>
	...
	<p class="posted">Posted by <b>Shane Sturgeon</b>, <b>September 15, 2008 11:40 AM</b></p>
  ...
  <td id="left"><!-- Comments -->
	...
	?>
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/09/onkyo_introduces_two_top-end_thx_ultra2_plus_receivers.php" type="text/javascript" charset="utf-8"></script>
</div></body>
</html>
