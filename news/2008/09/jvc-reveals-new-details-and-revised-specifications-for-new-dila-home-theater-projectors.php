...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/09/jvc-reveals-new-details-and-revised-specifications-for-new-dila-home-theater-projectors.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1493";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download JVC Reveals New Details And Revised Specifications For New D-ILA Home Theater Projectors" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="JVC Reveals New Details And Revised Specifications For New D-ILA Home Theater Projectors" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="JVC Reveals New Details And Revised Specifications For New D-ILA Home Theater Projectors" />
...
<html>
<head>
	<title>HDTV Magazine - JVC Reveals New Details And Revised Specifications For New D-ILA Home Theater Projectors</title>
	<meta name="keywords" content="native contrast, new projectors, contrast ratio, professional products, jvc company, dla, jvc, projectors, new, company, contrast, thx, available, lens, high, ila, professional, color, specifications, native, addition, ratio, screen, models, brightness" />
...
The new projectors are the..." />
	<meta name="title" content="JVC Reveals New Details And Revised Specifications For New D-ILA Home Theater Projectors" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="JVC Reveals New Details And Revised Specifications For New D-ILA Home Theater Projectors" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/09/jvc-reveals-new-details-and-revised-specifications-for-new-dila-home-theater-projectors.php" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1493', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/09/jvc-reveals-new-details-and-revised-specifications-for-new-dila-home-theater-projectors.php">JVC Reveals New Details And Revised Specifications For New D-ILA Home Theater Projectors</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>September 25, 2008</b>
...
JVC Company of America and JVC Professional Products Company are both divisions of JVC Americas Corp., based in Wayne, New Jersey and a wholly-owned subsidiary of Victor Company of Japan Ltd. JVC Professional Products Company is a leading manufacturer and distributor of a complete line of broadcast and professional equipment. JVC Company of America markets a complete line of consumer video and audio equipment. For further product information, visit JVC's website at http://www.jvc.com.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>September 25, 2008  7:48 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1493)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/09/jvc-reveals-new-details-and-revised-specifications-for-new-dila-home-theater-projectors.php" type="text/javascript" charset="utf-8"></script>
