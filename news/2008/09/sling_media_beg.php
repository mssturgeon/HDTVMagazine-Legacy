...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Sling Media Begins Shipping Slingbox PRO-HD&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1494";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Sling Media Begins Shipping Slingbox PRO-HD" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Sling Media Begins Shipping Slingbox PRO-HD" />
...
<html>
<head>
	<title>HDTV Magazine - Sling Media Begins Shipping Slingbox PRO-HD</title>
	<meta name="keywords" content="slingbox pro, sling media, slingplayer windows, capable streaming, laptop desktop, slingbox, pro, sling, media, video, digital, windows, home, both, including, slingplayer, product, available, features, slingstream, high, laptop, cable, programming, software" />
...
With the availability of the Slingbox PRO-HD, Sling Media has also updated its..." />
	<meta name="title" content="Sling Media Begins Shipping Slingbox PRO-HD" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/09/sling-media-begins-shipping-slingbox-prohd.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1494', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/09/sling-media-begins-shipping-slingbox-prohd.php">Sling Media Begins Shipping Slingbox PRO-HD</a></td>
						</tr><tr>
...
<p>Sling Media, Inc., a wholly owned subsidiary of EchoStar Corporation (NASDAQ:SATS), is a leading digital lifestyle products company offering consumer services and products that are a natural extension of today's digital way of life. Sling Media's product family includes the internationally acclaimed, Emmy award-winning Slingbox&trade; that allows consumers to watch and control their living room television shows at any time, from any location, using PCs, Macs, PDAs, and smartphones. For more information on Sling Media or the Slingbox, visit www.slingmedia.com. </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>September 25, 2008  7:51 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1494)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/09/sling-media-begins-shipping-slingbox-prohd.php" type="text/javascript" charset="utf-8"></script>
