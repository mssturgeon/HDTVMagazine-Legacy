...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1588 AND placement_is_primary = 1";
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/12/lg-electronics-announces-new-streaming-content-partners-for-its-network-bluray-disc-players.php&amp;title=LG Electronics Announces New Streaming Content Partners for Its Network Blu-ray Disc Players">
		<span style="display:none">LG Electronics today announced the expansion of network entertainment options for its Network Blu-ray Disc players through new alliances with CinemaNow and YouTube(TM).

Available on new LG Network Blu-ray Disc Players in...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1588";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download LG Electronics Announces New Streaming Content Partners for Its Network Blu-ray Disc Players" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="LG Electronics Announces New Streaming Content Partners for Its Network Blu-ray Disc Players" />
...
<html>
<head>
	<title>HDTV Magazine - LG Electronics Announces New Streaming Content Partners for Its Network Blu-ray Disc Players</title>
	<meta name="keywords" content="blu ray, network blu, ray disc, disc players, high definition, cinemanow, electronics, content, blu, ray, network, consumers, streaming, new, youtube, entertainment, access, netflix, disc, videos, digital, players, video, movies, high" />
	<meta name="description" content="LG Electronics today announced the expansion of network entertainment options for its Network Blu-ray Disc players through new alliances with CinemaNow and YouTube(TM).

Available on new LG Network Blu-ray Disc Players in..." />
	<meta name="title" content="LG Electronics Announces New Streaming Content Partners for Its Network Blu-ray Disc Players" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/12/lg-electronics-announces-new-streaming-content-partners-for-its-network-bluray-disc-players.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1588', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/12/lg-electronics-announces-new-streaming-content-partners-for-its-network-bluray-disc-players.php">LG Electronics Announces New Streaming Content Partners for Its Network Blu-ray Disc Players</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">LG Electronics Announces New Streaming Content Partners for Its Network Blu-ray Disc Players</p>

<center><i>LG to Offer Consumers Unparalleled Access to Streaming Entertainment from CinemaNow, YouTube and Netflix</i></center><br />
<br />

<p><B>ENGLEWOOD CLIFFS, N.J., Dec. 30 /PRNewswire/</B> -- LG Electronics today announced the expansion of network entertainment options for its Network Blu-ray Disc players through new alliances with CinemaNow and YouTube(TM).</p>
...
<p><br />
<B>CinemaNow: Instant Streaming of Hollywood's Latest Hits</B></p>
...
<p>  --  Browse the entire CinemaNow premium content catalog, including latest<br />
      Hollywood hits,<br />
  --  Instantly stream content to enjoy on compatible devices, and<br />
  --  Access and watch movies purchased from other CinemaNow-powered stores.</p>

<p></p>

<p>"We are extremely pleased to be providing CinemaNow premium content services to these innovative new products from LG Electronics that are helping to drive convenient consumer access to digital entertainment at home," said Mark Ely, executive vice president of strategy, Sonic Solutions (NASDAQ: SNIC) , parent company of CinemaNow.</p>

<p><br />
<B>YouTube: Original Streaming Video Content</B></p>
...
<p>  --  Unlimited access to millions of videos on topics such as current<br />
      events, instructional videos for hobbies and interests, comedic and<br />
      viral videos and<br />
  --  Easy searching, thumbnail previews and multiple screen size viewing<br />
      options.</p>

<p><br />
<B>Netflix:  High Definition Instant Streaming</B></p>
...
<p>Source: LG Electronics </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>December 30, 2008  7:07 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1588)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/12/lg-electronics-announces-new-streaming-content-partners-for-its-network-bluray-disc-players.php" type="text/javascript" charset="utf-8"></script>
