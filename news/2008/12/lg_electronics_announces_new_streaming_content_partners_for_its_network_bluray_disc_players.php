...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/12/lg-electronics-announces-new-streaming-content-partners-for-its-network-bluray-disc-players.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="LG Electronics Announces New Streaming Content Partners for Its Network Blu-ray Disc Players" />
...
Available on new LG Network Blu-ray Disc Players in..." />
	...
	<meta property="og:title" content="LG Electronics Announces New Streaming Content Partners for Its Network Blu-ray Disc Players" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/12/lg-electronics-announces-new-streaming-content-partners-for-its-network-bluray-disc-players.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="LG Electronics today announced the expansion of network entertainment options for its Network Blu-ray Disc players through new alliances with CinemaNow and YouTube(TM).
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1588', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
