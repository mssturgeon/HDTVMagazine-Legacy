...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/11/silicon-mountain-unveils-alliotm-42inch-hdtv-with-integrated-pc-and-bluray-player.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Silicon Mountain Unveils Allio(TM) 42-inch HDTV With Integrated PC and Blu-ray Player" />
...
The Allio HD TV / PC is the first..." />
	...
	<meta property="og:title" content="Silicon Mountain Unveils Allio(TM) 42-inch HDTV With Integrated PC and Blu-ray Player" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/11/silicon-mountain-unveils-alliotm-42inch-hdtv-with-integrated-pc-and-bluray-player.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Silicon Mountain Holdings, Inc., (OTC:SLCM) (BULLETIN BOARD: SLCM) , a technology company specializing in high-performance interactive computing solutions, today announced its design for a 32 and 42-inch High Definition LCD-TV with an integrated, full-function PC and Blu-ray/DVD player. Named Allio, this system will define an entirely new category of converged products, where entertainment and instant, on-demand information and productivity blend together seamlessly, in stunning high-definition.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1545', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
