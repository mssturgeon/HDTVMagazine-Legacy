...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Silicon Mountain Unveils Allio(TM) 42-inch HDTV With Integrated PC and Blu-ray Player&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/11/silicon-mountain-unveils-alliotm-42inch-hdtv-with-integrated-pc-and-bluray-player.php&amp;title=Silicon Mountain Unveils Allio(TM) 42-inch HDTV With Integrated PC and Blu-ray Player">
		<span style="display:none">Silicon Mountain Holdings, Inc., (OTC:SLCM) (BULLETIN BOARD: SLCM) , a technology company specializing in high-performance interactive computing solutions, today announced its design for a 32 and 42-inch High Definition LCD-TV with an integrated, full-function PC and Blu-ray/DVD player. Named Allio, this system will define an entirely new category of converged products, where entertainment and instant, on-demand information and productivity blend together seamlessly, in stunning high-definition.

The Allio HD TV / PC is the first...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1545";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Silicon Mountain Unveils Allio(TM) 42-inch HDTV With Integrated PC and Blu-ray Player" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Silicon Mountain Unveils Allio(TM) 42-inch HDTV With Integrated PC and Blu-ray Player" />
...
<html>
<head>
	<title>HDTV Magazine - Silicon Mountain Unveils Allio(TM) 42-inch HDTV With Integrated PC and Blu-ray Player</title>
	<meta name="keywords" content="silicon mountain, blu ray, mountain holdings, holdings inc, ray dvd, allio, mountain, silicon, blu, ray, company, holdings, digital, high, player, system, dvd, screen, statements, while, experience, inc, internet, product, integrated" />
...
The Allio HD TV / PC is the first..." />
	<meta name="title" content="Silicon Mountain Unveils Allio(TM) 42-inch HDTV With Integrated PC and Blu-ray Player" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/11/silicon-mountain-unveils-alliotm-42inch-hdtv-with-integrated-pc-and-bluray-player.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1545', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/11/silicon-mountain-unveils-alliotm-42inch-hdtv-with-integrated-pc-and-bluray-player.php">Silicon Mountain Unveils Allio(TM) 42-inch HDTV With Integrated PC and Blu-ray Player</a></td>
						</tr><tr>
...
<p>Source: Silicon Mountain Holdings, Inc. </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>November 10, 2008  1:07 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1545)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/11/silicon-mountain-unveils-alliotm-42inch-hdtv-with-integrated-pc-and-bluray-player.php" type="text/javascript" charset="utf-8"></script>
