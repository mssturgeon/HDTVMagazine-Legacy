...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/11/sharp-adds-enhanced-inputs-and-network-connectivity-to-professional-highdefinition-liquid-crystal-display-lineup.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1546";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Sharp Adds Enhanced Inputs and Network Connectivity to Professional High-Definition Liquid Crystal Display Lineup" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Sharp Adds Enhanced Inputs and Network Connectivity to Professional High-Definition Liquid Crystal Display Lineup" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Sharp Adds Enhanced Inputs and Network Connectivity to Professional High-Definition Liquid Crystal Display Lineup" />
...
<html>
<head>
	<title>HDTV Magazine - Sharp Adds Enhanced Inputs and Network Connectivity to Professional High-Definition Liquid Crystal Display Lineup</title>
	<meta name="keywords" content="lcd monitor, professional lcd, high definition, added resellers, sharp authorized, sharp, monitor, professional, high, display, lcd, digital, image, mode, information, new, landscape, added, both, corporation, backlight, definition, input, portrait, dealers" />
	...
	<meta name="title" content="Sharp Adds Enhanced Inputs and Network Connectivity to Professional High-Definition Liquid Crystal Display Lineup" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Sharp Adds Enhanced Inputs and Network Connectivity to Professional High-Definition Liquid Crystal Display Lineup" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/11/sharp-adds-enhanced-inputs-and-network-connectivity-to-professional-highdefinition-liquid-crystal-display-lineup.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Sharp is expanding its comprehensive line-up of professional LCD displays with the announcement of two Monitors that represent upgrades to two successful &quot;PN&quot; series monitors. The new PN-S525, designed for extended use in both landscape and portrait mode, replaces its predecessor - model PN-525U, while the new PN-S655, designed for extended use in landscape mode, replaces its predecessor - model PN-G655U. These new models offer high image quality and performance, adding a new LCD component panel for improved resistance to image retention, as well as additional inputs including HDMI and RJ-45 LAN for advanced connectivity and networking capability. Also..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1546', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/11/sharp-adds-enhanced-inputs-and-network-connectivity-to-professional-highdefinition-liquid-crystal-display-lineup.php">Sharp Adds Enhanced Inputs and Network Connectivity to Professional High-Definition Liquid Crystal Display Lineup</a></td>
						</tr><tr>
...
<p>All other trademarks are property of their respective owners. </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>November 10, 2008  1:09 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1546)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/11/sharp-adds-enhanced-inputs-and-network-connectivity-to-professional-highdefinition-liquid-crystal-display-lineup.php" type="text/javascript" charset="utf-8"></script>
