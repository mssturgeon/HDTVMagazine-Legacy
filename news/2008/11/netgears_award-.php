...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=NETGEAR\'s Award-Winning Powerline Adapters for HD and Multimedia Streaming Now Available&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/11/netgears-awardwinning-powerline-adapters-for-hd-and-multimedia-streaming-now-available.php&amp;title=NETGEAR's Award-Winning Powerline Adapters for HD and Multimedia Streaming Now Available">
		<span style="display:none">NETGEAR(R), Inc. (NASDAQ:NTGR) , a worldwide provider of technologically innovative, branded networking solutions, today announced the general availability of its latest powerline adapters for turning electrical power outlets into high-speed Internet and home network connections. Fast enough to stream high-definition video, the award-winning Powerline HD Plus Ethernet Adapter Kit (HDXB111) and Powerline AV Ethernet Adapter Kit (XAVB101) provide reliable, high-speed network connections up to...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/11/netgears-awardwinning-powerline-adapters-for-hd-and-multimedia-streaming-now-available.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1553', 340, 125);">Add ASIN</a>
