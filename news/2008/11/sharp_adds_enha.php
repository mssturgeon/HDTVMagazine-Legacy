...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Sharp Adds Enhanced Inputs and Network Connectivity to Professional High-Definition Liquid Crystal Display Lineup&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/11/sharp-adds-enhanced-inputs-and-network-connectivity-to-professional-highdefinition-liquid-crystal-display-lineup.php&amp;title=Sharp Adds Enhanced Inputs and Network Connectivity to Professional High-Definition Liquid Crystal Display Lineup">
		<span style="display:none">Sharp is expanding its comprehensive line-up of professional LCD displays with the announcement of two Monitors that represent upgrades to two successful &quot;PN&quot; series monitors. The new PN-S525, designed for extended use in both landscape and portrait mode, replaces its predecessor - model PN-525U, while the new PN-S655, designed for extended use in landscape mode, replaces its predecessor - model PN-G655U. These new models offer high image quality and performance, adding a new LCD component panel for improved resistance to image retention, as well as additional inputs including HDMI and RJ-45 LAN for advanced connectivity and networking capability. Also...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/11/sharp-adds-enhanced-inputs-and-network-connectivity-to-professional-highdefinition-liquid-crystal-display-lineup.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1546', 340, 125);">Add ASIN</a>
