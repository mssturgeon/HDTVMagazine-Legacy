...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=New JVC HD Everio Line Includes World\'s First 50-Hour AVCHD Camcorder and Dual-Format Models&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2008/06/new-jvc-hd-everio-line-includes-worlds-first-50hour-avchd-camcorder-and-dualformat-models.php&amp;title=New JVC HD Everio Line Includes World's First 50-Hour AVCHD Camcorder and Dual-Format Models">
		<span style="display:none">JVC has added three new high definition camcorders to its HD Everio line, including a pair of dual-format models, one of which records up to 50 hours of AVCHD Full HD video.

Two new models, the GZ-HD40 and GZ-HD30, are the world's first AVCHD / MPEG-2 dual-format camcorders, allowing access to the superior long time compression afforded by AVCHD, as well as MPEG-2's superior editing and post-production environment. Both offer...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
Two new models, the GZ-HD40 and GZ-HD30, are the world's first AVCHD / MPEG-2 dual-format camcorders, allowing access to the superior long time compression afforded by AVCHD, as well as MPEG-2's superior editing and post-production environment. Both offer..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2008/06/new-jvc-hd-everio-line-includes-worlds-first-50hour-avchd-camcorder-and-dualformat-models.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1428', 340, 125);">Add ASIN</a>
