...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2008/06/new-kaleidescape-movie-players-produce-stunning-video-quality-from-ordinary-dvds-provide-viewing-experience-that-rivals-bluray.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1442";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download New Kaleidescape Movie Players Produce Stunning Video Quality From Ordinary DVDs, Provide Viewing Experience That Rivals Blu-ray" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="New Kaleidescape Movie Players Produce Stunning Video Quality From Ordinary DVDs, Provide Viewing Experience That Rivals Blu-ray" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="New Kaleidescape Movie Players Produce Stunning Video Quality From Ordinary DVDs, Provide Viewing Experience That Rivals Blu-ray" />
...
<html>
<head>
	<title>HDTV Magazine - New Kaleidescape Movie Players Produce Stunning Video Quality From Ordinary DVDs, Provide Viewing Experience That Rivals Blu-ray</title>
	<meta name="keywords" content="mini player, viewing experience, dvds cds, kaleidescape inc, video quality, kaleidescape, player, video, movie, viewing, mini, dvds, new, players, experience, import, movies, dvd, home, cds, quality, inc, blu, ray, display" />
...
The 1080p Player is designed as a..." />
	<meta name="title" content="New Kaleidescape Movie Players Produce Stunning Video Quality From Ordinary DVDs, Provide Viewing Experience That Rivals Blu-ray" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="New Kaleidescape Movie Players Produce Stunning Video Quality From Ordinary DVDs, Provide Viewing Experience That Rivals Blu-ray" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2008/06/new-kaleidescape-movie-players-produce-stunning-video-quality-from-ordinary-dvds-provide-viewing-experience-that-rivals-bluray.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Kaleidescape, Inc., the market leader in entertainment servers, today introduced the 1080p Player and 1080p Mini Player - two Movie Players that produce stunning video quality from ordinary DVDs, providing a viewing experience that rivals Blu-ray. The new family of Players makes it possible to enjoy the Kaleidescape Experience even with DVDs and CDs that have not been imported into a Kaleidescape System, and a new form factor makes it possible to place a 1080p Mini Player anywhere in the home.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1442', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2008/06/new-kaleidescape-movie-players-produce-stunning-video-quality-from-ordinary-dvds-provide-viewing-experience-that-rivals-bluray.php">New Kaleidescape Movie Players Produce Stunning Video Quality From Ordinary DVDs, Provide Viewing Experience That Rivals Blu-ray</a></td>
						</tr><tr>
...
<p>© 2008 Kaleidescape, Inc. All rights reserved. Kaleidescape and the Kaleidescape logo are trademarks of Kaleidescape, Inc.; they are registered in the United States and certain other jurisdictions. Other trademarks and trade names are owned by third parties and may be registered in some jurisdictions.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>June 18, 2008  7:20 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1442)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2008/06/new-kaleidescape-movie-players-produce-stunning-video-quality-from-ordinary-dvds-provide-viewing-experience-that-rivals-bluray.php" type="text/javascript" charset="utf-8"></script>
