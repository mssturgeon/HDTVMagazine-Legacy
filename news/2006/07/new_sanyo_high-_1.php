...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=New Sanyo High-Definition Digital Media Camera&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2006/07/new-sanyo-highdefinition-digital-media-camera.php&amp;title=New Sanyo High-Definition Digital Media Camera">
		<span style="display:none">A video recording mode optimized for the video iPod&amp;reg;, 16:9 widescreen still picture mode and easy, convenient in-camera video editing. The SANYO Xacti HD1a features an ergonomic, one-handed operation. It can record both 720p high-definition video and 5.1 megapixel digital still images to a standard SD flash memory card. It will be available in the U.S. in September 2006 at a very competitive $699.99** MSRP.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2006/07/new-sanyo-highdefinition-digital-media-camera.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=403', 340, 125);">Add ASIN</a>
