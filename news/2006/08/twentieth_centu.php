...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Twentieth Century Fox Home Entertainment Announces Its First Blu-ray Disc Releases&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2006/08/twentieth-century-fox-home-entertainment-announces-its-first-bluray-disc-releases.php&amp;title=Twentieth Century Fox Home Entertainment Announces Its First Blu-ray Disc Releases">
		<span style="display:none">ICE AGE: THE MELTDOWN Is First Day-and-Date Release on Blu-ray and DVD in North America, Australia and Europe.

Continuing its unwavering and exclusive support for the Blu-ray Disc format, Twentieth Century Fox Home Entertainment President Worldwide Mike Dunn announced today the Studio's first wave of highly-anticipated motion pictures to debut on Blu-ray Disc (BD), which is the only high-definition packaged media platform broadly supported by the film, music, gaming, computing and consumer electronics industries. Representing more than $2 billion in box office and 90 million DVD units sold worldwide, the studio's first eight BD releases are right on target with the BD early adopter and Playstation 3 purchaser. Taking full advantage of the next generation format's high definition technology ...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
Continuing its unwavering and exclusive support for the Blu-ray Disc format, Twentieth Century Fox Home Entertainment President Worldwide Mike Dunn announced today the Studio's first wave of highly-anticipated motion pictures to debut on Blu-ray Disc (BD), which is the only high-definition packaged media platform broadly supported by the film, music, gaming, computing and consumer electronics industries. Representing more than $2 billion in box office and 90 million DVD units sold worldwide, the studio's first eight BD releases are right on target with the BD early adopter and Playstation 3 purchaser. Taking full advantage of the next generation format's high definition technology ..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2006/08/twentieth-century-fox-home-entertainment-announces-its-first-bluray-disc-releases.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=436', 340, 125);">Add ASIN</a>
