...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2006/09/tivo-debuts-series3-high-definition-digital-media-recorder.php&amp;title=TiVo Debuts Series3 High Definition Digital Media Recorder">
		<span style="display:none">TiVo Inc., the creator of and a leader in television services for digital video recorders (DVRs), announced today the launch of the high end TiVo&amp;reg; Series3&amp;trade; HD Digital Media Recorder - the first stand-alone TiVo product that is HD compatible. Available beginning mid-September, the TiVo Series3 HD box is the world's first THX&amp;reg;-certified, digital video recorder, delivering audio and video that truly maintains the fidelity of the original broadcast. Once again, TiVo is</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2006/09/tivo-debuts-series3-high-definition-digital-media-recorder.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=444', 340, 125);">Add ASIN</a>
