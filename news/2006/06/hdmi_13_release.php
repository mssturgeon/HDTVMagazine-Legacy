...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDMI 1.3 Released - Doubles Bandwidth, Deliveres Billions of Colors for  HDTVs&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2006/06/hdmi-13-released-doubles-bandwidth-deliveres-billions-of-colors-for-hdtvs.php&amp;title=HDMI 1.3 Released - Doubles Bandwidth, Deliveres Billions of Colors for  HDTVs">
		<span style="display:none">HDMI Founder companies (Hitachi, Ltd., Matsushita Electric Industrial Co., Ltd. (Panasonic), Royal Philips Electronics, Silicon Image, Inc., Sony Corp., Thomson, Inc. and Toshiba Corp.) today released a major enhancement of the High-Definition Multimedia Interface&amp;trade; (HDMI&amp;trade;) specification, the de facto standard digital interface for high definition consumer electronics. HDMI 1.3 will enable the next generation of HDTVs, PCs and DVD players to transmit and display content in billions of colors with unprecedented vividness and accuracy.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2006/06/hdmi-13-released-doubles-bandwidth-deliveres-billions-of-colors-for-hdtvs.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=392', 340, 125);">Add ASIN</a>
