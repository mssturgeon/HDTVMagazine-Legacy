...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 460";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download The CES Show Approaches --  Less Hotel Space and Higher Prices" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="The CES Show Approaches --  Less Hotel Space and Higher Prices" />
...
<html>
<head>
	<title>HDTV Magazine - The CES Show Approaches --  Less Hotel Space and Higher Prices</title>
	<meta name="keywords" content="sands venetian, international ces, tech ones, innovations plus, las vegas, ces, sands, venetian, press, innovations, tech, international, ones, events, year, technology, vegas, consumer, honorees, venue, las, home, plus, january, hotel" />
...
Arlington, Va., October 17, 2006 - CES keynotes, high-performance audio and home theater exhibitors, Innovations honorees, emerging technology exhibits, TechZones, and a range of special media events take center stage at the newest venue of the 2007 International Consumer Electronics Show (CES®) - Innovations Plus at the Sands. To accommodate these must-see events, CES is augmenting the Las Vegas Convention Center (LVCC) with halls B, C and D of the Sands Expo and Convention Center and portions of the adjoining Venetian Hotel. The 2007 International CES, the world's largest annual consumer technology tradeshow, runs January 8-11, in Las Vegas, Nevada. " />
	<meta name="title" content="The CES Show Approaches --  Less Hotel Space and Higher Prices" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2006/10/the-ces-show-approaches-less-hotel-space-and-higher-prices.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=460', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2006/10/the-ces-show-approaches-less-hotel-space-and-higher-prices.php">The CES Show Approaches --  Less Hotel Space and Higher Prices</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Dale Cripps</b> on <b>October 17, 2006</b>
...
<p>For more information on the 2007 International CES, including online registration, updated CES news, events and schedules, visit www.CESweb.org. </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Dale Cripps</b>, <b>October 17, 2006 10:34 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Dale Cripps', 460)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2006/10/the-ces-show-approaches-less-hotel-space-and-higher-prices.php" type="text/javascript" charset="utf-8"></script>
