...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=First Products with HDMI 1.3 Features Hit the Market&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2006/10/first-products-with-hdmi-13-features-hit-the-market.php&amp;title=First Products with HDMI 1.3 Features Hit the Market">
...
The demonstrations will preview high-definition (HD) video and audio technology that will begin hitting the consumer market in November and continue rolling out in 2007. According to announcements by manufacturers, among the first consumer products with HDMI 1.3 features to reach the market will be the PLAYSTATION&amp;reg;3 (PS3) from Sony Computer Entertainment Inc. in November, the HD-XA2 HD DVD player from Toshiba America Consumer Products, LLC in December, and the EMP-TW1000, a 3LCD 1080p projector from Epson in December." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2006/10/first-products-with-hdmi-13-features-hit-the-market.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=466', 340, 125);">Add ASIN</a>
