...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Sony Makes 3D Come to Life at Home with First 3D Capable Bravia HDTVs&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2010/01/sony-makes-3d-come-to-life-at-home-with-first-3d-capable-bravia-hdtvs.php&amp;title=Sony Makes 3D Come to Life at Home with First 3D Capable Bravia HDTVs">
		<span style="display:none">From black-and-white, to color, to digital, Sony Electronics is once again setting the new standard for how televisions look and perform.  Today, the company introduced its 2010 BRAVIA® LCD HDTV line featuring its first 3D HDTVs, a new innovative and stylish Monolithic Design Concept, and LED backlighting.

The new Sony televisions are...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
The new Sony televisions are..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2010/01/sony-makes-3d-come-to-life-at-home-with-first-3d-capable-bravia-hdtvs.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3486', 340, 125);">Add ASIN</a>
