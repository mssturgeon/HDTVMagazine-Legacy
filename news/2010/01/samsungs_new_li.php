...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3481 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Samsung\'s New Lineup of LED HDTVs Raises the Bar for TV Excellence&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2010/01/samsungs-new-lineup-of-led-hdtvs-raises-the-bar-for-tv-excellence.php&amp;title=Samsung's New Lineup of LED HDTVs Raises the Bar for TV Excellence">
		<span style="display:none">Samsung Electronics Co., Ltd., a market leader and award-winning innovator in consumer electronics, unveiled today the next generation of its award-winning LED back-lit TVs, featuring a first of its kind built-in 3D processor, connected interactive experiences and innovative, trend-setting designs with a wide range of options to match the décor of almost any living room. . This year’s flagship Series, the 9000, has proudly won the 2010 CES Best of Innovations award. Perhaps most notably, Samsung offers its most versatile LED TV lineup, which consists of entry level HD offerings to its highest performing full HD TV’s ever, in a variety of screen sizes.  Samsung’s latest HDTVs will be...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3481";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Samsung\'s New Lineup of LED HDTVs Raises the Bar for TV Excellence" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Samsung\'s New Lineup of LED HDTVs Raises the Bar for TV Excellence" />
...
<html>
<head>
	<title>HDTV Magazine - Samsung's New Lineup of LED HDTVs Raises the Bar for TV Excellence</title>
	<meta name="keywords" content="samsung electronics, picture quality, led tvs, award winning, blu ray, samsung, led, series, screen, lineup, electronics, technology, samsung’s, new, tvs, picture, remote, content, design, quality, built, ray, ”, award, blu" />
	<meta name="description" content="Samsung Electronics Co., Ltd., a market leader and award-winning innovator in consumer electronics, unveiled today the next generation of its award-winning LED back-lit TVs, featuring a first of its kind built-in 3D processor, connected interactive experiences and innovative, trend-setting designs with a wide range of options to match the décor of almost any living room. . This year’s flagship Series, the 9000, has proudly won the 2010 CES Best of Innovations award. Perhaps most notably, Samsung offers its most versatile LED TV lineup, which consists of entry level HD offerings to its highest performing full HD TV’s ever, in a variety of screen sizes.  Samsung’s latest HDTVs will be..." />
	<meta name="title" content="Samsung's New Lineup of LED HDTVs Raises the Bar for TV Excellence" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2010/01/samsungs-new-lineup-of-led-hdtvs-raises-the-bar-for-tv-excellence.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3481', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2010/01/samsungs-new-lineup-of-led-hdtvs-raises-the-bar-for-tv-excellence.php">Samsung's New Lineup of LED HDTVs Raises the Bar for TV Excellence</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">SAMSUNG'S NEW LINEUP OF LED HDTVS RAISES THE BAR FOR TV EXCELLENCE</p>
January 6, 2010
<center><i></center>Immersive Lifelike Depth and 3D Capabilities, Connected Interactive Content and Services, and Mold-Breaking Design Set Next Generation of Samsung LED back-lit HDTVs Apart</i><br />
<br />

<p><strong>LAS VEGAS, January 6, 2010</strong> – Samsung Electronics Co., Ltd., a market leader and award-winning innovator in consumer electronics, unveiled today the next generation of its award-winning LED back-lit TVs, featuring a first of its kind built-in 3D processor, connected interactive experiences and innovative, trend-setting designs with a wide range of options to match the décor of almost any living room. . This year’s flagship Series, the 9000, has proudly won the 2010 CES Best of Innovations award. Perhaps most notably, Samsung offers its most versatile LED TV lineup, which consists of entry level HD offerings to its highest performing full HD TV’s ever, in a variety of screen sizes.  Samsung’s latest HDTVs will be on display at Booth #11026 during the International Consumer Electronics Show, which will be held at the Las Vegas Convention Center, January 7 -10, 2010.</p>
...
<p><br />
<strong>Green Design</strong></p>

<p>All these functionalities are delivered without compromising on the energy efficiency that Samsung LED TVs are known for and meet even higher standards of sustainability.  They all exceed the more stringent EnergyStar® 4.0 guidelines. Samsung LED TVs are the highest performing and eco-conscious HDTV products Samsung has ever released, continuing to set new standards every year.</p>

<p><br />
<strong>Redefining the Remote</strong></p>

<p>In another industry first, Samsung developed an easy to use on-board TV display full touch-screen remote control.  The remote’s color touch-screen makes understanding features and options easy and simple. Its integrated Wi-Fi and infrared technology controls TV and AV devices with the on-screen buttons and QWERTY keyboard. It allows users to watch broadcast content directly on the remote so you can watch the first part of the big game, while a Blu-ray movie is just wrapping up on the large screen HDTV(9000 Series only). You can also browse music, photos, and video files from a DLNA certified PC then swipe the chosen content in the direction of the TV to enjoy on the larger screen (9000 Series only). The remote is the primary remote control for the 9000 Series and a derivative version of it is sold separately as an option for other LED TV models including the 7000 and 8000 Series.</p>

<p>Samsung Electronics America’s CES press releases, product images and video content is available at <a target="_blank" href="http://www.samsung.com/newsroom/">www.samsung.com/newsroom</a>.</p>
...
<p>Samsung Electronics Co., Ltd. is a global leader in semiconductor, telecommunication, digital media and digital convergence technologies with 2008 consolidated sales of US$96 billion. Employing approximately 164,600 people in 179 offices across 61 countries, the company is recognized as one of the fastest growing global brands. Samsung Electronics is a leading producer of digital TVs, memory chips, mobile phones and TFT-LCDs. For more information, please visit <a target="_blank" href="http://www.samsung.com/">www.samsung.com</a>.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  6, 2010  5:12 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3481)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2010/01/samsungs-new-lineup-of-led-hdtvs-raises-the-bar-for-tv-excellence.php" type="text/javascript" charset="utf-8"></script>
