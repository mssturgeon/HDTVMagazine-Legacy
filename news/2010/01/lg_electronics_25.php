...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=LG Electronics Expands Access to Content-On-Demand With New High-Performance Blu-ray Disc Players&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2010/01/lg-electronics-expands-access-to-contentondemand-with-new-highperformance-bluray-disc-players.php&amp;title=LG Electronics Expands Access to Content-On-Demand With New High-Performance Blu-ray Disc Players">
		<span style="display:none">Delivering on its commitment to give consumers endless entertainment options in a stylish package, LG Electronics today introduced its 2010 family of Network Blu-ray Disc Players and Home Theater Systems that bring a new level of convenience to playing pre-recorded and online high-definition content.

Leading the line-up...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
Leading the line-up..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2010/01/lg-electronics-expands-access-to-contentondemand-with-new-highperformance-bluray-disc-players.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3492', 340, 125);">Add ASIN</a>
