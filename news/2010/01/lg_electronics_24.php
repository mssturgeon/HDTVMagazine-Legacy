...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2010/01/lg-electronics-reinforces-commitment-to-plasma-hdtvs-with-slim-versatile-design-pictureenhancing-technology.php&amp;title=LG Electronics Reinforces Commitment to Plasma HDTVs With Slim, Versatile Design, Picture-Enhancing Technology">
		<span style="display:none">LG Electronics underscored its commitment to the plasma HDTV category with eight new models for 2010, led by the new LG INFINIA series, which represents the best in LG's design, technology and entertainment options.

Featuring new picture-enhancing technology and lightweight designs in a variety of screen sizes, four new plasma series...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
Featuring new picture-enhancing technology and lightweight designs in a variety of screen sizes, four new plasma series..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2010/01/lg-electronics-reinforces-commitment-to-plasma-hdtvs-with-slim-versatile-design-pictureenhancing-technology.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3491', 340, 125);">Add ASIN</a>
