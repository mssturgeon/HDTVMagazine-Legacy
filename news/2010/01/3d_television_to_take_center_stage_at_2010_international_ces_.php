<?
	...
	# Get category ID
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3450 AND placement_is_primary = 1";
	$res_category = mQuery($sql);
	$row_category = mysql_fetch_assoc($res_category);
	$category_id = $row_category['placement_category_id'];

	# Get enclosure info
	$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3450";
	...
	switch (7) {
		case 1: # Articles
			...
			$feed_tracker = '<script src="http://feeds.feedburner.com/~s/hdtv-articles?i=http://www.hdtvmagazine.com/news/2010/01/3d_television_to_take_center_stage_at_2010_international_ces_.php" type="text/javascript" charset="utf-8"></script>';
		...
		case 4: # Interviews
			...
			$feed_tracker = '<script src="http://feeds.feedburner.com/~s/hdtv-interviews?i=http://www.hdtvmagazine.com/news/2010/01/3d_television_to_take_center_stage_at_2010_international_ces_.php" type="text/javascript" charset="utf-8"></script>';
			break;
		case 5: # History
			$feed_link = '<link rel="alternate" type="application/rss+xml" title="HDTV Magazine Bulletins Feed" href="http://feeds.hdtvmagazine.com/hdtv-archive" />';
			$feed_tracker = '<script src="http://feeds.feedburner.com/~s/hdtv-archive?i=http://www.hdtvmagazine.com/news/2010/01/3d_television_to_take_center_stage_at_2010_international_ces_.php" type="text/javascript" charset="utf-8"></script>';
			break;
		case 6: # Test
			$container = 'article_container';
			$sub_type = 0;
		...
		case 7: # Bulletins
			...
			$feed_tracker = '<script src="http://feeds.feedburner.com/~s/hdtv-news?i=http://www.hdtvmagazine.com/news/2010/01/3d_television_to_take_center_stage_at_2010_international_ces_.php" type="text/javascript" charset="utf-8"></script>';
		...
		case 8: # Reviews
			...
			$feed_tracker = '<script src="http://feeds.feedburner.com/~s/hdtv-reviews?i=http://www.hdtvmagazine.com/news/2010/01/3d_television_to_take_center_stage_at_2010_international_ces_.php" type="text/javascript" charset="utf-8"></script>';
			$container = 'article_container';
		...
		case 10: # Columns
			...
			$feed_tracker = '<script src="http://feeds.feedburner.com/~s/hdtv-columns?i=http://www.hdtvmagazine.com/news/2010/01/3d_television_to_take_center_stage_at_2010_international_ces_.php" type="text/javascript" charset="utf-8"></script>';
			$container = 'article_container';
...
Some highlights at CES include..." />
	...
	<script type="text/javascript">
		digg_url = 'http://www.hdtvmagazine.com/news/2010/01/3d_television_to_take_center_stage_at_2010_international_ces_.php';
		digg_skin = 'compact';
		digg_window = 'new';
		digg_title = '3D TELEVISION TO TAKE CENTER STAGE AT 2010 INTERNATIONAL CES ';
		digg_bodytext = '3D TV is expected to dominate the show floor at the 2010 International CES this week with an abundance of products on display ranging from television displays and Blu-ray DVD players to end-to-end 3D solutions. A focal point of 3D exhibits at CES is the Experience 3D TechZone located in Central Hall of the Las Vegas Convention Center (LVCC) where more than 10 companies will showcase their products and technologies.\n\nSome highlights at CES include...';
//		digg_media = '';
...
//		ReTweet settings
		url = 'http://www.hdtvmagazine.com/news/2010/01/3d_television_to_take_center_stage_at_2010_international_ces_.php';
		size = 'small';
...
<body><div id="body_container">
	<?
		...
		$base_url = strleftback(PHP_SELF, '/') . '/3d_television_to_take_center_stage_at_2010_international_ces_';
		$title_encoded = rawurlencode(addslashes('3D TELEVISION TO TAKE CENTER STAGE AT 2010 INTERNATIONAL CES '));
		$email_url = "mailto:?subject=HDTV Magazine: $title_encoded&amp;body=http://www.hdtvmagazine.com/news/2010/01/3d_television_to_take_center_stage_at_2010_international_ces_.php";
		if ($author['img'] != '' && 7 != 7) {
	...
	if (strpos(strtolower($_SERVER['HTTP_USER_AGENT']), "google") === false) {?>
		...
		<table class="bare" cellpadding="0" cellspacing="0" style="width:100%;">
			<tr>
				...
				<td class="article_title" colspan="2">3D TELEVISION TO TAKE CENTER STAGE AT 2010 INTERNATIONAL CES </td>
			</tr><tr>
			<td id="article_byline" nowrap="nowrap">
					By <b>Shane Sturgeon</b><br />
					<?=$author_title?>
					Posted on <b>January  4, 2010</b><br />
					...
					<span><img src="http://cdn.stumble-upon.com/images/16x16_su_3d.gif" alt="" align="absmiddle" /><a target="_blank" href="http://www.stumbleupon.com/submit?url=http://www.hdtvmagazine.com/news/2010/01/3d_television_to_take_center_stage_at_2010_international_ces_.php&title=3D TELEVISION TO TAKE CENTER STAGE AT 2010 INTERNATIONAL CES ">StumbleUpon</a></span>
					<span><img src="/images/delicious.gif" alt="Add to Del.icio.us" align="absmiddle" /><a target="_blank" href="http://del.icio.us/post?url=http://www.hdtvmagazine.com/news/2010/01/3d_television_to_take_center_stage_at_2010_international_ces_.php&amp;title=<?=$title_encoded?>">Del.icio.us</a></span>
		...
		<div id="<?=$container?>">
			...
			<div class="header_buttons">
				<? if (7 == 9 || 7 == 6) { # Only show in the test area and for podcasts?>
					...
					<span><a href="<?=$enclosure_url?>"><img src="/images/chicklet-mp3-podcast.gif" alt="Download 3D TELEVISION TO TAKE CENTER STAGE AT 2010 INTERNATIONAL CES " /></a></span>
				<? }?>
			...
			<!-- sphereit start -->
			<p class="prtitle">3D TELEVISION TO TAKE CENTER STAGE AT 2010 INTERNATIONAL CES </p>

<center><i>Guide to 3D@CES is Comprehensive Resource</center></i><br />
<br />

<p><strong>LAS VEGAS, January 4, 2010</strong> – 3D TV is expected to dominate the show floor at the 2010 International CES this week with an abundance of products on display ranging from television displays and Blu-ray DVD players to end-to-end 3D solutions. A focal point of 3D exhibits at CES is the Experience 3D TechZone located in Central Hall of the Las Vegas Convention Center (LVCC) where more than 10 companies will showcase their products and technologies.</p>

<p>Some highlights at CES include:<br />
<ul><li>3D displays in all formats: flat screen (in a variety of sizes--mostly large screen), video projector and computer monitors</li><li>3D movies demonstrated via the just finalized Blu-ray 3D standard on prototype 3D Blu-ray players</li><li>3D games demonstrated on all popular videogame console formats</li><li>3D authoring software for Blu-ray</li><li>End-to-end 3D solutions encompassing everything from image capture through distribution and display</li><li>3D still images that do not require glasses to view</li><li>2D-to-3D real-time and offline video processing</li><li>Technology for converting a live high definition broadcast to 3D including live capture in HD of show attendees with 3D viewing</li><li>Accessories such as active shutter 3D glasses and 3D-optimized projector screens</li></ul></p>

<p>Specifics on these 3D developments and other news from 30 CES exhibitors will be included in a “Guide to 3D@CES”, developed by the 3D@Home Consortium. The Guide gives show attendees and the media a road map to 3D exhibits and provides a comprehensive overview of 3D technology. The Guide can be downloaded on Thursday, January 7 from the Consortium website: http://www.3dathome.org and is also available at the 3D@Home booth in the Experience 3D TechZone.</p>

<p>The 3D@Home Consortium will hold an open meeting on Friday, January 8 from 7:30 – 11:30 a.m. in Rooms 1 and 2 at the Las Vegas Hilton. At this meeting, the consortium Steering Teams and various standards organizations around the world that are looking at defining 3D requirements will provide updates. The meeting will conclude with a roundtable discussion on the direction of 3D, where the challenges lie and the opportunities for overcoming them. Pre-registration is required! To reserve a seat, please contact: Heidi@3Dathome.org.</p>

<p>A series of conference sessions on 3D will be held on Thursday, January 7: </p>

<p>Entertainment Technology@CES will take place from 10:00 am to 4:30 pm in room N260, in the North Hall of the LVCC, and is presented by The Entertainment Technology Center at USC. This program brings together the major Hollywood studios, consumer electronics and technology/services companies to collaborate on solutions for next-generation content delivery. </p>

<p>3D Hope or Hype will be held from 1:30 – 2:30 p.m. in N256 in the North Hall of the LVCC and will discuss 3D in the home including competing technologies, and whether today’s 3D is different from the 3D fads of the past.</p>
			<!-- sphereit end -->
			<div align="right"><a class="iconsphere" title="Related Blogs &amp; Articles" onclick="return Sphere.Widget.search()" href="http://www.sphere.com/search?q=sphereit:http://www.hdtvmagazine.com/news/2010/01/3d_television_to_take_center_stage_at_2010_international_ces_.php">Sphere: Related Content</a></div>
		</div>
	</div>
	<p class="posted">Posted by <b>Shane Sturgeon</b>, <b>January  4, 2010  8:40 PM</b></p>
  ...
  <td id="left"><!-- Comments -->
	...
	?>
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2010/01/3d_television_to_take_center_stage_at_2010_international_ces_.php" type="text/javascript" charset="utf-8"></script>
</div></body>
</html>
