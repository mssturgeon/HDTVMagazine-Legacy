...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3986 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2010/09/3d-cinema-comes-home-with-sonys-new-sxrd-front-projector.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3986";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download 3D Cinema Comes Home With Sony\'s New SXRD Front Projector" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="3D Cinema Comes Home With Sony\'s New SXRD Front Projector" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="3D Cinema Comes Home With Sony\'s New SXRD Front Projector" />
...
<html>
<head>
	<title>HDTV Magazine - 3D Cinema Comes Home With Sony's New SXRD Front Projector</title>
	<meta name="keywords" content="front projector, vpl vwpro, third party, control systems, party control, sony, projector, home, control, high, vpl, front, systems, experience, sxrd, new, technology, quality, seamlessly, full, integrate, delivering, theater, vwpro, performance" />
	<meta name="description" content="Sony today brings the big-screen 3D cinematic experience home with the new the VPL-VW90ES – the company's first 3D front projector.  
...
Designed with the custom and specialty consumer electronics market in mind, the VPL-VW90ES is the first projector to be been branded with Sony's &quot;Elevated Standard&quot; (ES) moniker, signifying an emphasis on high build quality and outstanding video experience. It was also engineered to seamlessly integrate third-party control systems." />
	<meta name="title" content="3D Cinema Comes Home With Sony's New SXRD Front Projector" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="3D Cinema Comes Home With Sony's New SXRD Front Projector" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2010/09/3d-cinema-comes-home-with-sonys-new-sxrd-front-projector.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Sony today brings the big-screen 3D cinematic experience home with the new the VPL-VW90ES – the company's first 3D front projector.  
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3986', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2010/09/3d-cinema-comes-home-with-sonys-new-sxrd-front-projector.php">3D Cinema Comes Home With Sony's New SXRD Front Projector</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<!--?=$v_buttons?-->
				<p class="prtitle">3D Cinema Comes Home With Sony's New SXRD Front Projector</p>

<center><i>Company's First 'Elevated Standard' Projector Integrates Seamlessly with Third-party Control Systems</center></i><br />
<br />

<p><strong>ATLANTA, Sept. 23 /PRNewswire/ -- (CEDIA Booth #1112) -- </strong>Sony today brings the big-screen 3D cinematic experience home with the new the VPL-VW90ES – the company's first 3D front projector.  </p>
...
<p><br />
<strong>VPL-VWPRO1 Home Theater Projector</strong></p>
...
<p>SOURCE Sony Electronics</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>September 23, 2010 10:22 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3986)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2010/09/3d-cinema-comes-home-with-sonys-new-sxrd-front-projector.php" type="text/javascript" charset="utf-8"></script>
