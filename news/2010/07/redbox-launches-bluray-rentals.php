...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3868 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2010/07/redbox-launches-bluray-rentals.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3868";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Redbox Launches Blu-ray Rentals" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Redbox Launches Blu-ray Rentals" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Redbox Launches Blu-ray Rentals" />
...
<html>
<head>
	<title>HDTV Magazine - Redbox Launches Blu-ray Rentals</title>
	<meta name="keywords" content="blu ray, coinstar inc, looking statements, ray rentals, ray titles, redbox, blu, ray, consumers, kiosk, titles, rentals, statements, coinstar, select, inc, locations, our, location, looking, performance, million, players, future, approximately" />
	<meta name="description" content="Redbox, the popular DVD rental kiosk provider, and wholly-owned subsidiary of Coinstar, Inc. (NASDAQ: CSTR) , today announced it has started rolling out Blu-ray(TM) titles with availability at approximately 13,300 kiosks nationwide. Redbox will rent Blu-ray Discs&amp;reg; at $1.50 per night plus tax and the company expects to have availability across its network of approximately 23,000 kiosk locations by the fall.

Each fully automated redbox kiosk holds..." />
	<meta name="title" content="Redbox Launches Blu-ray Rentals" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Redbox Launches Blu-ray Rentals" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2010/07/redbox-launches-bluray-rentals.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Redbox, the popular DVD rental kiosk provider, and wholly-owned subsidiary of Coinstar, Inc. (NASDAQ: CSTR) , today announced it has started rolling out Blu-ray(TM) titles with availability at approximately 13,300 kiosks nationwide. Redbox will rent Blu-ray Discs&amp;reg; at $1.50 per night plus tax and the company expects to have availability across its network of approximately 23,000 kiosk locations by the fall.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3868', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2010/07/redbox-launches-bluray-rentals.php">Redbox Launches Blu-ray Rentals</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>July 29, 2010</b>
			...
			<div id="<?=$container?>">
				...
				<!--?=$v_buttons?-->
				<p class="prtitle">Redbox Launches Blu-ray Rentals</p>

<center><i>DVD Rental Kiosk Leader Now Offering Popular Blu-ray Titles at an Affordable Price</center></i><br />
<br />

<p><strong>OAKBROOK TERRACE, Ill., July 29 /PRNewswire/ -- </strong>Redbox, the popular DVD rental kiosk provider, and wholly-owned subsidiary of Coinstar, Inc. (NASDAQ: CSTR) , today announced it has started rolling out Blu-ray(TM) titles with availability at approximately 13,300 kiosks nationwide. Redbox will rent Blu-ray Discs&reg; at $1.50 per night plus tax and the company expects to have availability across its network of approximately 23,000 kiosk locations by the fall.</p>
...
<p>"The Book of Eli," "Bounty Hunter," "Brooklyn's Finest" and "Green Zone" are among the Blu-ray titles currently available at redbox&reg; kiosks. The number of Blu-ray titles and copies will vary by kiosk and location with new titles being added each week. Consumers can visit <a target="_blank" href="http://www.redbox.com/bluray/">www.redbox.com/bluray</a> to find a nearby redbox location and to check Blu-ray availability in their area. Consumers can return their Blu-ray rentals to any redbox location as part of the company's rent-and-return anywhere&reg; policy.</p>

<p>Each fully automated redbox kiosk holds 630 discs, representing up to 200 titles, including standard definition DVDs and Blu-ray Discs at select locations. Consumers simply use a touch screen to select their favorite movies, swipe a valid credit or debit card and go. For added convenience, customers can visit <a target="_blank" href="http://www.redbox.com/">www.redbox.com</a> to select their movie online or via the iPhone&reg; app from redbox and pick it up immediately at the redbox location of their choice.</p>
...
<p>Source: Redbox Automated Retail, LLC</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>July 29, 2010  1:48 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3868)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2010/07/redbox-launches-bluray-rentals.php" type="text/javascript" charset="utf-8"></script>
