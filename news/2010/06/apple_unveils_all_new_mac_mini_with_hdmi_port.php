...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3791 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2010/06/apple-unveils-all-new-mac-mini-with-hdmi-port.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3791";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Apple Unveils All New Mac mini (with HDMI Port)" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Apple Unveils All New Mac mini (with HDMI Port)" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Apple Unveils All New Mac mini (with HDMI Port)" />
...
<html>
<head>
	<title>HDTV Magazine - Apple Unveils All New Mac mini (with HDMI Port)</title>
	<meta name="keywords" content="mac mini, snow leopard, new mac, leopard server, duo processor, mac, apple, mini, new, graphics, energy, hdmi, leopard, server, snow, digital, power, processor, audio, port, hard, core, performance, products, epeat" />
	<meta name="description" content="Apple&amp;reg; today unveiled a completely redesigned Mac&amp;reg; mini, featuring up to twice the graphics performance, a new HDMI port and a new SD card slot, all in an amazingly compact aluminum enclosure. Mac mini is the world's most energy efficient desktop and starting at $699, is the most affordable way to enjoy Mac OS&amp;reg; X, iLife&amp;reg; or Mac OS X Snow Leopard&amp;reg; Server.

Created with the unibody construction process pioneered by Apple, the new Mac mini features..." />
	<meta name="title" content="Apple Unveils All New Mac mini (with HDMI Port)" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Apple Unveils All New Mac mini (with HDMI Port)" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2010/06/apple-unveils-all-new-mac-mini-with-hdmi-port.php" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3791', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2010/06/apple-unveils-all-new-mac-mini-with-hdmi-port.php">Apple Unveils All New Mac mini (with HDMI Port)</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<!--?=$v_buttons?-->
				<p class="prtitle">Apple Unveils All New Mac mini</p>

<p><strong>CUPERTINO, Calif., June 15 /PRNewswire-FirstCall/ -- </strong>Apple&reg; today unveiled a completely redesigned Mac&reg; mini, featuring up to twice the graphics performance, a new HDMI port and a new SD card slot, all in an amazingly compact aluminum enclosure. Mac mini is the world's most energy efficient desktop and starting at $699, is the most affordable way to enjoy Mac OS&reg; X, iLife&reg; or Mac OS X Snow Leopard&reg; Server.</p>
...
<p>Mac mini comes with Mac OS X Snow Leopard, the world's most advanced operating system, and iLife, Apple's innovative suite of applications for managing photos, making movies and creating and learning to play music. Snow Leopard builds on a decade of OS X innovation and success with hundreds of refinements, new core technologies and out of the box support for Microsoft Exchange. iLife features iPhoto&reg;, to easily organize and manage photos; iMovie&reg; with powerful easy-to-use new features such as Precision Editor, video stabilization and advanced drag and drop; and GarageBand&reg; which introduces a whole new way to help you learn to play piano and guitar.</p>

<p>Mac mini with Mac OS X Snow Leopard Server fulfills all the server needs of a workgroup or small business including email, calendar, file serving, Time Machine&reg; backup, Wiki Server, Podcast Producer and more. Mac mini with Mac OS X Snow Leopard Server uses less than 11W of power at idle, a fraction of the power consumed in comparison to typical entry-level tower servers.*** Mac mini with Mac OS X Snow Leopard Server is faster than before with a 2.66 GHz Intel Core 2 Duo processor, two 500GB hard drives now running at 7200 rpm, 4GB of RAM and supports unlimited clients for $999.</p>

<p><br />
<strong>Pricing &amp; Availability</strong></p>

<p>The new Mac mini is shipping today and will be available through the Apple Store&reg; (<a target="_blank" href="http://www.apple.com/">www.apple.com</a>), Apple's retail stores and Apple Authorized Resellers.</p>

<p>  The Mac mini, for a suggested retail price of $699 (US), includes:<br />
  --  2.4 GHz Intel Core 2 Duo processor with 3MB of shared L2 cache;<br />
  --  2GB of 1066 MHz DDR3 SDRAM, expandable up to 8GB;<br />
  --  a slot-load 8X SuperDrive&reg; (DVD+/-R DL/DVD+/-RW/CD-RW) optical drive;<br />
  --  320GB Serial ATA hard drive running at 5400 rpm;<br />
  --  NVIDIA GeForce 320M integrated graphics;<br />
  --  AirPort Extreme&reg; 802.11n wireless networking and Bluetooth 2.1+EDR;<br />
  --  Gigabit Ethernet;<br />
  --  four USB 2.0 ports;<br />
  --  SD card slot;<br />
  --  one FireWire&reg; 800 port;<br />
...
<p>Build-to-order options and accessories include up to 8GB 1066 MHz DDR3 SDRAM, 500GB hard drive running at 5400 rpm, Apple Remote, Aperture(TM) 3, Final Cut&reg; Express 4, Logic&reg; Express, iWork&reg; (pre-installed), Apple Wireless Keyboard, Magic Mouse, Apple 24 inch LED Cinema Display and the AppleCare&reg; Protection Plan.</p>
...
<p>***Claim based on energy efficiency categories and products listed within the EPA Energy Star Small Scale Server database as of June 2010.</p>
...
<p>&copy; 2010 Apple Inc. All rights reserved. Apple, the Apple logo, Mac, Mac OS, Macintosh, iLife, Snow Leopard, iPhoto, iMovie, GarageBand, Time Machine, Apple Store, SuperDrive, AirPort Extreme, FireWire, Aperture, Final Cut, Logic, iWork and AppleCare are trademarks of Apple. Other company and product names may be trademarks of their respective owners.</p>

<p>Source: Apple</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>June 15, 2010  3:11 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3791)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2010/06/apple-unveils-all-new-mac-mini-with-hdmi-port.php" type="text/javascript" charset="utf-8"></script>
