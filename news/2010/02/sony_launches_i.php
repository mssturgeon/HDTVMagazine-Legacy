...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Sony Launches Its First Blu-ray 3D-Ready Player&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2010/02/sony-launches-its-first-bluray-3dready-player.php&amp;title=Sony Launches Its First Blu-ray 3D-Ready Player">
		<span style="display:none">&lt;img src=&quot;http://www.hdtvmagazine.com/news/images/2010-02-10_sony_blu_ray_3d_ready_player.jpg&quot; alt=&quot;SONY Blu-ray 3D-Ready Player&quot; height=&quot;67&quot; width=&quot;81&quot; style=&quot;float:left; padding:0 5px 5px 0&quot; /&gt;Continuing to drive innovation, Sony&amp;reg; today launched the new BDP-S470 stand-alone Blu-ray 3D(TM)-ready player. The model can be upgraded to play Blu-ray 3D content with a firmware update available this summer.

The company also announced that the previously introduced BDP-S570 Blu-ray Disc(TM) model and the BDV-E770W and BDV-E570 Blu-ray Disc home theater systems will be Blu-ray 3D capable with firmware updates available...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
The company also announced that the previously introduced BDP-S570 Blu-ray Disc(TM) model and the BDV-E770W and BDV-E570 Blu-ray Disc home theater systems will be Blu-ray 3D capable with firmware updates available..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2010/02/sony-launches-its-first-bluray-3dready-player.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3537', 340, 125);">Add ASIN</a>
