...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3557 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Walmart Announces Acquisition of Digital Entertainment Provider, VUDU&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2010/02/walmart-announces-acquisition-of-digital-entertainment-provider-vudu.php&amp;title=Walmart Announces Acquisition of Digital Entertainment Provider, VUDU">
		<span style="display:none">Walmart announced today a definitive agreement to acquire VUDU, Inc., a leading provider of digital technologies and services that enable the delivery of entertainment content directly to broadband high-definition TVs and Blu-ray players. The deal is expected to close within the next few weeks.
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3557";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Walmart Announces Acquisition of Digital Entertainment Provider, VUDU" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Walmart Announces Acquisition of Digital Entertainment Provider, VUDU" />
...
<html>
<head>
	<title>HDTV Magazine - Walmart Announces Acquisition of Digital Entertainment Provider, VUDU</title>
	<meta name="keywords" content="blu ray, tvs blu, ray players, home entertainment, announces acquisition, walmart, vudu, entertainment, internet, movies, digital, customers, blu, ray, broadband, provider, delivery, players, platform, access, next, offer, company, inc, acquisition" />
	<meta name="description" content="Walmart announced today a definitive agreement to acquire VUDU, Inc., a leading provider of digital technologies and services that enable the delivery of entertainment content directly to broadband high-definition TVs and Blu-ray players. The deal is expected to close within the next few weeks.

VUDU is..." />
	<meta name="title" content="Walmart Announces Acquisition of Digital Entertainment Provider, VUDU" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2010/02/walmart-announces-acquisition-of-digital-entertainment-provider-vudu.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3557', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2010/02/walmart-announces-acquisition-of-digital-entertainment-provider-vudu.php">Walmart Announces Acquisition of Digital Entertainment Provider, VUDU</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>February 22, 2010</b>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">Walmart Announces Acquisition of Digital Entertainment Provider, VUDU</p>

<center><i>Company takes next step to enhance home entertainment and information delivery options for consumers</center></i><br />
<br />

<p><strong>BENTONVILLE, Ark., Feb. 22 /PRNewswire-FirstCall/ -- </strong>Walmart announced today a definitive agreement to acquire VUDU, Inc., a leading provider of digital technologies and services that enable the delivery of entertainment content directly to broadband high-definition TVs and Blu-ray players. The deal is expected to close within the next few weeks.</p>
...
<p>Source: Wal-Mart Stores, Inc.</p>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3557)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2010/02/walmart-announces-acquisition-of-digital-entertainment-provider-vudu.php" type="text/javascript" charset="utf-8"></script>
