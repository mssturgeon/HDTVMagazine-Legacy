...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3609 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Bluetooth-Enabled JVC HD Everio Camera Now Available&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2010/03/bluetoothenabled-jvc-hd-everio-camera-now-available.php&amp;title=Bluetooth-Enabled JVC HD Everio Camera Now Available">
		<span style="display:none">&lt;img src=&quot;http://www.hdtvmagazine.us/news/images/jvc-everio-bluetooth.jpg&quot; alt=&quot;JVC Everio GZ-HM550&quot; height=&quot;84&quot; width=&quot;125&quot; style=&quot;padding:0 5px 5px 0;float:left&quot;&gt;JVC today announced the availability of a new high definition Everio camera with built-in Bluetooth&amp;reg; wireless technology, allowing the camera to work with a variety of other wireless devices. In addition, the new Everio GZ-HM550 features a 10.6 megapixel CMOS sensor for recording high quality Full HD video and nine megapixel digital stills to its internal 32GB flash memory. An SD/SDHC card slot provides the camera with additional storage.

Among the capabilities the camera's Bluetooth technology offers is...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3609";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Bluetooth-Enabled JVC HD Everio Camera Now Available" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Bluetooth-Enabled JVC HD Everio Camera Now Available" />
...
<html>
<head>
	<title>HDTV Magazine - Bluetooth-Enabled JVC HD Everio Camera Now Available</title>
	<meta name="keywords" content="cmos sensor, advanced image, registered trademarks, image stabilizer, everio mediabrowser, camera, jvc, bluetooth, everio, trademarks, megapixel, recording, new, stills, shooting, image, auto, advanced, registered, youtube, flash, light, technology, record, cmos" />
	<meta name="description" content="&lt;img src=&quot;http://www.hdtvmagazine.us/news/images/jvc-everio-bluetooth.jpg&quot; alt=&quot;JVC Everio GZ-HM550&quot; height=&quot;84&quot; width=&quot;125&quot; style=&quot;padding:0 5px 5px 0;float:left&quot;&gt;JVC today announced the availability of a new high definition Everio camera with built-in Bluetooth&amp;reg; wireless technology, allowing the camera to work with a variety of other wireless devices. In addition, the new Everio GZ-HM550 features a 10.6 megapixel CMOS sensor for recording high quality Full HD video and nine megapixel digital stills to its internal 32GB flash memory. An SD/SDHC card slot provides the camera with additional storage.

Among the capabilities the camera's Bluetooth technology offers is..." />
	<meta name="title" content="Bluetooth-Enabled JVC HD Everio Camera Now Available" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2010/03/bluetoothenabled-jvc-hd-everio-camera-now-available.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3609', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2010/03/bluetoothenabled-jvc-hd-everio-camera-now-available.php">Bluetooth-Enabled JVC HD Everio Camera Now Available</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>March 19, 2010</b>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">BLUETOOTH-ENABLED JVC HD EVERIO CAMERA NOW AVAILABLE</p>

<center><i>New GZ-HM550 features a 10.6 megapixel CMOS sensor; shoots 9 megapixel stills.</center></i><br />
<br />

<p><img src="http://www.hdtvmagazine.com/news/images/jvc-everio-bluetooth.jpg" alt="JVC Everio GZ-HM550" height="168" width="250" class="keyimg"><strong>WAYNE, NJ, March 19, 2010</strong> – JVC today announced the availability of a new high definition Everio camera with built-in Bluetooth&reg; wireless technology, allowing the camera to work with a variety of other wireless devices. In addition, the new Everio GZ-HM550 features a 10.6 megapixel CMOS sensor for recording high quality Full HD video and nine megapixel digital stills to its internal 32GB flash memory. An SD/SDHC card slot provides the camera with additional storage.</p>
...
<p>Digital files created can be easily shared in a variety of popular formats with the enhanced Everio MediaBrowser software for Windows&reg;, which now provides automatic conversion of HD videos for immediate sharing on YouTube&trade; at HD or SD resolution. Files also can be directly exported to iTunes&reg; and synced with an iPod&reg; or iPhone&reg;, or burned to DVD, all with just a few mouse clicks using the same Everio MediaBrowser application.</p>
...
<p>* Microsoft&reg; and Windows&reg; are either registered trademarks or trademarks of Microsoft Corporation in the United States and/or other countries<br />
...
* The Bluetooth&reg; word mark and logos are registered trademarks of Bluetooth SIG, Inc. and any use of such marks by JVC is under license.<br />
* All brand names are trademarks, registered trademarks, or trade names of their respective holders.</p>

<p><br />
<strong>JVC Everio GZ-HM550 Feature List</strong></p>

<p>HD Memory Camera</p>

<p>    * 32GB Internal Flash Memory and SD/SDHC card slot<br />
    ...
    * Bluetooth&reg; Wireless Technology<br />
    * Super LoLux<br />
    * Advanced Image Stabilizer<br />
    * Time-Lapse REC &amp; Auto REC<br />
    * One Touch Export*<br />
    * One Touch Upload to YouTube&trade;* (HD Compatible)<br />
    * Direct DVD Creation with SHARE STATION&reg;<br />
    ...
    * Everio MediaBrowser<br />
      †15x when Advanced Image Stabilizer set to ON</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>March 19, 2010  7:26 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3609)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2010/03/bluetoothenabled-jvc-hd-everio-camera-now-available.php" type="text/javascript" charset="utf-8"></script>
