...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Acer Extends Leadership in 3D Space With NVIDIA 3D Vision-Ready Projectors&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2010/03/acer-extends-leadership-in-3d-space-with-nvidia-3d-visionready-projectors.php&amp;title=Acer Extends Leadership in 3D Space With NVIDIA 3D Vision-Ready Projectors">
		<span style="display:none">&lt;img src=&quot;http://www.hdtvmagazine.us/news/images/acer-h5360-3d-projector.jpg&quot; alt=&quot;Acer H5360 3D Projector&quot; height=&quot;47&quot; width=&quot;72&quot; style=&quot;float:left;padding:0 5px 5px 0&quot;&gt;Acer America today extends its leadership in delivering excellent products that take advantage of consumers' growing demand for 3D imagery with two new NVIDIA 3D Vision-Ready video projectors.

The three-dimensional experience is made possible by...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
The three-dimensional experience is made possible by..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2010/03/acer-extends-leadership-in-3d-space-with-nvidia-3d-visionready-projectors.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3580', 340, 125);">Add ASIN</a>
