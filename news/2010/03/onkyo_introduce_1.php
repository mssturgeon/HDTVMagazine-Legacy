...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3588 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Onkyo Introduces the World\'s First THX Certified 3D-Ready A/V Receiver&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2010/03/onkyo-introduces-the-worlds-first-thx-certified-3dready-av-receiver.php&amp;title=Onkyo Introduces the World's First THX Certified 3D-Ready A/V Receiver">
		<span style="display:none">&lt;img src=&quot;http://www.hdtvmagazine.us/news/images/onkyo-tx-sr608.jpg&quot; alt=&quot;Onkyo TX SR608&quot; height=&quot;73&quot; width=&quot;100&quot; style=&quot;float:left; padding:0 5px 5px 0&quot;&gt;Onkyo USA has announced March deliveries of its first 3D-Ready home theater receivers and home theater in a box (HTiB) systems. The new models consist of three A/V receivers and three HTiB systems ranging in price from $299 to $599, and all of them support the new HDMI v1.4 connectivity standard for new 3D video displays and Audio Return Channel capabilities. All are exceptionally well equipped to provide a superior music, home theater sound and video experience, with high build-quality and offering excellent value.

The new TX-SR608 7.2-channel THX-Select2 Plus certified receiver has...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3588";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Onkyo Introduces the World\'s First THX Certified 3D-Ready A/V Receiver" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Onkyo Introduces the World\'s First THX Certified 3D-Ready A/V Receiver" />
...
<html>
<head>
	<title>HDTV Magazine - Onkyo Introduces the World's First THX Certified 3D-Ready A/V Receiver</title>
	<meta name="keywords" content="home theater, thx certified, introduces world, truehd dts, onkyo usa, onkyo, hdmi, new, audio, receiver, receivers, theater, products, channel, systems, thx, dolby, sound, certified, ready, home, htib, first, video, dts" />
	<meta name="description" content="&lt;img src=&quot;http://www.hdtvmagazine.us/news/images/onkyo-tx-sr608.jpg&quot; alt=&quot;Onkyo TX SR608&quot; height=&quot;73&quot; width=&quot;100&quot; style=&quot;float:left; padding:0 5px 5px 0&quot;&gt;Onkyo USA has announced March deliveries of its first 3D-Ready home theater receivers and home theater in a box (HTiB) systems. The new models consist of three A/V receivers and three HTiB systems ranging in price from $299 to $599, and all of them support the new HDMI v1.4 connectivity standard for new 3D video displays and Audio Return Channel capabilities. All are exceptionally well equipped to provide a superior music, home theater sound and video experience, with high build-quality and offering excellent value.

The new TX-SR608 7.2-channel THX-Select2 Plus certified receiver has..." />
	<meta name="title" content="Onkyo Introduces the World's First THX Certified 3D-Ready A/V Receiver" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2010/03/onkyo-introduces-the-worlds-first-thx-certified-3dready-av-receiver.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3588', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2010/03/onkyo-introduces-the-worlds-first-thx-certified-3dready-av-receiver.php">Onkyo Introduces the World's First THX Certified 3D-Ready A/V Receiver</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">Onkyo Introduces the World's First THX Certified 3D-Ready A/V Receiver</p>

<center><i>The Onkyo TX-SR608 THX-Certified A/V Receiver is one of several HDMI v1.4, 3D-Ready A/V Receivers and Home Theater Systems that will ship in March and April.</center></i><br />
<br />

<p><img src="http://www.hdtvmagazine.us/news/images/onkyo-tx-sr608.jpg" alt="Onkyo TX SR608" height="225" width="300" class="keyimg"><strong>UPPER SADDLE RIVER, NJ, (3/9/10) -- </strong>Onkyo USA has announced March deliveries of its first 3D-Ready home theater receivers and home theater in a box (HTiB) systems. The new models consist of three A/V receivers and three HTiB systems ranging in price from $299 to $599, and all of them support the new HDMI v1.4 connectivity standard for new 3D video displays and Audio Return Channel capabilities. All are exceptionally well equipped to provide a superior music, home theater sound and video experience, with high build-quality and offering excellent value.</p>
...
<p>Since 1946 Onkyo has been passionately committed to developing audio products that deliver uncommon performance, quality and value. Bundling proprietary technologies and innovations with other sound-enhancing exclusives, Onkyo continues to created award winning products that are lauded by many of the industry leading audio publications. The company's philosophy is to deliver products that are superbly designed and built to a consistently outstanding standard of excellence. Today, Onkyo is at the forefront of the home theater and digital revolutions. For more information about this and other fine Onkyo products, visit <a target="_blank" href="http://www.onkyousa.com/">www.onkyousa.com</a> or call 800-229-1687.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>March  9, 2010  4:26 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3588)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2010/03/onkyo-introduces-the-worlds-first-thx-certified-3dready-av-receiver.php" type="text/javascript" charset="utf-8"></script>
