...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/09/epsons-latest-1080p-pro-cinema-projectors-bring-custom-installers-highperforming-home-theater-solutions-with-up-to-2000001-contrast-ratio.php&amp;title=Epson's Latest 1080p Pro Cinema Projectors Bring Custom Installers High-Performing Home Theater Solutions with up to 200,000:1 Contrast Ratio">
...
Available for..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/09/epsons-latest-1080p-pro-cinema-projectors-bring-custom-installers-highperforming-home-theater-solutions-with-up-to-2000001-contrast-ratio.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3240', 340, 125);">Add ASIN</a>
