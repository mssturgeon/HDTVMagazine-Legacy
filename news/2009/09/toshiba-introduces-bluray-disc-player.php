...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/09/toshiba-introduces-bluray-disc-player.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Toshiba Introduces Blu-ray Disc Player" />
...
Supporting BD-Live(TM) (Profile 2.0), the BDX2000 allows users to ..." />
	...
	<meta property="og:title" content="Toshiba Introduces Blu-ray Disc Player" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/09/toshiba-introduces-bluray-disc-player.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Toshiba America Consumer Products L.L.C. (&quot;Toshiba&quot;), a market leader in home entertainment products, underscores its commitment to high-definition entertainment with the introduction of its first Blu-ray Disc player. The BDX2000 provides Full HD 1080p digital output that when coupled with a REGZA LCD TV, enables consumers to enjoy the superior quality of high-definition audio &amp; video content.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3231', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
