...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/09/samsung-instinct-hd-from-sprint-adds-high-definition-camera-and-camcorder-hdtv-capabilities-and-opera-mobile-web-browser.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Samsung Instinct HD from Sprint Adds High Definition Camera and Camcorder, HDTV Capabilities and Opera Mobile Web Browser" />
...
Samsung Instinct HD boasts an attractive and intuitive user interface as well as the high-speed connectivity of America's most dependable 3G network3 (EVDO Rev. A).With Samsung and Sprint's first high-definition 5-megapixel camera and camcorder and TV-out HD connection, it allows photo and video playback on an HD capable auxiliary device but it does not provide..." />
	...
	<meta property="og:title" content="Samsung Instinct HD from Sprint Adds High Definition Camera and Camcorder, HDTV Capabilities and Opera Mobile Web Browser" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/09/samsung-instinct-hd-from-sprint-adds-high-definition-camera-and-camcorder-hdtv-capabilities-and-opera-mobile-web-browser.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Sprint and Samsung Telecommunications America (Samsung Mobile) today announced the upcoming availability of Samsung Instinct&amp;reg; HD, the latest follow-up to the award-winning Samsung Instinct, which made its debut last summer exclusively from Sprint.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3291', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
