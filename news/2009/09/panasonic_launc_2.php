...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/09/panasonic-launches-bluray-disctm-home-theater-system.php&amp;title=Panasonic Launches Blu-ray Disc(TM) Home Theater System">
		<span style="display:none">Panasonic today announced the debut of its first 2.1 channel Blu-ray Disc(TM) home theater system. The innovative SC-BTX70 is designed with a chic, upright silhouette, making it an ideal match for a flat panel TV. Panasonic's SC-BTX70 unleashes the beauty of Blu-ray Disc, while also providing a wide variety of other digital media options for family and friends to enjoy.

Sporting a sleek and compact form factor, the SC-BTX70 is a 2.1 system delivers realistic virtual 7.1 channel sound dispersed through a wide listening area. Panasonic's advanced...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
Sporting a sleek and compact form factor, the SC-BTX70 is a 2.1 system delivers realistic virtual 7.1 channel sound dispersed through a wide listening area. Panasonic's advanced..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/09/panasonic-launches-bluray-disctm-home-theater-system.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3247', 340, 125);">Add ASIN</a>
