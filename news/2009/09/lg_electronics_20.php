...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3261 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=LG Electronics Broadens Home Entertainment Options With Two New Wireless HDTV Series&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/09/lg-electronics-broadens-home-entertainment-options-with-two-new-wireless-hdtv-series.php&amp;title=LG Electronics Broadens Home Entertainment Options With Two New Wireless HDTV Series">
		<span style="display:none">Offering diverse integration options for custom installers, LG Electronics is highlighting its first-ever series of wireless LCD HDTVs, including an LED model, this week at the Custom Electronic Design &amp;amp; Installation Association (CEDIA) EXPO 2009 (Booth #2623).
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3261";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download LG Electronics Broadens Home Entertainment Options With Two New Wireless HDTV Series" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="LG Electronics Broadens Home Entertainment Options With Two New Wireless HDTV Series" />
...
<html>
<head>
	<title>HDTV Magazine - LG Electronics Broadens Home Entertainment Options With Two New Wireless HDTV Series</title>
	<meta name="keywords" content="inch class, home entertainment, electronics usa, home theater, energy savings, wireless, home, inch, lhx, electronics, series, options, hdtv, picture, technology, design, consumers, hdtvs, calibration, experience, class, energy, isf, entertainment, both" />
	<meta name="description" content="Offering diverse integration options for custom installers, LG Electronics is highlighting its first-ever series of wireless LCD HDTVs, including an LED model, this week at the Custom Electronic Design &amp;amp; Installation Association (CEDIA) EXPO 2009 (Booth #2623).

Whether it's..." />
	<meta name="title" content="LG Electronics Broadens Home Entertainment Options With Two New Wireless HDTV Series" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/09/lg-electronics-broadens-home-entertainment-options-with-two-new-wireless-hdtv-series.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3261', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/09/lg-electronics-broadens-home-entertainment-options-with-two-new-wireless-hdtv-series.php">LG Electronics Broadens Home Entertainment Options With Two New Wireless HDTV Series</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">LG Electronics Broadens Home Entertainment Options With Two New Wireless HDTV Series</p>

<center><i>Wireless LCD HDTVs Offer Flexible and Convenient Custom Installation Options</center></i><br />
<br />

<p><strong>ATLANTA, Sept. 10 /PRNewswire/ -- </strong>Offering diverse integration options for custom installers, LG Electronics is highlighting its first-ever series of wireless LCD HDTVs, including an LED model, this week at the Custom Electronic Design &amp; Installation Association (CEDIA) EXPO 2009 (Booth #2623).</p>
...
<p><br />
<strong>ISFccc Calibration Options</strong></p>
...
<p>For more information please visit http://www.virtualpressoffice.com/kit/LGCEDIA</p>
...
<p>Source: LG Electronics USA, Inc.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>September 10, 2009 11:15 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3261)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/09/lg-electronics-broadens-home-entertainment-options-with-two-new-wireless-hdtv-series.php" type="text/javascript" charset="utf-8"></script>
