...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3248 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=LG Electronics Adds VUDU HD Movie Service to Wireless \'NetCast\' Network Blu-ray Disc Player&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/09/lg-electronics-adds-vudu-hd-movie-service-to-wireless-netcast-network-bluray-disc-player.php&amp;title=LG Electronics Adds VUDU HD Movie Service to Wireless 'NetCast' Network Blu-ray Disc Player">
		<span style="display:none">LG Electronics today announced the addition of the high-definition streaming movie service from VUDU, Inc. to the LG Wireless Network Blu-ray Player (model BD390). With VUDU, consumers can instantly buy or rent from an extensive library of movies and TV titles, including an industry-leading catalog of more than 2,200 high-definition (HD) movies. The BD390 with VUDU will be demonstrated here this week at the Custom Electronic Design &amp; Installation Association (CEDIA) EXPO 2009 (Booth #2623).

The addition of VUDU service to the BD390 adds...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3248";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download LG Electronics Adds VUDU HD Movie Service to Wireless \'NetCast\' Network Blu-ray Disc Player" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="LG Electronics Adds VUDU HD Movie Service to Wireless \'NetCast\' Network Blu-ray Disc Player" />
...
<html>
<head>
	<title>HDTV Magazine - LG Electronics Adds VUDU HD Movie Service to Wireless 'NetCast' Network Blu-ray Disc Player</title>
	<meta name="keywords" content="blu ray, network blu, movie service, high definition, ray player, vudu, electronics, movies, entertainment, blu, ray, network, service, consumers, movie, player, access, netcast, definition, available, inc, home, wireless, high, our" />
	<meta name="description" content="LG Electronics today announced the addition of the high-definition streaming movie service from VUDU, Inc. to the LG Wireless Network Blu-ray Player (model BD390). With VUDU, consumers can instantly buy or rent from an extensive library of movies and TV titles, including an industry-leading catalog of more than 2,200 high-definition (HD) movies. The BD390 with VUDU will be demonstrated here this week at the Custom Electronic Design &amp; Installation Association (CEDIA) EXPO 2009 (Booth #2623).

The addition of VUDU service to the BD390 adds..." />
	<meta name="title" content="LG Electronics Adds VUDU HD Movie Service to Wireless 'NetCast' Network Blu-ray Disc Player" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/09/lg-electronics-adds-vudu-hd-movie-service-to-wireless-netcast-network-bluray-disc-player.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3248', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/09/lg-electronics-adds-vudu-hd-movie-service-to-wireless-netcast-network-bluray-disc-player.php">LG Electronics Adds VUDU HD Movie Service to Wireless 'NetCast' Network Blu-ray Disc Player</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">LG Electronics Adds VUDU HD Movie Service to Wireless 'NetCast' Network Blu-ray Disc Player</p>

<center><i>Streaming Movie Service Brings Largest Library of HD Movies to Consumers' Fingertips</center></i><br />
<br />

<p><strong>ATLANTA, Sept. 9 /PRNewswire/ -- </strong>LG Electronics today announced the addition of the high-definition streaming movie service from VUDU, Inc. to the LG Wireless Network Blu-ray Player (model BD390). With VUDU, consumers can instantly buy or rent from an extensive library of movies and TV titles, including an industry-leading catalog of more than 2,200 high-definition (HD) movies. The BD390 with VUDU will be demonstrated here this week at the Custom Electronic Design & Installation Association (CEDIA) EXPO 2009 (Booth #2623).</p>
...
<p><br />
<strong>Connectivity and Storage</strong></p>
...
<p>* Internet connection and subscription required and sold separately</p>

<p>Source: LG Electronics USA, Inc.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>September  9, 2009  9:04 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3248)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/09/lg-electronics-adds-vudu-hd-movie-service-to-wireless-netcast-network-bluray-disc-player.php" type="text/javascript" charset="utf-8"></script>
