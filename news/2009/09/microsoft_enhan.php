...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Microsoft Enhances the Digital Cable Experience and Names 2009 Windows Media Center Ultimate Install Winner&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/09/microsoft-enhances-the-digital-cable-experience-and-names-2009-windows-media-center-ultimate-install-winner.php&amp;title=Microsoft Enhances the Digital Cable Experience and Names 2009 Windows Media Center Ultimate Install Winner">
		<span style="display:none">Today at CEDIA EXPO 2009, Microsoft Corp. discussed key Windows Media Center features for Windows 7 and announced a series of initiatives that enhance the digital cable experience in Windows Media Center. With the addition of native support for additional international broadcast TV standards, including QAM and ATSC, there will now be support for switched digital video (SDV), a new tool that will make it possible for end customers to add a digital cable tuner with CableCARD to their PC, and for existing digital cable tuner with CableCARD customers to enjoy more portability for digital cable TV that is marked as &quot;copy freely&quot; (CF). In addition, Microsoft and the Media Center Integrator Alliance (MCIA) announced...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/09/microsoft-enhances-the-digital-cable-experience-and-names-2009-windows-media-center-ultimate-install-winner.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3254', 340, 125);">Add ASIN</a>
