...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3231 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Toshiba Introduces Blu-ray Disc Player&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/09/toshiba-introduces-bluray-disc-player.php&amp;title=Toshiba Introduces Blu-ray Disc Player">
		<span style="display:none">Toshiba America Consumer Products L.L.C. (&quot;Toshiba&quot;), a market leader in home entertainment products, underscores its commitment to high-definition entertainment with the introduction of its first Blu-ray Disc player. The BDX2000 provides Full HD 1080p digital output that when coupled with a REGZA LCD TV, enables consumers to enjoy the superior quality of high-definition audio &amp; video content.

Supporting BD-Live(TM) (Profile 2.0), the BDX2000 allows users to ...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3231";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Toshiba Introduces Blu-ray Disc Player" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Toshiba Introduces Blu-ray Disc Player" />
...
<html>
<head>
	<title>HDTV Magazine - Toshiba Introduces Blu-ray Disc Player</title>
	<meta name="keywords" content="blu ray, high definition, ray disc, toshiba america, disc player, toshiba, content, blu, ray, products, high, player, may, hdmi, definition, disc, display, features, america, reg, registered, bdx, card, trademarks, home" />
	<meta name="description" content="Toshiba America Consumer Products L.L.C. (&quot;Toshiba&quot;), a market leader in home entertainment products, underscores its commitment to high-definition entertainment with the introduction of its first Blu-ray Disc player. The BDX2000 provides Full HD 1080p digital output that when coupled with a REGZA LCD TV, enables consumers to enjoy the superior quality of high-definition audio &amp; video content.

Supporting BD-Live(TM) (Profile 2.0), the BDX2000 allows users to ..." />
	<meta name="title" content="Toshiba Introduces Blu-ray Disc Player" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/09/toshiba-introduces-bluray-disc-player.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3231', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/09/toshiba-introduces-bluray-disc-player.php">Toshiba Introduces Blu-ray Disc Player</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">Toshiba Introduces Blu-ray Disc Player</p>

<center><i>Debut player delivers high image quality and sophisticated design, a great complement to Toshiba's superior line of HDTVs</center></i><br />
<br />

<p><strong>WAYNE, N.J., Sept. 3 /PRNewswire/ -- </strong>Toshiba America Consumer Products L.L.C. ("Toshiba"), a market leader in home entertainment products, underscores its commitment to high-definition entertainment with the introduction of its first Blu-ray Disc player. The BDX2000 provides Full HD 1080p digital output that when coupled with a REGZA LCD TV, enables consumers to enjoy the superior quality of high-definition audio & video content.</p>
...
<p>Using the REGZA-LINK function, the new BDX2000 can connect with a REGZA LCD TV via a HDMI(TM) cable and display full high definition content with a single remote control. For added convenience, the BDX2000 features a SD card slot, making it an entertainment hub in the home by allowing consumers to showcase photos and videos with ease.</p>

<p><br />
<strong>Additional Product Features:</strong><br />
<pre><br />
  --  BD-Live(TM) (Profile 2.0)<br />
  --  1080p/ 24 fps Full HD Video Output<br />
  --  AVCHD Playback<br />
  --  Toshiba REGZA-LINK  (HDMI-CEC)<br />
  --  Support for enhanced audio formats from Dolby  True HD and DTS-HD<br />
      Master Audio | Essential(TM) Playback<br />
  --  Bonus View<br />
  --  SD Card Slot</p>
...
<p>  Toshiba Blu-ray Disc Player<br />
  BDX2000 (available November, MSRP $249.99)</p>
...
<p>Use of REGZA-LINK , a feature based on HDMI-CEC, requires an HDMI-CEC compatible display device. Depending on the specifications of your display device, some or all REGZA-LINK functions may not work even if your display device is HDMI-CEC compatible.</p>
...
<p>Because Blu-ray is a format that makes use of new technologies, certain disc, digital connection and other compatibility and/or performance issues are possible. If you experience such issues, please refer to <a target="_blank" href="http://www.tacp.toshiba.com/">www.tacp.toshiba.com</a> for information on the availability of firmware updates that may resolve your problem, or contact Toshiba Customer Solutions.</p>
...
<p>Source: Toshiba America Consumer Products, L.L.C.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>September  4, 2009 12:58 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3231)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/09/toshiba-introduces-bluray-disc-player.php" type="text/javascript" charset="utf-8"></script>
