...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/09/lg-electronics-broadens-home-entertainment-options-with-two-new-wireless-hdtv-series.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="LG Electronics Broadens Home Entertainment Options With Two New Wireless HDTV Series" />
...
Whether it's..." />
	...
	<meta property="og:title" content="LG Electronics Broadens Home Entertainment Options With Two New Wireless HDTV Series" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/09/lg-electronics-broadens-home-entertainment-options-with-two-new-wireless-hdtv-series.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Offering diverse integration options for custom installers, LG Electronics is highlighting its first-ever series of wireless LCD HDTVs, including an LED model, this week at the Custom Electronic Design &amp;amp; Installation Association (CEDIA) EXPO 2009 (Booth #2623).
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3261', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
