...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Samsung Instinct HD from Sprint Adds High Definition Camera and Camcorder, HDTV Capabilities and Opera Mobile Web Browser&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/09/samsung-instinct-hd-from-sprint-adds-high-definition-camera-and-camcorder-hdtv-capabilities-and-opera-mobile-web-browser.php&amp;title=Samsung Instinct HD from Sprint Adds High Definition Camera and Camcorder, HDTV Capabilities and Opera Mobile Web Browser">
		<span style="display:none">Sprint and Samsung Telecommunications America (Samsung Mobile) today announced the upcoming availability of Samsung Instinct&amp;reg; HD, the latest follow-up to the award-winning Samsung Instinct, which made its debut last summer exclusively from Sprint.

Samsung Instinct HD boasts an attractive and intuitive user interface as well as the high-speed connectivity of America's most dependable 3G network3 (EVDO Rev. A).With Samsung and Sprint's first high-definition 5-megapixel camera and camcorder and TV-out HD connection, it allows photo and video playback on an HD capable auxiliary device but it does not provide...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
	...
	switch (7) {
		...
		case 9: # Podcasts
			...
			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Samsung Instinct HD from Sprint Adds High Definition Camera and Camcorder, HDTV Capabilities and Opera Mobile Web Browser" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Samsung Instinct HD from Sprint Adds High Definition Camera and Camcorder, HDTV Capabilities and Opera Mobile Web Browser" />
...
<html>
<head>
	<title>HDTV Magazine - Samsung Instinct HD from Sprint Adds High Definition Camera and Camcorder, HDTV Capabilities and Opera Mobile Web Browser</title>
	<meta name="keywords" content="samsung instinct, best buy, samsung electronics, opera mobile, camera camcorder, sprint, samsung, instinct, mobile, data, based, wireless, customers, coverage, unlimited, available, web, information, network, including, america, device, buy, recycling, video" />
	<meta name="description" content="Sprint and Samsung Telecommunications America (Samsung Mobile) today announced the upcoming availability of Samsung Instinct&amp;reg; HD, the latest follow-up to the award-winning Samsung Instinct, which made its debut last summer exclusively from Sprint.
...
Samsung Instinct HD boasts an attractive and intuitive user interface as well as the high-speed connectivity of America's most dependable 3G network3 (EVDO Rev. A).With Samsung and Sprint's first high-definition 5-megapixel camera and camcorder and TV-out HD connection, it allows photo and video playback on an HD capable auxiliary device but it does not provide..." />
	<meta name="title" content="Samsung Instinct HD from Sprint Adds High Definition Camera and Camcorder, HDTV Capabilities and Opera Mobile Web Browser" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/09/samsung-instinct-hd-from-sprint-adds-high-definition-camera-and-camcorder-hdtv-capabilities-and-opera-mobile-web-browser.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3291', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/09/samsung-instinct-hd-from-sprint-adds-high-definition-camera-and-camcorder-hdtv-capabilities-and-opera-mobile-web-browser.php">Samsung Instinct HD from Sprint Adds High Definition Camera and Camcorder, HDTV Capabilities and Opera Mobile Web Browser</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>September 24, 2009</b>
...
<p><strong>OVERLAND PARK, Kan. &amp; DALLAS--(BUSINESS WIRE)--</strong>Sprint (NYSE: S) and Samsung Telecommunications America (Samsung Mobile), the #1 mobile phone provider in the United States1, today announced the upcoming availability of Samsung Instinct&reg; HD, the latest follow-up to the award-winning Samsung Instinct, which made its debut last summer exclusively from Sprint.</p>
...
<p>    * Live Search for Sprint, powered by Microsoft, which provides easy access to directory information on-the-go, GPS-enabled directions, interactive maps and one-touch click to call access.<br />
    ...
    * Sprint TV&reg;, with an extensive selection of channels and on-demand programming.<br />
    * Advanced stereo Bluetooth&reg; 2.0.<br />
    * Support for personal and corporate email (sync with Microsoft&reg; Outlook&reg;).<br />
    * SMS voice and text messaging with threaded text.<br />
    * Easy access to social networking sites, including Facebook&reg;, Flickr&reg; and Twitter.</p>
...
<p>5 Coverage comparison based on publicly available information as of 4/01/09 inclusive of Sprint roaming partners. Based on square miles. Coverage comparison based on publicly available information as of 4/1/09 inclusive of Sprint roaming partners. Based on square miles.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>September 24, 2009  3:58 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3291)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/09/samsung-instinct-hd-from-sprint-adds-high-definition-camera-and-camcorder-hdtv-capabilities-and-opera-mobile-web-browser.php" type="text/javascript" charset="utf-8"></script>
