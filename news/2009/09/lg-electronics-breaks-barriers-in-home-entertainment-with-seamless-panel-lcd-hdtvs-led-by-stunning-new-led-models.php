...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/09/lg-electronics-breaks-barriers-in-home-entertainment-with-seamless-panel-lcd-hdtvs-led-by-stunning-new-led-models.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="LG Electronics Breaks Barriers in Home Entertainment With Seamless Panel LCD HDTVs, LED by Stunning New LED Models" />
...
Unlike conventional LCD TVs, where the panel is recessed slightly within a thick plastic frame, LG's new series of LCD HDTVs use..." />
	...
	<meta property="og:title" content="LG Electronics Breaks Barriers in Home Entertainment With Seamless Panel LCD HDTVs, LED by Stunning New LED Models" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/09/lg-electronics-breaks-barriers-in-home-entertainment-with-seamless-panel-lcd-hdtvs-led-by-stunning-new-led-models.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Breaking barriers in home entertainment, LG Electronics today introduced a &quot;Full HD&quot; LED LCD HDTV - that looks almost as thin as the single sheet of glass it resembles.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3246', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
