...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/09/sonic-launches-bd-powerstation.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Sonic Launches BD PowerStation" />
...
Configured and priced to meet the needs of professional videographers, independent film and corporate video producers, Sonic BD PowerStation includes..." />
	...
	<meta property="og:title" content="Sonic Launches BD PowerStation" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/09/sonic-launches-bd-powerstation.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Sonic Solutions (NASDAQ:SNIC) today released the Sonic BD PowerStation(TM), a new cost-effective Blu-ray Disc (BD) production suite for professional videographers that's built on Sonic's Hollywood-standard CineVision HD video encoding and Scenarist authoring products, which have been used to create millions of DVD and BD titles worldwide.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3235', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
