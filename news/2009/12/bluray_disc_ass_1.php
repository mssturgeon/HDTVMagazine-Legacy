...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3431 AND placement_is_primary = 1";
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/12/bluray-disc-association-announces-final-3d-specification.php&amp;title=Blu-ray Disc Association Announces Final 3D Specification">
		<span style="display:none">The Blu-ray Disc Association (BDA) today announced the finalization and release of the “Blu-ray 3DTM” specification. The specification, which represents the work of the leading Hollywood studios and consumer electronic and computer manufacturers, will enable the home entertainment industry to bring the 3D experience into consumers’ living rooms on Blu-ray Disc, the most capable high definition home entertainment platform.

The “Blu-ray 3D” specification fully leverages...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3431";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Blu-ray Disc Association Announces Final 3D Specification" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Blu-ray Disc Association Announces Final 3D Specification" />
...
<html>
<head>
	<title>HDTV Magazine - Blu-ray Disc Association Announces Final 3D Specification</title>
	<meta name="keywords" content="blu ray, ray disc, disc association, high definition, home entertainment, ray, blu, disc, specification, association, corporation, deliver, ”, bda, home, players, content, video, full, inc, high, display, format, definition, entertainment" />
...
The “Blu-ray 3D” specification fully leverages..." />
	<meta name="title" content="Blu-ray Disc Association Announces Final 3D Specification" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/12/bluray-disc-association-announces-final-3d-specification.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3431', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/12/bluray-disc-association-announces-final-3d-specification.php">Blu-ray Disc Association Announces Final 3D Specification</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>December 17, 2009</b>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle"> Blu-ray Disc Association Announces Final 3D Specification</p>

<center><i>“Blu-ray 3DTM” Expected to Reach Consumers in 2010</center></i><br />
...
<p>The Blu-ray Disc Association (BDA) is responsible for promoting and developing business opportunities for Blu-ray Disc - the next-generation optical disc format for storing high-definition movies, games, photos and other digital content. The BDA has more than 180 members. Its Board of Directors consists of individuals affiliated with the following companies: Apple Inc., Dell Inc., Hewlett-Packard Company, Hitachi, Ltd., Intel Corporation, LG Electronics Inc., Mitsubishi Electric Corporation, Panasonic Corporation, Pioneer Corporation, Royal Philips Electronics, Samsung Electronics Co., Ltd., Sharp Corporation, Sony Corporation, Sun Microsystems, Inc., TDK Corporation, Thomson, Twentieth Century Fox, Walt Disney Pictures and Television, and Warner Bros. Entertainment Inc.</p>

<p><br />
<strong>Blu-ray Disc Association at ICES 2010</strong></p>

<p>To schedule a 1:1 briefing with a Blu-ray Disc Association executive during the 2010 International Consumer Electronics Show, please contact the BDA at bluray@corporateadvocates.net</p>

<p>The Blu-ray DiscTM name and Blu-ray Disc logo are registered trademarks of the Blu-ray Disc Association.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>December 17, 2009  6:40 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3431)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/12/bluray-disc-association-announces-final-3d-specification.php" type="text/javascript" charset="utf-8"></script>
