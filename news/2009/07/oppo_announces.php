...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/07/oppo-announces-availability-of-bdp83-universal-bluray-player.php&amp;title=OPPO Announces Availability of BDP-83 Universal Blu-ray Player">
		<span style="display:none">I received the following email from OPPO today as a subscriber to their newsletter. Many of you may have received the same letter, but I wanted to make sure everyone was aware of the official &quot;release&quot;.

We have not yet reviewed this unit, but we will. A quick search of our site for OPPO will show that they have a good track record of churning out excellent products. And there's no reason to believe their Blu-ray effort would be any different.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
We have not yet reviewed this unit, but we will. A quick search of our site for OPPO will show that they have a good track record of churning out excellent products. And there's no reason to believe their Blu-ray effort would be any different." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/07/oppo-announces-availability-of-bdp83-universal-bluray-player.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1755', 340, 125);">Add ASIN</a>
