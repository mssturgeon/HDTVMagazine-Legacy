...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/07/lg-electronics-first-to-bring-vudu-hd-movie-service-to-broadband-hdtvs.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="LG Electronics First to Bring VUDU HD Movie Service to Broadband HDTVs" />
...
The VUDU service allows consumers to instantly buy or rent from an extensive library of movies and TV titles, including..." />
	...
	<meta property="og:title" content="LG Electronics First to Bring VUDU HD Movie Service to Broadband HDTVs" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/07/lg-electronics-first-to-bring-vudu-hd-movie-service-to-broadband-hdtvs.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="LG Electronics will be the first to introduce broadband HDTVs with the instant-access high-definition (HD) movie service from VUDU Inc., a leading provider of digital on-demand entertainment services, the companies announced today. VUDU on-demand movies will be available on LG's LH50 1080p LCD series and PS80 Plasma 1080p series with &quot;NetCast Entertainment Access,&quot; beginning next month.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=2913', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
