...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 2910 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Onkyo Home Theater Packages Ideal for Blu-ray and HD Video Systems&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 2910";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Onkyo Home Theater Packages Ideal for Blu-ray and HD Video Systems" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Onkyo Home Theater Packages Ideal for Blu-ray and HD Video Systems" />
...
<html>
<head>
	<title>HDTV Magazine - Onkyo Home Theater Packages Ideal for Blu-ray and HD Video Systems</title>
	<meta name="keywords" content="home theater, blu ray, speaker system, prologic iiz, cable connection, onkyo, audio, speakers, channel, system, inch, theater, home, systems, video, speaker, sound, deliver, powerful, including, processing, surround, front, port, both" />
	<meta name="description" content="Onkyo has introduced two new 7.1-channel home theater systems that deliver leading edge AV processing and surround sound reproduction for today's most advanced home theater programming, including HDTV and Blu-ray. The HT-S7200 and HT-S6200 each feature powerful AV receivers with 1080p-compatible HDMI inputs, 130 watt-per-channel amplification, processing for every major audio format on the market - including the option of incorporating front height-channel reproduction with Dolby's newly introduced ProLogic IIz processing. Each package also includes a high performance 7.1-channel speaker system with a powerful active subwoofer, and Onkyo's exclusive U-Port single-cable iPod dock and charging system.

The Onkyo HT-S7200 and HT-S6200 feature five and four HDMI 1.3a inputs, respectively, and are completely compatible with..." />
	<meta name="title" content="Onkyo Home Theater Packages Ideal for Blu-ray and HD Video Systems" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/07/onkyo-home-theater-packages-ideal-for-bluray-and-hd-video-systems.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=2910', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/07/onkyo-home-theater-packages-ideal-for-bluray-and-hd-video-systems.php">Onkyo Home Theater Packages Ideal for Blu-ray and HD Video Systems</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">Onkyo Home Theater Packages Ideal for Blu-ray and HD Video Systems</p>

<p><strong>UPPER SADDLE RIVER, NJ (7/28/09) -- </strong>Onkyo has introduced two new 7.1-channel home theater systems that deliver leading edge AV processing and surround sound reproduction for today's most advanced home theater programming, including HDTV and Blu-ray. The HT-S7200 and HT-S6200 each feature powerful AV receivers with 1080p-compatible HDMI inputs, 130 watt-per-channel amplification, processing for every major audio format on the market - including the option of incorporating front height-channel reproduction with Dolby's newly introduced ProLogic IIz processing. Each package also includes a high performance 7.1-channel speaker system with a powerful active subwoofer, and Onkyo's exclusive U-Port single-cable iPod dock and charging system.</p>
...
<p>The Onkyo HT-S7200 and HT-S6200 include Onkyo's exclusive Universal Port (U-Port) which enables one-cable connection for the included UP-A1 iPod&trade; dock. This control and charging dock integrates both audio and video playback from Apple&trade; iPhone&trade; or iPod portable devices, greatly extending the flexibility of these systems to integrate consumers' electronic entertainment devices. Additionally, the U-Port connection can also provide a one-cable connection to the company's optional HD-Radio tuner, making it simple to bring this new transmission format to the home theater.</p>
...
<p>Since 1946 Onkyo has been passionately committed to developing audio products that deliver uncommon performance, quality and value. Bundling proprietary technologies and innovations with other sound-enhancing exclusives, Onkyo continues to created award winning product that are lauded by many of the industry leading audio publications. The company's philosophy is to deliver products that are superbly designed and built to a consistently outstanding standard of excellence. Today, Onkyo is at the forefront of the home theater and digital revolutions. For more information about this and other fine Onkyo products, visit <a target="_blank" href="http://www.onkyousa.com/">www.onkyousa.com</a> or call 800-229-1687.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>July 28, 2009  2:39 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 2910)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/07/onkyo-home-theater-packages-ideal-for-bluray-and-hd-video-systems.php" type="text/javascript" charset="utf-8"></script>
