...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 2913 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=LG Electronics First to Bring VUDU HD Movie Service to Broadband HDTVs&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/07/lg-electronics-first-to-bring-vudu-hd-movie-service-to-broadband-hdtvs.php&amp;title=LG Electronics First to Bring VUDU HD Movie Service to Broadband HDTVs">
		<span style="display:none">LG Electronics will be the first to introduce broadband HDTVs with the instant-access high-definition (HD) movie service from VUDU Inc., a leading provider of digital on-demand entertainment services, the companies announced today. VUDU on-demand movies will be available on LG's LH50 1080p LCD series and PS80 Plasma 1080p series with &quot;NetCast Entertainment Access,&quot; beginning next month.

The VUDU service allows consumers to instantly buy or rent from an extensive library of movies and TV titles, including...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 2913";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download LG Electronics First to Bring VUDU HD Movie Service to Broadband HDTVs" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="LG Electronics First to Bring VUDU HD Movie Service to Broadband HDTVs" />
...
<html>
<head>
	<title>HDTV Magazine - LG Electronics First to Bring VUDU HD Movie Service to Broadband HDTVs</title>
	<meta name="keywords" content="inch class, broadband hdtvs, movie service, entertainment access, netcast entertainment, vudu, movies, inch, access, class, hdtvs, service, entertainment, electronics, broadband, available, movie, consumers, netcast, demand, instant, diagonal, model, experience, plasma" />
	<meta name="description" content="LG Electronics will be the first to introduce broadband HDTVs with the instant-access high-definition (HD) movie service from VUDU Inc., a leading provider of digital on-demand entertainment services, the companies announced today. VUDU on-demand movies will be available on LG's LH50 1080p LCD series and PS80 Plasma 1080p series with &quot;NetCast Entertainment Access,&quot; beginning next month.

The VUDU service allows consumers to instantly buy or rent from an extensive library of movies and TV titles, including..." />
	<meta name="title" content="LG Electronics First to Bring VUDU HD Movie Service to Broadband HDTVs" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/07/lg-electronics-first-to-bring-vudu-hd-movie-service-to-broadband-hdtvs.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=2913', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/07/lg-electronics-first-to-bring-vudu-hd-movie-service-to-broadband-hdtvs.php">LG Electronics First to Bring VUDU HD Movie Service to Broadband HDTVs</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">LG ELECTRONICS FIRST TO BRING VUDU HD MOVIE SERVICE TO BROADBAND HDTVs</p>

<center><i>VUDU's Unique Streaming Movie Service, Largest Library of HD Movies, enhance LG 'NetCast Entertainment Access' LCD and Plasma HDTVs</center></i><br />
<br />

<p><strong>NEW YORK, July 29, 2009</strong> -- LG Electronics will be the first to introduce broadband HDTVs with the instant-access high-definition (HD) movie service from VUDU Inc., a leading provider of digital on-demand entertainment services, the companies announced today. VUDU on-demand movies will be available on LG's LH50 1080p LCD series and PS80 Plasma 1080p series with "NetCast Entertainment Access," beginning next month.</p>
...
*42LH50 42-inch class/42.0-inch diagonal</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>July 29, 2009  7:11 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 2913)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/07/lg-electronics-first-to-bring-vudu-hd-movie-service-to-broadband-hdtvs.php" type="text/javascript" charset="utf-8"></script>
