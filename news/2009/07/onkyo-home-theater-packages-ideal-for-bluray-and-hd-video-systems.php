...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/07/onkyo-home-theater-packages-ideal-for-bluray-and-hd-video-systems.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Onkyo Home Theater Packages Ideal for Blu-ray and HD Video Systems" />
...
The Onkyo HT-S7200 and HT-S6200 feature five and four HDMI 1.3a inputs, respectively, and are completely compatible with..." />
	...
	<meta property="og:title" content="Onkyo Home Theater Packages Ideal for Blu-ray and HD Video Systems" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/07/onkyo-home-theater-packages-ideal-for-bluray-and-hd-video-systems.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Onkyo has introduced two new 7.1-channel home theater systems that deliver leading edge AV processing and surround sound reproduction for today's most advanced home theater programming, including HDTV and Blu-ray. The HT-S7200 and HT-S6200 each feature powerful AV receivers with 1080p-compatible HDMI inputs, 130 watt-per-channel amplification, processing for every major audio format on the market - including the option of incorporating front height-channel reproduction with Dolby's newly introduced ProLogic IIz processing. Each package also includes a high performance 7.1-channel speaker system with a powerful active subwoofer, and Onkyo's exclusive U-Port single-cable iPod dock and charging system.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=2910', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
