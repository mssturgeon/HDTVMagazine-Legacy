...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/01/epson-introduces-highperformance-home-theater-projector-with-1080p-resolution-and-750001-contrast-ratio.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1660";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Epson Introduces High-Performance Home Theater Projector With 1080p Resolution and 75,000:1 Contrast Ratio" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Epson Introduces High-Performance Home Theater Projector With 1080p Resolution and 75,000:1 Contrast Ratio" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Epson Introduces High-Performance Home Theater Projector With 1080p Resolution and 75,000:1 Contrast Ratio" />
...
<html>
<head>
	<title>HDTV Magazine - Epson Introduces High-Performance Home Theater Projector With 1080p Resolution and 75,000:1 Contrast Ratio</title>
	<meta name="keywords" content="home cinema, epson america, lcd technology, america inc, light output, epson, home, lcd, cinema, technology, projector, color, theater, america, contrast, output, light, system, new, lamp, features, trademarks, delivers, inc, leading" />
	...
	<meta name="title" content="Epson Introduces High-Performance Home Theater Projector With 1080p Resolution and 75,000:1 Contrast Ratio" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Epson Introduces High-Performance Home Theater Projector With 1080p Resolution and 75,000:1 Contrast Ratio" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/01/epson-introduces-highperformance-home-theater-projector-with-1080p-resolution-and-750001-contrast-ratio.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Building on its leadership position as the number-one selling projector brand worldwide(ii), Epson today announced the latest addition to its award-winning line of 3LCD 1080p front projectors, the PowerLite(R) Home Cinema 6500 UB. Offering true 1080p (1,920 x 1,080 pixels) resolution with the latest 3LCD D7 chip set for significantly higher contrast, a built-in HQV Reon-VX processor by Silicon Optix, and a wide range of new performance advantages, the Home Cinema 6500 UB delivers an outstanding viewing experience for..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1660', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/01/epson-introduces-highperformance-home-theater-projector-with-1080p-resolution-and-750001-contrast-ratio.php">Epson Introduces High-Performance Home Theater Projector With 1080p Resolution and 75,000:1 Contrast Ratio</a></td>
						</tr><tr>
...
<p>Source: Epson America Inc. </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  9, 2009  8:25 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1660)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/01/epson-introduces-highperformance-home-theater-projector-with-1080p-resolution-and-750001-contrast-ratio.php" type="text/javascript" charset="utf-8"></script>
