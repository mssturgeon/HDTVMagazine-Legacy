...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Canon U.S.A. Packs a Punch with a Powerful New Camcorder Line-up for 2009&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/01/canon-usa-packs-a-punch-with-a-powerful-new-camcorder-lineup-for-2009.php&amp;title=Canon U.S.A. Packs a Punch with a Powerful New Camcorder Line-up for 2009">
		<span style="display:none">Canon U.S.A., Inc, a leader in digital imaging technology, announces an exciting new line of five VIXIA high definition and six standard definition camcorders, which are available in a variety of different recording formats, including Flash Memory. The camcorders retain Canon's core imaging technologies, but add a wide selection of new features for enhanced image quality and added flexibility for sharing and storing memories.

Highlighting the list of new features is Canon's newest and most sophisticated image processor, DIGIC DV III. The new HD processor is featured in select VIXIA models and delivers...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1601";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Canon U.S.A. Packs a Punch with a Powerful New Camcorder Line-up for 2009" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Canon U.S.A. Packs a Punch with a Powerful New Camcorder Line-up for 2009" />
...
<html>
<head>
	<title>HDTV Magazine - Canon U.S.A. Packs a Punch with a Powerful New Camcorder Line-up for 2009</title>
	<meta name="keywords" content="flash memory, memory camcorders, high definition, genuine canon, definition camcorders, canon, vixia, camcorders, image, camcorder, memory, video, new, flash, definition, advanced, high, consumers, features, recording, genuine, technology, feature, models, quality" />
...
Highlighting the list of new features is Canon's newest and most sophisticated image processor, DIGIC DV III. The new HD processor is featured in select VIXIA models and delivers..." />
	<meta name="title" content="Canon U.S.A. Packs a Punch with a Powerful New Camcorder Line-up for 2009" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/01/canon-usa-packs-a-punch-with-a-powerful-new-camcorder-lineup-for-2009.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1601', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/01/canon-usa-packs-a-punch-with-a-powerful-new-camcorder-lineup-for-2009.php">Canon U.S.A. Packs a Punch with a Powerful New Camcorder Line-up for 2009</a></td>
						</tr><tr>
...
<p>All referenced product names, and other marks, are trademarks of their respective owners. </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  5, 2009  7:04 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1601)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/01/canon-usa-packs-a-punch-with-a-powerful-new-camcorder-lineup-for-2009.php" type="text/javascript" charset="utf-8"></script>
