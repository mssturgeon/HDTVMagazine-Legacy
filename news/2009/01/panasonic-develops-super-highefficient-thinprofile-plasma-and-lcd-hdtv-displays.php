...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/01/panasonic-develops-super-highefficient-thinprofile-plasma-and-lcd-hdtv-displays.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Panasonic Develops Super High-Efficient Thin-Profile Plasma and LCD HDTV Displays" />
...
The newly developed NeoPDP technology has been incorporated into two types of PDPs. The first is..." />
	...
	<meta property="og:title" content="Panasonic Develops Super High-Efficient Thin-Profile Plasma and LCD HDTV Displays" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/01/panasonic-develops-super-highefficient-thinprofile-plasma-and-lcd-hdtv-displays.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Panasonic, the industry and technology leader in HDTVs, has developed new thin-profile display panel technologies for both Plasma (PDPs) and LCD HDTVs, achieving further advancements in picture quality and environmental performance. These prototypes will be featured at the 2009 International Consumer Electronics Show (CES) this week.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1636', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
