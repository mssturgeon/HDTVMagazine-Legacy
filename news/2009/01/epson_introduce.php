...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Epson Introduces High-Performance Home Theater Projector With 1080p Resolution and 75,000:1 Contrast Ratio&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/01/epson-introduces-highperformance-home-theater-projector-with-1080p-resolution-and-750001-contrast-ratio.php&amp;title=Epson Introduces High-Performance Home Theater Projector With 1080p Resolution and 75,000:1 Contrast Ratio">
		<span style="display:none">Building on its leadership position as the number-one selling projector brand worldwide(ii), Epson today announced the latest addition to its award-winning line of 3LCD 1080p front projectors, the PowerLite(R) Home Cinema 6500 UB. Offering true 1080p (1,920 x 1,080 pixels) resolution with the latest 3LCD D7 chip set for significantly higher contrast, a built-in HQV Reon-VX processor by Silicon Optix, and a wide range of new performance advantages, the Home Cinema 6500 UB delivers an outstanding viewing experience for...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/01/epson-introduces-highperformance-home-theater-projector-with-1080p-resolution-and-750001-contrast-ratio.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1660', 340, 125);">Add ASIN</a>
