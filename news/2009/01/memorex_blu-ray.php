...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/01/memorex-bluray-disc-player-hdmi-cables-and-soundbar.php&amp;title=Memorex&amp;reg; Blu-ray Disc Player, HDMI Cables and Soundbar">
		<span style="display:none">Recreate the cinema movie experience right in your home with easy-to-use and affordable Memorex home theatre products. Memorex, a portfolio brand of Imation Corp. (NYSE: IMN), today introduced the powerful SimpleSurround HDMI DVD SoundBar with iPod&amp;reg; dock, the feature-packed MVBD-2520 Blu-ray Disc player, and high performance audio/video cables including High Definition Multimedia Interface (HDMI) cables. The latest in the Memorex line of home theatre components and accessories represent the perfect blend of quality and value, and offer consumers the exciting opportunity to experience high-definition (HD) movies in their homes without breaking the bank.

The following home theatre components and accessories will be on display...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
The following home theatre components and accessories will be on display..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/01/memorex-bluray-disc-player-hdmi-cables-and-soundbar.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1608', 340, 125);">Add ASIN</a>
