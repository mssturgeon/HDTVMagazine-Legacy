...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1634";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Panasonic Creates Ultimate HDTV and Blu-ray Entertainment Devices With Amazon Video On Demand" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Panasonic Creates Ultimate HDTV and Blu-ray Entertainment Devices With Amazon Video On Demand" />
...
<html>
<head>
	<title>HDTV Magazine - Panasonic Creates Ultimate HDTV and Blu-ray Entertainment Devices With Amazon Video On Demand</title>
	<meta name="keywords" content="viera cast, video demand, blu ray, amazon video, hdtvs blu, amazon, panasonic, viera, cast, video, demand, blu, ray, customers, entertainment, movies, services, devices, web, unique, shows, purchase, service, consumer, products" />
...
For 2009, Panasonic's VIERA CAST feature has been extended to..." />
	<meta name="title" content="Panasonic Creates Ultimate HDTV and Blu-ray Entertainment Devices With Amazon Video On Demand" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/01/panasonic-creates-ultimate-hdtv-and-bluray-entertainment-devices-with-amazon-video-on-demand.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1634', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/01/panasonic-creates-ultimate-hdtv-and-bluray-entertainment-devices-with-amazon-video-on-demand.php">Panasonic Creates Ultimate HDTV and Blu-ray Entertainment Devices With Amazon Video On Demand</a></td>
						</tr><tr>
...
<p>Source: Panasonic </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  7, 2009  5:01 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1634)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/01/panasonic-creates-ultimate-hdtv-and-bluray-entertainment-devices-with-amazon-video-on-demand.php" type="text/javascript" charset="utf-8"></script>
