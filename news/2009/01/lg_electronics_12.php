...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/01/lg-electronics-debuts-full-line-of-network-bluray-disc-players-and-home-theater-systems.php&amp;title=LG Electronics Debuts Full Line of Network Blu-ray Disc Players and Home Theater Systems">
		<span style="display:none">Building on the success of its BD300 Network Blu-ray Disc Player -- the world's first Blu-ray player to instantly stream Netflix -- LG Electronics introduced two new Network Blu-ray Disc Players (BD370, BD390) and three Network Blu-ray Disc Home Theater Systems (LHB954, LHB977, LHB979) with expanded content options and wireless connectivity...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1649";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download LG Electronics Debuts Full Line of Network Blu-ray Disc Players and Home Theater Systems" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="LG Electronics Debuts Full Line of Network Blu-ray Disc Players and Home Theater Systems" />
...
<html>
<head>
	<title>HDTV Magazine - LG Electronics Debuts Full Line of Network Blu-ray Disc Players and Home Theater Systems</title>
	<meta name="keywords" content="blu ray, network blu, ray disc, home theater, theater systems, home, blu, ray, network, electronics, disc, entertainment, theater, access, audio, lhb, content, consumers, players, systems, new, options, system, inc, video" />
	...
	<meta name="title" content="LG Electronics Debuts Full Line of Network Blu-ray Disc Players and Home Theater Systems" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/01/lg-electronics-debuts-full-line-of-network-bluray-disc-players-and-home-theater-systems.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1649', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/01/lg-electronics-debuts-full-line-of-network-bluray-disc-players-and-home-theater-systems.php">LG Electronics Debuts Full Line of Network Blu-ray Disc Players and Home Theater Systems</a></td>
						</tr><tr>
...
<p>Source: LG Electronics USA, Inc. </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  8, 2009  5:52 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1649)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/01/lg-electronics-debuts-full-line-of-network-bluray-disc-players-and-home-theater-systems.php" type="text/javascript" charset="utf-8"></script>
