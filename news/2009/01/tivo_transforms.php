...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1610 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=TiVo Transforms the TV World Once Again by Offering a New Way to Search & Discover Content&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/01/tivo-transforms-the-tv-world-once-again-by-offering-a-new-way-to-search-discover-content.php&amp;title=TiVo Transforms the TV World Once Again by Offering a New Way to Search &amp; Discover Content">
		<span style="display:none">TiVo Inc. (NASDAQ:TIVO) , the creator of and a leader in television services for digital video recorders (DVRs), today showed the future of television, unveiling a redesigned TiVo Search feature that offers improved search results with a completely new High Definition design, all at no additional charge. TiVo Search brings users the power of choice, offering millions of pieces of content not available via cable or satellite, along with thousands of linear TV choices. Delivered via broadband, TiVo Search combines a graphics rich experience with simplicity and relevancy that...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1610";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download TiVo Transforms the TV World Once Again by Offering a New Way to Search & Discover Content" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="TiVo Transforms the TV World Once Again by Offering a New Way to Search & Discover Content" />
...
<html>
<head>
	<title>HDTV Magazine - TiVo Transforms the TV World Once Again by Offering a New Way to Search & Discover Content</title>
	<meta name="keywords" content="tivo search, tivo inc, looking statements, high definition, new search, tivo, search, new, content, inc, television, looking, results, statements, broadband, program, users, video, definition, dvr, high, service, consumers, company, experience" />
	<meta name="description" content="TiVo Inc. (NASDAQ:TIVO) , the creator of and a leader in television services for digital video recorders (DVRs), today showed the future of television, unveiling a redesigned TiVo Search feature that offers improved search results with a completely new High Definition design, all at no additional charge. TiVo Search brings users the power of choice, offering millions of pieces of content not available via cable or satellite, along with thousands of linear TV choices. Delivered via broadband, TiVo Search combines a graphics rich experience with simplicity and relevancy that..." />
	<meta name="title" content="TiVo Transforms the TV World Once Again by Offering a New Way to Search &amp; Discover Content" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/01/tivo-transforms-the-tv-world-once-again-by-offering-a-new-way-to-search-discover-content.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1610', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/01/tivo-transforms-the-tv-world-once-again-by-offering-a-new-way-to-search-discover-content.php">TiVo Transforms the TV World Once Again by Offering a New Way to Search & Discover Content</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">TiVo Transforms the TV World Once Again by Offering a New Way to Search & Discover Content</p>

<center><i>Introduction of New TiVo Search Means Channel Surfing is a Now Thing of the Past</i></center><br />
<br />

<p><br />
<B>LAS VEGAS, Jan. 7 /PRNewswire-FirstCall/</B> -- TiVo Inc. (NASDAQ:TIVO) , the creator of and a leader in television services for digital video recorders (DVRs), today showed the future of television, unveiling a redesigned TiVo Search feature that offers improved search results with a completely new High Definition design, all at no additional charge. TiVo Search brings users the power of choice, offering millions of pieces of content not available via cable or satellite, along with thousands of linear TV choices. Delivered via broadband, TiVo Search combines a graphics rich experience with simplicity and relevancy that makes it a truly revolutionary way to get more out of your TV.</p>
...
<p>Seeing equals believing, and the new TiVo Search is no exception. Starting today broadband connected TiVo Series3, TiVo HD, and HD XL subscribers can experience a beta version of the feature on their TiVo DVR, which can be found under Music, Photos, and Showcases. For an online preview and to provide your comments and feedback on this new search tool to TiVo visit http://www.tivo.com/tivosearch.</p>
...
<p>TiVo, TiVoCast, 'TiVo, TV your way.' Season Pass, WishList, TiVoToGo and the TiVo Logo are trademarks or registered trademarks of TiVo Inc. and its subsidiaries worldwide. (c) 2008 TiVo Inc. All other trademarks are property of their respective owners. All rights reserved.</p>
...
<p>Source: TiVo Inc. </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  7, 2009  7:46 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1610)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/01/tivo-transforms-the-tv-world-once-again-by-offering-a-new-way-to-search-discover-content.php" type="text/javascript" charset="utf-8"></script>
