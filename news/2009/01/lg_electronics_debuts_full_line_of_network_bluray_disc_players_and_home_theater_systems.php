...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/01/lg-electronics-debuts-full-line-of-network-bluray-disc-players-and-home-theater-systems.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="LG Electronics Debuts Full Line of Network Blu-ray Disc Players and Home Theater Systems" />
...
<head>
	...
	<meta property="og:title" content="LG Electronics Debuts Full Line of Network Blu-ray Disc Players and Home Theater Systems" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/01/lg-electronics-debuts-full-line-of-network-bluray-disc-players-and-home-theater-systems.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Building on the success of its BD300 Network Blu-ray Disc Player -- the world's first Blu-ray player to instantly stream Netflix -- LG Electronics introduced two new Network Blu-ray Disc Players (BD370, BD390) and three Network Blu-ray Disc Home Theater Systems (LHB954, LHB977, LHB979) with expanded content options and wireless connectivity..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1649', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
