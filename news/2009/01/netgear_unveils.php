...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=NETGEAR Unveils Two New Internet-Connected Set-Top Products to Enrich TV Entertainment for Internet Families and Serious Media Enthusiasts&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/01/netgear-unveils-two-new-internetconnected-settop-products-to-enrich-tv-entertainment-for-internet-families-and-serious-media-enthusiasts.php&amp;title=NETGEAR Unveils Two New Internet-Connected Set-Top Products to Enrich TV Entertainment for Internet Families and Serious Media Enthusiasts">
		<span style="display:none">At the Consumer Electronics Show (CES) opening today, NETGEAR(R), Inc. (NASDAQ:NTGR) , a worldwide provider of technologically innovative, branded networking solutions, introduced two new products that enable consumers to enjoy the world of Internet videos and digital entertainment content on their HDTV screens. Designed to enhance the connected lifestyles of Internet-generation families and serious media enthusiasts, the NETGEAR Internet TV Player (ITV2000) and the NETGEAR Digital Entertainer Elite (EVA9150) will be...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/01/netgear-unveils-two-new-internetconnected-settop-products-to-enrich-tv-entertainment-for-internet-families-and-serious-media-enthusiasts.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1619', 340, 125);">Add ASIN</a>
