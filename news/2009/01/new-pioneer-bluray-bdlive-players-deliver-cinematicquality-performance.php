...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/01/new-pioneer-bluray-bdlive-players-deliver-cinematicquality-performance.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1656";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download New Pioneer Blu-ray BD-Live Players Deliver Cinematic-Quality Performance" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="New Pioneer Blu-ray BD-Live Players Deliver Cinematic-Quality Performance" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="New Pioneer Blu-ray BD-Live Players Deliver Cinematic-Quality Performance" />
...
<html>
<head>
	<title>HDTV Magazine - New Pioneer Blu-ray BD-Live Players Deliver Cinematic-Quality Performance</title>
	<meta name="keywords" content="blu ray, ray disc, elite bdp, pioneer bdp, home theater, pioneer, bdp, disc, blu, ray, players, home, live, elite, new, quality, models, entertainment, deliver, theater, features, experience, picture, player, feature" />
	...
	<meta name="title" content="New Pioneer Blu-ray BD-Live Players Deliver Cinematic-Quality Performance" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="New Pioneer Blu-ray BD-Live Players Deliver Cinematic-Quality Performance" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/01/new-pioneer-bluray-bdlive-players-deliver-cinematicquality-performance.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Pioneer Electronics (USA) Inc. today unveils a complete series of BD-Live Blu-ray Disc players for entertainment junkies who seek cinematic-quality performance along with a premium and unique user experience. The two Pioneer&amp;reg; BDP-120 and BDP-320 models and the Elite&amp;reg; BDP-23FD are outfitted with expandable or built-in memory to deliver on the promise of BD-Live&amp;trade; right out of the box. Pioneer's players combine supreme features, sophisticated internal construction with a rigid chassis design ensuring the highest quality playback of Blu-ray Disc, DVD and..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1656', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/01/new-pioneer-bluray-bdlive-players-deliver-cinematicquality-performance.php">New Pioneer Blu-ray BD-Live Players Deliver Cinematic-Quality Performance</a></td>
						</tr><tr>
...
<p>DOLBY and the double-D symbol are registered trademarks of Dolby Laboratories. </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  8, 2009 11:17 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1656)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/01/new-pioneer-bluray-bdlive-players-deliver-cinematicquality-performance.php" type="text/javascript" charset="utf-8"></script>
