...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/01/tivo-transforms-the-tv-world-once-again-by-offering-a-new-way-to-search-discover-content.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="TiVo Transforms the TV World Once Again by Offering a New Way to Search & Discover Content" />
...
<head>
	...
	<meta property="og:title" content="TiVo Transforms the TV World Once Again by Offering a New Way to Search &amp; Discover Content" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/01/tivo-transforms-the-tv-world-once-again-by-offering-a-new-way-to-search-discover-content.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="TiVo Inc. (NASDAQ:TIVO) , the creator of and a leader in television services for digital video recorders (DVRs), today showed the future of television, unveiling a redesigned TiVo Search feature that offers improved search results with a completely new High Definition design, all at no additional charge. TiVo Search brings users the power of choice, offering millions of pieces of content not available via cable or satellite, along with thousands of linear TV choices. Delivered via broadband, TiVo Search combines a graphics rich experience with simplicity and relevancy that..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1610', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
