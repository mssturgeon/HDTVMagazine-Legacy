...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/01/panasonics-expanded-2009-bluray-line-up-features-viera-castr-bd-livetm-worlds-first-vhsbluray-player-and-reduced-power-consumption.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Panasonic\'s Expanded 2009 Blu-ray Line Up Features VIERA CAST(R), BD Live(TM), World\'s First VHS-Blu-ray Player and Reduced Power Consumption" />
...
<head>
	...
	<meta property="og:title" content="Panasonic's Expanded 2009 Blu-ray Line Up Features VIERA CAST(R), BD Live(TM), World's First VHS-Blu-ray Player and Reduced Power Consumption" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/01/panasonics-expanded-2009-bluray-line-up-features-viera-castr-bd-livetm-worlds-first-vhsbluray-player-and-reduced-power-consumption.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Panasonic, a major developer and contributor to the success of the Blu-ray format, today introduced the successors to last year's award winning DMP-BD35 and DMP-BD55 players, as well as presenting the world's first Blu-ray-VHS dual player. All three of the new Blu-ray players - DMP-BD60, DMP-BD80, DMP-BD70V - combine high quality images with enhanced networking functions, including VIERA Cast's improved internet functionality that provides access to Amazon VOD's huge selection of titles. Continuing its commitment to producing products that stress ease of use, the 2009 line of Blu-ray Disc(TM) players continue to incorporate..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1632', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
