...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/01/panasonic-expands-line-of-high-definition-camcorders-including-model-with-worlds-highest-total-pixel-count.php&amp;title=Panasonic Expands Line of High Definition Camcorders, Including Model With World's Highest Total Pixel Count*">
		<span style="display:none">Panasonic today expanded its 2009 High Definition (HD) camcorder line with six new full-HD models, ranging from introductory to semi-professional. Three new models, the HDC-HS300, HDC-TM300 and HDC-HS250, are more advanced and feature a newly developed 3MOS chip system, while the three other introductory models, the HDC-HS20, HDC-TM20 and HDC-SD20, offer features ideal for first-time users wanting simple but powerful video capabilities. All six High Definition models feature...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/01/panasonic-expands-line-of-high-definition-camcorders-including-model-with-worlds-highest-total-pixel-count.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1633', 340, 125);">Add ASIN</a>
