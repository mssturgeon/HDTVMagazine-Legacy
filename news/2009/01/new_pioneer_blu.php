...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=New Pioneer Blu-ray BD-Live Players Deliver Cinematic-Quality Performance&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/01/new-pioneer-bluray-bdlive-players-deliver-cinematicquality-performance.php&amp;title=New Pioneer Blu-ray BD-Live Players Deliver Cinematic-Quality Performance">
		<span style="display:none">Pioneer Electronics (USA) Inc. today unveils a complete series of BD-Live Blu-ray Disc players for entertainment junkies who seek cinematic-quality performance along with a premium and unique user experience. The two Pioneer&amp;reg; BDP-120 and BDP-320 models and the Elite&amp;reg; BDP-23FD are outfitted with expandable or built-in memory to deliver on the promise of BD-Live&amp;trade; right out of the box. Pioneer's players combine supreme features, sophisticated internal construction with a rigid chassis design ensuring the highest quality playback of Blu-ray Disc, DVD and...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/01/new-pioneer-bluray-bdlive-players-deliver-cinematicquality-performance.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1656', 340, 125);">Add ASIN</a>
