...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/01/canon-usa-packs-a-punch-with-a-powerful-new-camcorder-lineup-for-2009.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Canon U.S.A. Packs a Punch with a Powerful New Camcorder Line-up for 2009" />
...
Highlighting the list of new features is Canon's newest and most sophisticated image processor, DIGIC DV III. The new HD processor is featured in select VIXIA models and delivers..." />
	...
	<meta property="og:title" content="Canon U.S.A. Packs a Punch with a Powerful New Camcorder Line-up for 2009" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/01/canon-usa-packs-a-punch-with-a-powerful-new-camcorder-lineup-for-2009.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Canon U.S.A., Inc, a leader in digital imaging technology, announces an exciting new line of five VIXIA high definition and six standard definition camcorders, which are available in a variety of different recording formats, including Flash Memory. The camcorders retain Canon's core imaging technologies, but add a wide selection of new features for enhanced image quality and added flexibility for sharing and storing memories.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1601', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
