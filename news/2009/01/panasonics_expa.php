...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1632";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Panasonic\'s Expanded 2009 Blu-ray Line Up Features VIERA CAST(R), BD Live(TM), World\'s First VHS-Blu-ray Player and Reduced Power Consumption" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Panasonic\'s Expanded 2009 Blu-ray Line Up Features VIERA CAST(R), BD Live(TM), World\'s First VHS-Blu-ray Player and Reduced Power Consumption" />
...
<html>
<head>
	<title>HDTV Magazine - Panasonic's Expanded 2009 Blu-ray Line Up Features VIERA CAST(R), BD Live(TM), World's First VHS-Blu-ray Player and Reduced Power Consumption</title>
	<meta name="keywords" content="blu ray, ray players, viera cast, power consumption, vhs blu, blu, ray, panasonic, players, dmp, viera, player, power, consumer, high, first, technology, video, audio, vhs, quality, cast, processing, format, company" />
	...
	<meta name="title" content="Panasonic's Expanded 2009 Blu-ray Line Up Features VIERA CAST(R), BD Live(TM), World's First VHS-Blu-ray Player and Reduced Power Consumption" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/01/panasonics-expanded-2009-bluray-line-up-features-viera-castr-bd-livetm-worlds-first-vhsbluray-player-and-reduced-power-consumption.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1632', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/01/panasonics-expanded-2009-bluray-line-up-features-viera-castr-bd-livetm-worlds-first-vhsbluray-player-and-reduced-power-consumption.php">Panasonic's Expanded 2009 Blu-ray Line Up Features VIERA CAST(R), BD Live(TM), World's First VHS-Blu-ray Player and Reduced Power Consumption</a></td>
						</tr><tr>
...
<p>Source: Panasonic </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  7, 2009  4:53 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1632)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/01/panasonics-expanded-2009-bluray-line-up-features-viera-castr-bd-livetm-worlds-first-vhsbluray-player-and-reduced-power-consumption.php" type="text/javascript" charset="utf-8"></script>
