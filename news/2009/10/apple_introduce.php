...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3359 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Apple Introduces Apple TV 3.0 Software With Redesigned User Interface&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3359";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Apple Introduces Apple TV 3.0 Software With Redesigned User Interface" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Apple Introduces Apple TV 3.0 Software With Redesigned User Interface" />
...
<html>
<head>
	<title>HDTV Magazine - Apple Introduces Apple TV 3.0 Software With Redesigned User Interface</title>
	<meta name="keywords" content="itunes extras, genius mixes, internet radio, new apple, favorite content, apple, itunes, ipod, new, software, store, iphone, internet, enjoy, content, video, users, mixes, favorite, available, music, photos, extras, access, including" />
	<meta name="description" content="Apple&amp;reg; today introduced new Apple TV&amp;reg; 3.0 software featuring a redesigned main menu that makes navigating your favorite content simpler and faster, and makes enjoying the largest selection of on-demand HD movie rentals and purchases, HD TV shows, music and podcasts from the iTunes&amp;reg; Store even better on your TV. You can now enjoy iTunes Extras and iTunes LP in stunning fullscreen with your Apple TV, as well as listen to Genius Mixes and Internet radio through your home theater system. The new Apple TV software is available immediately free of charge to existing Apple TV owners, and Apple TV with 160GB capacity is available for just $229.

The redesigned main menu on Apple TV gives you..." />
	<meta name="title" content="Apple Introduces Apple TV 3.0 Software With Redesigned User Interface" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/10/apple-introduces-apple-tv-30-software-with-redesigned-user-interface.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3359', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/10/apple-introduces-apple-tv-30-software-with-redesigned-user-interface.php">Apple Introduces Apple TV 3.0 Software With Redesigned User Interface</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">Apple Introduces Apple TV 3.0 Software With Redesigned User Interface</p>

<center><i>Enjoy iTunes Extras, iTunes LP &amp; Genius Mixes on Your HD TV</center></i><br />
<br />

<p><strong>CUPERTINO, Calif., Oct. 29 /PRNewswire-FirstCall/ -- </strong>Apple&reg; today introduced new Apple TV&reg; 3.0 software featuring a redesigned main menu that makes navigating your favorite content simpler and faster, and makes enjoying the largest selection of on-demand HD movie rentals and purchases, HD TV shows, music and podcasts from the iTunes&reg; Store even better on your TV. You can now enjoy iTunes Extras and iTunes LP in stunning fullscreen with your Apple TV, as well as listen to Genius Mixes and Internet radio through your home theater system. The new Apple TV software is available immediately free of charge to existing Apple TV owners, and Apple TV with 160GB capacity is available for just $229.</p>
...
<p>The new Apple TV software is available as a free automatic download to all Apple TV customers. The 160GB Apple TV is available from the Apple Store&reg; (www.apple.com), Apple's retail stores and Apple Authorized Resellers for a suggested retail price of $229 (US). Apple TV requires an 802.11b/g/n wireless network or 10/100 Base-T Ethernet networking, a broadband Internet connection and a high definition widescreen TV. Video availability varies by country.</p>
...
<p>&copy; 2009 Apple Inc. All rights reserved. Apple, the Apple logo, Mac, Mac OS, Macintosh, Apple TV, iTunes, iPhoto, iPod touch, iPhone, Apple Store, iPod classic and iPod nano are trademarks of Apple. Other company and product names may be trademarks of their respective owners.</p>

<p>Source: Apple</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>October 29, 2009 12:38 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3359)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/10/apple-introduces-apple-tv-30-software-with-redesigned-user-interface.php" type="text/javascript" charset="utf-8"></script>
