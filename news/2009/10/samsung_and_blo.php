...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/10/samsung-and-blockbuster-roll-out-blockbuster-on-demandr-services-starting-today.php&amp;title=Samsung and Blockbuster Roll Out Blockbuster On Demand(R) Services Starting Today">
		<span style="display:none">Samsung Electronics America, Inc., a market leader and award-winning innovator in consumer electronics, and Blockbuster Inc. (NYSE:BBI) (NYSE:BBI.B) , a global leader in entertainment, today announced the immediate availability of Blockbuster's vast and growing library of premium digital entertainment for rent or purchase on select 2009 Samsung HDTVs, Blu-ray Players and Blu-ray integrated Home Theater Systems.

Specific models featuring the new BLOCKBUSTER On Demand service include...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
	...
	switch (7) {
		...
		case 9: # Podcasts
			...
			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Samsung and Blockbuster Roll Out Blockbuster On Demand(R) Services Starting Today" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Samsung and Blockbuster Roll Out Blockbuster On Demand(R) Services Starting Today" />
...
<html>
<head>
	<title>HDTV Magazine - Samsung and Blockbuster Roll Out Blockbuster On Demand(R) Services Starting Today</title>
	<meta name="keywords" content="blu ray, blockbuster demand, samsung electronics, theater systems, home theater, blockbuster, samsung, blu, ray, demand, electronics, home, service, players, statements, inc, systems, america, theater, looking, hdtvs, digital, movie, entertainment, consumer" />
	<meta name="description" content="Samsung Electronics America, Inc., a market leader and award-winning innovator in consumer electronics, and Blockbuster Inc. (NYSE:BBI) (NYSE:BBI.B) , a global leader in entertainment, today announced the immediate availability of Blockbuster's vast and growing library of premium digital entertainment for rent or purchase on select 2009 Samsung HDTVs, Blu-ray Players and Blu-ray integrated Home Theater Systems.

Specific models featuring the new BLOCKBUSTER On Demand service include..." />
	<meta name="title" content="Samsung and Blockbuster Roll Out Blockbuster On Demand(R) Services Starting Today" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/10/samsung-and-blockbuster-roll-out-blockbuster-on-demandr-services-starting-today.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3325', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/10/samsung-and-blockbuster-roll-out-blockbuster-on-demandr-services-starting-today.php">Samsung and Blockbuster Roll Out Blockbuster On Demand(R) Services Starting Today</a></td>
						</tr><tr>
...
<p>Source: Blockbuster Inc.; Samsung Electronics America, Inc.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>October 14, 2009  8:08 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3325)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/10/samsung-and-blockbuster-roll-out-blockbuster-on-demandr-services-starting-today.php" type="text/javascript" charset="utf-8"></script>
