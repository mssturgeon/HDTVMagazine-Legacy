...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3338 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=SANYO Releases New Two-Lamp Projector With Innovative QuaDrive(TM) Optical Engine for Improved Color Reproduction&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/10/sanyo-releases-new-twolamp-projector-with-innovative-quadrivetm-optical-engine-for-improved-color-reproduction.php&amp;title=SANYO Releases New Two-Lamp Projector With Innovative QuaDrive(TM) Optical Engine for Improved Color Reproduction">
		<span style="display:none">&lt;img src=&quot;http://www.hdtvmagazine.com/news/images/2009-10-21_sanyo_plc_xf1000.jpg&quot; alt=&quot;Sanyo PLC-XF1000&quot; height=&quot;87&quot; width=&quot;134&quot; class=&quot;keyimg&quot;&gt;SANYO, one of the world's largest manufacturers of LCD and DLP projectors, announces the release of a new two-lamp projector, the PLC-XF1000, which features the exclusive QuaDrive(TM) optical engine for exceptional color reproduction for brighter capacities, 12,000 lumens brightness, 4000:1 contrast ratio, and the proprietary Active Maintenance Filter (AMF) for increased reliability.

The high brightness, two-lamp PLC-XF1000 projector is the second SANYO model to be equipped with...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3338";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download SANYO Releases New Two-Lamp Projector With Innovative QuaDrive(TM) Optical Engine for Improved Color Reproduction" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="SANYO Releases New Two-Lamp Projector With Innovative QuaDrive(TM) Optical Engine for Improved Color Reproduction" />
...
<html>
<head>
	<title>HDTV Magazine - SANYO Releases New Two-Lamp Projector With Innovative QuaDrive(TM) Optical Engine for Improved Color Reproduction</title>
	<meta name="keywords" content="optical engine, contrast ratio, color reproduction, north america, innovative quadrive, sanyo, color, plc, high, brightness, projector, projectors, quadrive, lamp, ratio, new, optical, engine, lens, improved, lumens, contrast, reproduction, filter, light" />
	<meta name="description" content="&lt;img src=&quot;http://www.hdtvmagazine.com/news/images/2009-10-21_sanyo_plc_xf1000.jpg&quot; alt=&quot;Sanyo PLC-XF1000&quot; height=&quot;87&quot; width=&quot;134&quot; class=&quot;keyimg&quot;&gt;SANYO, one of the world's largest manufacturers of LCD and DLP projectors, announces the release of a new two-lamp projector, the PLC-XF1000, which features the exclusive QuaDrive(TM) optical engine for exceptional color reproduction for brighter capacities, 12,000 lumens brightness, 4000:1 contrast ratio, and the proprietary Active Maintenance Filter (AMF) for increased reliability.

The high brightness, two-lamp PLC-XF1000 projector is the second SANYO model to be equipped with..." />
	<meta name="title" content="SANYO Releases New Two-Lamp Projector With Innovative QuaDrive(TM) Optical Engine for Improved Color Reproduction" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/10/sanyo-releases-new-twolamp-projector-with-innovative-quadrivetm-optical-engine-for-improved-color-reproduction.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3338', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/10/sanyo-releases-new-twolamp-projector-with-innovative-quadrivetm-optical-engine-for-improved-color-reproduction.php">SANYO Releases New Two-Lamp Projector With Innovative QuaDrive(TM) Optical Engine for Improved Color Reproduction</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">SANYO Releases New Two-Lamp Projector With Innovative QuaDrive(TM) Optical Engine for Improved Color Reproduction</p>

<center><i>- Equipped with the proprietary SANYO QuaDrive(TM) optical engine, the PLC-XF1000 delivers extremely rich color reproduction with bright, vivid images

<p>- Rated at 12,000 lumens, the highest brightness in the industry for 100V AC projectors</p>

<p>- Two-lamp output offers high-resolution images with a high contrast ratio of 4000:1</p>

<p>- Active Maintenance Filter (AMF) reduces servicing time and costs</center></i><br /><br />
<br /></p>

<p><img src="http://www.hdtvmagazine.com/news/images/2009-10-21_sanyo_plc_xf1000.jpg" alt="Sanyo PLC-XF1000" height="116" width="200" class="keyimg"><strong>CHATSWORTH, Calif., Oct. 20 /PRNewswire/ -- </strong>SANYO, one of the world's largest manufacturers of LCD and DLP projectors, announces the release of a new two-lamp projector, the PLC-XF1000, which features the exclusive QuaDrive(TM) optical engine for exceptional color reproduction for brighter capacities, 12,000 lumens brightness, 4000:1 contrast ratio, and the proprietary Active Maintenance Filter (AMF) for increased reliability.</p>
...
<p>     Resolution: 1024 x 768 (WUXGA)<br />
     Aspect Ratio: 4:3<br />
...
<p>Source: SANYO North America Corp.</p>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3338)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/10/sanyo-releases-new-twolamp-projector-with-innovative-quadrivetm-optical-engine-for-improved-color-reproduction.php" type="text/javascript" charset="utf-8"></script>
