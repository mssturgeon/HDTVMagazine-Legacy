...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/10/samsung-and-blockbuster-roll-out-blockbuster-on-demandr-services-starting-today.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Samsung and Blockbuster Roll Out Blockbuster On Demand(R) Services Starting Today" />
...
Specific models featuring the new BLOCKBUSTER On Demand service include..." />
	...
	<meta property="og:title" content="Samsung and Blockbuster Roll Out Blockbuster On Demand(R) Services Starting Today" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/10/samsung-and-blockbuster-roll-out-blockbuster-on-demandr-services-starting-today.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Samsung Electronics America, Inc., a market leader and award-winning innovator in consumer electronics, and Blockbuster Inc. (NYSE:BBI) (NYSE:BBI.B) , a global leader in entertainment, today announced the immediate availability of Blockbuster's vast and growing library of premium digital entertainment for rent or purchase on select 2009 Samsung HDTVs, Blu-ray Players and Blu-ray integrated Home Theater Systems.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3325', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
