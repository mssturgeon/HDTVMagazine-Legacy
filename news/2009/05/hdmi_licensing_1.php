...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1729 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDMI Licensing, LLC Announces Features of the Upcoming HDMI Specification Version 1.4&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/05/hdmi-licensing-llc-announces-features-of-the-upcoming-hdmi-specification-version-14.php&amp;title=HDMI Licensing, LLC Announces Features of the Upcoming HDMI Specification Version 1.4">
		<span style="display:none">HDMI Licensing, LLC, the agent responsible for licensing the High-Definition Multimedia Interface&amp;reg; (HDMI&amp;reg;) specification, today announced the features that will be incorporated in the upcoming HDMI 1.4 specification. This latest version of the HDMI specification will, among other advancements, offer networking capabilities with Ethernet connectivity and will add an Audio Return Channel to enable upstream audio connections via the HDMI cable. The HDMI specification 1.4 will be available for download...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1729";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDMI Licensing, LLC Announces Features of the Upcoming HDMI Specification Version 1.4" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDMI Licensing, LLC Announces Features of the Upcoming HDMI Specification Version 1.4" />
...
<html>
<head>
	<title>HDTV Magazine - HDMI Licensing, LLC Announces Features of the Upcoming HDMI Specification Version 1.4</title>
	<meta name="keywords" content="hdmi specification, hdmi cable, licensing llc, hdmi licensing, hdmi enabled, hdmi, specification, cable, devices, ethernet, new, audio, channel, licensing, llc, digital, high, enabled, connection, standard, system, connector, consumers, support, content" />
	<meta name="description" content="HDMI Licensing, LLC, the agent responsible for licensing the High-Definition Multimedia Interface&amp;reg; (HDMI&amp;reg;) specification, today announced the features that will be incorporated in the upcoming HDMI 1.4 specification. This latest version of the HDMI specification will, among other advancements, offer networking capabilities with Ethernet connectivity and will add an Audio Return Channel to enable upstream audio connections via the HDMI cable. The HDMI specification 1.4 will be available for download..." />
	<meta name="title" content="HDMI Licensing, LLC Announces Features of the Upcoming HDMI Specification Version 1.4" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/05/hdmi-licensing-llc-announces-features-of-the-upcoming-hdmi-specification-version-14.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1729', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/05/hdmi-licensing-llc-announces-features-of-the-upcoming-hdmi-specification-version-14.php">HDMI Licensing, LLC Announces Features of the Upcoming HDMI Specification Version 1.4</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>May 28, 2009</b>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">HDMI Licensing, LLC Announces Features of the Upcoming HDMI Specification Version 1.4</p>

<center><i>Enhancements Include Networking, Audio Return Channel, 3D Capability, Improved Performance and New Connectors</i></center><br />
<br />

<p><B>SUNNYVALE, Calif.--(BUSINESS WIRE)</B>--HDMI Licensing, LLC, the agent responsible for licensing the High-Definition Multimedia Interface&reg; (HDMI&reg;) specification, today announced the features that will be incorporated in the upcoming HDMI 1.4 specification. This latest version of the HDMI specification will, among other advancements, offer networking capabilities with Ethernet connectivity and will add an Audio Return Channel to enable upstream audio connections via the HDMI cable. The HDMI specification 1.4 will be available for download on the HDMI LLC website no later than June 30, 2009.</p>

<p>The HDMI 1.4 specification will offer the following enhanced functionalities:</p>

<p><br />
<B>    * HDMI Ethernet Channel</B></p>
...
<p><br />
<B>    * 4K x 2K Resolution Support</B></p>
...
<p>    * 3840x2160 24Hz/25Hz/30Hz<br />
    * 4096x2160 24Hz</p>

<p><br />
<B>    * Expanded Support For Color Spaces</B></p>
...
<p><br />
<B>    * Automotive Connection System</B></p>
...
<p>This news release contains forward-looking statements within the meaning of federal securities laws and regulations, including, but not limited to, statements regarding the HDMI 1.4 technology and its anticipated advantages, growth, market, adoption, consumer demand, and anticipated shipments and product introductions. These forward-looking statements involve risks and uncertainties, including, but not limited to, risks associated with the claims made regarding the HDMI 1.4 technology, as well as those risks and uncertainties described from time to time in Silicon Image's filings with the Securities and Exchange Commission (SEC). These risks and uncertainties could cause the actual results to differ materially from those anticipated by the forward-looking statements contained in this news release. Silicon Image assumes no obligation to update any forward-looking statement.</p>

<p>HDMI is a registered trademark of HDMI Licensing, LLC in the United States and/or other countries. All other trademarks and registered trademarks are the property of their respective owners in the Unites States and/or other countries. </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>May 28, 2009  4:23 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1729)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/05/hdmi-licensing-llc-announces-features-of-the-upcoming-hdmi-specification-version-14.php" type="text/javascript" charset="utf-8"></script>
