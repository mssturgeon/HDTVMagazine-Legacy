...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/06/vizio-announces-high-performance-xvt-hdtv-line-up-with-240hz-spstm-truledtm-and-smart-dimmingtm-technology-vizio-internet-apps-via-and-slim-linetm-120hz-lcd-hdtv-models.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="VIZIO Announces High Performance XVT HDTV Line Up with 240Hz SPS(TM), TruLED(TM) and Smart Dimming(TM) Technology, VIZIO Internet Apps (VIA), and Slim Line(TM) 120Hz LCD HDTV Models" />
...
<head>
	...
	<meta property="og:title" content="VIZIO Announces High Performance XVT HDTV Line Up with 240Hz SPS(TM), TruLED(TM) and Smart Dimming(TM) Technology, VIZIO Internet Apps (VIA), and Slim Line(TM) 120Hz LCD HDTV Models" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/06/vizio-announces-high-performance-xvt-hdtv-line-up-with-240hz-spstm-truledtm-and-smart-dimmingtm-technology-vizio-internet-apps-via-and-slim-linetm-120hz-lcd-hdtv-models.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="VIZIO has unveiled details for its Fall 2009 Extreme VIZIO Technology, (XVT) series lineup, with 8 new models ranging in sizes from 32&quot; to 55&quot;. The comprehensive range includes cutting-edge technologies like 240Hz scenes per second, TruLED(TM) with Smart Dimming(TM) backlight technology, VIZIO Internet Apps (VIA(TM)) feature and high-style Slim Line(TM) profile 120Hz LCD HDTVs. All of VIZIO's 2009 televisions are energy efficient, with each earning and exceeding Energy Star 3.0 qualifications by as much as 20%. Products are scheduled to ship..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1747', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
