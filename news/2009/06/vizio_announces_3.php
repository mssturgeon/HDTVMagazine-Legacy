...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1747 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=VIZIO Announces High Performance XVT HDTV Line Up with 240Hz SPS(TM), TruLED(TM) and Smart Dimming(TM) Technology, VIZIO Internet Apps (VIA), and Slim Line(TM) 120Hz LCD HDTV Models&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/06/vizio-announces-high-performance-xvt-hdtv-line-up-with-240hz-spstm-truledtm-and-smart-dimmingtm-technology-vizio-internet-apps-via-and-slim-linetm-120hz-lcd-hdtv-models.php&amp;title=VIZIO Announces High Performance XVT HDTV Line Up with 240Hz SPS(TM), TruLED(TM) and Smart Dimming(TM) Technology, VIZIO Internet Apps (VIA), and Slim Line(TM) 120Hz LCD HDTV Models">
		<span style="display:none">VIZIO has unveiled details for its Fall 2009 Extreme VIZIO Technology, (XVT) series lineup, with 8 new models ranging in sizes from 32&quot; to 55&quot;. The comprehensive range includes cutting-edge technologies like 240Hz scenes per second, TruLED(TM) with Smart Dimming(TM) backlight technology, VIZIO Internet Apps (VIA(TM)) feature and high-style Slim Line(TM) profile 120Hz LCD HDTVs. All of VIZIO's 2009 televisions are energy efficient, with each earning and exceeding Energy Star 3.0 qualifications by as much as 20%. Products are scheduled to ship...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1747";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download VIZIO Announces High Performance XVT HDTV Line Up with 240Hz SPS(TM), TruLED(TM) and Smart Dimming(TM) Technology, VIZIO Internet Apps (VIA), and Slim Line(TM) 120Hz LCD HDTV Models" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="VIZIO Announces High Performance XVT HDTV Line Up with 240Hz SPS(TM), TruLED(TM) and Smart Dimming(TM) Technology, VIZIO Internet Apps (VIA), and Slim Line(TM) 120Hz LCD HDTV Models" />
...
<html>
<head>
	<title>HDTV Magazine - VIZIO Announces High Performance XVT HDTV Line Up with 240Hz SPS(TM), TruLED(TM) and Smart Dimming(TM) Technology, VIZIO Internet Apps (VIA), and Slim Line(TM) 120Hz LCD HDTV Models</title>
	<meta name="keywords" content="yes yes, xvt series, smart dimming, lcd hdtv, slim line, xvt, yes, hdtv, technology, line, internet, lcd, via, sps, truled, models, series, smart, dimming, content, new, full, feature, top, apps" />
	<meta name="description" content="VIZIO has unveiled details for its Fall 2009 Extreme VIZIO Technology, (XVT) series lineup, with 8 new models ranging in sizes from 32&quot; to 55&quot;. The comprehensive range includes cutting-edge technologies like 240Hz scenes per second, TruLED(TM) with Smart Dimming(TM) backlight technology, VIZIO Internet Apps (VIA(TM)) feature and high-style Slim Line(TM) profile 120Hz LCD HDTVs. All of VIZIO's 2009 televisions are energy efficient, with each earning and exceeding Energy Star 3.0 qualifications by as much as 20%. Products are scheduled to ship..." />
	<meta name="title" content="VIZIO Announces High Performance XVT HDTV Line Up with 240Hz SPS(TM), TruLED(TM) and Smart Dimming(TM) Technology, VIZIO Internet Apps (VIA), and Slim Line(TM) 120Hz LCD HDTV Models" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/06/vizio-announces-high-performance-xvt-hdtv-line-up-with-240hz-spstm-truledtm-and-smart-dimmingtm-technology-vizio-internet-apps-via-and-slim-linetm-120hz-lcd-hdtv-models.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1747', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/06/vizio-announces-high-performance-xvt-hdtv-line-up-with-240hz-spstm-truledtm-and-smart-dimmingtm-technology-vizio-internet-apps-via-and-slim-linetm-120hz-lcd-hdtv-models.php">VIZIO Announces High Performance XVT HDTV Line Up with 240Hz SPS(TM), TruLED(TM) and Smart Dimming(TM) Technology, VIZIO Internet Apps (VIA), and Slim Line(TM) 120Hz LCD HDTV Models</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>June 23, 2009</b>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p><img alt="Vizio-XVT-HDTV_200x133.jpg" src="/news/images/products/Vizio-XVT-HDTV_200x133.jpg" align="left" /><p class="prtitle">VIZIO Announces High Performance XVT HDTV Line Up with 240Hz SPS(TM), TruLED(TM) and Smart Dimming(TM) Technology, VIZIO Internet Apps (VIA), and Slim Line(TM) 120Hz LCD HDTV Models</p></p>

<center><i>- Flagship Extreme VIZIO Technology, "XVT Series" advances television's state of the art with NEW TruLED(TM) with Smart Dimming(TM) and 240Hz SPS(TM) (Scenes per Second) in 42", 47" and 55" sizes
...
<p><B>IRVINE, Calif., June 23 /PRNewswire/ </B>-- VIZIO, America's #1 HDTV and Fastest Growing Consumer Electronics Company, has unveiled details for its Fall 2009 Extreme VIZIO Technology, (XVT) series lineup, with 8 new models ranging in sizes from 32" to 55". The comprehensive range includes cutting-edge technologies like 240Hz scenes per second, TruLED(TM) with Smart Dimming(TM) backlight technology, VIZIO Internet Apps (VIA(TM)) feature and high-style Slim Line(TM) profile 120Hz LCD HDTVs. All of VIZIO's 2009 televisions are energy efficient, with each earning and exceeding Energy Star 3.0 qualifications by as much as 20%. Products are scheduled to ship throughout summer and into Fall 2009, with several already in-store or due to hit shelves soon.</p>
...
<p><br />
<B>Superior Performance Meets Stylish New Designs</B></p>
...
<p>Superior TV audio is provided by SRS Labs' TruSurround(TM) HD which enhances clarity and produces surround sound without external speakers, and TruVolume(TM) which eliminates annoying volume fluctuations when switching channels or during commercial breaks.<br />
<pre><br />
                                                   SRS<br />
                                                TruSurround<br />
...
<p>  SV320XVT -     32" 1080p 120Hz<br />
  ...
  VF552XVT       55" 1080p 240Hz SPS<br />
                  w/Smart Dimming<br />
                  Backlight TruLED    Yes   5   Yes/Yes  December  $2,199.99<br />
</pre></p>

<p><br />
<B>VIZIO Internet Apps (VIA(TM)) -- Connecting to the Future of Television</B></p>
...
<p>The V, VIZIO, XVT, VIA, TruLED, 240Hz SPS, Slim Line, Smooth Motion, JAVA, Where Vision Meets Value names, phrase and symbols are trademarks or registered trademarks of VIZIO, Inc. All other trademarks may be the property of their respective holders.</p>

<p>Source: VIZIO, Inc. <br />
</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>June 23, 2009  8:31 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1747)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/06/vizio-announces-high-performance-xvt-hdtv-line-up-with-240hz-spstm-truledtm-and-smart-dimmingtm-technology-vizio-internet-apps-via-and-slim-linetm-120hz-lcd-hdtv-models.php" type="text/javascript" charset="utf-8"></script>
