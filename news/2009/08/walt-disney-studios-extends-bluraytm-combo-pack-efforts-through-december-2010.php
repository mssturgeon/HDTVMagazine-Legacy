...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/08/walt-disney-studios-extends-bluraytm-combo-pack-efforts-through-december-2010.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Walt Disney Studios Extends Blu-ray(TM) Combo Pack Efforts through December 2010" />
...
In a recent online survey..." />
	...
	<meta property="og:title" content="Walt Disney Studios Extends Blu-ray(TM) Combo Pack Efforts through December 2010" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/08/walt-disney-studios-extends-bluraytm-combo-pack-efforts-through-december-2010.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="In a time when price, quality and value are top of mind with consumers, Walt Disney Studios Home Entertainment (WDSHE) today announces the extension of it's Blu-ray Combo Pack initiatives worldwide, providing extended utility of DVD and exceptional quality of a Blu-ray Disc in a single value-pack. The Combo Packs will now be available across all Disney-branded Blu-ray titles releasing through December of 2010.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3196', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
