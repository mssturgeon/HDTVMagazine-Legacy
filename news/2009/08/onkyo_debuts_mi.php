...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3197 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Onkyo Debuts Mid-Price THX Select2 Plus AV Receiver With Streaming Internet Radio Capabilities and DLNA 1.5 Networking Compatibility.&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/08/onkyo-debuts-midprice-thx-select2-plus-av-receiver-with-streaming-internet-radio-capabilities-and-dlna-15-networking-compatibility.php&amp;title=Onkyo Debuts Mid-Price THX Select2 Plus AV Receiver With Streaming Internet Radio Capabilities and DLNA 1.5 Networking Compatibility.">
		<span style="display:none">Onkyo has introduced and begun shipping its first network-capable home theater receiver configured for Pandora, Rhapsody, and Sirius' streaming internet radio services. The new Onkyo TX-NR807 also capable of playing computer music files from networked PCs, is fully compatible with the Digital Living Network Alliance's DLNA 1.5 consumer electronics interoperability specification, and sells for less than...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3197";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Onkyo Debuts Mid-Price THX Select2 Plus AV Receiver With Streaming Internet Radio Capabilities and DLNA 1.5 Networking Compatibility." height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Onkyo Debuts Mid-Price THX Select2 Plus AV Receiver With Streaming Internet Radio Capabilities and DLNA 1.5 Networking Compatibility." />
...
<html>
<head>
	<title>HDTV Magazine - Onkyo Debuts Mid-Price THX Select2 Plus AV Receiver With Streaming Internet Radio Capabilities and DLNA 1.5 Networking Compatibility.</title>
	<meta name="keywords" content="internet radio, select plus, thx select, home theater, streaming internet, onkyo, receiver, internet, radio, audio, processing, home, capabilities, network, price, select, plus, technology, remote, thx, audyssey, theater, video, dolby, products" />
	<meta name="description" content="Onkyo has introduced and begun shipping its first network-capable home theater receiver configured for Pandora, Rhapsody, and Sirius' streaming internet radio services. The new Onkyo TX-NR807 also capable of playing computer music files from networked PCs, is fully compatible with the Digital Living Network Alliance's DLNA 1.5 consumer electronics interoperability specification, and sells for less than..." />
	<meta name="title" content="Onkyo Debuts Mid-Price THX Select2 Plus AV Receiver With Streaming Internet Radio Capabilities and DLNA 1.5 Networking Compatibility." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/08/onkyo-debuts-midprice-thx-select2-plus-av-receiver-with-streaming-internet-radio-capabilities-and-dlna-15-networking-compatibility.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3197', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/08/onkyo-debuts-midprice-thx-select2-plus-av-receiver-with-streaming-internet-radio-capabilities-and-dlna-15-networking-compatibility.php">Onkyo Debuts Mid-Price THX Select2 Plus AV Receiver With Streaming Internet Radio Capabilities and DLNA 1.5 Networking Compatibility.</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>August 12, 2009</b>
...
<p><br />
<strong>Onkyo Debuts TX-SR707</strong></p>
...
<p>Since 1946 Onkyo has been passionately committed to developing audio products that deliver uncommon performance, quality and value. Bundling proprietary technologies and innovations with other sound-enhancing exclusives, Onkyo continues to created award winning product that are lauded by many of the industry leading audio publications. The company's philosophy is to deliver products that are superbly designed and built to a consistently outstanding standard of excellence. Today, Onkyo is at the forefront of the home theater and digital revolutions. For more information about this and other fine Onkyo products, visit <a target="_blank" href="http://www.onkyousa.com/">www.onkyousa.com</a> or call 800-229-1687.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>August 12, 2009  8:22 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3197)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/08/onkyo-debuts-midprice-thx-select2-plus-av-receiver-with-streaming-internet-radio-capabilities-and-dlna-15-networking-compatibility.php" type="text/javascript" charset="utf-8"></script>
