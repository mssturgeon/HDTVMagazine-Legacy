...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Walt Disney Studios Extends Blu-ray(TM) Combo Pack Efforts through December 2010&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/08/walt-disney-studios-extends-bluraytm-combo-pack-efforts-through-december-2010.php&amp;title=Walt Disney Studios Extends Blu-ray(TM) Combo Pack Efforts through December 2010">
		<span style="display:none">In a time when price, quality and value are top of mind with consumers, Walt Disney Studios Home Entertainment (WDSHE) today announces the extension of it's Blu-ray Combo Pack initiatives worldwide, providing extended utility of DVD and exceptional quality of a Blu-ray Disc in a single value-pack. The Combo Packs will now be available across all Disney-branded Blu-ray titles releasing through December of 2010.

In a recent online survey...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
	...
	switch (7) {
		...
		case 9: # Podcasts
			...
			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Walt Disney Studios Extends Blu-ray(TM) Combo Pack Efforts through December 2010" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Walt Disney Studios Extends Blu-ray(TM) Combo Pack Efforts through December 2010" />
...
<html>
<head>
	<title>HDTV Magazine - Walt Disney Studios Extends Blu-ray(TM) Combo Pack Efforts through December 2010</title>
	<meta name="keywords" content="blu ray, home entertainment, walt disney, combo pack, disney studios, blu, ray, disney, home, combo, entertainment, pack, walt, studios, dvd, consumers, value, disc, quality, december, available, worldwide, exceptional, single, titles" />
	<meta name="description" content="In a time when price, quality and value are top of mind with consumers, Walt Disney Studios Home Entertainment (WDSHE) today announces the extension of it's Blu-ray Combo Pack initiatives worldwide, providing extended utility of DVD and exceptional quality of a Blu-ray Disc in a single value-pack. The Combo Packs will now be available across all Disney-branded Blu-ray titles releasing through December of 2010.

In a recent online survey..." />
	<meta name="title" content="Walt Disney Studios Extends Blu-ray(TM) Combo Pack Efforts through December 2010" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/08/walt-disney-studios-extends-bluraytm-combo-pack-efforts-through-december-2010.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3196', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2009/08/walt-disney-studios-extends-bluraytm-combo-pack-efforts-through-december-2010.php">Walt Disney Studios Extends Blu-ray(TM) Combo Pack Efforts through December 2010</a></td>
						</tr><tr>
...
<p>Source: Walt Disney Studios Home Entertainment</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>August 12, 2009  8:18 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 3196)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/08/walt-disney-studios-extends-bluraytm-combo-pack-efforts-through-december-2010.php" type="text/javascript" charset="utf-8"></script>
