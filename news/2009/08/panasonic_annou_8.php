...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2009/08/panasonic-announces-availability-of-amazon-video-on-demand-on-its-full-line-of-2009-viera-casttmenabled-bluray-disc-players.php&amp;title=Panasonic Announces Availability of Amazon Video on Demand on Its Full Line of 2009 VIERA CAST(TM)-Enabled Blu-ray Disc Players">
		<span style="display:none">Panasonic announced today that Amazon Video On Demand is now available on its full line of 2009 VIERA CAST(TM)-enabled Blu-ray Disc players. Current owners of Panasonic's 2009 Blu-ray Disc players automatically received a free software update today and can begin enjoying the service immediately when they...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2009/08/panasonic-announces-availability-of-amazon-video-on-demand-on-its-full-line-of-2009-viera-casttmenabled-bluray-disc-players.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=2932', 340, 125);">Add ASIN</a>
