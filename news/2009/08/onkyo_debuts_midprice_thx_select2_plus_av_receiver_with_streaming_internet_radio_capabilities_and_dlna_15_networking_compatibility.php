...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2009/08/onkyo-debuts-midprice-thx-select2-plus-av-receiver-with-streaming-internet-radio-capabilities-and-dlna-15-networking-compatibility.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Onkyo Debuts Mid-Price THX Select2 Plus AV Receiver With Streaming Internet Radio Capabilities and DLNA 1.5 Networking Compatibility." />
...
<head>
	...
	<meta property="og:title" content="Onkyo Debuts Mid-Price THX Select2 Plus AV Receiver With Streaming Internet Radio Capabilities and DLNA 1.5 Networking Compatibility." />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2009/08/onkyo-debuts-midprice-thx-select2-plus-av-receiver-with-streaming-internet-radio-capabilities-and-dlna-15-networking-compatibility.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Onkyo has introduced and begun shipping its first network-capable home theater receiver configured for Pandora, Rhapsody, and Sirius' streaming internet radio services. The new Onkyo TX-NR807 also capable of playing computer music files from networked PCs, is fully compatible with the Digital Living Network Alliance's DLNA 1.5 consumer electronics interoperability specification, and sells for less than..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3197', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
