<?
	...
	# Get category ID
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3192 AND placement_is_primary = 1";
	$res_category = mQuery($sql);
	$row_category = mysql_fetch_assoc($res_category);
	$category_id = $row_category['placement_category_id'];

	# Get enclosure info
	$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3192";
...
<head>
	...
	<meta name="keywords" content="america consumer, consumer products, toshiba america, statement media, media toshiba, consumer, america, products, toshiba, statement, media" />
	<meta name="description" content="Not much to this bulletin, but it's a fairly significant one, so we thought it would be worth publishing. Enjoy, - Shane Statement to the Media From Toshiba America Consumer Products, L.L.C. WAYNE, N.J., Aug. 10 /PRNewswire/ -- &quot;To meet..." />
	<title>HDTV Magazine Bulletins - Statement to the Media From Toshiba America Consumer Products, L.L.C.</title>
	<link rel="alternate" type="application/rss+xml" title="HDTV Magazine Bulletins Feed" href="http://feeds.hdtvmagazine.com/<?=$feed_name?>" />
	<script type="text/javascript">
		digg_url = 'http://www.hdtvmagazine.com/news/2009/08/statement_to_the_media_from_toshiba_america_consumer_products_llc.php';
		digg_skin = 'compact';
		digg_window = 'new';
		digg_title = 'Statement to the Media From Toshiba America Consumer Products, L.L.C.';
		digg_bodytext = 'Not much to this bulletin, but it\'s a fairly significant one, so we thought it would be worth publishing. Enjoy, - Shane Statement to the Media From Toshiba America Consumer Products, L.L.C. WAYNE, N.J., Aug. 10 /PRNewswire/ -- \"To meet...';
//		digg_media = '';
...
<body><div id="body_container">
	<?
		...
		$base_url = strleftback(PHP_SELF, '/') . '/statement_to_the_media_from_toshiba_america_consumer_products_llc';
		$title_encoded = rawurlencode(addslashes('Statement to the Media From Toshiba America Consumer Products, L.L.C.'));
		$email_url = "mailto:?subject=HDTV Magazine: $title_encoded&amp;body=http://www.hdtvmagazine.com/news/2009/08/statement_to_the_media_from_toshiba_america_consumer_products_llc.php";
		if ($author['img'] != '' && 7 != 7) {
	...
	if (strpos(strtolower($_SERVER['HTTP_USER_AGENT']), "google") === false) {?>
		...
		<table class="bare" cellpadding="0" cellspacing="0" style="width:100%;">
			<tr>
				...
				<td class="article_title" colspan="2">Statement to the Media From Toshiba America Consumer Products, L.L.C.</td>
			</tr><tr>
			<td id="article_byline" nowrap="nowrap">
					By <b>Shane Sturgeon</b><br />
					<?=$author_title?>
					Posted on <b>August 10, 2009</b><br />
					...
					<span><img src="http://cdn.stumble-upon.com/images/16x16_su_3d.gif" alt="" align="absmiddle" /><a target="_blank" href="http://www.stumbleupon.com/submit?url=http://www.hdtvmagazine.com/news/2009/08/statement_to_the_media_from_toshiba_america_consumer_products_llc.php&title=Statement to the Media From Toshiba America Consumer Products, L.L.C.">StumbleUpon</a></span>
					<span><img src="/images/delicious.gif" alt="Add to Del.icio.us" align="absmiddle" /><a target="_blank" href="http://del.icio.us/post?url=http://www.hdtvmagazine.com/news/2009/08/statement_to_the_media_from_toshiba_america_consumer_products_llc.php&amp;title=<?=$title_encoded?>">Del.icio.us</a></span>
	...
	<div>
		...
		<div id="<?=$container?>">
			...
			<div class="header_buttons">
				<? if (7 == 10 || 7 == 6) { # Only show in the test area and for podcasts?>
					...
					<span><a href="<?=$enclosure_url?>"><img src="/images/chicklet-mp3-podcast.gif" alt="Download Statement to the Media From Toshiba America Consumer Products, L.L.C." /></a></span>
				<? }?>
			...
			<p class="editorial">Not much to this bulletin, but it's a fairly significant one, so we thought it would be worth publishing.<br />
<br />
Enjoy,<br />
<br />
- Shane</p>
<p class="prtitle">Statement to the Media From Toshiba America Consumer Products, L.L.C.</p>

<p><strong>WAYNE, N.J., Aug. 10 /PRNewswire/ -- "</strong>To meet the increasing consumer demand for high definition content, Toshiba America Consumer Products, L.L.C. will be entering the Blu-ray market. We will share additional product information and details later this year."</p>

<p>Source: Toshiba America Consumer Products, L.L.C.</p>
		</div>
	</div>
	<p class="posted">Posted by <b>Shane Sturgeon</b>, <b>August 10, 2009  7:26 AM</b></p>
  ...
  <td id="left"><!-- Comments -->
	...
	?>
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2009/08/statement_to_the_media_from_toshiba_america_consumer_products_llc.php" type="text/javascript" charset="utf-8"></script>
</div></body>
</html>
