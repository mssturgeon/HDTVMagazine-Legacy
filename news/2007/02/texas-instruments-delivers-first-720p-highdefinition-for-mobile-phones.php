...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2007/02/texas-instruments-delivers-first-720p-highdefinition-for-mobile-phones.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Texas Instruments Delivers First 720p High-Definition for Mobile Phones" />
...
<head>
	...
	<meta property="og:title" content="Texas Instruments Delivers First 720p High-Definition for Mobile Phones" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2007/02/texas-instruments-delivers-first-720p-highdefinition-for-mobile-phones.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Texas Instruments Incorporated(NYSE: TXN) (TI) demonstrated the industry's first application processor to playback 720p high- definition (HD) video for high-end mobile phones. The OMAP3430 solution is also the first application processor to integrate the newly-defined OpenGL ES(R) 2.0 graphic standard, bringing &quot;life-like&quot; 3D graphics to the handset and creating a mobile gaming experience comparable to today's handheld gaming devices. In addition, TI introduced two..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=546', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
