...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/02/texas-instruments-delivers-first-720p-highdefinition-for-mobile-phones.php&amp;title=Texas Instruments Delivers First 720p High-Definition for Mobile Phones">
		<span style="display:none">Texas Instruments Incorporated(NYSE: TXN) (TI) demonstrated the industry's first application processor to playback 720p high- definition (HD) video for high-end mobile phones. The OMAP3430 solution is also the first application processor to integrate the newly-defined OpenGL ES(R) 2.0 graphic standard, bringing &quot;life-like&quot; 3D graphics to the handset and creating a mobile gaming experience comparable to today's handheld gaming devices. In addition, TI introduced two...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 546";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Texas Instruments Delivers First 720p High-Definition for Mobile Phones" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Texas Instruments Delivers First 720p High-Definition for Mobile Phones" />
...
<html>
<head>
	<title>HDTV Magazine - Texas Instruments Delivers First 720p High-Definition for Mobile Phones</title>
	<meta name="keywords" content="texas instruments, mobile gaming, omap product, high definition, product family, omap, mobile, graphics, processor, high, video, texas, market, instruments, gaming, performance, handset, new, phones, experience, wireless, product, family, advanced, first" />
	...
	<meta name="title" content="Texas Instruments Delivers First 720p High-Definition for Mobile Phones" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/02/texas-instruments-delivers-first-720p-highdefinition-for-mobile-phones.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=546', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/02/texas-instruments-delivers-first-720p-highdefinition-for-mobile-phones.php">Texas Instruments Delivers First 720p High-Definition for Mobile Phones</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>February 12, 2007</b>
...
OMAP is a trademark of Texas Instruments. All registered trademarks and other trademarks belong to their respective owners.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>February 12, 2007 12:18 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 546)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/02/texas-instruments-delivers-first-720p-highdefinition-for-mobile-phones.php" type="text/javascript" charset="utf-8"></script>
