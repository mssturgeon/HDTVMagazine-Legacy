...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Hitachi Unveils the World\'s First<sup>1</sup> Blu-ray Disc Camcorder&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 659";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Hitachi Unveils the World\'s First<sup>1</sup> Blu-ray Disc Camcorder" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Hitachi Unveils the World\'s First<sup>1</sup> Blu-ray Disc Camcorder" />
...
<html>
<head>
	<title>HDTV Magazine - Hitachi Unveils the World's First<sup>1</sup> Blu-ray Disc Camcorder</title>
	<meta name="keywords" content="high definition, full high, definition video, ray disc, blu ray, definition, hitachi, high, full, camcorder, camcorders, video, new, dvd, disc, world, drive, first, blu, ray, market, trademarks, hdd, mega, ltd" />
	<meta name="description" content="Hitachi, Ltd. (NYSE:HIT / TSE:6501) announced the world's first Blu-ray Disc (BD) Camcorder, -which records one hour of 1920x1080 Full High-Definition video onto a BD (single side, single layer.) The new camcorders will start selling in Japan on August 30, 2007, and overseas market sequentially starting from October.

The new DZ-BD7H is a Hybrid Cam with a BD drive and a 30 gigabyte (GB) built-in hard disc drive (HDD) which can record approximately four hours of 1920x1080 full high-definition video, or up to eight hours of 1440x1080 high-definition video. It can also copy the contents from HDD to 8cm BD within the camcorder so that users do not need to use any external devices." />
	<meta name="title" content="Hitachi Unveils the World's First&lt;sup&gt;1&lt;/sup&gt; Blu-ray Disc Camcorder" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/08/hitachi-unveils-the-worlds-first1-bluray-disc-camcorder.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=659', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/08/hitachi-unveils-the-worlds-first1-bluray-disc-camcorder.php">Hitachi Unveils the World's First<sup>1</sup> Blu-ray Disc Camcorder</a></td>
						</tr><tr>
...
Information contained in this news release is current as of the date of the press announcement, but may be subject to change without prior notice.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>August  2, 2007  6:35 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 659)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/08/hitachi-unveils-the-worlds-first1-bluray-disc-camcorder.php" type="text/javascript" charset="utf-8"></script>
