...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2007/08/panasonic-delivers-worlds-first-lifi-hdtv.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Panasonic Delivers World\'s First LIFI HDTV" />
...
By converting HID (High Intensity Discharge) lamps to LIFI, the models enjoy an especially long life span with incredible brightness. When the electrodes in HID lamps deteriorate..." />
	...
	<meta property="og:title" content="Panasonic Delivers World's First LIFI HDTV" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2007/08/panasonic-delivers-worlds-first-lifi-hdtv.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Panasonic has started to ship a new line of High Definition LCD Rear Projection Display televisions featuring the revolutionary long-life LIFI(TM), a first-of-its kind light fidelity projection display application that ensures image brightness over an extended period of time as well as greatly reduced start-up time. The Panasonic LIFI High Definition line includes two series - the LCZ and LCX. The LCZ series, available in three large-screen screen sizes, 61-inches, 56-inches and 50- inches, feature 1080p resolution and an elegant glossy black finish with a new floating panel design. The PT-61LCX70 and PT-56LCX70 offer 720p resolution.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=677', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
