...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2007/08/akamai-brings-high-definition-to-the-internet.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Akamai Brings High Definition to the Internet" />
...
HDTV is defined by the industry to be video with significantly high pixel resolution of 1080i, 1080p or 720p. In the broadcast world, the industry is undergoing a series of transformations that are standardizing the delivery of high-definition video to the home. For the Internet, Akamai is making the HD web possible by" />
	...
	<meta property="og:title" content="Akamai Brings High Definition to the Internet" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2007/08/akamai-brings-high-definition-to-the-internet.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Akamai Technologies, Inc. (NASDAQ: AKAM), the leading global service provider for accelerating content and applications online, today announced that a consistent, high-definition video experience is now possible online via its global content distribution network. Akamai's customers are now delivering HD quality content on Akamai's uniquely distributed edge delivery network that is specifically tuned for optimal delivery of HD files online.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=679', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
