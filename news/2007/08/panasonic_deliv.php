...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 677 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Panasonic Delivers World\'s First LIFI HDTV&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/08/panasonic-delivers-worlds-first-lifi-hdtv.php&amp;title=Panasonic Delivers World's First LIFI HDTV">
		<span style="display:none">Panasonic has started to ship a new line of High Definition LCD Rear Projection Display televisions featuring the revolutionary long-life LIFI(TM), a first-of-its kind light fidelity projection display application that ensures image brightness over an extended period of time as well as greatly reduced start-up time. The Panasonic LIFI High Definition line includes two series - the LCZ and LCX. The LCZ series, available in three large-screen screen sizes, 61-inches, 56-inches and 50- inches, feature 1080p resolution and an elegant glossy black finish with a new floating panel design. The PT-61LCX70 and PT-56LCX70 offer 720p resolution.

By converting HID (High Intensity Discharge) lamps to LIFI, the models enjoy an especially long life span with incredible brightness. When the electrodes in HID lamps deteriorate...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 677";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Panasonic Delivers World\'s First LIFI HDTV" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Panasonic Delivers World\'s First LIFI HDTV" />
...
<html>
<head>
	<title>HDTV Magazine - Panasonic Delivers World's First LIFI HDTV</title>
	<meta name="keywords" content="light source, high definition, lifi hdtv, panasonic lifi, card slot, lifi, panasonic, light, high, source, lcx, time, series, lcd, start, definition, august, hdtv, hid, new, consumer, company, display, lamps, black" />
	<meta name="description" content="Panasonic has started to ship a new line of High Definition LCD Rear Projection Display televisions featuring the revolutionary long-life LIFI(TM), a first-of-its kind light fidelity projection display application that ensures image brightness over an extended period of time as well as greatly reduced start-up time. The Panasonic LIFI High Definition line includes two series - the LCZ and LCX. The LCZ series, available in three large-screen screen sizes, 61-inches, 56-inches and 50- inches, feature 1080p resolution and an elegant glossy black finish with a new floating panel design. The PT-61LCX70 and PT-56LCX70 offer 720p resolution.
...
By converting HID (High Intensity Discharge) lamps to LIFI, the models enjoy an especially long life span with incredible brightness. When the electrodes in HID lamps deteriorate..." />
	<meta name="title" content="Panasonic Delivers World's First LIFI HDTV" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/08/panasonic-delivers-worlds-first-lifi-hdtv.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=677', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/08/panasonic-delivers-worlds-first-lifi-hdtv.php">Panasonic Delivers World's First LIFI HDTV</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>August 22, 2007</b>
...
<p>Panasonic LIFI HD MD-PTV 2007 Models</p>

<p>Model Description  SRP Availability</p>

<p>PT-56LCX70 720p LIFI HD-TV $1699.95 August, 2007</p>

<p>PT-61LCX70 720p LIFI HD-TV $1999.95 August, 2007</p>

<p>PT-50LCZ70 1080p LIFI HD-TV $1699.95 August, 2007</p>

<p>PT-56LCZ70 1080p LIFI HD-TV $1899.95 August, 2007</p>

<p>PT-61LCZ70 1080p LIFI HD-TV $2199.95 August, 2007</p>

<p>Source: Panasonic</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>August 22, 2007  6:02 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 677)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/08/panasonic-delivers-worlds-first-lifi-hdtv.php" type="text/javascript" charset="utf-8"></script>
