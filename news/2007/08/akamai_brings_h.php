...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 679 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Akamai Brings High Definition to the Internet&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/08/akamai-brings-high-definition-to-the-internet.php&amp;title=Akamai Brings High Definition to the Internet">
		<span style="display:none">Akamai Technologies, Inc. (NASDAQ: AKAM), the leading global service provider for accelerating content and applications online, today announced that a consistent, high-definition video experience is now possible online via its global content distribution network. Akamai's customers are now delivering HD quality content on Akamai's uniquely distributed edge delivery network that is specifically tuned for optimal delivery of HD files online.

HDTV is defined by the industry to be video with significantly high pixel resolution of 1080i, 1080p or 720p. In the broadcast world, the industry is undergoing a series of transformations that are standardizing the delivery of high-definition video to the home. For the Internet, Akamai is making the HD web possible by</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 679";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Akamai Brings High Definition to the Internet" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Akamai Brings High Definition to the Internet" />
...
<html>
<head>
	<title>HDTV Magazine - Akamai Brings High Definition to the Internet</title>
	<meta name="keywords" content="high definition, end user, high quality, high throughput, bit rate, akamai, content, high, video, files, online, quality, experience, end, throughput, delivery, technology, network, file, definition, large, user, delivering, broadband, networks" />
	<meta name="description" content="Akamai Technologies, Inc. (NASDAQ: AKAM), the leading global service provider for accelerating content and applications online, today announced that a consistent, high-definition video experience is now possible online via its global content distribution network. Akamai's customers are now delivering HD quality content on Akamai's uniquely distributed edge delivery network that is specifically tuned for optimal delivery of HD files online.
...
HDTV is defined by the industry to be video with significantly high pixel resolution of 1080i, 1080p or 720p. In the broadcast world, the industry is undergoing a series of transformations that are standardizing the delivery of high-definition video to the home. For the Internet, Akamai is making the HD web possible by" />
	<meta name="title" content="Akamai Brings High Definition to the Internet" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/08/akamai-brings-high-definition-to-the-internet.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=679', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/08/akamai-brings-high-definition-to-the-internet.php">Akamai Brings High Definition to the Internet</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">Akamai Brings High Definition to the Internet</p>

<center><i>Company defines key technology criteria for delivering high-definition (HD) Internet video<br />
<br />
Akamai's unique edge distribution architecture enables a quality HD experience by reducing latency and increasing capacity</i></center><br />
<br />

<p><B>CAMBRIDGE, Mass.--(BUSINESS WIRE)</B>--Akamai Technologies, Inc. (NASDAQ: AKAM), the leading global service provider for accelerating content and applications online, today announced that a consistent, high-definition video experience is now possible online via its global content distribution network. Akamai's customers are now delivering HD quality content on Akamai's uniquely distributed edge delivery network that is specifically tuned for optimal delivery of HD files online.</p>

<p>"As broadband connectivity becomes more ubiquitous, users are demanding - and frankly should expect - a high-quality, high-definition video experience on the Internet," said Mike Afergan, chief technology officer, Akamai. "Delivering premium HD content is a critical way for our customers to attract and delight their audiences in today's highly competitive media environment. We are just at the beginning of a very exciting market opportunity for delivering premium HD content. Consumer demand exists, broadband is ready, and businesses are looking for ways to maximize the value of their high-production HD content."</p>

<p><br />
<B>Technical Criteria for delivering HD</B></p>
...
<p>* Technology and an operational model to operate serving devices in the largest high-throughput networks around the world (servers need to be physically in the networks, as that is where the capacity lies)<br />
* Established relationships with the largest high throughput networks<br />
* Support for delivery, storage, and management of files greater than 2 Gigabytes<br />
* Support of VC-1 and MPEG-4 video standards, achieving visual parity with other broadcast video networks<br />
* Support for files with resolutions of 720p, 1080i and 1080p<br />
* Client-side technology that is deeply integrated into its delivery system to be deployed as appropriate</p>
...
<p><br />
<B>Akamai's Unique Architecture for High Throughput Media</B></p>
...
<p>Akamai&reg; is the leading global service provider for accelerating content and applications online. Thousands of organizations have formed trusted relationships with Akamai, improving their revenue and reducing costs by maximizing the performance of their online businesses. Leveraging the Akamai EdgePlatform, these organizations gain business advantage today, and have the foundation for the emerging Web solutions of tomorrow. Akamai is "The Trusted Choice for Online Business." For more information, visit www.akamai.com.</p>

<p><br />
<B>Akamai Statement Under the Private Securities Litigation Reform Act</B></p>

<p>The release contains information about future expectations, plans and prospects of Akamai's management that constitute forward-looking statements for purposes of the safe harbor provisions under The Private Securities Litigation Reform Act of 1995. Actual results may differ materially from those indicated by these forward-looking statements as a result of various important factors including, but not limited to, the effects of any attempts to intentionally disrupt our services or network by unauthorized users or others, failure to have available sufficient transmission capacity, a failure of Akamai's network infrastructure, and other factors that are discussed in the Company's Annual Report on Form 10-K, quarterly reports on Form 10-Q, and other documents periodically filed with the SEC.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>August 27, 2007  5:17 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 679)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/08/akamai-brings-high-definition-to-the-internet.php" type="text/javascript" charset="utf-8"></script>
