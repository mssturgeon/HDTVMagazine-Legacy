...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 668";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download ONKYO Introduces Its First HD DVD Player, Including High-Bit-Rate and Lossless Audio Streaming via HDMI 1.3a" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="ONKYO Introduces Its First HD DVD Player, Including High-Bit-Rate and Lossless Audio Streaming via HDMI 1.3a" />
...
<html>
<head>
	<title>HDTV Magazine - ONKYO Introduces Its First HD DVD Player, Including High-Bit-Rate and Lossless Audio Streaming via HDMI 1.3a</title>
	<meta name="keywords" content="hdmi version, high definition, high bit, bit rate, dvd player, dvd, high, onkyo, hdmi, audio, video, bit, dts, definition, dolby, player, version, content, trademarks, rate, streaming, hqv, resolution, first, truehd" />
...
The DV-HD805 is designed to partner with Onkyo's 2007 A/V receiver line-up. Both the HD DVD player and the A/V receivers feature HDMI version 1.3a connections, making the combination of these components the perfect platform for high-definition 1080p video images. It also nicely complements Onkyo's A/V receivers by streaming of the new lossless surround sound formats, Dolby&amp;reg; TrueHD and DTS&amp;reg;-HD Master Audio, as well as two &quot;lossy&quot; formats, Dolby&amp;reg; Digital Plus and DTS&amp;reg;-HD High Resolution Audio." />
	<meta name="title" content="ONKYO Introduces Its First HD DVD Player, Including High-Bit-Rate and Lossless Audio Streaming via HDMI 1.3a" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/08/onkyo-introduces-its-first-hd-dvd-player-including-highbitrate-and-lossless-audio-streaming-via-hdmi-13a.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=668', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/08/onkyo-introduces-its-first-hd-dvd-player-including-highbitrate-and-lossless-audio-streaming-via-hdmi-13a.php">ONKYO Introduces Its First HD DVD Player, Including High-Bit-Rate and Lossless Audio Streaming via HDMI 1.3a</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>August  9, 2007</b>
...
<p>HQV is a registered trademark of Silicon Optix.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>August  9, 2007  3:46 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 668)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/08/onkyo-introduces-its-first-hd-dvd-player-including-highbitrate-and-lossless-audio-streaming-via-hdmi-13a.php" type="text/javascript" charset="utf-8"></script>
