...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2007/05/dlinkr-introduces-wireless-draft-11n-solution-that-moves-highdefinition-content-throughout-the-home-using-any-router.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="D-Link(R) Introduces Wireless Draft 11N Solution That Moves High-Definition Content Throughout the Home Using Any Router" />
...
<head>
	...
	<meta property="og:title" content="D-Link(R) Introduces Wireless Draft 11N Solution That Moves High-Definition Content Throughout the Home Using Any Router" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2007/05/dlinkr-introduces-wireless-draft-11n-solution-that-moves-highdefinition-content-throughout-the-home-using-any-router.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="D-Link(R), the end-to-end networking solutions provider for consumers and business, today introduced the new D-Link(R) Xtreme N(TM) Duo(TM) MediaBridge(TM) which allows users to add 5GHz Draft 802.11n capabilities to an existing router. Wireless 802.11n operating at 5GHz makes it possible to stream high-definition (HD) multimedia content throughout the home, from PCs to home entertainment centers, with minimal interference and congestion from legacy (2.4GHz) networks. The new D-Link Xtreme N Duo MediaBridge (DAP-1555) helps avoid interference by allowing the user to use the 5GHz frequency band to provide a stable high-performance wireless link for streaming HD video and more." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=599', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
