...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=D-Link(R) Introduces Wireless Draft 11N Solution That Moves High-Definition Content Throughout the Home Using Any Router&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/05/dlinkr-introduces-wireless-draft-11n-solution-that-moves-highdefinition-content-throughout-the-home-using-any-router.php&amp;title=D-Link(R) Introduces Wireless Draft 11N Solution That Moves High-Definition Content Throughout the Home Using Any Router">
		<span style="display:none">D-Link(R), the end-to-end networking solutions provider for consumers and business, today introduced the new D-Link(R) Xtreme N(TM) Duo(TM) MediaBridge(TM) which allows users to add 5GHz Draft 802.11n capabilities to an existing router. Wireless 802.11n operating at 5GHz makes it possible to stream high-definition (HD) multimedia content throughout the home, from PCs to home entertainment centers, with minimal interference and congestion from legacy (2.4GHz) networks. The new D-Link Xtreme N Duo MediaBridge (DAP-1555) helps avoid interference by allowing the user to use the 5GHz frequency band to provide a stable high-performance wireless link for streaming HD video and more.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 599";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download D-Link(R) Introduces Wireless Draft 11N Solution That Moves High-Definition Content Throughout the Home Using Any Router" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="D-Link(R) Introduces Wireless Draft 11N Solution That Moves High-Definition Content Throughout the Home Using Any Router" />
...
<html>
<head>
	<title>HDTV Magazine - D-Link(R) Introduces Wireless Draft 11N Solution That Moves High-Definition Content Throughout the Home Using Any Router</title>
	<meta name="keywords" content="duo mediabridge, link systems, systems inc, link xtreme, content home, link, wireless, xtreme, home, mediabridge, duo, draft, performance, technology, systems, dap, router, inc, ghz, users, video, networking, high, provide, network" />
	...
	<meta name="title" content="D-Link(R) Introduces Wireless Draft 11N Solution That Moves High-Definition Content Throughout the Home Using Any Router" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/05/dlinkr-introduces-wireless-draft-11n-solution-that-moves-highdefinition-content-throughout-the-home-using-any-router.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=599', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/05/dlinkr-introduces-wireless-draft-11n-solution-that-moves-highdefinition-content-throughout-the-home-using-any-router.php">D-Link(R) Introduces Wireless Draft 11N Solution That Moves High-Definition Content Throughout the Home Using Any Router</a></td>
						</tr><tr>
...
<p>Web site: http://www.dlink.com/</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>May 15, 2007  6:59 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 599)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/05/dlinkr-introduces-wireless-draft-11n-solution-that-moves-highdefinition-content-throughout-the-home-using-any-router.php" type="text/javascript" charset="utf-8"></script>
