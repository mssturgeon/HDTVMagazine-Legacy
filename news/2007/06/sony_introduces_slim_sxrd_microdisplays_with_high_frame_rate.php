...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2007/06/sony-introduces-slim-sxrd-microdisplays-with-high-frame-rate.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Sony Introduces Slim SXRD Micro-Displays With High Frame Rate" />
...
About 20 percent slimmer than last year's sets, Sony's A3000 line features three new models including the 50-inch KDS-50A3000, the 55-inch KDS-55A3000, the 60-inch KDS-60A3000 (screen sizes measured diagonally) models." />
	...
	<meta property="og:title" content="Sony Introduces Slim SXRD Micro-Displays With High Frame Rate" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2007/06/sony-introduces-slim-sxrd-microdisplays-with-high-frame-rate.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Sony today unveiled five new BRAVIA(R)SXRD(R) (Silicon X-tal (Crystal) Reflective Display) micro-display HDTVs featuring Motionflow 120Hz high frame rate technology and dramatically thinner cabinets.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=609', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
