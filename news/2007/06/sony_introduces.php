...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/06/sony-introduces-slim-sxrd-microdisplays-with-high-frame-rate.php&amp;title=Sony Introduces Slim SXRD Micro-Displays With High Frame Rate">
		<span style="display:none">Sony today unveiled five new BRAVIA(R)SXRD(R) (Silicon X-tal (Crystal) Reflective Display) micro-display HDTVs featuring Motionflow 120Hz high frame rate technology and dramatically thinner cabinets.

About 20 percent slimmer than last year's sets, Sony's A3000 line features three new models including the 50-inch KDS-50A3000, the 55-inch KDS-55A3000, the 60-inch KDS-60A3000 (screen sizes measured diagonally) models.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 609";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Sony Introduces Slim SXRD Micro-Displays With High Frame Rate" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Sony Introduces Slim SXRD Micro-Displays With High Frame Rate" />
...
<html>
<head>
	<title>HDTV Magazine - Sony Introduces Slim SXRD Micro-Displays With High Frame Rate</title>
	<meta name="keywords" content="frame rate, high frame, inch kds, kds xbr, sony electronics, sony, models, kds, high, video, bravia, new, feature, digital, xbr, display, internet, including, sxrd, technology, users, inch, hdmi, rate, micro" />
...
About 20 percent slimmer than last year's sets, Sony's A3000 line features three new models including the 50-inch KDS-50A3000, the 55-inch KDS-55A3000, the 60-inch KDS-60A3000 (screen sizes measured diagonally) models." />
	<meta name="title" content="Sony Introduces Slim SXRD Micro-Displays With High Frame Rate" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/06/sony-introduces-slim-sxrd-microdisplays-with-high-frame-rate.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=609', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/06/sony-introduces-slim-sxrd-microdisplays-with-high-frame-rate.php">Sony Introduces Slim SXRD Micro-Displays With High Frame Rate</a></td>
						</tr><tr>
...
<p>Web site: http://www.sony.com/news</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>June  6, 2007  3:13 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 609)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/06/sony-introduces-slim-sxrd-microdisplays-with-high-frame-rate.php" type="text/javascript" charset="utf-8"></script>
