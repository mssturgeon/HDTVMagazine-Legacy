...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/06/amd-ati-radeon-hd-2600-directx-10-hdmi-hdcp-and-1080p.php&amp;title=AMD ATI Radeon&amp;trade; HD 2600: DirectX&amp;reg; 10, HDMI (HDCP), and 1080p">
		<span style="display:none">AMD (NYSE: AMD) today announced the arrival of the ATI Radeon&amp;trade; HD 2600 and ATI Radeon&amp;trade; HD 2400 series, the mid-range and entry-level graphics processors in the ATI Radeon&amp;trade; HD 2000 series. These next-generation graphics processing units (GPU) bring premium support for Windows Vista&amp;reg; with feature-rich DirectX&amp;reg; 10 graphics1, and built-in multimedia functions for an immersive HD video experience on the PC. Ranging from USD $89-$149 (SEP) for the ATI Radeon HD 2600 series and USD $50-$85 (SEP) for the ATI Radeon HD 2400 series2, the new graphics solutions deliver compelling performance and image quality at an unbelievable price point. The ATI Radeon HD 2600 and ATI Radeon 2400 series have enjoyed broad customer adoption and are designed into a significant number of major OEM mainstream and value DirectX&amp;reg; 10 PCs to be shipped in 2H07.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/06/amd-ati-radeon-hd-2600-directx-10-hdmi-hdcp-and-1080p.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=621', 340, 125);">Add ASIN</a>
