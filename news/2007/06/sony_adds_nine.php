...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Sony Adds Nine Models to BRAVIA(R) Flat-Panel LCD Line&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/06/sony-adds-nine-models-to-braviar-flatpanel-lcd-line.php&amp;title=Sony Adds Nine Models to BRAVIA(R) Flat-Panel LCD Line">
		<span style="display:none">Sony today introduced nine new BRAVIA(R) flat-panel LCD high-definition televisions with advanced features.

The new models all feature 1920 x 1080 full high-definition resolution, 10-bit panels and, in select models, Motionflow 120Hz high frame rate technology, as well as x.v.Color(TM) capability. Encompassing the XBR5, XBR4 and W series, they come in screen sizes of 52, 46 and 40 inches (measured diagonally). Including the previously announced S series and V series flat- panel LCD models, the complete line of 17 models range in size from 70 to 26 inches (measured diagonally.)</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
The new models all feature 1920 x 1080 full high-definition resolution, 10-bit panels and, in select models, Motionflow 120Hz high frame rate technology, as well as x.v.Color(TM) capability. Encompassing the XBR5, XBR4 and W series, they come in screen sizes of 52, 46 and 40 inches (measured diagonally). Including the previously announced S series and V series flat- panel LCD models, the complete line of 17 models range in size from 70 to 26 inches (measured diagonally.)" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/06/sony-adds-nine-models-to-braviar-flatpanel-lcd-line.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=610', 340, 125);">Add ASIN</a>
