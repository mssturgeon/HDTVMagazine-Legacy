...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=New Pioneer Elite Blu-Ray Disc Player Sets Benchmark for High Performance Video and Audio Playback&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 702";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download New Pioneer Elite Blu-Ray Disc Player Sets Benchmark for High Performance Video and Audio Playback" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="New Pioneer Elite Blu-Ray Disc Player Sets Benchmark for High Performance Video and Audio Playback" />
...
<html>
<head>
	<title>HDTV Magazine - New Pioneer Elite Blu-Ray Disc Player Sets Benchmark for High Performance Video and Audio Playback</title>
	<meta name="keywords" content="ray disc, blu ray, high definition, pioneer elite, disc player, high, home, pioneer, disc, blu, ray, player, elite, hdmi, audio, bdp, theater, definition, digital, new, performance, trademarks, media, dts, registered" />
...
The Pioneer Elite Blu-ray Disc player leads the industry with sophisticated home theater offerings including HDMI Consumer Electronics Control (CEC) to ensure seamless integration with other high definition theater components. In addition..." />
	<meta name="title" content="New Pioneer Elite Blu-Ray Disc Player Sets Benchmark for High Performance Video and Audio Playback" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/09/new-pioneer-elite-bluray-disc-player-sets-benchmark-for-high-performance-video-and-audio-playback.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=702', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/09/new-pioneer-elite-bluray-disc-player-sets-benchmark-for-high-performance-video-and-audio-playback.php">New Pioneer Elite Blu-Ray Disc Player Sets Benchmark for High Performance Video and Audio Playback</a></td>
						</tr><tr>
...
<p>BLU-RAY DISC is a registered trademark of Sony Corporation.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>September  6, 2007 11:36 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 702)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/09/new-pioneer-elite-bluray-disc-player-sets-benchmark-for-high-performance-video-and-audio-playback.php" type="text/javascript" charset="utf-8"></script>
