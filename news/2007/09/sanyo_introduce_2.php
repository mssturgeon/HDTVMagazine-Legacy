...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=SANYO Introduces the Xacti HD700, a Pocket-Sized 720p High-Defintion Camcorder&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/09/sanyo-introduces-the-xacti-hd700-a-pocketsized-720p-highdefintion-camcorder.php&amp;title=SANYO Introduces the Xacti HD700, a Pocket-Sized 720p High-Defintion Camcorder">
		<span style="display:none">SANYO, a world leading digital camera manufacturer, debuts the Xacti HD700, a pocket-sized, 720p high-definition digital camcorder. The HD700 is a high-performance camcorder capable of recording both high-definition video and 7.1-megapixel photos easily to an SD or SDHC memory card (memory card sold separately). Featuring an ultra-compact, ergonomic shape, the HD700 is specifically designed for publishing high quality video and high resolution still photos in formats ideally suited for Web-use or sharing. Fun and easy to use anytime inspiration strikes, the HD700 is truly an advanced communication tool for the emerging information age.

The SANYO Xacti HD700 will be available in</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
The SANYO Xacti HD700 will be available in" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/09/sanyo-introduces-the-xacti-hd700-a-pocketsized-720p-highdefintion-camcorder.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=733', 340, 125);">Add ASIN</a>
