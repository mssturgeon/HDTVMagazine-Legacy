...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2007/09/lg-electronics-launches-secondgeneration-dualformat-highdefinition-disc-player.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="LG Electronics Launches Second-Generation Dual-Format High-Definition Disc Player" />
...
The BH200 further strengthens LG's position as an innovator. Seven months ago..." />
	...
	<meta property="og:title" content="LG Electronics Launches Second-Generation Dual-Format High-Definition Disc Player" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2007/09/lg-electronics-launches-secondgeneration-dualformat-highdefinition-disc-player.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="LG Electronics, the first company to introduce a dual-format high-definition disc player, today unveiled its second-generation LG Super Blu(TM) Player (model BH200). Sporting both formats' logos, LG's new high-def player is capable of Blu-ray disc and HD DVD playback with advanced BD-Java and HDi interactivity, enabling consumers to choose from the widest variety of high-def content regardless of disc format.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=694', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
