...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2007/09/ti-dlpr-technology-enables-3d-tv-viewing-in-the-home.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="TI DLP(R) Technology Enables 3-D TV Viewing in the Home" />
...
Following a similar path to DLP Product's innovation that launched DLP Cinema(R) and the digital cinema industry, 3-D DLP HDTV opens the doors for..." />
	...
	<meta property="og:title" content="TI DLP(R) Technology Enables 3-D TV Viewing in the Home" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2007/09/ti-dlpr-technology-enables-3d-tv-viewing-in-the-home.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="DLP(R) Products from Texas Instruments (TI) (NYSE:TXN) is showcasing high definition 3-D DLP technology at CEDIA Expo, the high end home theatre and entertainment industry's annual meeting. DLP core technology is enabling stereoscopic 3-D capability for HDTVs that are currently on the market. CEDIA attendees will see first-hand how TI DLP Products, a world leader in digital imaging innovations, is providing consumer electronics manufacturers with a simple, yet high performance solution that will deliver the thrill of 3-D content in the home.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=704', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
