...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/09/ti-dlpr-technology-enables-3d-tv-viewing-in-the-home.php&amp;title=TI DLP(R) Technology Enables 3-D TV Viewing in the Home">
		<span style="display:none">DLP(R) Products from Texas Instruments (TI) (NYSE:TXN) is showcasing high definition 3-D DLP technology at CEDIA Expo, the high end home theatre and entertainment industry's annual meeting. DLP core technology is enabling stereoscopic 3-D capability for HDTVs that are currently on the market. CEDIA attendees will see first-hand how TI DLP Products, a world leader in digital imaging innovations, is providing consumer electronics manufacturers with a simple, yet high performance solution that will deliver the thrill of 3-D content in the home.
...
Following a similar path to DLP Product's innovation that launched DLP Cinema(R) and the digital cinema industry, 3-D DLP HDTV opens the doors for...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 704";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download TI DLP(R) Technology Enables 3-D TV Viewing in the Home" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="TI DLP(R) Technology Enables 3-D TV Viewing in the Home" />
...
<html>
<head>
	<title>HDTV Magazine - TI DLP(R) Technology Enables 3-D TV Viewing in the Home</title>
	<meta name="keywords" content="texas instruments, dlp products, dlp technology, dlp hdtv, dlp cinema, dlp, technology, products, texas, instruments, hdtv, high, cinema, home, viewing, fast, immersive, hdtvs, experience, world, first, display, content, digital, information" />
...
Following a similar path to DLP Product's innovation that launched DLP Cinema(R) and the digital cinema industry, 3-D DLP HDTV opens the doors for..." />
	<meta name="title" content="TI DLP(R) Technology Enables 3-D TV Viewing in the Home" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/09/ti-dlpr-technology-enables-3d-tv-viewing-in-the-home.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=704', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/09/ti-dlpr-technology-enables-3d-tv-viewing-in-the-home.php">TI DLP(R) Technology Enables 3-D TV Viewing in the Home</a></td>
						</tr><tr>
...
http://www.ti.com/</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>September  6, 2007 11:41 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 704)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/09/ti-dlpr-technology-enables-3d-tv-viewing-in-the-home.php" type="text/javascript" charset="utf-8"></script>
