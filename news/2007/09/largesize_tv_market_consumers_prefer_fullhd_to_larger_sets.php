...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2007/09/largesize-tv-market-consumers-prefer-fullhd-to-larger-sets.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Large-Size TV Market: Consumers Prefer Full-HD to Larger Sets" />
...
While the full HD TV market is continuing to flourish, led by large sizes, Displaybank (CEO Peter Kwon, www.displaybank.com &lt;http://www.displaybank.com/&gt; ), a display market research institute, has surveyed on the preference of 46-inch full HD LCD TV and 50-inch HF PDP TV targeting 673 website visitors,..." />
	...
	<meta property="og:title" content="Large-Size TV Market: Consumers Prefer Full-HD to Larger Sets" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2007/09/largesize-tv-market-consumers-prefer-fullhd-to-larger-sets.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="&lt;em&gt;Consumers prefer a 46-inch full HD LCD TV rather than a 50-inch HD PDP TV, according to the latest survey data. &lt;/em&gt;
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=718', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
