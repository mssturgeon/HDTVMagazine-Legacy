...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=LCD-TV Prices Rise in July-but Declines Likely to Resume in September&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/09/lcdtv-prices-rise-in-julybut-declines-likely-to-resume-in-september.php&amp;title=LCD-TV Prices Rise in July-but Declines Likely to Resume in September">
		<span style="display:none">After declining or remaining stable for the past six months, the Average Selling Price (ASP) for LCD-TVs rose significantly in July and remained at a higher level in August, according to iSuppli Corp.'s TV PriceTrak service.

The increase mainly was due to...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
The increase mainly was due to..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/09/lcdtv-prices-rise-in-julybut-declines-likely-to-resume-in-september.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=717', 340, 125);">Add ASIN</a>
