...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/09/largesize-tv-market-consumers-prefer-fullhd-to-larger-sets.php&amp;title=Large-Size TV Market: Consumers Prefer Full-HD to Larger Sets">
		<span style="display:none">&lt;em&gt;Consumers prefer a 46-inch full HD LCD TV rather than a 50-inch HD PDP TV, according to the latest survey data. &lt;/em&gt;

While the full HD TV market is continuing to flourish, led by large sizes, Displaybank (CEO Peter Kwon, www.displaybank.com &lt;http://www.displaybank.com/&gt; ), a display market research institute, has surveyed on the preference of 46-inch full HD LCD TV and 50-inch HF PDP TV targeting 673 website visitors,...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 718";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Large-Size TV Market: Consumers Prefer Full-HD to Larger Sets" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Large-Size TV Market: Consumers Prefer Full-HD to Larger Sets" />
...
<html>
<head>
	<title>HDTV Magazine - Large-Size TV Market: Consumers Prefer Full-HD to Larger Sets</title>
	<meta name="keywords" content="inch full, price premium, lcd tvs, displaybank tel, consumers prefer, inch, full, lcd, displaybank, pdp, price, survey, market, tel, preference, consumers, inquires, premium, research, consumer, wide, respondents, prefer, result, range" />
...
While the full HD TV market is continuing to flourish, led by large sizes, Displaybank (CEO Peter Kwon, www.displaybank.com &lt;http://www.displaybank.com/&gt; ), a display market research institute, has surveyed on the preference of 46-inch full HD LCD TV and 50-inch HF PDP TV targeting 673 website visitors,..." />
	<meta name="title" content="Large-Size TV Market: Consumers Prefer Full-HD to Larger Sets" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/09/largesize-tv-market-consumers-prefer-fullhd-to-larger-sets.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=718', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/09/largesize-tv-market-consumers-prefer-fullhd-to-larger-sets.php">Large-Size TV Market: Consumers Prefer Full-HD to Larger Sets</a></td>
						</tr><tr>
...
- Tel :+1.408.366.1448<br />
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Dale Cripps</b>, <b>September 14, 2007  8:11 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Dale Cripps', 718)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/09/largesize-tv-market-consumers-prefer-fullhd-to-larger-sets.php" type="text/javascript" charset="utf-8"></script>
