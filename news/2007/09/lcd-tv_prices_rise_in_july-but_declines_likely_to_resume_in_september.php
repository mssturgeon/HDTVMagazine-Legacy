<?
	...
	$sql = "SELECT digg_url FROM aux_mt_entry WHERE entry_id = 717";
	$result = mQuery($sql);
...
<head>
	...
	<meta name="keywords" content="lcd tvs, market share, end premium, rise july, july declines, LCD, lcd, prices, brands, inch, TVs, tvs, july, July, isuppli, Prices, model, market, new, models, iSuppli, end, Corp, September, premium" />
...
The increase mainly was due to..." />
	<title>HDTV Magazine Bulletins - LCD-TV Prices Rise in July-but Declines Likely to Resume in September</title>
...
<body><div id="body_container">
	<?
		...
		$base_url = strleftback(PHP_SELF, '/') . '/lcd-tv_prices_rise_in_july-but_declines_likely_to_resume_in_september';
		$print_url = $base_url .'-print.php';
		$save_url = $base_url .'-save.php';
		$title_encoded = rawurlencode(addslashes('LCD-TV Prices Rise in July-but Declines Likely to Resume in September'));
		$email_url = "mailto:?subject=HDTV Magazine: $title_encoded&amp;body=http://www.hdtvmagazine.com/news/2007/09/lcd-tv_prices_rise_in_july-but_declines_likely_to_resume_in_september.php";
		if ($author[img] != '' && 7 != 7) {
	...
	<table class="bare" cellpadding="0" cellspacing="0" style="width:100%;">
		<tr>
			...
			<td class="article_title" colspan="2">LCD-TV Prices Rise in July-but Declines Likely to Resume in September</td>
		</tr><tr>
			<td id="article_byline" nowrap="nowrap">
				...
				<!--span><img src="/images/digg.png" alt="Digg Article" align="absmiddle" /><a target="_blank" href="http://digg.com/submit?url=http://www.hdtvmagazine.com/news/2007/09/lcd-tv_prices_rise_in_july-but_declines_likely_to_resume_in_september.php&amp;phase=2">Digg</a></span-->
				<span><img src="/images/newsvine.gif" alt="Add to Newsvine" align="absmiddle" /><a href="javascript:addToNewsvine('http://www.hdtvmagazine.com/news/2007/09/lcd-tv_prices_rise_in_july-but_declines_likely_to_resume_in_september.php', '<?=$title_encoded?>')">Newsvine</a></span>
				<span><img src="/images/delicious.gif" alt="Add to Del.icio.us" align="absmiddle" /><a target="_blank" href="http://del.icio.us/post?url=http://www.hdtvmagazine.com/news/2007/09/lcd-tv_prices_rise_in_july-but_declines_likely_to_resume_in_september.php&amp;title=<?=$title_encoded?>">Del.icio.us</a></span>
	...
	<div>
		<div style="float:left; margin:0 5px 5px 0;"><?
			if ($digg_url == '') {
				echo '<a target="_blank" href="http://digg.com/submit?url=http://www.hdtvmagazine.com/news/2007/09/lcd-tv_prices_rise_in_july-but_declines_likely_to_resume_in_september.php&amp;phase=2&amp;title=LCD-TV%20Prices%20Rise%20in%20July-but%20Declines%20Likely%20to%20Resume%20in%20September&amp;bodytext=After%20declining%20or%20remaining%20stable%20for%20the%20past%20six%20months%2C%20the%20Average%20Selling%20Price%20%28ASP%29%20for%20LCD-TVs%20rose%20significantly%20in%20July%20and%20remained%20at%20a%20higher%20level%20in%20August%2C%20according%20to%20iSuppli%20Corp.%27s%20TV%20PriceTrak%20service.%0A%0AThe%20increase%20mainly%20was%20due%20to...&amp;topic=television"><img src="/images/digg-this.gif" alt="Digg This" style="padding:0"></a>';
			} else {
...
www.isuppli.com</p>
	...
	<p class="posted">Posted by <b>Dale Cripps</b>, <b>September 14, 2007 07:53 AM</b></p>
  ...
  <td id="left"><!-- Comments -->
	...
	?>
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/09/lcd-tv_prices_rise_in_july-but_declines_likely_to_resume_in_september.php" type="text/javascript" charset="utf-8"></script>
</div></body>
</html>
