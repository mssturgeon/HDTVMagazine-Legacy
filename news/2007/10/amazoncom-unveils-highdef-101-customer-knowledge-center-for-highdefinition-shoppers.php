...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2007/10/amazoncom-unveils-highdef-101-customer-knowledge-center-for-highdefinition-shoppers.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Amazon.com Unveils "High-Def 101" Customer Knowledge Center for High-Definition Shoppers" />
...
In a confusing high-definition marketplace, there are many different TVs, DVD players, DVD formats, cable boxes (and cable companies), and surround sound systems (which include receivers, tuners, speakers, sub-woofers and more) to choose from - and they all have to be installed. The goal of High-Def 101 is to..." />
	...
	<meta property="og:title" content="Amazon.com Unveils &quot;High-Def 101&quot; Customer Knowledge Center for High-Definition Shoppers" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2007/10/amazoncom-unveils-highdef-101-customer-knowledge-center-for-highdefinition-shoppers.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Amazon.com, Inc. today unveiled a new customer knowledge center, Amazon High-Def 101 (www.amazon.com/hd101), which will help customers navigate the mountains of information available about the high-definition (HD) home entertainment marketplace. As a one-stop education and shopping destination, Amazon High-Def 101 allows visitors to explore a comprehensive lineup of HD-related products -- including HDTVs, movie players, game systems, PC options, accessories and movies -- while getting the facts on how to &quot;high-def&quot; their homes. Visitors also have access to other HD product offerings and new content, including educational videos and weekly blog posts highlighting the latest trends.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=747', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
