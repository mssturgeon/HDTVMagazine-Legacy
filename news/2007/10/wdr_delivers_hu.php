...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 757 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=WD(R) Delivers Hundreds More Hours to High Definition TiVo(R) DVRs&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 757";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download WD(R) Delivers Hundreds More Hours to High Definition TiVo(R) DVRs" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="WD(R) Delivers Hundreds More Hours to High Definition TiVo(R) DVRs" />
...
<html>
<head>
	<title>HDTV Magazine - WD(R) Delivers Hundreds More Hours to High Definition TiVo(R) DVRs</title>
	<meta name="keywords" content="dvr expander, external hard, expander external, hard drive, western digital, tivo, dvr, expander, external, drive, hard, digital, hours, storage, dvrs, series, western, verified, product, content, products, definition, available, high, compatible" />
	<meta name="description" content="Expanding consumers' TV recording capabilities by as many as hundreds of hours, WD(R) (NYSE:WDC) today announced that its My DVR Expander(TM) external hard drives are verified compatible with TiVo(R) HD and TiVo Series3(TM) DVRs (digital video recorders). Available now at Best Buy retail stores and online at TiVo.com/store, the My DVR Expander external hard drive is capable of storing up to 300 hours of digital standard-definition (SD) or up to 60 hours of high- definition (HD) television programming based on 500 GB of hard drive storage(1). Users can instantly expand their recording capacity by simply attaching the My DVR Expander drive to their TiVo HD and TiVo Series3 HD DVRs. The My DVR Expander external hard drive is designed for TiVo subscribers who want even more room to store not only broadcast content, but also broadband content that TiVo makes available through TiVoCast partners, including movie and TV downloads via Amazon Unbox(TM) on TiVo.

The My DVR Expander external hard drive, a TiVo Verified(TM) product, has been tested for compatibility with..." />
	<meta name="title" content="WD(R) Delivers Hundreds More Hours to High Definition TiVo(R) DVRs" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/10/wdr-delivers-hundreds-more-hours-to-high-definition-tivor-dvrs.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=757', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/10/wdr-delivers-hundreds-more-hours-to-high-definition-tivor-dvrs.php">WD(R) Delivers Hundreds More Hours to High Definition TiVo(R) DVRs</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">WD(R) Delivers Hundreds More Hours to High Definition TiVo(R) DVRs</p>

<center><i>My DVR Expander(TM) External Hard Drives Verified Compatible with TiVo Series3(TM) HD And TiVo HD DVRs</i></center><br />
<br />

<p><img src="/images/products/wd-my-dvr-expander.jpg" alt="Western Digital My DVR Expander" align="left" /><B>LAKE FOREST, Calif., Oct. 23 /PRNewswire-FirstCall/</B> -- Expanding consumers' TV recording capabilities by as many as hundreds of hours, WD(R) (NYSE:WDC) today announced that its My DVR Expander(TM) external hard drives are verified compatible with TiVo(R) HD and TiVo Series3(TM) DVRs (digital video recorders). Available now at Best Buy retail stores and online at TiVo.com/store, the My DVR Expander external hard drive is capable of storing up to 300 hours of digital standard-definition (SD) or up to 60 hours of high- definition (HD) television programming based on 500 GB of hard drive storage(1). Users can instantly expand their recording capacity by simply attaching the My DVR Expander drive to their TiVo HD and TiVo Series3 HD DVRs. The My DVR Expander external hard drive is designed for TiVo subscribers who want even more room to store not only broadcast content, but also broadband content that TiVo makes available through TiVoCast partners, including movie and TV downloads via Amazon Unbox(TM) on TiVo.</p>
...
<p>Western Digital, WD and the WD logo are registered trademarks; My DVR Expander is a trademark of Western Digital Technologies, Inc. TiVo, TiVo Verified and Series3 are trademarks or registered trademarks of TiVo Inc. or its subsidiaries worldwide. Other marks may be mentioned herein that belong to other companies. All other brand and product names mentioned herein are the property of their respective companies. Product specifications are subject to change without notice.</p>

<p>(1) The total program hours that can be stored depends upon the format and data rate of the programming source, operating environment and other factors. Your results may vary. One gigabyte (GB) = one billion bytes. One terabyte (TB) = one trillion bytes. Total accessible capacity varies depending on operating environment.</p>

<p>Source: Western Digital Technologies, Inc.</p>

<p>CONTACT: Constance A. Griffiths, WD Press Relations, +1-949-672-7891,<br />
Constance.Griffiths@wdc.com, or Bob Blair, WD Investor Relations,<br />
+1-949-672-7834, Robert.Blair@wdc.com, both of Western Digital</p>

<p>Web site: http://www.westerndigital.com/</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>October 23, 2007  8:31 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 757)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/10/wdr-delivers-hundreds-more-hours-to-high-definition-tivor-dvrs.php" type="text/javascript" charset="utf-8"></script>
