...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2007/10/the-guaranteed-internet-connection-in-every-hd-dvd-player-allows-moviespecific-access-to-content-community-building-and-online-purchases.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="The Guaranteed Internet Connection in Every HD DVD Player Allows Movie-Specific Access to Content, Community Building and Online Purchases" />
...
In addition to title-centric experiences available through any HD DVD player..." />
	...
	<meta property="og:title" content="The Guaranteed Internet Connection in Every HD DVD Player Allows Movie-Specific Access to Content, Community Building and Online Purchases" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2007/10/the-guaranteed-internet-connection-in-every-hd-dvd-player-allows-moviespecific-access-to-content-community-building-and-online-purchases.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Today, Universal Studios Home Entertainment raised the bar on HD DVD's unique web-enabled experiences by unveiling an Internet infrastructure that allows it to take advantage of the guaranteed Internet connection in every HD DVD player and deliver compelling, title specific features. Heroes: Season 1 on HD DVD was the first title to take advantage of web-enabled capabilities, but with the forthcoming availability of Evan Almighty on HD DVD, Universal is setting the stage for new home entertainment experiences with web-enabled features such as the Download Center, U-Shop, and much more. Taking advantage of the infinite possibilities of web-enabled experiences, Universal is utilizing HD DVD to explore the promise of digitally distributed scenarios and infusing movie content with e-commerce and social media capabilities.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=741', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
