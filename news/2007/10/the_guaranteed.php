...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/10/the-guaranteed-internet-connection-in-every-hd-dvd-player-allows-moviespecific-access-to-content-community-building-and-online-purchases.php&amp;title=The Guaranteed Internet Connection in Every HD DVD Player Allows Movie-Specific Access to Content, Community Building and Online Purchases">
...
In addition to title-centric experiences available through any HD DVD player...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 741";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download The Guaranteed Internet Connection in Every HD DVD Player Allows Movie-Specific Access to Content, Community Building and Online Purchases" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="The Guaranteed Internet Connection in Every HD DVD Player Allows Movie-Specific Access to Content, Community Building and Online Purchases" />
...
<html>
<head>
	<title>HDTV Magazine - The Guaranteed Internet Connection in Every HD DVD Player Allows Movie-Specific Access to Content, Community Building and Online Purchases</title>
	<meta name="keywords" content="web enabled, dvd player, universal studios, home entertainment, evan almighty, dvd, universal, web, enabled, entertainment, experiences, movie, player, features, content, new, online, consumers, studios, shop, access, download, allows, home, users" />
...
In addition to title-centric experiences available through any HD DVD player..." />
	<meta name="title" content="The Guaranteed Internet Connection in Every HD DVD Player Allows Movie-Specific Access to Content, Community Building and Online Purchases" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/10/the-guaranteed-internet-connection-in-every-hd-dvd-player-allows-moviespecific-access-to-content-community-building-and-online-purchases.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=741', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/10/the-guaranteed-internet-connection-in-every-hd-dvd-player-allows-moviespecific-access-to-content-community-building-and-online-purchases.php">The Guaranteed Internet Connection in Every HD DVD Player Allows Movie-Specific Access to Content, Community Building and Online Purchases</a></td>
						</tr><tr>
...
<p>Universal Studios Home Entertainment is a unit of Universal Pictures, a division of Universal Studios (www.universalstudios.com). Universal Studios is a part of NBC Universal, one of the world's leading media and entertainment companies in the development, production, and marketing of entertainment, news, and information to a global audience. Formed in May 2004 through the combining of NBC and Vivendi Universal Entertainment, NBC Universal owns and operates a valuable portfolio of news and entertainment networks, a premier motion picture company, significant television production operations, a leading television stations group, and world-renowned theme parks. NBC Universal is 80%-owned by General Electric, with 20% owned by Vivendi.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>October  3, 2007  2:24 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 741)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/10/the-guaranteed-internet-connection-in-every-hd-dvd-player-allows-moviespecific-access-to-content-community-building-and-online-purchases.php" type="text/javascript" charset="utf-8"></script>
