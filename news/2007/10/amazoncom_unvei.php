...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 747";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Amazon.com Unveils "High-Def 101" Customer Knowledge Center for High-Definition Shoppers" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Amazon.com Unveils "High-Def 101" Customer Knowledge Center for High-Definition Shoppers" />
...
<html>
<head>
	<title>HDTV Magazine - Amazon.com Unveils "High-Def 101" Customer Knowledge Center for High-Definition Shoppers</title>
	<meta name="keywords" content="high def, high definition, home entertainment, customer knowledge, amazon high, amazon, high, def, home, customers, definition, customer, entertainment, information, center, dvd, knowledge, help, including, new, consumer, consumers, include, our, inc" />
...
In a confusing high-definition marketplace, there are many different TVs, DVD players, DVD formats, cable boxes (and cable companies), and surround sound systems (which include receivers, tuners, speakers, sub-woofers and more) to choose from - and they all have to be installed. The goal of High-Def 101 is to..." />
	<meta name="title" content="Amazon.com Unveils &quot;High-Def 101&quot; Customer Knowledge Center for High-Definition Shoppers" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/10/amazoncom-unveils-highdef-101-customer-knowledge-center-for-highdefinition-shoppers.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=747', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/10/amazoncom-unveils-highdef-101-customer-knowledge-center-for-highdefinition-shoppers.php">Amazon.com Unveils "High-Def 101" Customer Knowledge Center for High-Definition Shoppers</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>October 10, 2007</b>
...
206-266-7180</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>October 10, 2007  9:50 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 747)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/10/amazoncom-unveils-highdef-101-customer-knowledge-center-for-highdefinition-shoppers.php" type="text/javascript" charset="utf-8"></script>
