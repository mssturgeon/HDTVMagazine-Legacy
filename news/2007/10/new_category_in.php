...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/10/new-category-in-lcds-the-ultra-thin-and-hitachi-is-leading.php&amp;title=New Category in LCDs - The &quot;Ultra Thin&quot; and Hitachi Is Leading">
		<span style="display:none">The HDTV revolution put the display industry into frenetic motion. Out of this phenomena sprang new departures in technology which promise to keep the &quot;WOW&quot; in HDTV for years to come. Hitachi sent us this &quot;WOW&quot; announcement (below) today. Watch for a luxury grade of new Ultra Thin flat panels as soon as next year at a retail outlet near you. _Dale
...
These slim, stylish LCDs from Hitachi represent an important new...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 760";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download New Category in LCDs - The "Ultra Thin" and Hitachi Is Leading" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="New Category in LCDs - The "Ultra Thin" and Hitachi Is Leading" />
...
<html>
<head>
	<title>HDTV Magazine - New Category in LCDs - The "Ultra Thin" and Hitachi Is Leading</title>
	<meta name="keywords" content="ultra thin, thin displays, new ultra, new category, consumers want, hitachi, thin, new, ultra, displays, consumers, picture, frame, high, display, market, sound, frames, features, our, line, hdtv, image, series, called" />
...
These slim, stylish LCDs from Hitachi represent an important new..." />
	<meta name="title" content="New Category in LCDs - The &quot;Ultra Thin&quot; and Hitachi Is Leading" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/10/new-category-in-lcds-the-ultra-thin-and-hitachi-is-leading.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=760', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/10/new-category-in-lcds-the-ultra-thin-and-hitachi-is-leading.php">New Category in LCDs - The "Ultra Thin" and Hitachi Is Leading</a></td>
						</tr><tr>
...
42"     1920x1080       Q2 '08 </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Dale Cripps</b>, <b>October 23, 2007 11:36 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Dale Cripps', 760)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/10/new-category-in-lcds-the-ultra-thin-and-hitachi-is-leading.php" type="text/javascript" charset="utf-8"></script>
