...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=LG.Philips LCD Showcases Cutting-Edge Suite of LCDs at CES 2007&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/01/lgphilips-lcd-showcases-cuttingedge-suite-of-lcds-at-ces-2007.php&amp;title=LG.Philips LCD Showcases Cutting-Edge Suite of LCDs at CES 2007">
		<span style="display:none">LG.Philips LCD Co., Ltd. (NYSE:LPL)(KRX:034220), a leading innovator of thin-film transistor liquid crystal display (TFT-LCD) technology, announced today that it will showcase its cutting-edge suite of TFT-LCDs for HDTVs, desktop monitors, notebook PCs, digital information displays and other applications during CES 2007 in Las Vegas, Nevada, to be held from January 8-11, 2007.

Products showcased will include a full line-up of full high definition...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 498";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download LG.Philips LCD Showcases Cutting-Edge Suite of LCDs at CES 2007" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="LG.Philips LCD Showcases Cutting-Edge Suite of LCDs at CES 2007" />
...
<html>
<head>
	<title>HDTV Magazine - LG.Philips LCD Showcases Cutting-Edge Suite of LCDs at CES 2007</title>
	<meta name="keywords" content="philips lcd, tft lcd, lcd panels, lcd panel, looking statements, lcd, philips, inch, panels, panel, tft, full, statements, looking, information, power, technology, lcds, display, including, ces, our, percent, feature, displays" />
...
Products showcased will include a full line-up of full high definition..." />
	<meta name="title" content="LG.Philips LCD Showcases Cutting-Edge Suite of LCDs at CES 2007" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/01/lgphilips-lcd-showcases-cuttingedge-suite-of-lcds-at-ces-2007.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=498', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/01/lgphilips-lcd-showcases-cuttingedge-suite-of-lcds-at-ces-2007.php">LG.Philips LCD Showcases Cutting-Edge Suite of LCDs at CES 2007</a></td>
						</tr><tr>
...
sue.kim@lgphilips-lcd.com</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  7, 2007  8:26 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 498)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/01/lgphilips-lcd-showcases-cuttingedge-suite-of-lcds-at-ces-2007.php" type="text/javascript" charset="utf-8"></script>
