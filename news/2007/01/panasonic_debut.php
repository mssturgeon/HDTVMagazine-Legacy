...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Panasonic Debuts Next Generation Big Screen 1080p High Definition Plasma TV\'s And Shows Prototype 42-Inch 1080p&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/01/panasonic-debuts-next-generation-big-screen-1080p-high-definition-plasma-tvs-and-shows-prototype-42inch-1080p.php&amp;title=Panasonic Debuts Next Generation Big Screen 1080p High Definition Plasma TV's And Shows Prototype 42-Inch 1080p">
		<span style="display:none">Panasonic, the leader in high definition and Plasma TV, today announced its full line of Plasmas for 2007, including a 50-inch and 58-inch 1080p high definition model, which compliment Panasonic's current 65-inch and the world's largest Plasma, the 103-inch, to provide a wide choice of Plasmas in the 1080p resolution arena.  The full line brings seven new Plasmas to consumers for 2007, and further demonstrates Panasonic's industry leadership and cutting edge technology in big screen Plasma entertainment.

Also, at the 2007 Consumer Electronics Show, Panasonic unveiled a prototype 42-inch 1080p high definition Plasma...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 508";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Panasonic Debuts Next Generation Big Screen 1080p High Definition Plasma TV\'s And Shows Prototype 42-Inch 1080p" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Panasonic Debuts Next Generation Big Screen 1080p High Definition Plasma TV\'s And Shows Prototype 42-Inch 1080p" />
...
<html>
<head>
	<title>HDTV Magazine - Panasonic Debuts Next Generation Big Screen 1080p High Definition Plasma TV's And Shows Prototype 42-Inch 1080p</title>
	<meta name="keywords" content="high definition, new cosmetic, big screen, definition plasma, panasonic plasma, panasonic, plasma, new, inch, high, definition, cosmetic, line, plasmas, consumer, consumers, experience, spring, commitment, nelkin, screen, resolution, full, big, both" />
...
Also, at the 2007 Consumer Electronics Show, Panasonic unveiled a prototype 42-inch 1080p high definition Plasma..." />
	<meta name="title" content="Panasonic Debuts Next Generation Big Screen 1080p High Definition Plasma TV's And Shows Prototype 42-Inch 1080p" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/01/panasonic-debuts-next-generation-big-screen-1080p-high-definition-plasma-tvs-and-shows-prototype-42inch-1080p.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=508', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/01/panasonic-debuts-next-generation-big-screen-1080p-high-definition-plasma-tvs-and-shows-prototype-42inch-1080p.php">Panasonic Debuts Next Generation Big Screen 1080p High Definition Plasma TV's And Shows Prototype 42-Inch 1080p</a></td>
						</tr><tr>
...
Spring 2007</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>January  7, 2007  8:26 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 508)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/01/panasonic-debuts-next-generation-big-screen-1080p-high-definition-plasma-tvs-and-shows-prototype-42inch-1080p.php" type="text/javascript" charset="utf-8"></script>
