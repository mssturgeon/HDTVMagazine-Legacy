...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2007/01/toshiba-announces-midrange-1080p-hd-dvd-player.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Toshiba Announces Mid-range 1080p HD DVD Player" />
...
<head>
	...
	<meta property="og:title" content="Toshiba Announces Mid-range 1080p HD DVD Player" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2007/01/toshiba-announces-midrange-1080p-hd-dvd-player.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="At CES, Toshiba is introducing the new HD-A20, which is expected to retail at $599.99. With the 1080p capabilities of the HD-A20, Toshiba has taken high definition to the next level at an attractive price point. The HD-A20 joins the existing Toshiba HD DVD line-up which includes the entry level HD-A2 and the top of the line model, HD-XA2. This expanded line of products offers..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=507', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
