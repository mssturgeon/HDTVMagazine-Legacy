...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Macrovision to Acquire Blu-ray Disc Security Technology from Cryptography Research, Inc.&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2007/11/macrovision-to-acquire-bluray-disc-security-technology-from-cryptography-research-inc.php&amp;title=Macrovision to Acquire Blu-ray Disc Security Technology from Cryptography Research, Inc.">
		<span style="display:none">Macrovision Corporation (Nasdaq:MVSN) today announced that it has signed a definitive agreement to acquire certain technology assets from Cryptography Research, Inc. (CRI), the San Francisco-based R&amp;D organization focused on solving complex security problems. Upon closing of the transaction, Macrovision will own the SPDC&amp;trade; (Self-Protecting Digital Content) technology, which formed the basis of BD+, a key element of Blu-ray's content security platform. The purchase includes certain CRI's patents, security software code, and related third party customer and partner agreements. Macrovision will also hire certain CRI employees involved in the technology.

The Blu-ray Disc Association adopted BD+, exclusive to the Blu-ray format, as an added layer of content protection for movies and other premium entertainment released on the Blu-ray Disc standard. The technology will complement Macrovision's...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 785";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Macrovision to Acquire Blu-ray Disc Security Technology from Cryptography Research, Inc." height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Macrovision to Acquire Blu-ray Disc Security Technology from Cryptography Research, Inc." />
...
<html>
<head>
	<title>HDTV Magazine - Macrovision to Acquire Blu-ray Disc Security Technology from Cryptography Research, Inc.</title>
	<meta name="keywords" content="blu ray, cryptography research, research inc, conference call, ray disc, macrovision, security, technology, content, cryptography, research, blu, ray, call, conference, our, inc, spdc, technologies, disc, information, code, closing, offerings, certain" />
...
The Blu-ray Disc Association adopted BD+, exclusive to the Blu-ray format, as an added layer of content protection for movies and other premium entertainment released on the Blu-ray Disc standard. The technology will complement Macrovision's..." />
	<meta name="title" content="Macrovision to Acquire Blu-ray Disc Security Technology from Cryptography Research, Inc." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/11/macrovision-to-acquire-bluray-disc-security-technology-from-cryptography-research-inc.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=785', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/11/macrovision-to-acquire-bluray-disc-security-technology-from-cryptography-research-inc.php">Macrovision to Acquire Blu-ray Disc Security Technology from Cryptography Research, Inc.</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>November 19, 2007</b>
...
<p>@copy;Macrovision 2007. Macrovision is a registered trademark of Macrovision Corporation. All other brands and product names and trademarks are the registered property of their respective companies.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>November 19, 2007  9:17 AM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 785)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/11/macrovision-to-acquire-bluray-disc-security-technology-from-cryptography-research-inc.php" type="text/javascript" charset="utf-8"></script>
