...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2007/11/macrovision-to-acquire-bluray-disc-security-technology-from-cryptography-research-inc.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Macrovision to Acquire Blu-ray Disc Security Technology from Cryptography Research, Inc." />
...
The Blu-ray Disc Association adopted BD+, exclusive to the Blu-ray format, as an added layer of content protection for movies and other premium entertainment released on the Blu-ray Disc standard. The technology will complement Macrovision's..." />
	...
	<meta property="og:title" content="Macrovision to Acquire Blu-ray Disc Security Technology from Cryptography Research, Inc." />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2007/11/macrovision-to-acquire-bluray-disc-security-technology-from-cryptography-research-inc.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Macrovision Corporation (Nasdaq:MVSN) today announced that it has signed a definitive agreement to acquire certain technology assets from Cryptography Research, Inc. (CRI), the San Francisco-based R&amp;D organization focused on solving complex security problems. Upon closing of the transaction, Macrovision will own the SPDC&amp;trade; (Self-Protecting Digital Content) technology, which formed the basis of BD+, a key element of Blu-ray's content security platform. The purchase includes certain CRI's patents, security software code, and related third party customer and partner agreements. Macrovision will also hire certain CRI employees involved in the technology.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=785', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
