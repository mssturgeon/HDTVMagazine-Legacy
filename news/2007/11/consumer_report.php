...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 778 AND placement_is_primary = 1";
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 778";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Consumer Reports: First Ever Brand Repair Rates for LCD, Plasma and Rear-Projection TVs" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Consumer Reports: First Ever Brand Repair Rates for LCD, Plasma and Rear-Projection TVs" />
...
<html>
<head>
	<title>HDTV Magazine - Consumer Reports: First Ever Brand Repair Rates for LCD, Plasma and Rear-Projection TVs</title>
	<meta name="keywords" content="rear projection, consumer reports, flat panel, lcd plasma, projection tvs, repair, consumer, sets, tvs, projection, reports, rear, plasma, lcd, consumers, warranty, flat, panel, average, extended, repairs, rates, brand, rate, issue" />
	<meta name="description" content="For the first time ever, Consumer Reports has brand repair rates for flat-panel and rear-projection TVs. CR's data reveals that flat-panel LCD and plasma TVs have been highly reliable, requiring few repairs during the first three years of use. The report, featured in CR's December issue, reveals that on average, rear-projection TVs were much more repair prone than LCD and plasma sets. These results are based on Consumer Report's National Research Center's Annual Product Reliability Survey which covers almost 93,000 TV sets bought new between 2004 and 2007.

Consumer Reports' new reliability data provides consumers with more detailed information for..." />
	<meta name="title" content="Consumer Reports: First Ever Brand Repair Rates for LCD, Plasma and Rear-Projection TVs" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2007/11/consumer-reports-first-ever-brand-repair-rates-for-lcd-plasma-and-rearprojection-tvs.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=778', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2007/11/consumer-reports-first-ever-brand-repair-rates-for-lcd-plasma-and-rearprojection-tvs.php">Consumer Reports: First Ever Brand Repair Rates for LCD, Plasma and Rear-Projection TVs</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>November  5, 2007</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=371&category=Cable HDTV">Cable HDTV</a></b>, <b><a href="/category.php?id=367&category=LCD HDTVs">LCD HDTVs</a></b>, <b><a href="/category.php?id=504&category=Plasma HDTVs">Plasma HDTVs</a></b>, <b><a href="/category.php?id=326&category=Service & Repair">Service & Repair</a></b>
							</td>
						</tr><tr colspan="2">
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p class="prtitle">Consumer Reports: First Ever Brand Repair Rates for LCD, Plasma and Rear-Projection TVs</p>

<center><i>December issue also features Ratings of HDTVs; Advice on extended warranties for TVs</i></center><br />
<br />

<p><B>YONKERS, N.Y., Nov. 5 /PRNewswire-USNewswire/</B> -- For the first time ever, Consumer Reports has brand repair rates for flat-panel and rear-projection TVs. CR's data reveals that flat-panel LCD and plasma TVs have been highly reliable, requiring few repairs during the first three years of use. The report, featured in CR's December issue, reveals that on average, rear-projection TVs were much more repair prone than LCD and plasma sets. These results are based on Consumer Report's National Research Center's Annual Product Reliability Survey which covers almost 93,000 TV sets bought new between 2004 and 2007.</p>
...
<p><br />
<B>FLAT-PANEL TVs: LCD AND PLASMA</B></p>
...
lhackett@consumer.org</p>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 778)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2007/11/consumer-reports-first-ever-brand-repair-rates-for-lcd-plasma-and-rearprojection-tvs.php" type="text/javascript" charset="utf-8"></script>
