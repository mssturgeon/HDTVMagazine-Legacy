...
<head>
	<!-- index.php template -->
	<title>HDTV Magazine Bulletins</title>
	...
	<meta name="description" content="Breaking HDTV news and up-to-the-minute press releases from all the major high definition manufacturers: Sony, Samsung, LG, Philips, Sharp, Toshiba and more. Also find the latest from the programming providers like Dish Network, DirecTV, Comcast, Time Warner and others. Get it first here." />
	<? require(BASE_DIR .'/includes/page_header.php');?>
</head>
<body><div id="<?=$container?>">
	<? include(BASE_DIR .'/includes/body_header-4.php');?>

	<h1>HDTV Magazine Bulletins</h1>
			...
			<? if ($feed_url != '') {?>
				<div class="item"><span class="corners-top"><span></span></span>
					...
					<ul class="nosquare">
						...
						<li><a target="_blank" href="http://toolbar.google.com/buttons/add?url=http://www.hdtvmagazine.com/news/toolbar_button.xml">Add to Google Toolbar</a></li>
					</ul>
				<span class="corners-bottom"><span></span></span></div>
			<?}?>
