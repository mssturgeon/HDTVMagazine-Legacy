...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2005/11/displaysearch-announces-q305-oled-yy-growth-shipments-up-144-revenues-up-49.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="DisplaySearch Announces Q3\'05 OLED Y/Y Growth: Shipments Up 144%, Revenues Up 49%" />
...
" />
	...
	<meta property="og:title" content="DisplaySearch Announces Q3'05 OLED Y/Y Growth: Shipments Up 144%, Revenues Up 49%" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2005/11/displaysearch-announces-q305-oled-yy-growth-shipments-up-144-revenues-up-49.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="AUSTIN, TEXAS, November 30, 2005—DisplaySearch, an NPD Group Company and the worldwide leader in display market research and consulting, indicated in its latest Quarterly OLED Shipment and Forecast Report that OLED shipments grew to 16.7M and revenues hit $130.9M in Q3'05. Organic Light Emitting Diodes (OLED) displays compete with LCDs in small/medium applications such as mobile phone main displays and subdisplays, MP3s and automotive consoles. OLED shipments increased 144% Y/Y due to 35% growth in MP3 player sales, and 93% growth in industrial displays. All of the growth is in PMOLEDs using small molecule material; AMOLED producers—Sanyo Kodak, AUO and Sony—shipped less than 50K displays in Q3’05. P-OLED material panel producers continued to struggle with less than a 3% share of total shipments.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=262', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
