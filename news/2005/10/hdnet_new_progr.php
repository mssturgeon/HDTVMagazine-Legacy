...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDNet New Programming Line-up for fall schedule features both series premieres and new episodes of current favorites.&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/news/2005/10/hdnet-new-programming-lineup-for-fall-schedule-features-both-series-premieres-and-new-episodes-of-current-favorites.php&amp;title=HDNet New Programming Line-up for fall schedule features both series premieres and new episodes of current favorites.">
		<span style="display:none">DALLAS, TX - October 5, 2005 - HDNet announced it's new fall programming line-up with exciting additions to their schedule for every night of the week.  Viewers can catch new episodes of their favorite HDNet original programs, along with new series and a host of other special programs making their debut this month.
...
EOT;
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 221";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDNet New Programming Line-up for fall schedule features both series premieres and new episodes of current favorites." height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDNet New Programming Line-up for fall schedule features both series premieres and new episodes of current favorites." />
...
<html>
<head>
	<title>HDTV Magazine - HDNet New Programming Line-up for fall schedule features both series premieres and new episodes of current favorites.</title>
	<meta name="keywords" content="new episodes, night hdnet, concert series, schedule every, programming line, hdnet, new, series, night, viewers, october, episodes, programming, get, fall, world, both, programs, game, schedule, season, music, first, presents, national" />
...
&quot;We're very excited to offer this new schedule of great, high-definition programming to our viewers,&quot; said Mark Cuban, president and co-founder of HDNet.  &quot;In nearly five years of delivering ground-breaking HD programming, we feel that this October will be one of our best months, yet.&quot;
" />
	<meta name="title" content="HDNet New Programming Line-up for fall schedule features both series premieres and new episodes of current favorites." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/news/2005/10/hdnet-new-programming-lineup-for-fall-schedule-features-both-series-premieres-and-new-episodes-of-current-favorites.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=221', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2005/10/hdnet-new-programming-lineup-for-fall-schedule-features-both-series-premieres-and-new-episodes-of-current-favorites.php">HDNet New Programming Line-up for fall schedule features both series premieres and new episodes of current favorites.</a></td>
						</tr><tr>
...
<p><img alt="hdnetlogo.jpg" src="http://www.hdtvmagazine.com/news/images/hdnetlogo.jpg" width="104" height="74" /></p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Dale Cripps</b>, <b>October  5, 2005 10:27 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Dale Cripps', 221)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2005/10/hdnet-new-programming-lineup-for-fall-schedule-features-both-series-premieres-and-new-episodes-of-current-favorites.php" type="text/javascript" charset="utf-8"></script>
