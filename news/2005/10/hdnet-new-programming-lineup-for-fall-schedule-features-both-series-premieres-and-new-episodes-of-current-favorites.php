...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2005/10/hdnet-new-programming-lineup-for-fall-schedule-features-both-series-premieres-and-new-episodes-of-current-favorites.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDNet New Programming Line-up for fall schedule features both series premieres and new episodes of current favorites." />
...
" />
	...
	<meta property="og:title" content="HDNet New Programming Line-up for fall schedule features both series premieres and new episodes of current favorites." />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2005/10/hdnet-new-programming-lineup-for-fall-schedule-features-both-series-premieres-and-new-episodes-of-current-favorites.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="DALLAS, TX - October 5, 2005 - HDNet announced it's new fall programming line-up with exciting additions to their schedule for every night of the week.  Viewers can catch new episodes of their favorite HDNet original programs, along with new series and a host of other special programs making their debut this month.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=221', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
