...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 4241 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2011/03/jvc-first-to-offer-full-hd-3d-consumer-camcorder.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 4241";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download JVC First To Offer Full HD 3D Consumer Camcorder" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="JVC First To Offer Full HD 3D Consumer Camcorder" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="JVC First To Offer Full HD 3D Consumer Camcorder" />
...
<html>
<head>
	<title>HDTV Magazine - JVC First To Offer Full HD 3D Consumer Camcorder</title>
	<meta name="keywords" content="blu ray, consumer camcorder, several options, compatible blu, playing back, jvc, video, full, camcorder, new, images, back, shooting, consumer, blu, ray, –, avchd, high, side, disc, compatible, several, footage, mode" />
...
What's more, the camcorder can shoot 3D video that can be burned to a Blu-ray disc or DVD-R for 3D playback on..." />
	<meta name="title" content="JVC First To Offer Full HD 3D Consumer Camcorder" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="JVC First To Offer Full HD 3D Consumer Camcorder" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2011/03/jvc-first-to-offer-full-hd-3d-consumer-camcorder.php" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4241', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2011/03/jvc-first-to-offer-full-hd-3d-consumer-camcorder.php">JVC First To Offer Full HD 3D Consumer Camcorder</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>March  7, 2011</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=344&category=3D HDTV">3D HDTV</a></b>, <b><a href="/category.php?id=273&category=Blu-ray">Blu-ray</a></b>, <b><a href="/category.php?id=343&category=HD Camcorders & Cameras">HD Camcorders & Cameras</a></b>
							</td>
						</tr><tr colspan="2">
			...
			<div id="<?=$container?>">
				...
				<!--?=$v_buttons?-->
				<p class="prtitle">JVC First To Offer Full HD 3D Consumer Camcorder</p>

<center><i>New GS-TD1 3D camcorder now available</center></i><br />
<br />

<p><strong>WAYNE, NJ, March 7, 2011</strong> －JVC today announced the availability of a new 3D consumer camcorder, the first on the consumer market that offers 3D video recording in Full High Definition.  The new JVC GS-TD1 uses two camera lenses and two imaging sensors – one for each lens – to capture three-dimensional images in much same way that human eyes work.</p>
...
<p>The GS-TD1 comes with new Everio MediaBrowser 3D software (for Windows&reg;) for full management, editing and sharing of content. In addition to full-fledged video and still image editing, files can be uploaded effortlessly to social media sites such as YouTube&trade; or Facebook, and the software allows 3D video to be shared on YouTube.</p>

<p>For archiving and playing back 3D recordings, there are several options depending on the shooting mode used.<br />
<ul><li>Full HD 3D video, shot using the MP4 MVC mode, can be archived to a computer hard drive or Blu-ray disc drive.  This Full HD material can be played back in 3D by running the footage back through the camcorder.</li><li>AVCHD 3D (Side-by-Side mode) video can be burned to a DVD-R disc and played back in 3D on any AVCHD-compatible Blu-ray player – including non-3D AVCHD-compatible Blu-ray players – when the disc was created with a PC or JVC Share Station.</li></ul></p>
...
<p>JVC U.S.A., headquartered in Wayne, New Jersey, is a division of JVC Americas Corp., a wholly-owned subsidiary of Victor Company of Japan Ltd. JVC distributes a complete line of video and audio equipment, including high definition displays, camcorders, home and portable audio and video equipment, and mobile entertainment products. For further product information, visit JVC's website at or call 1-800-526-5308.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>March  7, 2011  5:23 PM</b>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 4241)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2011/03/jvc-first-to-offer-full-hd-3d-consumer-camcorder.php" type="text/javascript" charset="utf-8"></script>
