...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 4475 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/news/2011/08/panasonic-samsung-sony-and-xpand-3d-join-forces-in-full-hd-3d-glasses-initiative.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (7) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 4475";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Panasonic, Samsung, Sony, and XPAND 3D Join Forces in \'Full HD 3D Glasses Initiative\'" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Panasonic, Samsung, Sony, and XPAND 3D Join Forces in \'Full HD 3D Glasses Initiative\'" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Panasonic, Samsung, Sony, and XPAND 3D Join Forces in \'Full HD 3D Glasses Initiative\'" />
...
<html>
<head>
	<title>HDTV Magazine - Panasonic, Samsung, Sony, and XPAND 3D Join Forces in 'Full HD 3D Glasses Initiative'</title>
	<meta name="keywords" content="glasses initiative, consumer electronics, samsung electronics, samsung sony, active glasses, technology, glasses, bluetooth, xpand, consumer, active, panasonic, sony, samsung, electronics, corporation, initiative, full, companies, new, ltd, today, consumers, company, protocols" />
	<meta name="description" content="Panasonic Corporation, Samsung Electronics Co., Ltd., Sony Corporation and X6D Limited (XPAND 3D) today announced their intent to collaborate on the development of a new technology standard for consumer 3D active glasses, under the name, &quot;Full HD 3D Glasses Initiative.&quot;

With this new agreement, the companies intend to..." />
	<meta name="title" content="Panasonic, Samsung, Sony, and XPAND 3D Join Forces in 'Full HD 3D Glasses Initiative'" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Panasonic, Samsung, Sony, and XPAND 3D Join Forces in 'Full HD 3D Glasses Initiative'" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/news/2011/08/panasonic-samsung-sony-and-xpand-3d-join-forces-in-full-hd-3d-glasses-initiative.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Panasonic Corporation, Samsung Electronics Co., Ltd., Sony Corporation and X6D Limited (XPAND 3D) today announced their intent to collaborate on the development of a new technology standard for consumer 3D active glasses, under the name, &quot;Full HD 3D Glasses Initiative.&quot;
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4475', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/news/2011/08/panasonic-samsung-sony-and-xpand-3d-join-forces-in-full-hd-3d-glasses-initiative.php">Panasonic, Samsung, Sony, and XPAND 3D Join Forces in 'Full HD 3D Glasses Initiative'</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>August  9, 2011</b>
			...
			<div id="<?=$container?>">
				...
				<!--?=$v_buttons?-->
				<p class="prtitle">PANASONIC, SAMSUNG, SONY, AND XPAND 3D JOIN FORCES IN 'FULL HD 3D GLASSES INITIATIVE'</p>

<center><i>Four Companies Will Seek Development of Joint Licensing on 'BLUETOOTH&reg; ENABLED RF' and 'IR' Consumer 3D Active Glasses</center></i><br />
<br />

<p><strong>August 8, 2011— </strong>Panasonic Corporation, Samsung Electronics Co., Ltd., Sony Corporation and X6D Limited (XPAND 3D) today announced their intent to collaborate on the development of a new technology standard for consumer 3D active glasses, under the name, "Full HD 3D Glasses Initiative."</p>
...
<p>Through this initiative, the four companies aim to widely introduce universal active 3D glasses to the market. Today's announcement marks a unique collaboration of the world's leading 3D TV manufacturers and 3D technology providers for the benefit of consumers. Glasses utilizing 3D active technology benefits consumers in that they enable Full HD 3D picture quality to be displayed to each eye, as well as a greater freedom of movement thanks to Bluetooth&reg; technology.</p>
...
<p><strong>About Bluetooth&reg; Wireless Technology</strong></p>
...
<p># # #</p>
			...
			<? if (7 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 4475)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/news/2011/08/panasonic-samsung-sony-and-xpand-3d-join-forces-in-full-hd-3d-glasses-initiative.php" type="text/javascript" charset="utf-8"></script>
