<?
	...
	$sql = "SELECT digg_url FROM aux_mt_entry WHERE entry_id = 84";
	$result = mQuery($sql);
	...
	# Get category ID
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 84 AND placement_is_primary = 1";
...
<head>
	...
	<meta name="keywords" content="high definition, prime time, production program, program exchange, program production, high, definition, production, television, programs, program, HDTV, hdtv, transmission, electronic, film, system, Europe, europe, worldwide, today, distribution, digital, time, standard" />
	<meta name="description" content="&quot;There is nothing more difficult to take in hand, more perilous to conduct or more uncertain of success, than to take the lead in the introduction of a new order of things, because the innovator has for enemies all those who have done well under the old conditions, and but lukewarm defenders in those who may do well under the new.&quot;
" />
	<title>HDTV Magazine Archive &amp; History - From the Father Of HDTV  In U.S.A.--Dr. Joseph Flaherty. CBS - 1995</title>
...
<body><div id="body_container">
	<?
		...
		$base_url = strleftback(PHP_SELF, '/') . '/from_the_father_of_hdtv_in_usa--dr_joseph_flaherty_cbs_-_1995';
		$print_url = $base_url .'-print.php';
		$save_url = $base_url .'-save.php';
		$title_encoded = rawurlencode(addslashes('From the Father Of HDTV  In U.S.A.--Dr. Joseph Flaherty. CBS - 1995'));
		$email_url = "mailto:?subject=HDTV Magazine: $title_encoded&amp;body=http://www.hdtvmagazine.com/history/2005/06/from_the_father_of_hdtv_in_usa--dr_joseph_flaherty_cbs_-_1995.php";
		if ($author[img] != '' && 5 != 7) {
	...
	<table class="bare" cellpadding="0" cellspacing="0" style="width:100%;">
		<tr>
			...
			<td class="article_title" colspan="2">From the Father Of HDTV  In U.S.A.--Dr. Joseph Flaherty. CBS - 1995</td>
		</tr><tr>
			<td id="article_byline" nowrap="nowrap">
				...
				<!--span><img src="/images/digg.png" alt="Digg Article" align="absmiddle" /><a target="_blank" href="http://digg.com/submit?url=http://www.hdtvmagazine.com/history/2005/06/from_the_father_of_hdtv_in_usa--dr_joseph_flaherty_cbs_-_1995.php&amp;phase=2">Digg</a></span-->
				<span><img src="/images/newsvine.gif" alt="Add to Newsvine" align="absmiddle" /><a href="javascript:addToNewsvine('http://www.hdtvmagazine.com/history/2005/06/from_the_father_of_hdtv_in_usa--dr_joseph_flaherty_cbs_-_1995.php', '<?=$title_encoded?>')">Newsvine</a></span>
				<span><img src="/images/delicious.gif" alt="Add to Del.icio.us" align="absmiddle" /><a target="_blank" href="http://del.icio.us/post?url=http://www.hdtvmagazine.com/history/2005/06/from_the_father_of_hdtv_in_usa--dr_joseph_flaherty_cbs_-_1995.php&amp;title=<?=$title_encoded?>">Del.icio.us</a></span>
	...
	<div>
		<div style="float:left; margin:0 5px 5px 0;"><?
			if ($digg_url == '') {
				echo '<a target="_blank" href="http://digg.com/submit?url=http://www.hdtvmagazine.com/history/2005/06/from_the_father_of_hdtv_in_usa--dr_joseph_flaherty_cbs_-_1995.php&amp;phase=2&amp;title=From%20the%20Father%20Of%20HDTV%20%20In%20U.S.A.--Dr.%20Joseph%20Flaherty.%20CBS%20-%201995&amp;bodytext=%22There%20is%20nothing%20more%20difficult%20to%20take%20in%20hand%2C%20more%20perilous%20to%20conduct%20or%20more%20uncertain%20of%20success%2C%20than%20to%20take%20the%20lead%20in%20the%20introduction%20of%20a%20new%20order%20of%20things%2C%20because%20the%20innovator%20has%20for%20enemies%20all%20those%20who%20have%20done%20well%20under%20the%20old%20conditions%2C%20and%20but%20lukewarm%20defenders%20in%20those%20who%20may%20do%20well%20under%20the%20new.%22%0A&amp;topic=television"><img src="/images/digg-this.gif" alt="Digg This" style="padding:0"></a>';
			} else {
		...
		<div id="<?=$container?>">
			<p><em>This address was given in the mid 1990s.</em></p>
...
<p>To conclude I offer three messages.</p>
...
Joseph Flaherty is senior vice president of technology at CBS. In this position, he advises CBS management on issues and strategies related to broadcast technology, and represents CBS nationally and internationally with major manufacturers and on government and industry committees and organizations. Flaherty joined CBS in 1957, and has directed the Engineering and Development Department since 1967—first as general manager, then, since 1977, as vice president and general manager. During his career, he has received many prestigious broadcast industry awards, including several Emmys for technical achievement; the David Sarnoff Gold Medal for progress in television engineering; the NAB Engineering Award; the Progress Medal of the SMPTE; and the International Montreux Achievement Gold Medal. Flaherty also received France’s Chevalier de l’Ordre des Arts et des Lettres, and in 1985 was awarded France’s highest decoration, the Chevalier de l’Ordre National de la Legion d’Honneur, by French President François Mitterand. He is a Fellow of the British Institution of Electrical Engineers; the British Royal Television Society; and SMPTE. Flaherty holds a degree in physics and an honorary doctorate of science from Rockhurst College in Kansas City, Missouri.</p>
  ...
  <td id="left"><!-- Comments -->
	...
	?>
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/history/2005/06/from_the_father_of_hdtv_in_usa--dr_joseph_flaherty_cbs_-_1995.php" type="text/javascript" charset="utf-8"></script>
</div></body>
</html>
