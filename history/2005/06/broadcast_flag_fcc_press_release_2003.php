...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/history/2005/06/broadcast_flag_fcc_press_release_2003.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (5) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 121";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Broadcast Flag - FCC Press Release 2003" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Broadcast Flag - FCC Press Release 2003" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Broadcast Flag - FCC Press Release 2003" />
...
<html>
<head>
	<title>HDTV Magazine - Broadcast Flag - FCC Press Release 2003</title>
	<meta name="keywords" content="broadcast flag, content protection, protection recording, broadcast content, broadcast television, fcc, flag, broadcast, content, digital, technology, protection, equipment, programming, technologies, new, television, recording, dtv, interim, public, notice, issue, today, consumers" />
	...
	<meta name="title" content="Broadcast Flag - FCC Press Release 2003" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Broadcast Flag - FCC Press Release 2003" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/history/2005/06/broadcast_flag_fcc_press_release_2003.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="This is the original 2003 press release from the FCC about the Broadcast Flag. This issue is now before the courts awaiting new jurisdiction. FCC ADOPTS ANTI-PIRACY PROTECTION FOR DIGITAL TV Broadcast Flag Prevents Mass Internet Distribution; Consumer Copying Not..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=121', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/history/2005/06/broadcast_flag_fcc_press_release_2003.php">Broadcast Flag - FCC Press Release 2003</a></td>
						</tr><tr>
...
<p>-The FCC determined that additional public comment is needed in order to formulate a permanent open, objective process for the approval of digital recording and output content protection technologies that will foster innovation and marketplace competition.  The FCC initiated a Further Notice of Proposed Rulemaking to examine this issue in greater detail.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Dale Cripps</b>, <b>June 25, 2005 12:55 AM</b>
			...
			<? if (5 != 7) echo getBoxMoreFromAuthor('Dale Cripps', 121)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/history/2005/06/broadcast_flag_fcc_press_release_2003.php" type="text/javascript" charset="utf-8"></script>
