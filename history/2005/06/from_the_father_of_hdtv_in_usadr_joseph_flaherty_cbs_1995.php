...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/history/2005/06/from_the_father_of_hdtv_in_usadr_joseph_flaherty_cbs_1995.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (5) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 84";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download From the Father Of HDTV  In U.S.A.--Dr. Joseph Flaherty. CBS - 1995" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="From the Father Of HDTV  In U.S.A.--Dr. Joseph Flaherty. CBS - 1995" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="From the Father Of HDTV  In U.S.A.--Dr. Joseph Flaherty. CBS - 1995" />
...
<html>
<head>
	<title>HDTV Magazine - From the Father Of HDTV  In U.S.A.--Dr. Joseph Flaherty. CBS - 1995</title>
	<meta name="keywords" content="high definition, prime time, production program, program exchange, program production, high, definition, production, television, programs, program, hdtv, transmission, electronic, film, system, europe, worldwide, today, distribution, digital, time, standard, world, percent" />
...
" />
	<meta name="title" content="From the Father Of HDTV  In U.S.A.--Dr. Joseph Flaherty. CBS - 1995" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="From the Father Of HDTV  In U.S.A.--Dr. Joseph Flaherty. CBS - 1995" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/history/2005/06/from_the_father_of_hdtv_in_usadr_joseph_flaherty_cbs_1995.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="&quot;There is nothing more difficult to take in hand, more perilous to conduct or more uncertain of success, than to take the lead in the introduction of a new order of things, because the innovator has for enemies all those who have done well under the old conditions, and but lukewarm defenders in those who may do well under the new.&quot;
" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=84', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/history/2005/06/from_the_father_of_hdtv_in_usadr_joseph_flaherty_cbs_1995.php">From the Father Of HDTV  In U.S.A.--Dr. Joseph Flaherty. CBS - 1995</a></td>
						</tr><tr>
...
Joseph Flaherty is senior vice president of technology at CBS. In this position, he advises CBS management on issues and strategies related to broadcast technology, and represents CBS nationally and internationally with major manufacturers and on government and industry committees and organizations. Flaherty joined CBS in 1957, and has directed the Engineering and Development Department since 1967—first as general manager, then, since 1977, as vice president and general manager. During his career, he has received many prestigious broadcast industry awards, including several Emmys for technical achievement; the David Sarnoff Gold Medal for progress in television engineering; the NAB Engineering Award; the Progress Medal of the SMPTE; and the International Montreux Achievement Gold Medal. Flaherty also received France’s Chevalier de l’Ordre des Arts et des Lettres, and in 1985 was awarded France’s highest decoration, the Chevalier de l’Ordre National de la Legion d’Honneur, by French President François Mitterand. He is a Fellow of the British Institution of Electrical Engineers; the British Royal Television Society; and SMPTE. Flaherty holds a degree in physics and an honorary doctorate of science from Rockhurst College in Kansas City, Missouri.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Dale Cripps</b>, <b>June 16, 2005  1:48 PM</b>
			...
			<? if (5 != 7) echo getBoxMoreFromAuthor('Dale Cripps', 84)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/history/2005/06/from_the_father_of_hdtv_in_usadr_joseph_flaherty_cbs_1995.php" type="text/javascript" charset="utf-8"></script>
