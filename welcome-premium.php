...
<html>
<head>
	<title>HDTV Magazine - Welcome (Premium Membership)</title>
...
<body>
	...
	<p>
		...
		you provided (<?=str_replace('@', ' "at" ', $email_address)?>). In this email is a link which will confirm your email address and activate your account. You will not be able to
		 log in until your account is activated.
	</p><p>
		Your Premium Membership includes:<br>
		- The HDTV Magazine Daily (a daily update on the world of HDTV)<br>
		- 10% off everything in our HDTV Store<br />
		- Ability to turn off all banner advertising site-wide<br />
		...
		You may opt-out from these lists at any time through your <a href="<?=URL_PROFILE_SUBSCRIPTIONS?>">subscription profile</a>.
	</p><p>
		...
		We are confident that you will enjoy your Premium Membership, and are committed to your satisfaction. If you experience any problems or have any recommendations for improving our services,
		please use our convenient <a href="<?=URL_HELP_FEEDBACK?>">feedback form</a>.
	</p><p>
		Enjoy,
	</p><p>
