...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2011/07/typical-passive-3dtvs-displaying-and-perceiving-3d-images.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Typical Passive 3DTVs - Displaying and Perceiving 3D Images" />
...
Small Pixels make..." />
	...
	<meta property="og:title" content="Typical Passive 3DTVs - Displaying and Perceiving 3D Images" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2011/07/typical-passive-3dtvs-displaying-and-perceiving-3d-images.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="The first article of this series covered the current battle of 3DTV technology concepts between active and passive 3DTV manufacturers. The second article provided a brief introduction of how passive and active 3DTV differ in displaying video pixels to make 3D images. This article further expands the illustration of the passive 3DTV method. The next article will illustrate LG’s implementation of the passive 3DTV display method. 
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4452', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2011/07/typical-passive-3dtvs-displaying-and-perceiving-3d-images.php">Typical Passive 3DTVs - Displaying and Perceiving 3D Images</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Rodolfo La Maestra</b> on <b>July 29, 2011</b>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Rodolfo La Maestra', 4452)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2011/07/typical-passive-3dtvs-displaying-and-perceiving-3d-images.php" type="text/javascript" charset="utf-8"></script>
