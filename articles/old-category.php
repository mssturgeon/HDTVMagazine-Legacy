...
<html>
<head>
	<title>HDTV Magazine - <?=$category?> Articles</title>
	<link rel="alternate" type="application/rss+xml" title="RSS 2.0" href="http://feeds.hdtvmagazine.com/hdtv-articles" />
	<meta name="description" content="HDTV Magazine articles covering <?=$category?>." />
	<meta name="keywords" content="hdtv,hdtv articles,high definition,hd,article,articles,category,<?=$category?>" />
	...
	<table class="bare" cellpadding="0" cellspacing="0"><tr>
		<td id="left">
			<?
				...
				FROM mt_entry e, mt_author a, mt_placement p, aux_mt_entry aux, phpbb_topics t
				WHERE entry_author_id = author_id
					AND e.entry_id = p.placement_entry_id
					AND e.entry_id = aux.entry_id
					AND aux.topic_id = t.topic_id
					AND p.placement_category_id = $id
