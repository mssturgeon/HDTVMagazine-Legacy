...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$res_author = mQuery("SELECT title, channel, amazon_tracking_id, img, bio_short FROM aux_author au, mt_author a WHERE au.author_id = a.author_id AND a.author_name = 'Eddie Fritts'");
	$author = mysql_fetch_assoc($res_author);
	$author_title = ($author['title'] == '') ? '' : "{$author['title']}<br />";
	$author_headshot = ($author['img'] == '') ? '' : '<img src="'. BASE_IMG_HOST .'/images/portraits/'. $author['img'] .'" alt="Eddie Fritts" height="100" width="100"/>';
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Broadcast Spectrum Hearings - The View Of Broadcasting&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2005/05/broadcast-spectrum-hearings-the-view-of-broadcasting.php&amp;title=Broadcast Spectrum Hearings - The View Of Broadcasting">
		<span style="display:none">There is a hearing in Washington today with the House Telecommunications Subcommittee. It's about the DTV transition and cutting off the analog signals. Legislation is being crafted that seeks a specific date for shutting down analog services so the spectrum can be returned and reassigned by way of auctions to some presumably &quot;new&quot; highest bidder. As with any complex issue there is never an easy answer that fully satisfies all, but the one party that must be satisfied above all...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (1) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 35";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Broadcast Spectrum Hearings - The View Of Broadcasting" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Broadcast Spectrum Hearings - The View Of Broadcasting" />
...
<html>
<head>
	<title>HDTV Magazine - Broadcast Spectrum Hearings - The View Of Broadcasting</title>
	<meta name="keywords" content="cable carriage, television stations, air television, multi cast, good consumers, consumers, stations, cable, television, air, draft, dtv, sets, viewers, good, let, analog, must, transition, services, local, carriage, today, digital, broadcasters" />
	...
	<meta name="title" content="Broadcast Spectrum Hearings - The View Of Broadcasting" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2005/05/broadcast-spectrum-hearings-the-view-of-broadcasting.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=35', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2005/05/broadcast-spectrum-hearings-the-view-of-broadcasting.php">Broadcast Spectrum Hearings - The View Of Broadcasting</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Eddie Fritts</b> on <b>May 26, 2005</b>
...
<p><br />
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Eddie Fritts</b>, <b>May 26, 2005  8:49 AM</b>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Eddie Fritts', 35)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2005/05/broadcast-spectrum-hearings-the-view-of-broadcasting.php" type="text/javascript" charset="utf-8"></script>
