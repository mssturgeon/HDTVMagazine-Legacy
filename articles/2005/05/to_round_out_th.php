...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Cable\'s View On The Transition&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2005/05/cables-view-on-the-transition.php&amp;title=Cable's View On The Transition">
		<span style="display:none">To round out things at the Subcommittee On Telecommunications hearings today the cable industry weighed in saying they could provide the least pain to the public (some think that is a new policy for cable) and that Congress could accomplish the goal of hastening the transition with a date certain cut off by &quot;giving cable operators the flexibility to down-convert digital must carry signals to analog format at the headend and to carry some of those down-converted signals in lieu...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2005/05/cables-view-on-the-transition.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=38', 340, 125);">Add ASIN</a>
