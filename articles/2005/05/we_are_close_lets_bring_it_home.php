...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2005/05/we-are-close-lets-bring-it-home.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="We Are Close -- Let\'s Bring it Home" />
...
" />
	...
	<meta property="og:title" content="We Are Close -- Let's Bring it Home" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2005/05/we-are-close-lets-bring-it-home.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Even as CEA president Gary Shapiro was urging Congress to pass legislation for a &quot;certain&quot; cut off date for analog terrestrial broadcast services (thus ending broadcasting as we have known it) he offered high praise to CBS and their affiliates for their exemplary work in HDTV. His remarks were given at the annual CBS NAB Engineering breakfast where affiliate stations are brought up-to-speed on what CBS did during the last year and what the outlook is for the next. Shapiro's remarks, made in Las Vegas, are presented here unedited in order that you may understand and gain a greater sense of appreciation for the strong influences shaping this movement. _Dale Cripps
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=5', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
