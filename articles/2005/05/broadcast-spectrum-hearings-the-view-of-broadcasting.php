...
EOT;
	...
	$author_headshot = ($row_aux['img'] == '') ? '' : '<img src="'. BASE_IMG_HOST .'/images/portraits/'. $row_aux['img'] .'" alt="Eddie Fritts" height="100" width="100"/>';
...
/*
	...
	WHERE au.author_id = a.author_id AND a.author_name = 'Eddie Fritts'";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2005/05/broadcast-spectrum-hearings-the-view-of-broadcasting.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Broadcast Spectrum Hearings - The View Of Broadcasting" />
...
<head>
	...
	<meta property="og:title" content="Broadcast Spectrum Hearings - The View Of Broadcasting" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2005/05/broadcast-spectrum-hearings-the-view-of-broadcasting.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="There is a hearing in Washington today with the House Telecommunications Subcommittee. It's about the DTV transition and cutting off the analog signals. Legislation is being crafted that seeks a specific date for shutting down analog services so the spectrum can be returned and reassigned by way of auctions to some presumably &quot;new&quot; highest bidder. As with any complex issue there is never an easy answer that fully satisfies all, but the one party that must be satisfied above all..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=35', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
