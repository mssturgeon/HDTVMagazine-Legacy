...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=We Are Close -- Let\'s Bring it Home&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
EOT;
	...
	switch (1) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 5";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download We Are Close -- Let\'s Bring it Home" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="We Are Close -- Let\'s Bring it Home" />
...
<html>
<head>
	<title>HDTV Magazine - We Are Close -- Let's Bring it Home</title>
	<meta name="keywords" content="marty franks, hdtv programming, cut date, hdtv content, dtv academy, hdtv, cbs, dtv, years, today, been, analog, consumers, must, cea, transition, here, broadcast, success, date, programming, fact, content, academy, hard" />
...
Thank you for inviting me to speak to you all this morning. I am honored to be here today, celebrating HDTV with the network that has believed in HDTV and has backed HDTV where it counts  with HDTV content! And not just any HDTV content  compelling, original HDTV programming that has spurred more consumers to embrace this dazzling technology. The NCAA tournament, the Masters, Monday Night Football, the SuperBowlYou know the list and I join millions of sports fans in thanking you and the manufacturers who helped pay for it.
" />
	<meta name="title" content="We Are Close -- Let's Bring it Home" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2005/05/we-are-close-lets-bring-it-home.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=5', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2005/05/we-are-close-lets-bring-it-home.php">We Are Close -- Let's Bring it Home</a></td>
						</tr><tr>
...
<p>I congratulate CBS for its HDTV commitment, investment and hard work. You should be proud of your contributions to the overwhelming success of HDTV and the overall transition. But I encourage you, as leaders in this transition, to set the example for others in broadcasting, by embracing my prescriptions for the swift completion of analog. We are this close  lets bring it home!</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Dale Cripps</b>, <b>May 12, 2005 11:07 AM</b>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Dale Cripps', 5)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2005/05/we-are-close-lets-bring-it-home.php" type="text/javascript" charset="utf-8"></script>
