...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Ed\'s View - The (H)DTV Transition&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2005/07/eds-view-the-hdtv-transition.php&amp;title=Ed's View - The (H)DTV Transition">
		<span style="display:none">Talk about herding cats!  That's an apt analogy to the task the FCC has, and continues having, in an attempt to reconcile the positions of all the various entities with a vested interest in the DTV transition - and its star, HDTV.  These DTV &quot;stakeholders&quot; are, indeed, just like a bunch of cats - hissing, growling and pawing at each other. But this is understandable, for a lot is at stake as the most fundamental change in the history of US broadcasting takes place. So, let's take a look at the salient issues surrounding these stakeholders to get a better understanding of the various positions and their impact on the growth of HDTV.  </span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2005/07/eds-view-the-hdtv-transition.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=170', 340, 125);">Add ASIN</a>
