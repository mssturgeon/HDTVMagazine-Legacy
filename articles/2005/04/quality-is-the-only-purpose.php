...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2005/04/quality-is-the-only-purpose.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Quality Is The Only Purpose" />
...
" />
	...
	<meta property="og:title" content="Quality Is The Only Purpose" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2005/04/quality-is-the-only-purpose.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Quality is the infectious and addictive thing which digital brings to terrestrial broadcasting and all television services that engage HDTV. Low quality digital has already brought us multiple low-quality channels (by way of cable and DBS) to all but a few. This opportunity with HDTV is one time in our nation's history when high-quality can be accepted and delivered to the masses. Never before has a studio creation been so completely deliverable to the home as it is today. A new standard of living, many believe (and me among them) is being given birth through HDTV.
" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=10', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
