...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2005/10/2005-hdtv-report-part-6-crt-lcos-dila-sxrd-sed-and-lcd.php&amp;title=2005 HDTV Report, Part 6: CRT, LCoS, D-ILA, SXRD, SED, and LCD">
		<span style="display:none">This part 6 details display monitors and integrated TVs using the technologies of CRT, Liquid Crystal On Silicon (LCoS), JVC's D-ILA, Sony's SXRD, Toshiba/Canon SED, and LCD projection displays. All Direct-view, Rear Projection (RPTV), and Front Projection (FPTV) technologies are included.

The parts covering DLP (FPTV and RPTV), LCD-TV panels, and PDP Plasma panel displays will be released shortly.

Please keep in mind that the MSRP and TTM (time to market) information was supplied as of 1Q05 for the CES 2005 report and, as is usual with CE, the prices and availability change upon product release, as well as street sale prices usually differ from the MSRP data used throughout the report.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
Please keep in mind that the MSRP and TTM (time to market) information was supplied as of 1Q05 for the CES 2005 report and, as is usual with CE, the prices and availability change upon product release, as well as street sale prices usually differ from the MSRP data used throughout the report." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2005/10/2005-hdtv-report-part-6-crt-lcos-dila-sxrd-sed-and-lcd.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=236', 340, 125);">Add ASIN</a>
