...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=2005 HDTV Report, Part 16: Non-Display Equipment with HDMI/DVI/IEEE 1394&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2005/10/2005-hdtv-report-part-16-nondisplay-equipment-with-hdmidviieee-1394.php&amp;title=2005 HDTV Report, Part 16: Non-Display Equipment with HDMI/DVI/IEEE 1394">
		<span style="display:none">This year a larger number of units implementing DVI and HDMI were released, in addition to the monitors and integrated TVs mentioned on the previous sections.
...
The data included below is an example of some of the new units, not a complete list...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (1) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 230";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download 2005 HDTV Report, Part 16: Non-Display Equipment with HDMI/DVI/IEEE 1394" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="2005 HDTV Report, Part 16: Non-Display Equipment with HDMI/DVI/IEEE 1394" />
...
<html>
<head>
	<title>HDTV Magazine - 2005 HDTV Report, Part 16: Non-Display Equipment with HDMI/DVI/IEEE 1394</title>
	<meta name="keywords" content="dvd audio, dvd player, hdmi dvi, hdmi output, hdmi inputs, hdmi, dvd, dvi, audio, receiver, video, output, input, ces, inputs, ttm, player, ieee, denon, upconversion, universal, sep, watts, channels, component" />
	<meta name="description" content="This year a larger number of units implementing DVI and HDMI were released, in addition to the monitors and integrated TVs mentioned on the previous sections.

Although the implementation of HDMI inputs/outputs was also seen in more receivers, it is still mainly reserved for top-of-the-line receivers, which usually are on the $4000-$6000 range.    
   
The data included below is an example of some of the new units, not a complete list..." />
	<meta name="title" content="2005 HDTV Report, Part 16: Non-Display Equipment with HDMI/DVI/IEEE 1394" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2005/10/2005-hdtv-report-part-16-nondisplay-equipment-with-hdmidviieee-1394.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=230', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2005/10/2005-hdtv-report-part-16-nondisplay-equipment-with-hdmidviieee-1394.php">2005 HDTV Report, Part 16: Non-Display Equipment with HDMI/DVI/IEEE 1394</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Rodolfo La Maestra</b> on <b>October 25, 2005</b>
...
<p>Be sure that you read the next article in the series: Digital Connectivity (Coming Soon)</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Rodolfo La Maestra</b>, <b>October 25, 2005  5:35 AM</b>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Rodolfo La Maestra', 230)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2005/10/2005-hdtv-report-part-16-nondisplay-equipment-with-hdmidviieee-1394.php" type="text/javascript" charset="utf-8"></script>
