...
Companies like..." />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2012/06/does-your-lcd-image-look-the-same-from-an-angled-view-part-3-how-the-3m-solution-applies-to-your-lcd.php" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4831', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2012/06/does-your-lcd-image-look-the-same-from-an-angled-view-part-3-how-the-3m-solution-applies-to-your-lcd.php">Does Your LCD Image Look the Same from an Angled View? (Part 3) - How the 3M Solution Applies to Your LCD</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Rodolfo La Maestra</b> on <b>June 11, 2012</b>
			...
			<div id="<?=$container?>" class="<?=$viglink_suppress?>">
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Rodolfo La Maestra</b>, <b>June 11, 2012  7:55 AM</b>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Rodolfo La Maestra', 4831)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2012/06/does-your-lcd-image-look-the-same-from-an-angled-view-part-3-how-the-3m-solution-applies-to-your-lcd.php" type="text/javascript" charset="utf-8"></script>
