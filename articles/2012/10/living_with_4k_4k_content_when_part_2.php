...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 4925 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2012/10/living-with-4k-4k-content-when-part-2.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (1) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 4925";
...
<head>
	...
	<meta name="keywords" content="blu ray, sony projector, recorded media, video processing, part living, content, resolution, part, image, sony, video, original, hdtv, ultra, living, display, blu, ray, displays, should, projector, quality, pixels, both, even" />
...
Not having 4K content available now does not render a 4K display useless, the same as HDTVs without much content in 1998/9 were questioned, with just a few HD loops and no Blu-ray until 8 years later." />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2012/10/living-with-4k-4k-content-when-part-2.php" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4925', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2012/10/living-with-4k-4k-content-when-part-2.php">Living with 4K: 4K Content, when? (Part 2)</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Rodolfo La Maestra</b> on <b>October 30, 2012</b>
	...
	This is one of a series of articles. If you are interested in other articles in this series, they are as follows:<br><ul>
		...
		<li><a href="/articles/2012/12/living-with-4k-part-6-which-4k-sony-dci-4k-and-ultrahd-capable.php" target="_blank">Living with 4K (Part 6) - Which 4K? Sony - DCI 4K and Ultra-HD Capable</a></li>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Rodolfo La Maestra', 4925)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2012/10/living-with-4k-4k-content-when-part-2.php" type="text/javascript" charset="utf-8"></script>
