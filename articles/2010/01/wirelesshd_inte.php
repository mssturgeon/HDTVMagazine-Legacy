...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=WirelessHD - Integrating Wireless HDMI For Displays&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2010/01/wirelesshd-integrating-wireless-hdmi-for-displays.php&amp;title=WirelessHD - Integrating Wireless HDMI For Displays">
		<span style="display:none">A wireless solution to get rid of the audio and video cables for a display has been a focal point for many years now. While many wireless adapters have come to market the Achilles Heal has always been that none of these solutions could fully duplicate the capability (and more importantly the performance) of a wired HDMI connection. At CES 2008 the WirelessHD group announced they were developing a new wireless standard and technology that could!

At CES 2009 there were...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
At CES 2009 there were..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2010/01/wirelesshd-integrating-wireless-hdmi-for-displays.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3507', 340, 125);">Add ASIN</a>
