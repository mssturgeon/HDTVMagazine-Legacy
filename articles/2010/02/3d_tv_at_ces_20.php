...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2010/02/3d-tv-at-ces-2010-was-it-actually-like-hd-a-decade-ago-part-4.php&amp;title=3D TV at CES 2010 - Was it Actually Like HD a Decade Ago? (Part 4)">
		<span style="display:none">My previous articles in this series have mentioned a few factors by which the 3D implementation effort is different from HD a decade ago, rather than similar, as some industry experts have expressed. 

In this fourth installment, I analyze how consumers could embrace the 3D effort, and I provide some ideas to help them evaluate the adoption of 3D for their particular application: Either as a replacement of HDTV, or as a value added feature for 3D content, whether it is sourced from satellite, cable, or Blu-ray.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
In this fourth installment, I analyze how consumers could embrace the 3D effort, and I provide some ideas to help them evaluate the adoption of 3D for their particular application: Either as a replacement of HDTV, or as a value added feature for 3D content, whether it is sourced from satellite, cable, or Blu-ray." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2010/02/3d-tv-at-ces-2010-was-it-actually-like-hd-a-decade-ago-part-4.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3565', 340, 125);">Add ASIN</a>
