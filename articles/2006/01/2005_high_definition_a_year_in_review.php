...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2006/01/2005-high-definition-a-year-in-review.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="2005 High Definition: A Year in Review" />
...
<head>
	...
	<meta property="og:title" content="2005 High Definition: A Year in Review" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2006/01/2005-high-definition-a-year-in-review.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="In this article, the first in a three-part series, Tom Fletcher gives us a comprehensive overview of &quot;HDTV in 2005&quot;. It places on the calendar those events which have left an historical echo in our national transition to superior television. Highlighting this progressive report on the health of HDTV are new HD channel launches, increased HD movie production, 1080p TV's, new HD cameras (both consumer and professional), and the arrival of HD console gaming (Xbox). The year-end numbers for Digital Cinema and HDTV penetration are sure to impress those who still think that HDTV is slow to catch on. A must-read for those with a careful eye on the HDTV phenomena." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=307', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
