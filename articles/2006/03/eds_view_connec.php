...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Ed\'s View  -  Connections&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2006/03/eds-view-connections.php&amp;title=Ed's View  -  Connections">
		<span style="display:none">I continue to be amazed at the growing number of input jacks one finds on the back (and front) of today's HDTV sets.  This all started in the mid 1980's with the advent of the first audio/video components such as VCR's and early videodisc players.  These devices gave rise to the &quot;monitor/receiver&quot; with one or two sets of composite (Right, Left, Video) RCA jacks.  With the introduction of S-Video, another jack was added along with audio output jacks for the rising audio receiver market.  The final addition to the analog complement was the &quot;component&quot; inputs (Y, Pr, Pb or YUV).  This interface allowed the coupling of the wider bandwidth video information</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2006/03/eds-view-connections.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=347', 340, 125);">Add ASIN</a>
