...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2006/02/analysis-of-dtv-content-protection-rulings-and-agreements.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Analysis of DTV Content Protection Rulings and Agreements" />
...
This subject has been covered by the press and other magazines over time in bits and pieces.  In order to provide you with a complete perspective, I have prepared this simplified analysis of the approved FCC rulings, the areas not ruled on yet, and how their integration could affect you as an HDTV adopter." />
	...
	<meta property="og:title" content="Analysis of DTV Content Protection Rulings and Agreements" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2006/02/analysis-of-dtv-content-protection-rulings-and-agreements.php" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=293', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
