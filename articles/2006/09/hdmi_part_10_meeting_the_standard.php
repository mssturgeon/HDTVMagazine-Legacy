...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2006/09/hdmi-part-10-meeting-the-standard.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDMI Part 10 - Meeting the Standard" />
...
As you might be aware by now, some people are having problems with the way HDMI has been implemented by some manufacturers. The problems are sometimes related to HDCP, sometimes related to limitations in the audio channels (we covered that), sometimes in the HDMI repeating ability of certain pieces of equipment, some related to the new Toshiba HD DVD player, some people with 1080p equipment using the wrong cable (and not necessarily that means a cheap cable), some due to the construction of the cable (and that could be a number of things), some plugs disconnect themselves from the back panels, some cable set-top-boxes not activating the HDMI outputs, etc." />
	...
	<meta property="og:title" content="HDMI Part 10 - Meeting the Standard" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2006/09/hdmi-part-10-meeting-the-standard.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Over the last couple of years, Silicon Image is being doing efforts to help manufacturers test and deliver HDMI compliant equipment so consumers would experience the minimum of connectivity and compatibility problems.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=424', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
