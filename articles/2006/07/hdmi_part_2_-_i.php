...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDMI Part 2 - "I Want My Version X.Z"&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
EOT;
	...
	switch (1) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 407";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDMI Part 2 - "I Want My Version X.Z"" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDMI Part 2 - "I Want My Version X.Z"" />
...
<html>
<head>
	<title>HDTV Magazine - HDMI Part 2 - "I Want My Version X.Z"</title>
	<meta name="keywords" content="bits per, per component, silicon image, bit bit, hdmi licensing, hdmi, bits, bit, per, component, digital, support, versions, ycbcr, version, part, image, need, pixels, silicon, subject, means, control, why, video" />
...
I anticipate that some of our readers would be interested in my notes and analysis from those exchanges. The material is complex and is long; as I mentioned in Part 1, I am covering the subject in 10 parts. The material is the product of many exchanges between Paul Wolf (Chief of Engineering HDMI Licensing, LLC), Joseph Lee (Director of Marketing for Simplay Labs, LLC), Leslie Chard (President, HDMI Licensing LLC), and me; it was intended to cover all the angles, and was summarized here to single statements to facilitate reading. In other words, is a teamwork brainstorming of a variety of technical issues, an exclusive of HDTV Magazine. Enjoy the ride." />
	<meta name="title" content="HDMI Part 2 - &quot;I Want My Version X.Z&quot;" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2006/07/hdmi-part-2-i-want-my-version-xz.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=407', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2006/07/hdmi-part-2-i-want-my-version-xz.php">HDMI Part 2 - "I Want My Version X.Z"</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Rodolfo La Maestra</b> on <b>July 28, 2006</b>
...
<br clear="all"></p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Rodolfo La Maestra</b>, <b>July 28, 2006 10:57 AM</b>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Rodolfo La Maestra', 407)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2006/07/hdmi-part-2-i-want-my-version-xz.php" type="text/javascript" charset="utf-8"></script>
