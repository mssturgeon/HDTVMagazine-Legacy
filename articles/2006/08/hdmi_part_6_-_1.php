...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDMI Part 6 - 1080p Support&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2006/08/hdmi-part-6-1080p-support.php&amp;title=HDMI Part 6 - 1080p Support">
		<span style="display:none">Although the 1080p capability exists since version 1.0, 1080p is not mandatory in the HDMI spec, in any of the versions.

It would be difficult for Silicon Image to require TV makers (especially those with non-SiI chips) to indicate the chip's 1080p feature to end-users. It is not too different from how consumers know whether their component analog input can handle 1080i, 720p, or 480p. It was not too long ago that 100% of component inputs handle 480i only. Then shortly after that there was 480i and 480p, etc.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
It would be difficult for Silicon Image to require TV makers (especially those with non-SiI chips) to indicate the chip's 1080p feature to end-users. It is not too different from how consumers know whether their component analog input can handle 1080i, 720p, or 480p. It was not too long ago that 100% of component inputs handle 480i only. Then shortly after that there was 480i and 480p, etc." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2006/08/hdmi-part-6-1080p-support.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=416', 340, 125);">Add ASIN</a>
