...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 539 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=TV Guide On Screen&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2007/02/tv-guide-on-screen.php&amp;title=TV Guide On Screen">
		<span style="display:none">TV Guide has become the new industry standard for providing the mass market with a universal guide system. It operates anywhere in the US using your local over the air broadcast stations, which are also carried on your cable system. QAM digital cable tuners are typically part and parcel of a product supporting TV Guide, often times including a cable card option. This review will help you navigate the potential problems that may arise in setting up this feature for your HDTV.

When you first install the TV, or other product with this feature, you will be prompted to setup the system by answering...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (1) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 539";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download TV Guide On Screen" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="TV Guide On Screen" />
...
<html>
<head>
	<title>HDTV Magazine - TV Guide On Screen</title>
	<meta name="keywords" content="guide data, cable system, cable card, turn product, next time, guide, cable, data, product, system, channel, time, updates, turn, sony, panasonic, record, channels, problems, setup, new, moxi, first, may, problem" />
	<meta name="description" content="TV Guide has become the new industry standard for providing the mass market with a universal guide system. It operates anywhere in the US using your local over the air broadcast stations, which are also carried on your cable system. QAM digital cable tuners are typically part and parcel of a product supporting TV Guide, often times including a cable card option. This review will help you navigate the potential problems that may arise in setting up this feature for your HDTV.

When you first install the TV, or other product with this feature, you will be prompted to setup the system by answering..." />
	<meta name="title" content="TV Guide On Screen" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2007/02/tv-guide-on-screen.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=539', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2007/02/tv-guide-on-screen.php">TV Guide On Screen</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Richard Fisher</b> on <b>February 12, 2007</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=288&category=Broadcast">Broadcast</a></b>, <b><a href="/category.php?id=361&category=Cable HDTV">Cable HDTV</a></b>, <b><a href="/category.php?id=328&category=Digital (DTV) Transition">Digital (DTV) Transition</a></b>
							</td>
						</tr><tr colspan="2">
...
If you are having intermittent or wacky TV Guide problems this is something to keep in mind. First and foremost I can only be very fuzzy on this issue. I have not received nor required the first one. On the other hand while there is quite a bit of standardization for manufacturers implementing the TV Guide feature for their product it is also obvious that there is some leeway for self expression and interfacing specific aspects of the service to the user and the unique design of a product. Manual recording, setting up a TV Guide recording, list of recordings and finding a program to record functions of the Panasonic and Sony are uniquely different in presentation and function. With that said, if all else fails, contact the manufacturer or your local authorized service center to find out if there is a firmware upgrade.<br />
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Richard Fisher', 539)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2007/02/tv-guide-on-screen.php" type="text/javascript" charset="utf-8"></script>
