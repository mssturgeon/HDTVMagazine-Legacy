...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2007/06/cinemascope-hdht-part-3-screens-and-aspect-ratios.php&amp;title=CinemaScope&amp;trade; HDHT - Part 3 - Screens and Aspect Ratios">
		<span style="display:none">If your HDTV has a fixed frame, such as an LCD/plasma panel or a rear-projection TV, and you want to see the CinemaScope&amp;trade; image at its intended aspect ratio, there is not much that can be done about the bars at the top and bottom of the screen. As a result, the bars use part of the valuable vertical resolution of the 16:9 TV or the projector's chip. To make things worse some technologies, such as LCD projection, show the black bars as dark gray, distracting the viewing of the actual image.

The HD chip of a front projector is fixed to the resolution of its design (720px1280 or 1080px1920 pixels). Many projectors today are chip-based DLP, LCD, and LCoS technologies at 720p resolution. More recently, several affordable 1080p projectors were introduced to the market.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
The HD chip of a front projector is fixed to the resolution of its design (720px1280 or 1080px1920 pixels). Many projectors today are chip-based DLP, LCD, and LCoS technologies at 720p resolution. More recently, several affordable 1080p projectors were introduced to the market." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2007/06/cinemascope-hdht-part-3-screens-and-aspect-ratios.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=620', 340, 125);">Add ASIN</a>
