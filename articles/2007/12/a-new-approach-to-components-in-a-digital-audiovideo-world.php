...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2007/12/a-new-approach-to-components-in-a-digital-audiovideo-world.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="A New Approach to Components in a Digital Audio/Video World" />
...
Fast forwarding a bit (through LPs, Audio Cassette Tapes, 8 Track Players, Cable TV, VCRs, PCs, CDs, Satellite TV, DVDs, SACDs, DVD-As and similar) we arrive at the present..." />
	...
	<meta property="og:title" content="A New Approach to Components in a Digital Audio/Video World" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2007/12/a-new-approach-to-components-in-a-digital-audiovideo-world.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Remember when Home Entertainment life was much simpler? All you did was to sit back and turn on the TV to watch programs. Or, if you remember TV before the days of remotes you turned on the TV and then sat back unless you had a young son who was your human remote. Carrying this one step further back (as this writer remembers) there was actually a time when you only listened to programs for your nightly entertainment. Fibber McGee and Molly anyone? In any event, in the 1950's to somewhere in the 1980's &quot;Home Theater in a Box&quot; was just that for most people - the family television.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=814', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
