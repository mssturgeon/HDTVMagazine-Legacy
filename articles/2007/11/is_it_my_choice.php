...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Is It My Choice, or Is It Yours?&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
Well, since they insist that it is my job as the consumer I best get on with it decisively. The good news is that to me it makes very little difference which format is selected. Either has its own cost of entry to me and each has an advantage here or there. And, they are both getting cheaper. When I (the consumer) make a decision the big commodity makers will produce it at a fraction of what either sells for now. So, I cannot find &quot;cost&quot; as a reason to choose one over the other. Nor can I find...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
Well, since they insist that it is my job as the consumer I best get on with it decisively. The good news is that to me it makes very little difference which format is selected. Either has its own cost of entry to me and each has an advantage here or there. And, they are both getting cheaper. When I (the consumer) make a decision the big commodity makers will produce it at a fraction of what either sells for now. So, I cannot find &quot;cost&quot; as a reason to choose one over the other. Nor can I find..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2007/11/is-it-my-choice-or-is-it-yours.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=776', 340, 125);">Add ASIN</a>
