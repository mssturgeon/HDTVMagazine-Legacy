...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2007/09/mobile-dtv-reception-advancedvestigial-sideband-avsb-impact-analysis.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (1) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 686";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - Impact Analysis" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - Impact Analysis" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - Impact Analysis" />
...
<html>
<head>
	<title>HDTV Magazine - Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - Impact Analysis</title>
	<meta name="keywords" content="dtv reception, advanced vestigial, vestigial side, side band, mobile dtv, quality, channel, mobile, dtv, vsb, hdtv, channels, atsc, system, consumers, services, several, image, already, bandwidth, broadcast, implementation, reception, advanced, side" />
...
Many broadcasting stations are already using part of the HDTV 6 MHz channel (19.4 Mbps) to transmit several simultaneous multi-cast SD channels, and those are already degrading considerably the quality of the once alone HD channel, reducing its available bandwidth to close to half of the 19.4 Mbps, a bandwidth it requires to show acceptable quality." />
	<meta name="title" content="Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - Impact Analysis" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - Impact Analysis" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2007/09/mobile-dtv-reception-advancedvestigial-sideband-avsb-impact-analysis.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="As I mentioned in my previous articles I am concerned with the bandwidth required for the A-VSB mobile transmission taken from the 8-VSB transmitted channel of DTV terrestrial television, an issue that I particularly consider a risky opportunity to further degrade the quality of full HDTV channels.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=686', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2007/09/mobile-dtv-reception-advancedvestigial-sideband-avsb-impact-analysis.php">Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - Impact Analysis</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Rodolfo La Maestra</b> on <b>September  6, 2007</b>
...
<p>This concludes this series of articles regarding A-VSB as a DTV Mobile Broadcasting solution.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Rodolfo La Maestra</b>, <b>September  6, 2007  5:48 AM</b>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Rodolfo La Maestra', 686)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2007/09/mobile-dtv-reception-advancedvestigial-sideband-avsb-impact-analysis.php" type="text/javascript" charset="utf-8"></script>
