...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2007/09/mobile-dtv-reception-advancedvestigial-sideband-avsb-the-implementation.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - The Implementation" />
...
In April 2007, I privately discussed with Mr. John Godfrey, VP of government and public affairs for Samsung Information Systems America, to confirm some of the technical aspects of AVSB." />
	...
	<meta property="og:title" content="Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - The Implementation" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2007/09/mobile-dtv-reception-advancedvestigial-sideband-avsb-the-implementation.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="In the first two articles, I covered the details of how this mobile DTV system works, the requirements, and some potential effects on HDTV channels if not used with quality of terrestrial broadcast in mind.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=685', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
