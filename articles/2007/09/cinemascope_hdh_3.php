...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2007/09/cinemascope-hdht-part-4-budgeting-for-the-project.php&amp;title=CinemaScope&amp;trade; HDHT Part 4 - Budgeting for the Project">
		<span style="display:none">Some people budget for the sky is the limit (or should I say they do not need to budget) when implementing solutions from professional projection systems, like Barco, Sony 4K, etc. Some professional projection systems used for local theaters are in the $100K to $250K range for just the projector.
...
Just to put some numbers together, the video part of a CinemaScope&amp;trade; project could require...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
Just to put some numbers together, the video part of a CinemaScope&amp;trade; project could require..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2007/09/cinemascope-hdht-part-4-budgeting-for-the-project.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=710', 340, 125);">Add ASIN</a>
