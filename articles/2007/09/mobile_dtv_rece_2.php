...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2007/09/mobile-dtv-reception-advancedvestigial-sideband-avsb-the-implementation.php&amp;title=Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - The Implementation">
		<span style="display:none">In the first two articles, I covered the details of how this mobile DTV system works, the requirements, and some potential effects on HDTV channels if not used with quality of terrestrial broadcast in mind.

In April 2007, I privately discussed with Mr. John Godfrey, VP of government and public affairs for Samsung Information Systems America, to confirm some of the technical aspects of AVSB.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (1) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 685";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - The Implementation" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - The Implementation" />
...
<html>
<head>
	<title>HDTV Magazine - Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - The Implementation</title>
	<meta name="keywords" content="mobile dtv, dtv reception, vestigial side, reception advanced, advanced vestigial, system, mobile, bandwidth, using, reception, dtv, turbo, avsb, channel, programming, mhz, same, channels, srs, quality, samsung, could, stations, station, vsb" />
...
In April 2007, I privately discussed with Mr. John Godfrey, VP of government and public affairs for Samsung Information Systems America, to confirm some of the technical aspects of AVSB." />
	<meta name="title" content="Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - The Implementation" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2007/09/mobile-dtv-reception-advancedvestigial-sideband-avsb-the-implementation.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=685', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2007/09/mobile-dtv-reception-advancedvestigial-sideband-avsb-the-implementation.php">Mobile DTV Reception - Advanced-Vestigial Side-Band (A-VSB) - The Implementation</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Rodolfo La Maestra</b> on <b>September  3, 2007</b>
...
<p>Stay tuned for the final article in this series, which outlines the impact analysis of overusing AVSB.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Rodolfo La Maestra</b>, <b>September  3, 2007  5:47 AM</b>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Rodolfo La Maestra', 685)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2007/09/mobile-dtv-reception-advancedvestigial-sideband-avsb-the-implementation.php" type="text/javascript" charset="utf-8"></script>
