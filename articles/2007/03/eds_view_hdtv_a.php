...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Ed\'s View - HDTV All the Time - The Amazing UMP&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2007/03/eds-view-hdtv-all-the-time-the-amazing-ump.php&amp;title=Ed's View - HDTV All the Time - The Amazing UMP">
		<span style="display:none">Imagine virtually any digital video source -regardless of its original resolution- being rendered in full 1920x1080 HDTV.  Of course, most any modern display up-converter/scaling system will render images in a 1920x1080 format, but not at full HDTV resolution.  Enter an incredible development shortly to be revealed - one that is truly exemplary of disruptive technology - the Ultimate Media Player or UMP, the working name and acronym for this amazing innovation.

An interesting consortium of three companies, spearheaded by a large Japanese based electronics powerhouse, developed the UMP. (I am unable to confirm the name of this &quot;prime contractor,&quot; but you can guess.)  The key to the operation of the UMP is...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (1) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 564";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Ed\'s View - HDTV All the Time - The Amazing UMP" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Ed\'s View - HDTV All the Time - The Amazing UMP" />
...
<html>
<head>
	<title>HDTV Magazine - Ed's View - HDTV All the Time - The Amazing UMP</title>
	<meta name="keywords" content="amazing ump, codec used, architecture contains, ump project, display system, ump, data, chip, system, software, any, accuracy, development, project, design, audio, time, network, video, well, however, amazing, process, capability, physical" />
...
An interesting consortium of three companies, spearheaded by a large Japanese based electronics powerhouse, developed the UMP. (I am unable to confirm the name of this &quot;prime contractor,&quot; but you can guess.)  The key to the operation of the UMP is..." />
	<meta name="title" content="Ed's View - HDTV All the Time - The Amazing UMP" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2007/03/eds-view-hdtv-all-the-time-the-amazing-ump.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=564', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2007/03/eds-view-hdtv-all-the-time-the-amazing-ump.php">Ed's View - HDTV All the Time - The Amazing UMP</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Ed Milbourn</b> on <b>March 21, 2007</b>
...
April 1, 2007</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Ed Milbourn</b>, <b>March 21, 2007 11:02 AM</b>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Ed Milbourn', 564)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2007/03/eds-view-hdtv-all-the-time-the-amazing-ump.php" type="text/javascript" charset="utf-8"></script>
