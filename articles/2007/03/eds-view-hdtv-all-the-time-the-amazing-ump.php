...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2007/03/eds-view-hdtv-all-the-time-the-amazing-ump.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Ed\'s View - HDTV All the Time - The Amazing UMP" />
...
An interesting consortium of three companies, spearheaded by a large Japanese based electronics powerhouse, developed the UMP. (I am unable to confirm the name of this &quot;prime contractor,&quot; but you can guess.)  The key to the operation of the UMP is..." />
	...
	<meta property="og:title" content="Ed's View - HDTV All the Time - The Amazing UMP" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2007/03/eds-view-hdtv-all-the-time-the-amazing-ump.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Imagine virtually any digital video source -regardless of its original resolution- being rendered in full 1920x1080 HDTV.  Of course, most any modern display up-converter/scaling system will render images in a 1920x1080 format, but not at full HDTV resolution.  Enter an incredible development shortly to be revealed - one that is truly exemplary of disruptive technology - the Ultimate Media Player or UMP, the working name and acronym for this amazing innovation.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=564', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
