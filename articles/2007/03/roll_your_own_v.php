...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Roll Your Own Video Server - Mac Mini-style&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2007/03/roll-your-own-video-server-mac-ministyle.php&amp;title=Roll Your Own Video Server - Mac Mini-style">
		<span style="display:none">When I bought my Mac Mini last year it was done so with the sole purpose to turn it into an HTPC. But after spending a year with it, the Mini has become so much more. We primarily use the Mini as our video server. We also have an ATSC tuner (El Gato EyeTV) connected to it so it is used as a back up DVR on those rare occasions that we have to record three programs at the same time. With a little networking know-how and a couple of applications the Mini becomes quite a powerful video server.

First lets talk about the hardware...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (1) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 560";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Roll Your Own Video Server - Mac Mini-style" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Roll Your Own Video Server - Mac Mini-style" />
...
<html>
<head>
	<title>HDTV Magazine - Roll Your Own Video Server - Mac Mini-style</title>
	<meta name="keywords" content="video server, hard drive, mac mini, backup main, screen mode, dvd, mini, video, application, server, network, drive, backup, mac, remote, hard, want, need, movie, dvdpedia, frontrow, add, applications, even, player" />
...
First lets talk about the hardware..." />
	<meta name="title" content="Roll Your Own Video Server - Mac Mini-style" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2007/03/roll-your-own-video-server-mac-ministyle.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=560', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2007/03/roll-your-own-video-server-mac-ministyle.php">Roll Your Own Video Server - Mac Mini-style</a></td>
						</tr><tr>
...
<p>You also have the benefit of using the Mini for web browsing, email, and other computer related functions.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>March  9, 2007 10:00 AM</b>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('The HT Guys', 560)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2007/03/roll-your-own-video-server-mac-ministyle.php" type="text/javascript" charset="utf-8"></script>
