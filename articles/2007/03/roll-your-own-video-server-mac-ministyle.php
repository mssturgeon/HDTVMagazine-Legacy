...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2007/03/roll-your-own-video-server-mac-ministyle.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Roll Your Own Video Server - Mac Mini-style" />
...
First lets talk about the hardware..." />
	...
	<meta property="og:title" content="Roll Your Own Video Server - Mac Mini-style" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2007/03/roll-your-own-video-server-mac-ministyle.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="When I bought my Mac Mini last year it was done so with the sole purpose to turn it into an HTPC. But after spending a year with it, the Mini has become so much more. We primarily use the Mini as our video server. We also have an ATSC tuner (El Gato EyeTV) connected to it so it is used as a back up DVR on those rare occasions that we have to record three programs at the same time. With a little networking know-how and a couple of applications the Mini becomes quite a powerful video server.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=560', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
