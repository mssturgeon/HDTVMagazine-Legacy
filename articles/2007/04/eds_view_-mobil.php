...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2007/04/eds-view-mobile-digital-television-mdt-this-is-a-winner.php&amp;title=Ed's View - Mobile Digital Television (MDT) This is a Winner">
		<span style="display:none">&lt;p class=&quot;editorial&quot;&gt; Strictly speaking what you are about to read is not focused upon HDTV. Most of the communications systems forming around the world, however, are major benefactors from the technical development of HDTV. As with NASA's spin offs the strengths found in HDTV solutions are becoming cornerstones for other services. In this article by DTV pioneer and designer Ed Milbourn we see such developments supporting the enjoyment factor of still another of our national pass times--motoring about the countryside. The kid in us is going to love this marriage between car and cartoon. _Dale Cripps
&lt;/p&gt;


It's not HDTV - yet.  But this application of digital television is truly a seminal event in expanding the amazing benefits of DTV technology.  To punctuate that thought is the recent announcement by Sirius Satellite Radio that it will start providing</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (1) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 576";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Ed\'s View - Mobile Digital Television (MDT) This is a Winner" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Ed\'s View - Mobile Digital Television (MDT) This is a Winner" />
...
<html>
<head>
	<title>HDTV Magazine - Ed's View - Mobile Digital Television (MDT) This is a Winner</title>
	<meta name="keywords" content="high quality, mdt service, video data, video qos, modulation scheme, video, sirius, service, mdt, chrysler, data, content, television, audio, however, qos, mobile, hdtv, most, high, system, channels, applications, family, dodge" />
...
It's not HDTV - yet.  But this application of digital television is truly a seminal event in expanding the amazing benefits of DTV technology.  To punctuate that thought is the recent announcement by Sirius Satellite Radio that it will start providing" />
	<meta name="title" content="Ed's View - Mobile Digital Television (MDT) This is a Winner" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2007/04/eds-view-mobile-digital-television-mdt-this-is-a-winner.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=576', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2007/04/eds-view-mobile-digital-television-mdt-this-is-a-winner.php">Ed's View - Mobile Digital Television (MDT) This is a Winner</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Ed Milbourn</b> on <b>April 12, 2007</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=328&category=Digital (DTV) Transition">Digital (DTV) Transition</a></b>, <b><a href="/category.php?id=331&category=Digital Rights Management (DRM)">Digital Rights Management (DRM)</a></b>, <b><a href="/category.php?id=364&category=Mobile HDTV">Mobile HDTV</a></b>, <b><a href="/category.php?id=362&category=Satellite HDTV">Satellite HDTV</a></b>
							</td>
						</tr><tr colspan="2">
...
<p>Ed<br />
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Ed Milbourn</b>, <b>April 12, 2007 12:23 PM</b>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Ed Milbourn', 576)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2007/04/eds-view-mobile-digital-television-mdt-this-is-a-winner.php" type="text/javascript" charset="utf-8"></script>
