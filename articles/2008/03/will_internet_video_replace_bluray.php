...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2008/03/will-internet-video-replace-bluray.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Will Internet Video Replace Blu-ray?" />
...
Historically, this battle has been ongoing via your local cable system or satellite service; it is called Pay Per View (PPV) and Video On Demand (VOD). While the providers have found great profits in this service and their customers have enjoyed the convenience, it didn't ..." />
	...
	<meta property="og:title" content="Will Internet Video Replace Blu-ray?" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2008/03/will-internet-video-replace-bluray.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="With one war over and Blu-ray taking victory, there is yet another war brewing in the background ... or is there? The new question being asked by the rank and file is whether or not there is even a future for packaged media. Can you imagine a day where nobody physically rents a movie? Some are.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1287', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
