<?
	...
	$sql = "SELECT digg_url FROM aux_mt_entry WHERE entry_id = 1287";
	$result = mQuery($sql);
	...
	# Get category ID
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1287 AND placement_is_primary = 1";
...
<head>
	...
	<meta name="keywords" content="blu ray, new kids, packaged media, special features, sales rentals, new, blu, ray, Blu, packaged, media, kids, services, disc, DVD, internet, dvd, video, box, our, movie, going, while, years, convenience" />
	<meta name="description" content="With one war over and Blu-ray taking victory, there is yet another war brewing in the background ... or is there? The new question being asked by the rank and file is whether or not there is even a future for packaged media. Can you imagine a day where nobody physically rents a movie? Some are.
...
Historically, this battle has been ongoing via your local cable system or satellite service; it is called Pay Per View (PPV) and Video On Demand (VOD). While the providers have found great profits in this service and their customers have enjoyed the convenience, it didn't ..." />
	<title>HDTV Magazine Articles - Will Internet Video Replace Blu-ray?</title>
...
<body><div id="body_container">
	<?
		...
		$base_url = strleftback(PHP_SELF, '/') . '/will_internet_video_replace_blu-ray';
		$print_url = $base_url .'-print.php';
		$save_url = $base_url .'-save.php';
		$title_encoded = rawurlencode(addslashes('Will Internet Video Replace Blu-ray?'));
		$email_url = "mailto:?subject=HDTV Magazine: $title_encoded&amp;body=http://www.hdtvmagazine.com/articles/2008/03/will_internet_video_replace_blu-ray.php";
		if ($author[img] != '' && 1 != 7) {
	...
	<table class="bare" cellpadding="0" cellspacing="0" style="width:100%;">
		<tr>
			...
			<td class="article_title" colspan="2">Will Internet Video Replace Blu-ray?</td>
		</tr><tr>
			<td id="article_byline" nowrap="nowrap">
				By <b>Richard Fisher</b><br />
				<?=$author_title?>
				Posted on <b>March 11, 2008</b><br />
				Category: <b><a href="/category.php?id=<?=$category_id?>&category=HD DVD & Blu-ray">HD DVD & Blu-ray</a></b><br />
			</td><td id="article_links">
				<!--span><img src="/images/digg.png" alt="Digg Article" align="absmiddle" /><a target="_blank" href="http://digg.com/submit?url=http://www.hdtvmagazine.com/articles/2008/03/will_internet_video_replace_blu-ray.php&amp;phase=2">Digg</a></span-->
				<span><img src="/images/newsvine.gif" alt="Add to Newsvine" align="absmiddle" /><a href="javascript:addToNewsvine('http://www.hdtvmagazine.com/articles/2008/03/will_internet_video_replace_blu-ray.php', '<?=$title_encoded?>')">Newsvine</a></span>
				<span><img src="/images/delicious.gif" alt="Add to Del.icio.us" align="absmiddle" /><a target="_blank" href="http://del.icio.us/post?url=http://www.hdtvmagazine.com/articles/2008/03/will_internet_video_replace_blu-ray.php&amp;title=<?=$title_encoded?>">Del.icio.us</a></span>
	...
	<div>
		<div style="float:left; margin:0 5px 5px 0;"><?
			if ($digg_url == '') {
				echo '<a target="_blank" href="http://digg.com/submit?url=http://www.hdtvmagazine.com/articles/2008/03/will_internet_video_replace_blu-ray.php&amp;phase=2&amp;title=Will%20Internet%20Video%20Replace%20Blu-ray%3F&amp;bodytext=With%20one%20war%20over%20and%20Blu-ray%20taking%20victory%2C%20there%20is%20yet%20another%20war%20brewing%20in%20the%20background%20...%20or%20is%20there%3F%20The%20new%20question%20being%20asked%20by%20the%20rank%20and%20file%20is%20whether%20or%20not%20there%20is%20even%20a%20future%20for%20packaged%20media.%20Can%20you%20imagine%20a%20day%20where%20nobody%20physically%20rents%20a%20movie%3F%20Some%20are.%0A%0AHistorically%2C%20this%20battle%20has%20been%20ongoing%20via%20your%20local%20cable%20system%20or%20satellite%20service%3B%20it%20is%20called%20Pay%20Per%20View%20%28PPV%29%20and%20Video%20On%20Demand%20%28VOD%29.%20While%20the%20providers%20have%20found%20great%20profits%20in%20this%20service%20and%20their%20customers%20have%20enjoyed%20the%20convenience%2C%20it%20didn%27t%20...&amp;topic=television"><img src="/images/digg-this.gif" alt="Digg This" style="padding:0"></a>';
			} else {
...
<p>If you look at audio, the social ownership experience of packaged media has waned dramatically over the years in favor of data only. Conversely, as evidenced by the DVD market and movie collector that experience seems firmly entrenched for now. On the other hand, our youth represents the future and they clearly don't put audio and video on the same pedestal as the older generation does. The new generation takes for granted our wonderful HT systems and widescreen movies that just over 10 years ago was considered a luxury. Let us not underestimate the fact that the younger generation has been trained by the new world of audio downloads and there is every reason to suspect they are willing and ready to do the same with movies. The new kids on the video rental block are counting on it!</p>
  ...
  <td id="left"><!-- Comments -->
	...
	?>
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2008/03/will_internet_video_replace_blu-ray.php" type="text/javascript" charset="utf-8"></script>
</div></body>
</html>
