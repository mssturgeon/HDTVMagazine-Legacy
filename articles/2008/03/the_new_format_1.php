...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Will Internet Video Replace Blu-ray?&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/articles/2008/03/will-internet-video-replace-bluray.php&amp;title=Will Internet Video Replace Blu-ray?">
		<span style="display:none">With one war over and Blu-ray taking victory, there is yet another war brewing in the background ... or is there? The new question being asked by the rank and file is whether or not there is even a future for packaged media. Can you imagine a day where nobody physically rents a movie? Some are.

Historically, this battle has been ongoing via your local cable system or satellite service; it is called Pay Per View (PPV) and Video On Demand (VOD). While the providers have found great profits in this service and their customers have enjoyed the convenience, it didn't ...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (1) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1287";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Will Internet Video Replace Blu-ray?" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Will Internet Video Replace Blu-ray?" />
...
<html>
<head>
	<title>HDTV Magazine - Will Internet Video Replace Blu-ray?</title>
	<meta name="keywords" content="blu ray, new kids, packaged media, special features, sales rentals, new, blu, ray, packaged, media, kids, services, disc, internet, dvd, video, box, our, movie, going, while, years, convenience, generation, provide" />
...
Historically, this battle has been ongoing via your local cable system or satellite service; it is called Pay Per View (PPV) and Video On Demand (VOD). While the providers have found great profits in this service and their customers have enjoyed the convenience, it didn't ..." />
	<meta name="title" content="Will Internet Video Replace Blu-ray?" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/articles/2008/03/will-internet-video-replace-bluray.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1287', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2008/03/will-internet-video-replace-bluray.php">Will Internet Video Replace Blu-ray?</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Richard Fisher</b> on <b>March 11, 2008</b>
...
<p>If you look at audio, the social ownership experience of packaged media has waned dramatically over the years in favor of data only. Conversely, as evidenced by the DVD market and movie collector that experience seems firmly entrenched for now. On the other hand, our youth represents the future and they clearly don't put audio and video on the same pedestal as the older generation does. The new generation takes for granted our wonderful HT systems and widescreen movies that just over 10 years ago was considered a luxury. Let us not underestimate the fact that the younger generation has been trained by the new world of audio downloads and there is every reason to suspect they are willing and ready to do the same with movies. The new kids on the video rental block are counting on it!</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Richard Fisher</b>, <b>March 11, 2008  9:35 AM</b>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Richard Fisher', 1287)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2008/03/will-internet-video-replace-bluray.php" type="text/javascript" charset="utf-8"></script>
