...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/articles/2014/02/kaleidescape-cinema-one-review.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
...
The Cinema One is a Kaleidescape server to store and organize the digital copy of movies and music into its 4TB hard drive. It can handle up to..." />
	...
	<meta property="og:url" content="http://www.hdtvmagazine.com/articles/2014/02/kaleidescape-cinema-one-review.php" />
...
<body onload="init();"><div id="body_container">
	...
	<table class="bare" cellpadding="0" cellspacing="0"><tr>
		<td id="left">
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/articles/2014/02/kaleidescape-cinema-one-review.php">Kaleidescape Cinema One - Review</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>" class="<?=$viglink_suppress?>">
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Rodolfo La Maestra</b>, <b>February  3, 2014  8:30 PM</b>
			...
			<? if (1 != 7) echo getBoxMoreFromAuthor('Rodolfo La Maestra', 5191)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/articles/2014/02/kaleidescape-cinema-one-review.php" type="text/javascript" charset="utf-8"></script>
