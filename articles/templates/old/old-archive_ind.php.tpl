	...
	switch (<$MTBlogID$>) {
		...
		case 6: # Test
			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="<?=BASE_IMG_HOST?>/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="<?=BASE_IMG_HOST?>/images/chicklet-mp3-podcast.gif" alt="Download <$MTEntryTitle$>" height="15" width="85"/></a></span>';
			$container = 'article_container';
			$sub_type = 0;
...
<body><div id="body_container">
	<?
		...
		if ($author['img'] != '' && <$MTBlogID$> != 7) {
			$img = '<img src="'. BASE_IMG_HOST .'/images/portraits/'. $author['img'] .'" alt="<$MTEntryAuthor$>" />';
		} else {$img = '';}
	...
	<div>
		...
		<div id="<?=$container?>">
			...
			<$MTEntryBody$>
			<!-- sphereit end -->
			<!--div align="right"><a class="iconsphere" title="Related Blogs &amp; Articles" onclick="return Sphere.Widget.search()" href="http://www.sphere.com/search?q=sphereit:<$MTEntryLink$>">Sphere: Related Content</a></div-->
		</div>
	</div>
  ...
  <td id="left"><!-- Comments -->
 		...
 		<div class="item"><span class="corners-top"><span></span></span>
 			...
 			WHERE entry_author_id = author_id
 				...
 				AND category_label = '<$MTEntryCategory encode_php="qq"$>'
