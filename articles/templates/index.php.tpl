...
<head>
	<!-- index.php template -->
	<title>HDTV Magazine <$MTBlogName encode_xml="1"$></title>
	...
	<meta name="description" content="<$MTBlogDescription remove_html="1" encode_xml="1"$>" />
	<? require(BASE_DIR .'/includes/page_header.php');?>
</head>
<body><div id="<?=$container?>">
	<? include(BASE_DIR .'/includes/body_header-4.php');?>

	<h1>HDTV Magazine <$MTBlogName remove_html="1" encode_xml="1"$></h1>
		...
		<td id="left">
			<? if ($user->data['subscriptions'] & $sub_type) {} else {
				...
				while ($row = mysql_fetch_assoc($result)) {
					...
					if ($x == 6) {
						echo '<h2>More <$MTBlogName encode_xml="1"$> ...</h2>';
						$format = 'title-only';
					}
			...
			<div class="item"><span class="corners-top"><span></span></span>
				<h2><$MTBlogName encode_xml="1"$> Archive</h2>
			...
			<? if ($feed_url != '') {?>
				<div class="item"><span class="corners-top"><span></span></span>
					...
					<ul class="nosquare">
						...
						<li><a target="_blank" href="http://toolbar.google.com/buttons/add?url=<$MTLink template="Google Toolbar Button"$>">Add to Google Toolbar</a></li>
					</ul>
				<span class="corners-bottom"><span></span></span></div>
			<?}?>
