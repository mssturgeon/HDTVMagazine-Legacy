<?
	...
	# Author Title & Bio
	$res_author = mQuery("SELECT title, channel, img, user_id, bio_short FROM aux_author au, mt_author a WHERE au.author_id = a.author_id AND a.author_name = '<$MTEntryAuthor$>'");
...
<body><div id="body_container">
		...
		<table class="bare" cellpadding="0" cellspacing="0" style="width:100%;">
			<tr>
				...
				<td id="article_byline" nowrap="nowrap">
					...
					Category: <b><a href="../../<?=$category_page?>?category=<$MTEntryCategory url_encode="1"$>&id=<?=$category_id?>"><$MTEntryCategory$></a></b><br />
	...
	?>
	<script src="http://feeds.feedburner.com/~s/hdtv?i=<$MTEntryPermalink$>" type="text/javascript" charset="utf-8"></script>
</div></body>
</html>
