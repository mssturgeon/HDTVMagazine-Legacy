...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 4654 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2012/01/hdtv-and-home-theater-podcast-podcast-515-pioneer-elite-n30-networked-audio-player.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 4654";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast - Podcast #515: Pioneer Elite N-30 Networked Audio Player" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast - Podcast #515: Pioneer Elite N-30 Networked Audio Player" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast - Podcast #515: Pioneer Elite N-30 Networked Audio Player" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast - Podcast #515: Pioneer Elite N-30 Networked Audio Player</title>
	<meta name="keywords" content="radio stations, stations world, networked audio, audio player, pioneer elite, music, pioneer, device, unit, stations, connect, sound, app, kbps, ’s, stream, nice, available, our, listen, digital, radio, setup, networked, adapter" />
	<meta name="description" content="The HT Guys love music and when a product comes along that lets us enjoy it, we want to take a look. The Pioneer N-30 is just such a device. It&amp;#039;s a networked device that lets you listen to your favorite music whether it&amp;#039;s on a computer, iPad, or on one of over a thousand Internet radio stations from around the world. The N-30 will have a MSRP of $499 when it becomes available. At the time of this writing we could not find available from the usual outlets." />
	<meta name="title" content="HDTV and Home Theater Podcast - Podcast #515: Pioneer Elite N-30 Networked Audio Player" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HDTV and Home Theater Podcast - Podcast #515: Pioneer Elite N-30 Networked Audio Player" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2012/01/hdtv-and-home-theater-podcast-podcast-515-pioneer-elite-n30-networked-audio-player.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="The HT Guys love music and when a product comes along that lets us enjoy it, we want to take a look. The Pioneer N-30 is just such a device. It&amp;#039;s a networked device that lets you listen to your favorite music whether it&amp;#039;s on a computer, iPad, or on one of over a thousand Internet radio stations from around the world. The N-30 will have a MSRP of $499 when it becomes available. At the time of this writing we could not find available from the usual outlets." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4654', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2012/01/hdtv-and-home-theater-podcast-podcast-515-pioneer-elite-n30-networked-audio-player.php">HDTV and Home Theater Podcast - Podcast #515: Pioneer Elite N-30 Networked Audio Player</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>January 26, 2012</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=456&category=Cable HDTV">Cable HDTV</a></b>, <b><a href="/category.php?id=435&category=Internet HD Video">Internet HD Video</a></b>, <b><a href="/category.php?id=414&category=Mobile HDTV">Mobile HDTV</a></b>
							</td>
						</tr><tr colspan="2">
...
<br />  
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>January 26, 2012 11:19 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 4654)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2012/01/hdtv-and-home-theater-podcast-podcast-515-pioneer-elite-n30-networked-audio-player.php" type="text/javascript" charset="utf-8"></script>
