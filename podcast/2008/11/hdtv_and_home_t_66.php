...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/11/hdtv-and-home-theater-podcast-329-five-technology-trends-to-watch.php&amp;title=HDTV and Home Theater Podcast #329 - Five Technology Trends to Watch">
		<span style="display:none">Every year the Consumer Electronics Association compiles Five Technology Trends to Watch. The full document is about 25 pages long, but it has some great information in it, so we went through it to pull out the highlights. The CEA claims that the &quot;topics chosen this year by CEA market analysts cover a wide range of digital technologies that will impact the world.&quot; While they may not end world hunger or and end to war, we do agree that they are interesting trends that we all will want to keep an eye on. We'll give the HT Guys Digest version, but please read the whole article if we pique your interest. </span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1555";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #329 - Five Technology Trends to Watch" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #329 - Five Technology Trends to Watch" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #329 - Five Technology Trends to Watch</title>
	<meta name="keywords" content="gesture recognition, trends watch, technology trends, sensing gesture, picture quality, control, technology, experience, home, kitchen, –, information, connectivity, recognition, oled, manufacturers, energy, displays, further, watch, next, power, several, gesture, internet" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #329 - Five Technology Trends to Watch" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/11/hdtv-and-home-theater-podcast-329-five-technology-trends-to-watch.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1555', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/11/hdtv-and-home-theater-podcast-329-five-technology-trends-to-watch.php">HDTV and Home Theater Podcast #329 - Five Technology Trends to Watch</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>November 17, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=429&category=Digital (DTV) Transition">Digital (DTV) Transition</a></b>, <b><a href="/category.php?id=447&category=PC & Laptop Technology">PC & Laptop Technology</a></b>, <b><a href="/category.php?id=378&category=Politics & Policy">Politics & Policy</a></b>
							</td>
						</tr><tr colspan="2">
...
<br><br><br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>November 17, 2008 11:07 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1555)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/11/hdtv-and-home-theater-podcast-329-five-technology-trends-to-watch.php" type="text/javascript" charset="utf-8"></script>
