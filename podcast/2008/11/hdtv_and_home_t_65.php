...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/11/hdtv-and-home-theater-podcast-328-western-digital-wd-tv-hd-media-player.php&amp;title=HDTV and Home Theater Podcast #328 - Western Digital WD TV HD Media Player">
		<span style="display:none">Today we take a look at the Western Digital WD TV HD Media player. The WD TV HD Media Player is a device about the size of an external hard drive that plays A/V content from USB storage media. The WD TV HD Media player is optimized for the WD &quot;My Passport&quot; line of hard drives but it will work with other USB devices. The player supports 1080p for content and menus navigation.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1552";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #328 - Western Digital WD TV HD Media Player" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #328 - Western Digital WD TV HD Media Player" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #328 - Western Digital WD TV HD Media Player</title>
	<meta name="keywords" content="media player, western digital, hard drive, dolby digital, does support, player, media, digital, hard, drive, content, western, mpeg, video, setup, dolby, drives, does, supports, support, music, filename, attached, fps, usb" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #328 - Western Digital WD TV HD Media Player" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/11/hdtv-and-home-theater-podcast-328-western-digital-wd-tv-hd-media-player.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1552', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/11/hdtv-and-home-theater-podcast-328-western-digital-wd-tv-hd-media-player.php">HDTV and Home Theater Podcast #328 - Western Digital WD TV HD Media Player</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>November 14, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=429&category=Digital (DTV) Transition">Digital (DTV) Transition</a></b>, <b><a href="/category.php?id=432&category=Digital Rights Management (DRM)">Digital Rights Management (DRM)</a></b>, <b><a href="/category.php?id=517&category=HD DVD">HD DVD</a></b>, <b><a href="/category.php?id=478&category=HTPCs & Laptops">HTPCs & Laptops</a></b>
							</td>
						</tr><tr colspan="2">
...
<br><br><br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>November 14, 2008  6:52 AM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1552)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/11/hdtv-and-home-theater-podcast-328-western-digital-wd-tv-hd-media-player.php" type="text/javascript" charset="utf-8"></script>
