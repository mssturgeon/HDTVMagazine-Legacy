...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/11/hdtv-and-home-theater-podcast-329-five-technology-trends-to-watch.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #329 - Five Technology Trends to Watch" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #329 - Five Technology Trends to Watch" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/11/hdtv-and-home-theater-podcast-329-five-technology-trends-to-watch.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Every year the Consumer Electronics Association compiles Five Technology Trends to Watch. The full document is about 25 pages long, but it has some great information in it, so we went through it to pull out the highlights. The CEA claims that the &quot;topics chosen this year by CEA market analysts cover a wide range of digital technologies that will impact the world.&quot; While they may not end world hunger or and end to war, we do agree that they are interesting trends that we all will want to keep an eye on. We'll give the HT Guys Digest version, but please read the whole article if we pique your interest. " />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1555', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
