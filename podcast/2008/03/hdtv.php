...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1288";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #255 - The Gefen HD PVR (EXT-HD-PVR)" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #255 - The Gefen HD PVR (EXT-HD-PVR)" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #255 - The Gefen HD PVR (EXT-HD-PVR)</title>
	<meta name="keywords" content="recording internal, internal hard, hard drive, internal drive, copy protected, pvr, recording, drive, record, hours, gefen, internal, set, want, card, take, mac, bit, copy, hdmi, digital, hard, computer, watch, ext" />
	<meta name="description" content="If you are like us you probably have one or two recordings on your DVR that you simply won't delete. But what if you want to archive the recording or watch it on your computer? Your choices in the past have been to down convert the program to 480i and record it on a DVD recorder or a computer with a capture card.  Today we talk about a product that we saw at CES that solves this problem. The Gefen HD PVR (EXT-HD-PVR) " />
	<meta name="title" content="HDTV and Home Theater Podcast #255 - The Gefen HD PVR (EXT-HD-PVR)" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-255-the-gefen-hd-pvr-exthdpvr.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1288', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-255-the-gefen-hd-pvr-exthdpvr.php">HDTV and Home Theater Podcast #255 - The Gefen HD PVR (EXT-HD-PVR)</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>March  3, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=513&category=Events & Tradeshows">Events & Tradeshows</a></b>, <b><a href="/category.php?id=517&category=HD DVD">HD DVD</a></b>
							</td>
						</tr><tr colspan="2">
...
<strong>Conclusion:</strong><br>
      The Gefen PVR does what Gefen says it will with good results. We would have liked to see Dolby Digital audio and the ability to take a SD card and plug it directly into the Mac. The price is a little steep for what you get but if you want to record HD via HDMI, this is the way to go. If you want to move the content to your PC make sure what you are recording is not copy protected. Another plus is that the unit is small enough to take take with you to a friends house. It is roughly the size of a Mac Mini, so if you want to watch a copy protected recording on the internal drive you can easily take the PVR with you.
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>March  3, 2008  9:10 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1288)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-255-the-gefen-hd-pvr-exthdpvr.php" type="text/javascript" charset="utf-8"></script>
