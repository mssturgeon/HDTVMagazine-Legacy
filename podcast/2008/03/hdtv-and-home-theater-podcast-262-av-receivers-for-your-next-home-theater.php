...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-262-av-receivers-for-your-next-home-theater.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #262 - A/V Receivers for your next Home Theater" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #262 - A/V Receivers for your next Home Theater" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-262-av-receivers-for-your-next-home-theater.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Today we discuss a recent article in CE Pro that runs down 9 A/V Receivers that you may want to consider for your next home theater. These receivers are not entry level and as such will cost a little more than your bargain receivers." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1314', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
