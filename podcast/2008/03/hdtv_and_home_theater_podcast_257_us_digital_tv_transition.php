...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-257-us-digital-tv-transition.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #257 - US Digital TV Transition" />
...
The United States is set to transition all over the air, or free to air, television broadcasts from analog to digital in just under a year from now.  It acronym speak, we'll all need to use ATSC tuners instead of the NTSC tuners we've been using for the past half century.  There are a bunch of questions swirling about the transition, we'll try to answer the most popular ones.  If you live outside the US, this information may apply to you at some point in the future, when your governing body decides to make a similar transition." />
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #257 - US Digital TV Transition" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-257-us-digital-tv-transition.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="US Digital TV Transition
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1292', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
