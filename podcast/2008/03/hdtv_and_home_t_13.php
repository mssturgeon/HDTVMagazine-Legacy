...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-260-options-for-an-energy-efficient-home-theater.php&amp;title=HDTV and Home Theater Podcast #260 - Options for an Energy Efficient Home Theater">
		<span style="display:none">Many of us want to make sure that we are the most efficient we can be in how we use the resources we consume.  One concern that has come up in our email inbox lately is all the power that is consumed by adding so many new home theater gadgets.  We're using bigger TVs than ever before, more surround sound processors are in use, often people will add a game system like and XBox360 or PS3 and still have a DVD player or a Blu-ray player along with it.  Of course you have to have a DVR, and there's the whole HTPC angle;  it just keeps going.  With all this technology proliferation, how do we keep our electricity usage in check, if for no other reason than we want to keep our monthly bills in a reasonable range?</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1308";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #260 - Options for an Energy Efficient Home Theater" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #260 - Options for an Energy Efficient Home Theater" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #260 - Options for an Energy Efficient Home Theater</title>
	<meta name="keywords" content="energy star, home theater, energy efficient, options energy, blu ray, energy, star, theater, home, efficient, options, while, our, power, dvd, website, want, pioneer, player, program, blu, ray, quite, electricity, little" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #260 - Options for an Energy Efficient Home Theater" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-260-options-for-an-energy-efficient-home-theater.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1308', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-260-options-for-an-energy-efficient-home-theater.php">HDTV and Home Theater Podcast #260 - Options for an Energy Efficient Home Theater</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>March 21, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=411&category=Blu-ray">Blu-ray</a></b>, <b><a href="/category.php?id=450&category=Environment / Green">Environment / Green</a></b>, <b><a href="/category.php?id=517&category=HD DVD">HD DVD</a></b>, <b><a href="/category.php?id=447&category=PC & Laptop Technology">PC & Laptop Technology</a></b>
							</td>
						</tr><tr colspan="2">
...
It's probably more than just a "noble" idea to want to conserve energy, and it goes deeper than just wanting to save money on your bills.  We applaud the Energy Star concept and hope that more manufacturers will embrace it in the future.  It sure makes it convenient for a consumer to simply look for that special logo and know that they're getting a certified product.  But as we found in our research, it can be a bit limiting in designing your home theater around that logo and you may need to do a little research on your own.  But with some digging and due diligence you can put together a home theater that not only rocks, but lets you do your part as well.<br />
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>March 21, 2008 12:15 AM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1308)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-260-options-for-an-energy-efficient-home-theater.php" type="text/javascript" charset="utf-8"></script>
