...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-258-harmony-one-universal-remote.php&amp;title=HDTV and Home Theater Podcast #258 - Harmony One Universal Remote">
		<span style="display:none">This week we finally get to the review at lot of listeners have been asking for, the Harmony One Advanced Universal Remote by Logitech.  We reviewed the Harmony 880 almost three years ago, and although Ara questioned the price premium, it eventually became our standard universal remote recommendation.  Now with the release of the One, we were eager to see if it would replace the 880 in our hearts and minds.  It won the 'Best of Innovations' award in the Home Theater Accessories category at CES 2008.  You can find it in retail stores and online for an MSRP of $250 US.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1296";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #258 - Harmony One Universal Remote" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #258 - Harmony One Universal Remote" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #258 - Harmony One Universal Remote</title>
	<meta name="keywords" content="home theater, universal remote, harmony universal, touch screen, remote box, harmony, remote, theater, home, programming, buttons, screen, easy, button, software, setup, universal, new, need, great, touchscreen, sexy, activity, cool, touch" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #258 - Harmony One Universal Remote" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-258-harmony-one-universal-remote.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1296', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-258-harmony-one-universal-remote.php">HDTV and Home Theater Podcast #258 - Harmony One Universal Remote</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>March 13, 2008</b>
...
As with any Harmony remote, the One is a great choice for your home theater.  It's new, sexy and easy to use.  The touchscreen is cool and the larger buttons make it a bit easier to use.  But overall it doesn't represent a huge departure from the 880.  Of course we're gadget freaks, so we'll both be using them, but if you want to save some money, the 880 remains a great option.  Bang for the buck, the 880 is still probably the way to go.  For the coolness factor, the One is where it's at.<br />
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>March 13, 2008 10:27 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1296)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-258-harmony-one-universal-remote.php" type="text/javascript" charset="utf-8"></script>
