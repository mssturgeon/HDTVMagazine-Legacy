...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-261-media-extender-devices.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #261 - Media Extender Devices" />
...
We also discus the results of a survey that we recently conducted.  " />
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #261 - Media Extender Devices" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-261-media-extender-devices.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Windows Media Center Extenders
Up until recently the only extender device available for your media center PC was the Xbox 360. On today's show we will discuss some new extender devices that are currently (or soon to be) on the market.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1312', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
