...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-262-av-receivers-for-your-next-home-theater.php&amp;title=HDTV and Home Theater Podcast #262 - A/V Receivers for your next Home Theater">
		<span style="display:none">Today we discuss a recent article in CE Pro that runs down 9 A/V Receivers that you may want to consider for your next home theater. These receivers are not entry level and as such will cost a little more than your bargain receivers.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1314";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #262 - A/V Receivers for your next Home Theater" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #262 - A/V Receivers for your next Home Theater" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #262 - A/V Receivers for your next Home Theater</title>
	<meta name="keywords" content="dolby digital, dolby truehd, truehd dts, digital plus, master audio, audio, hdmi, dolby, dts, truehd, video, buy, digital, receivers, support, theater, home, master, plus, deep, color, certified, next, internet, via" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #262 - A/V Receivers for your next Home Theater" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-262-av-receivers-for-your-next-home-theater.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1314', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-262-av-receivers-for-your-next-home-theater.php">HDTV and Home Theater Podcast #262 - A/V Receivers for your next Home Theater</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>March 27, 2008</b>
...
<li>Network Receiver functions allow you to play Internet radio, stream PC music files, use Yamaha MusicCast, and play USB portable audio players and flash drives</li></ul></p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>March 27, 2008  8:04 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1314)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-262-av-receivers-for-your-next-home-theater.php" type="text/javascript" charset="utf-8"></script>
