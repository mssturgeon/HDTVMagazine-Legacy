...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-260-options-for-an-energy-efficient-home-theater.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #260 - Options for an Energy Efficient Home Theater" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #260 - Options for an Energy Efficient Home Theater" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/03/hdtv-and-home-theater-podcast-260-options-for-an-energy-efficient-home-theater.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Many of us want to make sure that we are the most efficient we can be in how we use the resources we consume.  One concern that has come up in our email inbox lately is all the power that is consumed by adding so many new home theater gadgets.  We're using bigger TVs than ever before, more surround sound processors are in use, often people will add a game system like and XBox360 or PS3 and still have a DVD player or a Blu-ray player along with it.  Of course you have to have a DVR, and there's the whole HTPC angle;  it just keeps going.  With all this technology proliferation, how do we keep our electricity usage in check, if for no other reason than we want to keep our monthly bills in a reasonable range?" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1308', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
