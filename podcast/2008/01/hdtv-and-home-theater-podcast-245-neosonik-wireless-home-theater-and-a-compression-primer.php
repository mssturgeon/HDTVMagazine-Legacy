...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/01/hdtv-and-home-theater-podcast-245-neosonik-wireless-home-theater-and-a-compression-primer.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #245 - Neosonik Wireless Home Theater and a Compression Primer" />
...
We've discussed compression in the past, on Episode 13 and then again on Episode 107, but with all the talk about downloading HD content to your Vudu or Apple TV, and how that measures up to HD-DVD or Blu-ray, we thought it might be a good time to revisit the topic. " />
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #245 - Neosonik Wireless Home Theater and a Compression Primer" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/01/hdtv-and-home-theater-podcast-245-neosonik-wireless-home-theater-and-a-compression-primer.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="This year's CES was as big as ever. Its too big for us to see and talk about everything so we try to stay focused on what most of our listeners are interested in. We recently received an email from Dale in McPherson, KS asking us to look into a product that was not shown on the main floor but in the Venetian hotel. The product is the Neosonik wireless home theater and hi-fi system. We have requested an evaluation system but we thought that the product would make a good topic for discussion.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=920', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
