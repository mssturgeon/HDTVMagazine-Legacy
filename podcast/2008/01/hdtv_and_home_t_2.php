...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 920";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #245 - Neosonik Wireless Home Theater and a Compression Primer" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #245 - Neosonik Wireless Home Theater and a Compression Primer" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #245 - Neosonik Wireless Home Theater and a Compression Primer</title>
	<meta name="keywords" content="blu ray, high definition, beach ball, lossy compression, audio video, video, mpeg, compression, wireless, dvd, quality, blu, ray, much, looks, content, audio, mbps, digital, beach, compress, high, lossy, back, codec" />
...
We've discussed compression in the past, on Episode 13 and then again on Episode 107, but with all the talk about downloading HD content to your Vudu or Apple TV, and how that measures up to HD-DVD or Blu-ray, we thought it might be a good time to revisit the topic. " />
	<meta name="title" content="HDTV and Home Theater Podcast #245 - Neosonik Wireless Home Theater and a Compression Primer" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/01/hdtv-and-home-theater-podcast-245-neosonik-wireless-home-theater-and-a-compression-primer.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=920', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/01/hdtv-and-home-theater-podcast-245-neosonik-wireless-home-theater-and-a-compression-primer.php">HDTV and Home Theater Podcast #245 - Neosonik Wireless Home Theater and a Compression Primer</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>January 26, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=411&category=Blu-ray">Blu-ray</a></b>, <b><a href="/category.php?id=513&category=Events & Tradeshows">Events & Tradeshows</a></b>, <b><a href="/category.php?id=517&category=HD DVD">HD DVD</a></b>, <b><a href="/category.php?id=441&category=Wireless HDMI/HDTV">Wireless HDMI/HDTV</a></b>
							</td>
						</tr><tr colspan="2">
...
<p>The bottom line is that compression allows us to watch high definition video in our homes.  Without it, a high definition movie would take up terabytes of storage space and would never fit on a Blu-ray or HD-DVD disc.  Forget about trying to broadcast an HDTV show to your house.  Compression is often expressed in terms of bitrate, or how much data (bits) are used to render a second of information non the screen.  Really good high definition broadcasts tend to be in the 18 Mbps range.  When your HDTV content looks really bad, it's because the broadcaster may be compressing the image even more, possibly allowing for only 12, 10 or even 8 Mbps.  You just can't re-inflate the beach ball once you've squeezed it down that small.  Compare that to how good an HD-DVD or Blu-ray movie looks.  Blu-ray can go all the way up to 40 Mbps for video (54 Mbps total for audio and video).  Now that's some high quality viewing.  Then compare that to "HD" downloads to your Apple TV.  The Apple TV supports a max bitrate of 5 Mbps.  Even DVDs allowed for 9.8 Mbps, but then the Apply TV is using MPEG4 while DVD uses MPEG2, so you'll have to draw your own conclusions on that one. </p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>January 26, 2008  4:40 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 920)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/01/hdtv-and-home-theater-podcast-245-neosonik-wireless-home-theater-and-a-compression-primer.php" type="text/javascript" charset="utf-8"></script>
