...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/05/hdtv-and-home-theater-podcast-278-motorola-tuning-adapter-and-more-mobile-digital-media.php&amp;title=HDTV and Home Theater Podcast #278 - Motorola Tuning Adapter and More Mobile Digital Media">
		<span style="display:none">Motorola Tuning Adapter MTR700
...
A few weeks ago on Show 272  we discussed the emerging mobile TV standard of the Open Mobile Video Coalition. At that time we discussed how the standard was just being deployed. We received an email from Glenn, host of “The ZA Show ” asking us to talk about a format that is already deployed called MediaFlo.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1409";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #278 - Motorola Tuning Adapter and More Mobile Digital Media" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #278 - Motorola Tuning Adapter and More Mobile Digital Media" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #278 - Motorola Tuning Adapter and More Mobile Digital Media</title>
	<meta name="keywords" content="tuning adapter, motorola tuning, switched digital, digital media, cable service, cable, service, mobile, digital, adapter, box, motorola, video, tuning, programming, channel, tivo, mediaflo, switched, mtr, flo, available, series, device, standard" />
...
A few weeks ago on Show 272  we discussed the emerging mobile TV standard of the Open Mobile Video Coalition. At that time we discussed how the standard was just being deployed. We received an email from Glenn, host of “The ZA Show ” asking us to talk about a format that is already deployed called MediaFlo." />
	<meta name="title" content="HDTV and Home Theater Podcast #278 - Motorola Tuning Adapter and More Mobile Digital Media" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/05/hdtv-and-home-theater-podcast-278-motorola-tuning-adapter-and-more-mobile-digital-media.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1409', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/05/hdtv-and-home-theater-podcast-278-motorola-tuning-adapter-and-more-mobile-digital-media.php">HDTV and Home Theater Podcast #278 - Motorola Tuning Adapter and More Mobile Digital Media</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>May 23, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=456&category=Cable HDTV">Cable HDTV</a></b>, <b><a href="/category.php?id=429&category=Digital (DTV) Transition">Digital (DTV) Transition</a></b>, <b><a href="/category.php?id=432&category=Digital Rights Management (DRM)">Digital Rights Management (DRM)</a></b>, <b><a href="/category.php?id=414&category=Mobile HDTV">Mobile HDTV</a></b>
							</td>
						</tr><tr colspan="2">
...
<p>Links:<ul><li><a target="_blank" href="http://www.wireless.att.com/learn/messaging-internet/mobile-tv/index.jsp">AT&T MobileTV</a></li><li><a target="_blank" href="http://products.vzw.com/index.aspx?id=mobileTV">Verizon V-Cast</a></li></ul></p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>May 23, 2008  9:23 AM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1409)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/05/hdtv-and-home-theater-podcast-278-motorola-tuning-adapter-and-more-mobile-digital-media.php" type="text/javascript" charset="utf-8"></script>
