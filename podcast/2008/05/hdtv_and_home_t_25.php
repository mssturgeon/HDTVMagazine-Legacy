...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/05/hdtv-and-home-theater-podcast-272-mobile-digital-tv-standard.php&amp;title=HDTV and Home Theater Podcast #272 - Mobile digital TV standard">
		<span style="display:none">Our recent discussion about the Digital Television transition prompted a few emails asking about emergency preparedness and how the loss of analog TV transmission would affect consumers in the event of a natural (or man-made) disaster. This prompted a great email from one of our listeners about the emerging Mobile Digital TV Standard. And we have a quick review of the Panasonic Lumix DMC-FX35A 10.1MP Digital Camera.
</span></a>
	</li>
</ul></div>
EOT;
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1375";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #272 - Mobile digital TV standard" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #272 - Mobile digital TV standard" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #272 - Mobile digital TV standard</title>
	<meta name="keywords" content="mobile digital, digital video, digital television, television spectrum, new technologies, mobile, video, digital, television, camera, devices, quality, spectrum, home, time, new, today, standard, broadcast, signals, coalition, content, technologies, well, hdtv" />
	<meta name="description" content="Our recent discussion about the Digital Television transition prompted a few emails asking about emergency preparedness and how the loss of analog TV transmission would affect consumers in the event of a natural (or man-made) disaster. This prompted a great email from one of our listeners about the emerging Mobile Digital TV Standard. And we have a quick review of the Panasonic Lumix DMC-FX35A 10.1MP Digital Camera.
" />
	<meta name="title" content="HDTV and Home Theater Podcast #272 - Mobile digital TV standard" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/05/hdtv-and-home-theater-podcast-272-mobile-digital-tv-standard.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1375', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/05/hdtv-and-home-theater-podcast-272-mobile-digital-tv-standard.php">HDTV and Home Theater Podcast #272 - Mobile digital TV standard</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>May  2, 2008</b>
...
So there is still a little ways to go but in the near future in the even of an emergency we will be able to tune into public broadcasts no matter where we are using devices we already carry. Of course you'll need one that supports mobile digital video. We have extended an invitation to the group to come on the show to talk a bit more about the subject.<br />
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>May  2, 2008 10:03 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1375)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/05/hdtv-and-home-theater-podcast-272-mobile-digital-tv-standard.php" type="text/javascript" charset="utf-8"></script>
