...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/05/hdtv-and-home-theater-podcast-278-motorola-tuning-adapter-and-more-mobile-digital-media.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #278 - Motorola Tuning Adapter and More Mobile Digital Media" />
...
A few weeks ago on Show 272  we discussed the emerging mobile TV standard of the Open Mobile Video Coalition. At that time we discussed how the standard was just being deployed. We received an email from Glenn, host of “The ZA Show ” asking us to talk about a format that is already deployed called MediaFlo." />
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #278 - Motorola Tuning Adapter and More Mobile Digital Media" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/05/hdtv-and-home-theater-podcast-278-motorola-tuning-adapter-and-more-mobile-digital-media.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Motorola Tuning Adapter MTR700
If you are a Tivo lover and have your Series 3 box so that you can watch and record HD from your cable company, you may be wondering what will happen to your service when your cable company rolls out Switched Digital service. We have great news for you! Your Tivo Series 3 will be compatible with the new format. You will need an adapter to make it work however.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1409', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
