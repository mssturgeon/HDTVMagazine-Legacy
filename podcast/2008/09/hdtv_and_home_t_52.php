...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/09/hdtv-and-home-theater-podcast-315-why-arent-there-any-good-dlna-servers.php&amp;title=HDTV and Home Theater Podcast #315 - Why aren't there any good DLNA servers?">
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1498";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #315 - Why aren\'t there any good DLNA servers?" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #315 - Why aren\'t there any good DLNA servers?" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #315 - Why aren't there any good DLNA servers?</title>
	<meta name="keywords" content="dlna servers, dlna server, good dlna, dlna players, play back, dlna, server, servers, players, support, video, movie, good, really, any, backup, online, play, cover, network, get, back, why, content, bunch" />
	<meta name="description" content="We've talked about DLNA, or Digital Living Network Alliance, several times before - on Episodes 264 and 161 both get into the nitty gritty on what it is and what it's for.  Let's just cut it short and say that it's a way for consumer electronic devices to share media content.  You've got DLNA servers that dish out content and DLNA players that play it back.  There are a ton of great options out there for DLNA players, as well as a bunch of server options.  While many of the players are top notch, we're having trouble tracking down a really good server.
" />
	<meta name="title" content="HDTV and Home Theater Podcast #315 - Why aren't there any good DLNA servers?" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/09/hdtv-and-home-theater-podcast-315-why-arent-there-any-good-dlna-servers.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1498', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/09/hdtv-and-home-theater-podcast-315-why-arent-there-any-good-dlna-servers.php">HDTV and Home Theater Podcast #315 - Why aren't there any good DLNA servers?</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>September 29, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=429&category=Digital (DTV) Transition">Digital (DTV) Transition</a></b>, <b><a href="/category.php?id=478&category=HTPCs & Laptops">HTPCs & Laptops</a></b>, <b><a href="/category.php?id=502&category=LED (LCD) HDTVs">LED (LCD) HDTVs</a></b>, <b><a href="/category.php?id=459&category=Satellite HDTV">Satellite HDTV</a></b>
							</td>
						</tr><tr colspan="2">
...
content in your home media network.&nbsp; What server do you use? <br><br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>September 29, 2008 11:10 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1498)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/09/hdtv-and-home-theater-podcast-315-why-arent-there-any-good-dlna-servers.php" type="text/javascript" charset="utf-8"></script>
