...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/12/hdtv-and-home-theater-podcast-338-can-iptv-replace-cable-and-satellite.php&amp;title=HDTV and Home Theater Podcast #338 - Can IPTV replace Cable and Satellite?">
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1582";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #338 - Can IPTV replace Cable and Satellite?" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #338 - Can IPTV replace Cable and Satellite?" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #338 - Can IPTV replace Cable and Satellite?</title>
	<meta name="keywords" content="cable satellite, mbps mbps, iptv replace, news weather, replace cable, cable, watch, news, live, online, weather, mbps, sports, iptv, may, stream, abc, available, move, satellite, national, internet, shows, content, local" />
	<meta name="description" content="We've talked about wanting to give our television providers the boot for the past two years now. In the end, at least for us, there is no way to eliminate them completely. This week while reading an article in Broadcasting and Cable entitled Web Sports Enters HD Arena we thought it would be a good idea to revisit the subject. For this study we looked at our viewing habits and tried to come up with online equivalents.
" />
	<meta name="title" content="HDTV and Home Theater Podcast #338 - Can IPTV replace Cable and Satellite?" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/12/hdtv-and-home-theater-podcast-338-can-iptv-replace-cable-and-satellite.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1582', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/12/hdtv-and-home-theater-podcast-338-can-iptv-replace-cable-and-satellite.php">HDTV and Home Theater Podcast #338 - Can IPTV replace Cable and Satellite?</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>December 18, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=456&category=Cable HDTV">Cable HDTV</a></b>, <b><a href="/category.php?id=423&category=Cable, Satellite & Fiber">Cable, Satellite & Fiber</a></b>, <b><a href="/category.php?id=462&category=Fiber/IPTV HDTV">Fiber/IPTV HDTV</a></b>, <b><a href="/category.php?id=517&category=HD DVD">HD DVD</a></b>
							</td>
						</tr><tr colspan="2">
...
<br><br><br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>December 18, 2008 11:05 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1582)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/12/hdtv-and-home-theater-podcast-338-can-iptv-replace-cable-and-satellite.php" type="text/javascript" charset="utf-8"></script>
