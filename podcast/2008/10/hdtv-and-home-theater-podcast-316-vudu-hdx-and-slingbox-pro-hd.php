...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-316-vudu-hdx-and-slingbox-pro-hd.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #316 - Vudu HDX and Slingbox Pro HD" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #316 - Vudu HDX and Slingbox Pro HD" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-316-vudu-hdx-and-slingbox-pro-hd.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="We reviewed the original Slingbox way back in 2005. Ara currently has two of them and has been able to watch TV from his hotel in Chicago, Denver, and Europe. But the main way the Slingbox is used in the Derderian family is to extend TV reception to any room in the house. While the Slingbox works well via the Internet it works really well on your local network. The issue with Internet usage is bandwidth. First, if your upstream bandwidth is limited it really doesn't matter how much downstream bandwidth you have. In Ara's home the upstream is capped at 1 Mbps (although lately he has exceeded that)." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1504', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
