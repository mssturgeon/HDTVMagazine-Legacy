...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-323-a-few-amazoncom-top-ten-lists.php&amp;title=HDTV and Home Theater Podcast #323 - A few amazon.com top ten lists">
		<span style="display:none">We've compile a few lists of some of the top selling items at Amazon.com.  A few of the lists shocked us a little bit.  Of course, we have an opinion  on what they mean, and what we might see for the Holiday shopping season.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-323-a-few-amazoncom-top-ten-lists.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1534', 340, 125);">Add ASIN</a>
