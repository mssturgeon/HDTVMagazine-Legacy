...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-319-updates-on-playon-and-dlna-servers.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #319 - Updates on PlayOn and DLNA Servers" />
...
For the last couple weeks, since we did Episode #315 complaining about the lack of good choices for DLNA servers, we've received a ton of recommendations and tried out almost a thousand of them.  For the short term we had to focus on software-based options, but there are also a bunch of hardware solutions available as well.  We're trying to get our hands on some of them to add to the trials.  With so many options, something was sure to blow us away, right?" />
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #319 - Updates on PlayOn and DLNA Servers" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-319-updates-on-playon-and-dlna-servers.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="MediaMall has released a new version of PlayOn that now supports Netflix Watch Instantly streaming.  This is the feature we've all been waiting for, so we had to check it out.  Setup is simple, you just add your Netflix username and password and you're done.  There's even a test button to make sure you typed your password correctly.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1512', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
