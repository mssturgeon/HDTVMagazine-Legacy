...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-319-updates-on-playon-and-dlna-servers.php&amp;title=HDTV and Home Theater Podcast #319 - Updates on PlayOn and DLNA Servers">
		<span style="display:none">MediaMall has released a new version of PlayOn that now supports Netflix Watch Instantly streaming.  This is the feature we've all been waiting for, so we had to check it out.  Setup is simple, you just add your Netflix username and password and you're done.  There's even a test button to make sure you typed your password correctly.

For the last couple weeks, since we did Episode #315 complaining about the lack of good choices for DLNA servers, we've received a ton of recommendations and tried out almost a thousand of them.  For the short term we had to focus on software-based options, but there are also a bunch of hardware solutions available as well.  We're trying to get our hands on some of them to add to the trials.  With so many options, something was sure to blow us away, right?</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1512";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #319 - Updates on PlayOn and DLNA Servers" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #319 - Updates on PlayOn and DLNA Servers" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #319 - Updates on PlayOn and DLNA Servers</title>
	<meta name="keywords" content="dlna servers, media library, media server, dlna player, nero mediahome, media, dlna, playon, netflix, servers, server, player, library, get, options, new, actually, our, computer, nero, windows, add, content, mediahome, queue" />
...
For the last couple weeks, since we did Episode #315 complaining about the lack of good choices for DLNA servers, we've received a ton of recommendations and tried out almost a thousand of them.  For the short term we had to focus on software-based options, but there are also a bunch of hardware solutions available as well.  We're trying to get our hands on some of them to add to the trials.  With so many options, something was sure to blow us away, right?" />
	<meta name="title" content="HDTV and Home Theater Podcast #319 - Updates on PlayOn and DLNA Servers" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-319-updates-on-playon-and-dlna-servers.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1512', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-319-updates-on-playon-and-dlna-servers.php">HDTV and Home Theater Podcast #319 - Updates on PlayOn and DLNA Servers</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>October 13, 2008</b>
...
<br>Now to uninstall about a thousand DLNA servers from our test machine.&nbsp; We really need to get VMs for this stuff...<br><br><br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>October 13, 2008 11:40 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1512)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-319-updates-on-playon-and-dlna-servers.php" type="text/javascript" charset="utf-8"></script>
