...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-316-vudu-hdx-and-slingbox-pro-hd.php&amp;title=HDTV and Home Theater Podcast #316 - Vudu HDX and Slingbox Pro HD">
		<span style="display:none">We reviewed the original Slingbox way back in 2005. Ara currently has two of them and has been able to watch TV from his hotel in Chicago, Denver, and Europe. But the main way the Slingbox is used in the Derderian family is to extend TV reception to any room in the house. While the Slingbox works well via the Internet it works really well on your local network. The issue with Internet usage is bandwidth. First, if your upstream bandwidth is limited it really doesn't matter how much downstream bandwidth you have. In Ara's home the upstream is capped at 1 Mbps (although lately he has exceeded that).</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1504";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #316 - Vudu HDX and Slingbox Pro HD" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #316 - Vudu HDX and Slingbox Pro HD" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #316 - Vudu HDX and Slingbox Pro HD</title>
	<meta name="keywords" content="slingbox pro, local network, via internet, significant improvement, atsc tuner, slingbox, pro, internet, video, new, network, mbps, via, improvement, see, software, local, performance, slingplayer, watch, ara, guide, cable, computer, channels" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #316 - Vudu HDX and Slingbox Pro HD" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-316-vudu-hdx-and-slingbox-pro-hd.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1504', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-316-vudu-hdx-and-slingbox-pro-hd.php">HDTV and Home Theater Podcast #316 - Vudu HDX and Slingbox Pro HD</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>October  3, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=517&category=HD DVD">HD DVD</a></b>, <b><a href="/category.php?id=435&category=Internet HD Video">Internet HD Video</a></b>, <b><a href="/category.php?id=502&category=LED (LCD) HDTVs">LED (LCD) HDTVs</a></b>
							</td>
						</tr><tr colspan="2">
...
<br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>October  3, 2008 12:13 AM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1504)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-316-vudu-hdx-and-slingbox-pro-hd.php" type="text/javascript" charset="utf-8"></script>
