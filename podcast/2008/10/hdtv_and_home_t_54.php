...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-317-10-really-expensive-av-products-and-superslim-hdtvs.php&amp;title=HDTV and Home Theater Podcast #317 - 10 Really Expensive A/V Products and Super-Slim HDTVs">
		<span style="display:none">Amazon has an excellent write-up on four super slim HDTVs.  They offer a glimpse into the future of what television may be like in a few years.  Imagine what the family room or the home theater will look like when wireless HDMI removes the need to tether your TV to a set top box or a Bu-ray player.  And it also removes the need to have your speakers wired to your receiver or amplifier.  Couple that with a giant 60, 70 or even 80-inch flat panel TV only millimeters thick, mounted directly to the wall.  Now we're talking Jetson's technology.  And by the looks of things, it may not be that far off.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1507";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #317 - 10 Really Expensive A/V Products and Super-Slim HDTVs" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #317 - 10 Really Expensive A/V Products and Super-Slim HDTVs" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #317 - 10 Really Expensive A/V Products and Super-Slim HDTVs</title>
	<meta name="keywords" content="slim hdtvs, street price, super slim, flat panel, picture quality, color, hdtvs, technology, lcd, oled, panel, sony, inch, outstanding, content, series, bravia, flat, xel, samsung, features, slim, plasma, hdtv, edge" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #317 - 10 Really Expensive A/V Products and Super-Slim HDTVs" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-317-10-really-expensive-av-products-and-superslim-hdtvs.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1507', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-317-10-really-expensive-av-products-and-superslim-hdtvs.php">HDTV and Home Theater Podcast #317 - 10 Really Expensive A/V Products and Super-Slim HDTVs</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>October  6, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=411&category=Blu-ray">Blu-ray</a></b>, <b><a href="/category.php?id=447&category=PC & Laptop Technology">PC & Laptop Technology</a></b>, <b><a href="/category.php?id=381&category=Sports">Sports</a></b>, <b><a href="/category.php?id=441&category=Wireless HDMI/HDTV">Wireless HDMI/HDTV</a></b>
							</td>
						</tr><tr colspan="2">
...
<br><br><br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>October  6, 2008 11:14 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1507)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/10/hdtv-and-home-theater-podcast-317-10-really-expensive-av-products-and-superslim-hdtvs.php" type="text/javascript" charset="utf-8"></script>
