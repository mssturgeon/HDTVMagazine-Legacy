...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/02/hdtv-and-home-theater-podcast-254-playstation-3-in-your-home-theater.php&amp;title=HDTV and Home Theater Podcast #254 - Playstation 3 in your Home Theater">
		<span style="display:none">It's pretty clear by now that Blu-ray won the high definition video disk war.  By the end of this year HD-DVD could be a distant memory and those who want to watch High Definition movies will need a Blu-ray player.  There are a bunch of options out there for those in the market, and the Sony PlayStation 3 has been talked about as the most capable player available.  For a long time it was the least expensive way to get a Blu-ray player.  That isn't true anymore, but it's still close.  It's currently available in two models, a 40 GB model for $399.99 and an 80 GB model for $499.99.  Today we'll ignore the gaming side for the most part and look at how the device performs as a home theater device.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1281";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #254 - Playstation 3 in your Home Theater" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #254 - Playstation 3 in your Home Theater" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #254 - Playstation 3 in your Home Theater</title>
	<meta name="keywords" content="blu ray, ray player, home theater, high definition, stream network, blu, ray, player, network, support, really, video, audio, playback, need, players, theater, well, home, any, first, remote, internet, control, market" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #254 - Playstation 3 in your Home Theater" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/02/hdtv-and-home-theater-podcast-254-playstation-3-in-your-home-theater.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1281', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/02/hdtv-and-home-theater-podcast-254-playstation-3-in-your-home-theater.php">HDTV and Home Theater Podcast #254 - Playstation 3 in your Home Theater</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>February 29, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=411&category=Blu-ray">Blu-ray</a></b>, <b><a href="/category.php?id=408&category=Gaming">Gaming</a></b>, <b><a href="/category.php?id=517&category=HD DVD">HD DVD</a></b>, <b><a href="/category.php?id=417&category=High Definition Production">High Definition Production</a></b>
							</td>
						</tr><tr colspan="2">
...
<br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>February 29, 2008  6:24 AM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1281)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/02/hdtv-and-home-theater-podcast-254-playstation-3-in-your-home-theater.php" type="text/javascript" charset="utf-8"></script>
