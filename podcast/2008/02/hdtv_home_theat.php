...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDTV and Home Theater Podcast #252 - Blu-ray Backlash&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/02/hdtv-and-home-theater-podcast-252-bluray-backlash.php&amp;title=HDTV and Home Theater Podcast #252 - Blu-ray Backlash">
		<span style="display:none">We had planned some very different content for today's show, but something very strange happened this week.  There seems to be a huge backlash against Blu-ray for some reason.  It caught us somewhat by surprise, but the trend is too strong to ignore, so we just have to talk about it.  If the war really is over, and by most accounts it is, why aren't people rejoicing in the peaceful times ahead?  Why can't we put the differences behind us and move on to soak in all our movies in HD on one kind of disc, and maybe enjoy a little wide scale adoption at the same time?</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1270";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #252 - Blu-ray Backlash" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #252 - Blu-ray Backlash" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #252 - Blu-ray Backlash</title>
	<meta name="keywords" content="blu ray, dvd player, upconverting dvd, high definition, ray player, blu, ray, dvd, player, why, war, our, backlash, much, isn, good, movies, high, upconverting, content, little, format, better, neutral, worth" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #252 - Blu-ray Backlash" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/02/hdtv-and-home-theater-podcast-252-bluray-backlash.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1270', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/02/hdtv-and-home-theater-podcast-252-bluray-backlash.php">HDTV and Home Theater Podcast #252 - Blu-ray Backlash</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>February 22, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=411&category=Blu-ray">Blu-ray</a></b>, <b><a href="/category.php?id=456&category=Cable HDTV">Cable HDTV</a></b>, <b><a href="/category.php?id=517&category=HD DVD">HD DVD</a></b>
							</td>
						</tr><tr colspan="2">
...
We'll close with the <a title="Top 11 Ways Sony Plans to Celebrate Their Blu-Ray Victory" target="_blank" href="http://www.bbspot.com/News/2008/02/top-11-ways-sony-plans-to-celebrate-their-blu-ray-victory.html" id="oc.j">Top 11 Ways Sony Plans to Celebrate Their Blu-Ray Victory</a> from <a title="BBSpot.com" target="_blank" href="http://www.bbspot.com/" id="mpgz">BBSpot.com</a>.<br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>February 22, 2008  6:26 AM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1270)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/02/hdtv-and-home-theater-podcast-252-bluray-backlash.php" type="text/javascript" charset="utf-8"></script>
