...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/02/hdtv-and-home-theater-podcast-247-how-much-will-my-home-theater-cost-and-monoprice-hs102-1x2-hdmi-distribution-amplifier.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1242";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #247 - How Much Will my Home Theater Cost and Monoprice HS-102 1X2 HDMI Distribution Amplifier" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #247 - How Much Will my Home Theater Cost and Monoprice HS-102 1X2 HDMI Distribution Amplifier" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #247 - How Much Will my Home Theater Cost and Monoprice HS-102 1X2 HDMI Distribution Amplifier" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #247 - How Much Will my Home Theater Cost and Monoprice HS-102 1X2 HDMI Distribution Amplifier</title>
	<meta name="keywords" content="hdmi distribution, distribution amplifier, home theater, theater cost, between source, device, monoprice, hdmi, distribution, source, amplifier, audio, tvs, theater, equipment, home, yamaha, multiple, get, article, between, our, receiver, much, signal" />
...
We also review the Monoprice HS-102 1X2 HDMI Distribution Amplifier..." />
	<meta name="title" content="HDTV and Home Theater Podcast #247 - How Much Will my Home Theater Cost and Monoprice HS-102 1X2 HDMI Distribution Amplifier" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HDTV and Home Theater Podcast #247 - How Much Will my Home Theater Cost and Monoprice HS-102 1X2 HDMI Distribution Amplifier" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/02/hdtv-and-home-theater-podcast-247-how-much-will-my-home-theater-cost-and-monoprice-hs102-1x2-hdmi-distribution-amplifier.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="We go over an article published at ElectronicHouse.com entitled How Much Will my Home Theater Cost? It describes what you can expect to get for $5K, $10K, $20K, $50K and $100k. We give your our take on the article. This is an audio feature but you can follow along with the link to the original article
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1242', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/02/hdtv-and-home-theater-podcast-247-how-much-will-my-home-theater-cost-and-monoprice-hs102-1x2-hdmi-distribution-amplifier.php">HDTV and Home Theater Podcast #247 - How Much Will my Home Theater Cost and Monoprice HS-102 1X2 HDMI Distribution Amplifier</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>February  4, 2008</b>
...
<p>The HS-102 is available at Monoprice.com for $71.50 and works as advertised! They also have 1X4 and 1X8 splitters as well. <br />
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>February  4, 2008  1:51 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1242)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/02/hdtv-and-home-theater-podcast-247-how-much-will-my-home-theater-cost-and-monoprice-hs102-1x2-hdmi-distribution-amplifier.php" type="text/javascript" charset="utf-8"></script>
