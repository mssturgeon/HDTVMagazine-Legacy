...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-296-rca-selectavision-and-orb-audio-mod-2-speakers.php&amp;title=HDTV and Home Theater Podcast #296 - RCA SelectaVision and Orb Audio Mod 2 speakers">
		<span style="display:none">From time to time our listeners send us emails asking us to review equipment that they are interested in buying or themselves. Recently  we received an email from Kris asking us to take a look at the Orb Audio line of speakers. We were able to obtain the Orb Audio Mod 2 speakers with an upgraded Uber Ten subwoofer. The total cost for the 5.1 system was $1597 including standard ground shipping.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1477";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #296 - RCA SelectaVision and Orb Audio Mod 2 speakers" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #296 - RCA SelectaVision and Orb Audio Mod 2 speakers" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #296 - RCA SelectaVision and Orb Audio Mod 2 speakers</title>
	<meta name="keywords" content="orb audio, wall mounts, audio mod, orb speakers, rated ohms, speakers, orb, audio, subwoofer, our, room, mounts, work, small, listen, speaker, wall, mod, hand, receiver, control, able, selectavision, because, uber" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #296 - RCA SelectaVision and Orb Audio Mod 2 speakers" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-296-rca-selectavision-and-orb-audio-mod-2-speakers.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1477', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-296-rca-selectavision-and-orb-audio-mod-2-speakers.php">HDTV and Home Theater Podcast #296 - RCA SelectaVision and Orb Audio Mod 2 speakers</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>July 24, 2008</b>
...
<br><br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>July 24, 2008 11:22 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1477)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-296-rca-selectavision-and-orb-audio-mod-2-speakers.php" type="text/javascript" charset="utf-8"></script>
