...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-293-when-to-upgrade-your-gear.php&amp;title=HDTV and Home Theater Podcast #293 - When to Upgrade your Gear">
		<span style="display:none">We get email after email asking for advice on when is the right time to upgrade your home theater equipment. The answer, of course, is always &quot;right now,&quot; but that isn't always possible. Often we have to compromise in one area to upgrade another. So what components are the most important to keep up to date? Which ones can wait a while? Let's take a look.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1466";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #293 - When to Upgrade your Gear" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #293 - When to Upgrade your Gear" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #293 - When to Upgrade your Gear</title>
	<meta name="keywords" content="surround sound, blu ray, home theater, high definition, right time, upgrade, hdmi, hdtv, speakers, content, need, get, want, receiver, home, sound, surround, high, may, theater, good, really, blu, ray, support" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #293 - When to Upgrade your Gear" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-293-when-to-upgrade-your-gear.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1466', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-293-when-to-upgrade-your-gear.php">HDTV and Home Theater Podcast #293 - When to Upgrade your Gear</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>July 14, 2008</b>
...
games available on the Xbox 360 and the PS3 are amazing. If everything
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>July 14, 2008 10:40 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1466)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-293-when-to-upgrade-your-gear.php" type="text/javascript" charset="utf-8"></script>
