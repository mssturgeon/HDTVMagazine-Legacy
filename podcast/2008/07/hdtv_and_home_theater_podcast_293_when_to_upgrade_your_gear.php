...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-293-when-to-upgrade-your-gear.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #293 - When to Upgrade your Gear" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #293 - When to Upgrade your Gear" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-293-when-to-upgrade-your-gear.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="We get email after email asking for advice on when is the right time to upgrade your home theater equipment. The answer, of course, is always &quot;right now,&quot; but that isn't always possible. Often we have to compromise in one area to upgrade another. So what components are the most important to keep up to date? Which ones can wait a while? Let's take a look." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1466', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
