...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-289-like-it-or-not-bdlive-is-coming.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #289 - Like it or not, BD-Live is coming" />
...
very soon.  It could be cool, or it could just be a lot of hype." />
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #289 - Like it or not, BD-Live is coming" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-289-like-it-or-not-bdlive-is-coming.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="We've never really been into special features on discs, but what if the
special features weren't actually on the disc, but were on the Internet?  Like it or not, BD Live looks like it's coming in full force
very soon.  It could be cool, or it could just be a lot of hype." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1453', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
