...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1470";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #294 - Playstation Movie Downloads" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #294 - Playstation Movie Downloads" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #294 - Playstation Movie Downloads</title>
	<meta name="keywords" content="playstation store, vudu appletv, store still, high definition, advantage vudu, vudu, store, playstation, movies, content, available, appletv, features, still, shows, titles, download, feature, easy, sony, previews, find, able, purchase, tie" />
	<meta name="description" content="Sony announced on Tuesday that that they would begin offering movies and TV shows for download to the Playstation 3 through the Playstation store.  Movies are available from Disney, Fox and Warner Bros in addition to the obvious inclusion of Sony Pictures titles.  The system is setup much like Vudu and AppleTV, new release movies can be rented for $3.99 in standard def and $5.99 in high definition or purchased in SD for $14.99.  Older titles are available for rent for $2.99 for SD, $4.50 for HD and $9.99 for purchase.  So the big question is, &quot;How does Sony's offering stack up against Vudu or AppleTV?&quot;" />
	<meta name="title" content="HDTV and Home Theater Podcast #294 - Playstation Movie Downloads" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-294-playstation-movie-downloads.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1470', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-294-playstation-movie-downloads.php">HDTV and Home Theater Podcast #294 - Playstation Movie Downloads</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>July 17, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=456&category=Cable HDTV">Cable HDTV</a></b>, <b><a href="/category.php?id=408&category=Gaming">Gaming</a></b>, <b><a href="/category.php?id=417&category=High Definition Production">High Definition Production</a></b>, <b><a href="/category.php?id=435&category=Internet HD Video">Internet HD Video</a></b>
							</td>
						</tr><tr colspan="2">
...
the way to go.</div>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>July 17, 2008 11:37 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1470)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/07/hdtv-and-home-theater-podcast-294-playstation-movie-downloads.php" type="text/javascript" charset="utf-8"></script>
