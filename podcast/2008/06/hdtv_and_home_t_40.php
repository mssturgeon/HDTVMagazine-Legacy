...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-287-next-generation-television.php&amp;title=HDTV and Home Theater Podcast #287 - Next Generation Television">
		<span style="display:none">DisplaySearch recently released a report about what TV manufactures will need to do to sell more televisions in the coming years.  One of the key features was network, and specifically Internet, connectivity.  Just a couple days prior to that report we received a press release about the availability of HP's MediaSmart Connect for pre-order.  We saw the demo at CES and liked the idea.  All of this got us thinking;  DisaplySearch says TV's need Internet connectivity, HP agrees in theory, but prefers the set top box route.  If we could design our own Internet connected TV or STB, what would it do.  From the &quot;If the HT Guys ruled the world...&quot; point of view.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-287-next-generation-television.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1445', 340, 125);">Add ASIN</a>
