...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDTV and Home Theater Podcast #282 - Bathroom TVs&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-282-bathroom-tvs.php&amp;title=HDTV and Home Theater Podcast #282 - Bathroom TVs">
		<span style="display:none">We have designed whole house video and audio systems and talked about them on our show. The one room we really haven't done much with is the Bathroom. We know what you are probably thinking: the bathroom is one area in the home where you don't want to be bombarded with the world's problems.  We hear you; but what if you are in the middle of a football game and your wife tells you that its time to get ready so you can go to your in-law's?  Having a TV in the bathroom sounds like a good way keep everyone happy.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1422";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #282 - Bathroom TVs" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #282 - Bathroom TVs" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #282 - Bathroom TVs</title>
	<meta name="keywords" content="ready morning, bathroom well, thing approach, approach computer, bathroom tvs, bathroom, need, equipment, tvs, run, solution, mirrors, get, while, thing, our, laptop, mirror, may, homerun, want, ready, mount, mini, put" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #282 - Bathroom TVs" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-282-bathroom-tvs.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1422', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-282-bathroom-tvs.php">HDTV and Home Theater Podcast #282 - Bathroom TVs</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>June  6, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=456&category=Cable HDTV">Cable HDTV</a></b>, <b><a href="/category.php?id=475&category=HD Video Production">HD Video Production</a></b>, <b><a href="/category.php?id=381&category=Sports">Sports</a></b>
							</td>
						</tr><tr colspan="2">
...
<p>While not as sexy as the in mirror or in shower devices, our solution will get you a decent size screen at an affordable price.<br />
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>June  6, 2008 10:15 AM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1422)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-282-bathroom-tvs.php" type="text/javascript" charset="utf-8"></script>
