...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-283-soundbar-shootout.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #283 - Soundbar Shootout" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #283 - Soundbar Shootout" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-283-soundbar-shootout.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Home Theater Magazine recently put a panel together to look at five different soundbars.  Since we've only ever used the Yamaha Sound projector, and often get questions about models from other manufacturers, we thought it would be valuable to share their results.  The full article, called 'The Power of One' was written by Adrienne Maxwell.  It's certainly worth reading if you're in the market for a soundbar, since we won't cover all the details.  The five models tested were from Philips, Marantz, Yamaha, Denon, and Polk." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1426', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
