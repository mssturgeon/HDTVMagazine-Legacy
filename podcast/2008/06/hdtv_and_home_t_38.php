...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-285-custom-installers-favorite-brands.php&amp;title=HDTV and Home Theater Podcast #285 - Custom Installers' Favorite Brands">
		<span style="display:none">Every year CE Pro puts together a list of the top 100 custom electronics dealers in the country.  Then they poll those top dealers for their favorite brands to sell in 37 different categories.  Of course half the picture for dealers is how much profit they can make selling a particular product, but the other half of the picture is reliability and returns.  We like to look at the list to see what all the custom home theater installers are endorsing.  If you've narrowed a purchase down to two brands, it may help to swing your vote.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1432";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #285 - Custom Installers\' Favorite Brands" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #285 - Custom Installers\' Favorite Brands" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #285 - Custom Installers' Favorite Brands</title>
	<meta name="keywords" content="favorite brands, home theater, custom installers, half picture, triad paradigm, sony, custom, pioneer, brands, tvs, dealers, theater, marantz, installers, home, triad, categories, runco, projection, integra, speakers, favorite, klipsch, samsung, list" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #285 - Custom Installers' Favorite Brands" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-285-custom-installers-favorite-brands.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1432', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-285-custom-installers-favorite-brands.php">HDTV and Home Theater Podcast #285 - Custom Installers' Favorite Brands</a></td>
						</tr><tr>
...
<br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>June 16, 2008 11:11 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1432)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-285-custom-installers-favorite-brands.php" type="text/javascript" charset="utf-8"></script>
