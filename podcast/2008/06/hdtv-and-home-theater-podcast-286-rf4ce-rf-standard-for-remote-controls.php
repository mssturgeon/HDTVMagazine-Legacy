...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-286-rf4ce-rf-standard-for-remote-controls.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #286 - RF4CE: RF Standard for Remote Controls" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #286 - RF4CE: RF Standard for Remote Controls" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-286-rf4ce-rf-standard-for-remote-controls.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Isn't it annoying when you want to turn on your home theater with your IR based remote control and one or more components misses the command. It could be that someone walked in front of the remote or that you just didn't keep it pointed at your system long enough for the entire macro sequence to be transmitted. That's why most integrators shy away from IR based remotes and use systems like Crestron or Control4  to transmit commands to a head end unit which then sends the commands via Ethernet, Serial, or IR via an emitter to the equipment being controlled." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1444', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
