...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDTV and Home Theater Podcast #283 - Soundbar Shootout&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-283-soundbar-shootout.php&amp;title=HDTV and Home Theater Podcast #283 - Soundbar Shootout">
		<span style="display:none">Home Theater Magazine recently put a panel together to look at five different soundbars.  Since we've only ever used the Yamaha Sound projector, and often get questions about models from other manufacturers, we thought it would be valuable to share their results.  The full article, called 'The Power of One' was written by Adrienne Maxwell.  It's certainly worth reading if you're in the market for a soundbar, since we won't cover all the details.  The five models tested were from Philips, Marantz, Yamaha, Denon, and Polk.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1426";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #283 - Soundbar Shootout" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #283 - Soundbar Shootout" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #283 - Soundbar Shootout</title>
	<meta name="keywords" content="back lighting, surround sound, home theater, hdmi inputs, passive design, soundbar, sound, subwoofer, surround, speaker, hdmi, inputs, marantz, system, design, audio, pros, receiver, panel, speakers, yamaha, cons, both, hts, back" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #283 - Soundbar Shootout" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-283-soundbar-shootout.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1426', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-283-soundbar-shootout.php">HDTV and Home Theater Podcast #283 - Soundbar Shootout</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>June 11, 2008</b>
...
Overall the Polk sounded the Best, the Yamaha provided the best simulated surround sound and the Denon provided the best all around package.  But none of them were actually able to replace a true 5.1 system.<br />
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>June 11, 2008 11:01 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1426)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-283-soundbar-shootout.php" type="text/javascript" charset="utf-8"></script>
