...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-286-rf4ce-rf-standard-for-remote-controls.php&amp;title=HDTV and Home Theater Podcast #286 - RF4CE: RF Standard for Remote Controls">
		<span style="display:none">Isn't it annoying when you want to turn on your home theater with your IR based remote control and one or more components misses the command. It could be that someone walked in front of the remote or that you just didn't keep it pointed at your system long enough for the entire macro sequence to be transmitted. That's why most integrators shy away from IR based remotes and use systems like Crestron or Control4  to transmit commands to a head end unit which then sends the commands via Ethernet, Serial, or IR via an emitter to the equipment being controlled.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1444";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #286 - RF4CE: RF Standard for Remote Controls" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #286 - RF4CE: RF Standard for Remote Controls" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #286 - RF4CE: RF Standard for Remote Controls</title>
	<meta name="keywords" content="iphone ipod, home theater, global cache, remote controls, network access, remote, wifi, control, equipment, new, system, iphone, standard, commands, network, remotes, home, could, ipod, access, systems, based, want, via, theater" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #286 - RF4CE: RF Standard for Remote Controls" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-286-rf4ce-rf-standard-for-remote-controls.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1444', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-286-rf4ce-rf-standard-for-remote-controls.php">HDTV and Home Theater Podcast #286 - RF4CE: RF Standard for Remote Controls</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>June 22, 2008</b>
...
Theoretically the AirRemote is programmed via the iPhone and does not require the use of a professional installer. Air Remote supports AMX or Crestron automation systems. The developer says support for more devices are on the way.<br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>June 22, 2008  9:44 AM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1444)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-286-rf4ce-rf-standard-for-remote-controls.php" type="text/javascript" charset="utf-8"></script>
