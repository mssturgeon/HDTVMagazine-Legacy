...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-285-custom-installers-favorite-brands.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #285 - Custom Installers\' Favorite Brands" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #285 - Custom Installers' Favorite Brands" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/06/hdtv-and-home-theater-podcast-285-custom-installers-favorite-brands.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Every year CE Pro puts together a list of the top 100 custom electronics dealers in the country.  Then they poll those top dealers for their favorite brands to sell in 37 different categories.  Of course half the picture for dealers is how much profit they can make selling a particular product, but the other half of the picture is reliability and returns.  We like to look at the list to see what all the custom home theater installers are endorsing.  If you've narrowed a purchase down to two brands, it may help to swing your vote." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1432', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
