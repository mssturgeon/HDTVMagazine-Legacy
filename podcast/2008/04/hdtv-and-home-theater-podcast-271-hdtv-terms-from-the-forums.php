...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-271-hdtv-terms-from-the-forums.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #271 - HDTV Terms from the Forums" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #271 - HDTV Terms from the Forums" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-271-hdtv-terms-from-the-forums.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="When you're researching an HDTV, you often find yourself reading what others have posted at various forums such as AVS.  In those forums they tend to use a lot of jargon and lingo that a casual TV watcher may not understand, be aware of, or for that matter even care about.  Today we'll try to define a few of them and add some clarity around the whole subject.  As a &quot;spoiler warning&quot; if you own an HDTV, especially a rear projection HDTV, be warned.  We'll talk about some issues that can appear on the screen that you may have never noticed before.  If you start to look for them, you might start to actually see them.  If you prefer to live in ignorant bliss, you might want to skip this feature." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1368', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
