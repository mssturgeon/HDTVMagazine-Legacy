...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-266-cnets-top-5-hdtvs-and-hulucom.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1336";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #266 - CNet\'s top 5 HDTVs and Hulu.com" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #266 - CNet\'s top 5 HDTVs and Hulu.com" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #266 - CNet\'s top 5 HDTVs and Hulu.com" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #266 - CNet's top 5 HDTVs and Hulu.com</title>
	<meta name="keywords" content="best hdtv, between inches, buy best, hdtv between, best hdtvs, hulu, best, hdtv, content, video, new, inches, site, buy, shows, show, want, get, processor, pretty, website, intel, cnet, hdtvs, ram" />
...
" />
	<meta name="title" content="HDTV and Home Theater Podcast #266 - CNet's top 5 HDTVs and Hulu.com" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HDTV and Home Theater Podcast #266 - CNet's top 5 HDTVs and Hulu.com" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-266-cnets-top-5-hdtvs-and-hulucom.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="For today's show we'll talk about CNet's listing of the 5 best HDTVs they have reviewed.  Then we get into a discussion on Hulu.com - a new video streaming site with a lot of potential.
" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1336', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-266-cnets-top-5-hdtvs-and-hulucom.php">HDTV and Home Theater Podcast #266 - CNet's top 5 HDTVs and Hulu.com</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>April 10, 2008</b>
...
<p>System Requirements for viewing HD videos at Hulu<ul><li>Flash Player 9.0.115.0</li><li>2.5Mbps Internet connection or greater</li><li>Windows: Intel Pentium 4 3GHz processor (or equivalent), 128MB of RAM, 64MB of VRAM</li><li>Macintosh: Intel Core Duo 1.83GHz or faster processor, 256MB of RAM, 64MB of VRAM</li><li>Linux: Intel Pentium 4 3GHz processor (or equivalent), 128MB of RAM, 64MB of VRAM</li></ul></p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>April 10, 2008 11:45 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1336)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-266-cnets-top-5-hdtvs-and-hulucom.php" type="text/javascript" charset="utf-8"></script>
