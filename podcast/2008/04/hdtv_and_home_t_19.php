...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-266-cnets-top-5-hdtvs-and-hulucom.php&amp;title=HDTV and Home Theater Podcast #266 - CNet's top 5 HDTVs and Hulu.com">
		<span style="display:none">For today's show we'll talk about CNet's listing of the 5 best HDTVs they have reviewed.  Then we get into a discussion on Hulu.com - a new video streaming site with a lot of potential.
</span></a>
	</li>
</ul></div>
EOT;
...
" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-266-cnets-top-5-hdtvs-and-hulucom.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1336', 340, 125);">Add ASIN</a>
