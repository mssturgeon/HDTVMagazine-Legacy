...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-263-bradens-home-theater-setup.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #263 - Braden\'s Home Theater Setup" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #263 - Braden's Home Theater Setup" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-263-bradens-home-theater-setup.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="So by now everyone knows what's in Ara's Home Theater, in fact all over Ara's house, but we get questions occasionally on what Braden is using as well.  To put those questions to rest, we'll get into all the details today.  You've heard bits and pieces, like the recent addition of the PS3, but here's the whole system, all at one time." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1323', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
