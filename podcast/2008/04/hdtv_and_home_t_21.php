...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDTV and Home Theater Podcast #268 - Budget 32-inch LCDs&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-268-budget-32inch-lcds.php&amp;title=HDTV and Home Theater Podcast #268 - Budget 32-inch LCDs">
		<span style="display:none">First of all, you can now follow us at &lt;a target=&quot;blank&quot; href=&quot;http://twitter.com/hdtvpodcast&quot;&gt;Twitter&lt;/a&gt;.  Check it out and tell us what you think.  There's a fun article about &lt;a target=&quot;blank&quot; href=&quot;http://www.electronichouse.com/article/great_movie_scenes_for_surround_sound/C155&quot;&gt;Great Movie Scenes for Surround Sound&lt;/a&gt; at Electronic House and it seemed like something cool to discuss on the show.  And we've compiled a list of six 32&quot; HDTVs for budget conscious buyers. </span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1353";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #268 - Budget 32-inch LCDs" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #268 - Budget 32-inch LCDs" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #268 - Budget 32-inch LCDs</title>
	<meta name="keywords" content="accepts signals, lcd hdtv, composite video, video accepts, inputs including, video, star, signals, accepts, inch, digital, hdtv, buy, ntsc, reviews, inputs, including, component, amazon, atsc, lcd, composite, analog, time, response" />
	<meta name="description" content="First of all, you can now follow us at &lt;a target=&quot;blank&quot; href=&quot;http://twitter.com/hdtvpodcast&quot;&gt;Twitter&lt;/a&gt;.  Check it out and tell us what you think.  There's a fun article about &lt;a target=&quot;blank&quot; href=&quot;http://www.electronichouse.com/article/great_movie_scenes_for_surround_sound/C155&quot;&gt;Great Movie Scenes for Surround Sound&lt;/a&gt; at Electronic House and it seemed like something cool to discuss on the show.  And we've compiled a list of six 32&quot; HDTVs for budget conscious buyers. " />
	<meta name="title" content="HDTV and Home Theater Podcast #268 - Budget 32-inch LCDs" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-268-budget-32inch-lcds.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1353', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-268-budget-32inch-lcds.php">HDTV and Home Theater Podcast #268 - Budget 32-inch LCDs</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>April 17, 2008</b>
...
<em>Vizio VW32L 32 inch LCD HDTV</em> ($650 <a target="blank" href="http://www.htguys.com/shop.php?id=B0015EUO56">Buy Now</a>)<ul><li>720p 1366 x 768 Pixels</li><li>8 ms Response Time</li><li>built-in digital (ATSC) and analog (NTSC) tuners</li><li>6 A/V inputs, including:</li><ul><li>1 composite video (1 rear, 1 side)</li><li>1 VGA</li><li>2 component video (accepts signals up to 1080i)</li><li>2 HDMI</li></ul></ul>No reviews at Amazon at this time. A previous model received an average of four stars based on 19 customers. There were (3) three star reviews , (1) two star and (1) one star review for the previous model.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>April 17, 2008 11:34 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1353)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-268-budget-32inch-lcds.php" type="text/javascript" charset="utf-8"></script>
