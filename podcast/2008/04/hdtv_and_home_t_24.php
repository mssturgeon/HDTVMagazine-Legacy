...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1368";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #271 - HDTV Terms from the Forums" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #271 - HDTV Terms from the Forums" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #271 - HDTV Terms from the Forums</title>
	<meta name="keywords" content="refresh rate, response time, per second, response times, frame rate, screen, rate, response, refresh, time, see, effect, color, hdtv, lcd, often, times, ips, televisions, frames, dlp, display, appears, fps, second" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #271 - HDTV Terms from the Forums" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-271-hdtv-terms-from-the-forums.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1368', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-271-hdtv-terms-from-the-forums.php">HDTV and Home Theater Podcast #271 - HDTV Terms from the Forums</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>April 28, 2008</b>
...
Along with slow response times, another known on early LCD televisions was their very narrow viewing angle.  Off angle viewing was, let's just say, less than ideal.  The advent of in-plane switching solved that problem.  The technology itself gets a little too involved to discuss on the show, but it's important to know the LCD TVs with IPS have a practical viewing angle that rivals plasma.  Early versions of IPS caused significant slowdown in response times, as high as 50ms.  A newer version of IPS, called Super In-Plane Switching (S-IPS) offers all the benefit of IPS at the faster response times required by modern HDTV viewers.<br />
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>April 28, 2008 11:23 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1368)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-271-hdtv-terms-from-the-forums.php" type="text/javascript" charset="utf-8"></script>
