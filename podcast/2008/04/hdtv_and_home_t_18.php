...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-265-digital-converter-boxes-a-clarification.php&amp;title=HDTV and Home Theater Podcast #265 - Digital Converter Boxes, a clarification">
		<span style="display:none">As most of us know the big transition from analog to digital television in the US will happen in less than a year.  Either the public service announcements are starting to work, or people are just finally starting to pay attention, but our inbox is filling up with questions.  We tried to cover the whole issue back in &lt;a href=&quot;http://www.htguys.com/archive/2008/March11.html&quot;&gt;Episode 257&lt;/a&gt;, but we must have left out some crucial details because the email keeps coming.  We'll probably need to do this again in the future, but let's see if we can clarify things a little better.</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2008/04/hdtv-and-home-theater-podcast-265-digital-converter-boxes-a-clarification.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1333', 340, 125);">Add ASIN</a>
