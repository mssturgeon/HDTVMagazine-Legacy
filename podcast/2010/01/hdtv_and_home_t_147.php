...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3523 AND placement_is_primary = 1";
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2010/01/hdtv-and-home-theater-podcast-podcast-410-the-details-behind-3d-tv.php&amp;title=HDTV and Home Theater Podcast - Podcast #410: The Details Behind 3D TV">
		<span style="display:none">Far be it from us to stay away from the latest juicy new idea in home theater technology, 3D.  It's been all over the news and the blogs for a while, recently culminating with a huge display at CES.  Whether or not the technology actually catches on is a discussion for a different day.  Today we're going to talk about the technology behind it.&lt;img alt=&quot;&quot; border=&quot;0&quot; src=&quot;http://stats.wordpress.com/b.gif?host=htguys.wordpress.com&amp;blog=8935650&amp;post=119&amp;subd=htguys&amp;ref=&amp;feed=1&quot; /&gt;</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3523";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast - Podcast #410: The Details Behind 3D TV" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast - Podcast #410: The Details Behind 3D TV" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast - Podcast #410: The Details Behind 3D TV</title>
	<meta name="keywords" content="red blue, eye sees, saw ces, slightly different, active polarized, glasses, technology, polarized, different, eye, screen, image, seen, really, active, display, red, theater, create, ces, brain, home, movie, polarization, passive" />
	<meta name="description" content="Far be it from us to stay away from the latest juicy new idea in home theater technology, 3D.  It's been all over the news and the blogs for a while, recently culminating with a huge display at CES.  Whether or not the technology actually catches on is a discussion for a different day.  Today we're going to talk about the technology behind it.&lt;img alt=&quot;&quot; border=&quot;0&quot; src=&quot;http://stats.wordpress.com/b.gif?host=htguys.wordpress.com&amp;blog=8935650&amp;post=119&amp;subd=htguys&amp;ref=&amp;feed=1&quot; /&gt;" />
	<meta name="title" content="HDTV and Home Theater Podcast - Podcast #410: The Details Behind 3D TV" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2010/01/hdtv-and-home-theater-podcast-podcast-410-the-details-behind-3d-tv.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3523', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2010/01/hdtv-and-home-theater-podcast-podcast-410-the-details-behind-3d-tv.php">HDTV and Home Theater Podcast - Podcast #410: The Details Behind 3D TV</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>January 28, 2010</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=444&category=3D HDTV">3D HDTV</a></b>, <b><a href="/category.php?id=513&category=Events & Tradeshows">Events & Tradeshows</a></b>, <b><a href="/category.php?id=447&category=PC & Laptop Technology">PC & Laptop Technology</a></b>
							</td>
						</tr><tr colspan="2">
...
<h3><strong>The Details Behind 3D TV</strong></h3>
...
<p><a id="w8b0" title="More information on Anaglyphic 3D" href="http://en.wikipedia.org/wiki/Anaglyph_image">More information on Anaglyphic 3D</a></p>
...
<p><a id="w5-r" title="More info on Polarized 3D (RealD 3D)" href="http://en.wikipedia.org/wiki/RealD_3D">More info on Polarized 3D (RealD 3D)</a></p>
...
<p><a href="http://media.libsyn.com/media/hdtvpodcast/HDTV-2010-01-29.mp3">Download Episode #410</a></p>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 3523)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2010/01/hdtv-and-home-theater-podcast-podcast-410-the-details-behind-3d-tv.php" type="text/javascript" charset="utf-8"></script>
