...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1680 AND placement_is_primary = 1";
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2009/02/hdtv-and-home-theater-podcast-358-homenet-powerline-networking-by-corinex.php&amp;title=HDTV and Home Theater Podcast #358 - HomeNet Powerline Networking by Corinex">
		<span style="display:none">With more products entering the marketplace that support network connectivity it has become important for you to have network access near your electronics. For many a wireless adapter is enough to do the trick. But if you want to stream HD content you need 802.11N which will work well in most cases. Wireless works well until you have interference from other electronics or a neighbor's wifi setup. So what can you do to install a secure hardwired network without crawling through attics and ripping up drywall? </span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1680";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #358 - HomeNet Powerline Networking by Corinex" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #358 - HomeNet Powerline Networking by Corinex" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #358 - HomeNet Powerline Networking by Corinex</title>
	<meta name="keywords" content="powerline networking, homenet powerline, homenet adapter, netflix watch, networking corinex, homenet, network, via, adapter, powerline, mbps, less, data, slingbox, home, corinex, power, watch, product, networking, movies, hdtv, plug, setup, test" />
	<meta name="description" content="With more products entering the marketplace that support network connectivity it has become important for you to have network access near your electronics. For many a wireless adapter is enough to do the trick. But if you want to stream HD content you need 802.11N which will work well in most cases. Wireless works well until you have interference from other electronics or a neighbor's wifi setup. So what can you do to install a secure hardwired network without crawling through attics and ripping up drywall? " />
	<meta name="title" content="HDTV and Home Theater Podcast #358 - HomeNet Powerline Networking by Corinex" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2009/02/hdtv-and-home-theater-podcast-358-homenet-powerline-networking-by-corinex.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1680', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2009/02/hdtv-and-home-theater-podcast-358-homenet-powerline-networking-by-corinex.php">HDTV and Home Theater Podcast #358 - HomeNet Powerline Networking by Corinex</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>February 27, 2009</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=517&category=HD DVD">HD DVD</a></b>, <b><a href="/category.php?id=402&category=Marketplace">Marketplace</a></b>, <b><a href="/category.php?id=441&category=Wireless HDMI/HDTV">Wireless HDMI/HDTV</a></b>
							</td>
						</tr><tr colspan="2">
...
<div><a href="http://media.libsyn.com/media/hdtvpodcast/HDTV-2009-02-27.mp3">Listen Now - mp3</a></div>
...
<br><br>
<a target="_blank" href="http://www.corinex.com/">HomeNet Powerline Networking by Corinex</a>
<br><br>
...
<ul>
    <li>The HomeNet adapter has increased transmission line noise immunity. Traditionally electrically noisy devices such as hair dryers and vacuums plugged into the power line circuit now have less affect on the network.</li>
    <li>The HomeNet adapter has improved circuit sensitivity. Powerline adapters can now receive network data at higher speeds over longer distances with less packet loss.</li>
</ul>
...
<br><br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>February 27, 2009 12:00 AM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1680)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2009/02/hdtv-and-home-theater-podcast-358-homenet-powerline-networking-by-corinex.php" type="text/javascript" charset="utf-8"></script>
