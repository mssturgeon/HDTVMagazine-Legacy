...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2009/02/hdtv-and-home-theater-podcast-358-homenet-powerline-networking-by-corinex.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #358 - HomeNet Powerline Networking by Corinex" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #358 - HomeNet Powerline Networking by Corinex" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2009/02/hdtv-and-home-theater-podcast-358-homenet-powerline-networking-by-corinex.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="With more products entering the marketplace that support network connectivity it has become important for you to have network access near your electronics. For many a wireless adapter is enough to do the trick. But if you want to stream HD content you need 802.11N which will work well in most cases. Wireless works well until you have interference from other electronics or a neighbor's wifi setup. So what can you do to install a secure hardwired network without crawling through attics and ripping up drywall? " />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1680', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
