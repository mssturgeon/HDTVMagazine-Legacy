...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-359-universal-remote-control-20.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #359 - Universal Remote Control 2.0" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #359 - Universal Remote Control 2.0" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-359-universal-remote-control-20.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="We first mentioned the AirRemote application for the iPhone on Episode #286, noting that it should be coming soon and that it looked pretty cool. CE Pro recently posted a nice writeup about it. While we haven't tried it ourselves just yet, it does look like a very interesting concept. Although the power isn't just in using the iPhone to control your TV and Surround Sound receiver, it goes much deeper than that. Unfortunately we aren't quite there yet. " />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1683', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
