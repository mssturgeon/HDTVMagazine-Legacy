...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1685 AND placement_is_primary = 1";
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-361-refresh-rate-and-response-time.php&amp;title=HDTV and Home Theater Podcast #361 - Refresh Rate and Response Time">
		<span style="display:none">We get a handful of emails every week asking about Refresh Rates and Response Times: what are they? are they different? do I care? While refresh rate applies to any TV technology, response time is something an LCD buyer needs to know about. And with the rapid growth of LCD sales, it looks like just about everyone these days is an LCD buyer. So what do they mean and why do you care? We're glad you asked... </span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1685";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #361 - Refresh Rate and Response Time" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #361 - Refresh Rate and Response Time" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #361 - Refresh Rate and Response Time</title>
	<meta name="keywords" content="refresh rate, response time, per second, response times, times per, refresh, response, time, rate, screen, times, picture, get, change, second, lcd, takes, per, see, fps, fast, course, again, frames, image" />
	<meta name="description" content="We get a handful of emails every week asking about Refresh Rates and Response Times: what are they? are they different? do I care? While refresh rate applies to any TV technology, response time is something an LCD buyer needs to know about. And with the rapid growth of LCD sales, it looks like just about everyone these days is an LCD buyer. So what do they mean and why do you care? We're glad you asked... " />
	<meta name="title" content="HDTV and Home Theater Podcast #361 - Refresh Rate and Response Time" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-361-refresh-rate-and-response-time.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1685', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-361-refresh-rate-and-response-time.php">HDTV and Home Theater Podcast #361 - Refresh Rate and Response Time</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>March  9, 2009</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=456&category=Cable HDTV">Cable HDTV</a></b>, <b><a href="/category.php?id=493&category=LCD">LCD</a></b>, <b><a href="/category.php?id=510&category=LCD HDTVs">LCD HDTVs</a></b>, <b><a href="/category.php?id=484&category=LED (LCD)">LED (LCD)</a></b>
							</td>
						</tr><tr colspan="2">
...
<div><a href="http://media.libsyn.com/media/hdtvpodcast/HDTV-2009-03-10.mp3">Listen Now - mp3</a></div>
...
<br><br>
<strong>Refresh Rate and Response Time, What's up with That?</strong><br>
...
<br><br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>March  9, 2009 11:53 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1685)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-361-refresh-rate-and-response-time.php" type="text/javascript" charset="utf-8"></script>
