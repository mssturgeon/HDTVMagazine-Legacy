...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1683 AND placement_is_primary = 1";
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-359-universal-remote-control-20.php&amp;title=HDTV and Home Theater Podcast #359 - Universal Remote Control 2.0">
		<span style="display:none">We first mentioned the AirRemote application for the iPhone on Episode #286, noting that it should be coming soon and that it looked pretty cool. CE Pro recently posted a nice writeup about it. While we haven't tried it ourselves just yet, it does look like a very interesting concept. Although the power isn't just in using the iPhone to control your TV and Surround Sound receiver, it goes much deeper than that. Unfortunately we aren't quite there yet. </span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1683";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #359 - Universal Remote Control 2.0" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #359 - Universal Remote Control 2.0" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #359 - Universal Remote Control 2.0</title>
	<meta name="keywords" content="home theater, universal remote, remote control, communication between, iphone, remote, airremote, set, cool, control, theater, goes, home, could, want, touch, box, receiver, ipod, system, much, guide, same, isn, while" />
	<meta name="description" content="We first mentioned the AirRemote application for the iPhone on Episode #286, noting that it should be coming soon and that it looked pretty cool. CE Pro recently posted a nice writeup about it. While we haven't tried it ourselves just yet, it does look like a very interesting concept. Although the power isn't just in using the iPhone to control your TV and Surround Sound receiver, it goes much deeper than that. Unfortunately we aren't quite there yet. " />
	<meta name="title" content="HDTV and Home Theater Podcast #359 - Universal Remote Control 2.0" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-359-universal-remote-control-20.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1683', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-359-universal-remote-control-20.php">HDTV and Home Theater Podcast #359 - Universal Remote Control 2.0</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>March  3, 2009</b>
...
<div><a href="http://media.libsyn.com/media/hdtvpodcast/HDTV-2009-03-03.mp3">Listen Now - mp3</a></div>
...
We first mentioned the AirRemote application for the iPhone on 
<a target="_blank" href="http://www.htguys.com/archive/2008/June20.html">Episode #286</a>, noting that it should be coming soon and that it looked pretty cool.  CE Pro recently posted a nice 
<a target="_blank" href="http://www.cepro.com/article/airremote_for_iphone_greatest_little_tv_remote/">writeup</a> about it.  While we haven't tried it ourselves just yet, it does look like a very interesting concept.  Although the power isn't just in using the iPhone to control your TV and Surround Sound receiver, it goes much deeper than that.  Unfortunately we aren't quite there yet.
<br><br>
<strong>AirRemote for iPhone: ‘Greatest Little TV Remote’</strong>
<br><br>
...
<br><br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>March  3, 2009 12:12 AM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1683)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-359-universal-remote-control-20.php" type="text/javascript" charset="utf-8"></script>
