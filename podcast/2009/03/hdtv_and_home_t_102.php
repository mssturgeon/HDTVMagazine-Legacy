...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1695 AND placement_is_primary = 1";
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-365-gefen-wireless-hdmi-adapter-extwhdmi.php&amp;title=HDTV and Home Theater Podcast #365 - Gefen Wireless HDMI Adapter (EXT-WHDMI)">
		<span style="display:none">One issue many of us come across when setting up our home theaters is that the TV would look great in a particular spot in the room that is not necessarily the best spot for the source equipment. The dilemma is how do you get the video to the TV or projector. Gefen has you covered in this case. Their new wireless HDMI adapter will transmit HDMI audio and video up to 30 feet using Ultra-Wideband technology. But that is going to come at a cost. For that capability Gefen is selling the WDHDMI for $999. Still for some of you that cost is less than the cost of ripping up walls and running physical cables. </span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1695";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #365 - Gefen Wireless HDMI Adapter (EXT-WHDMI)" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #365 - Gefen Wireless HDMI Adapter (EXT-WHDMI)" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #365 - Gefen Wireless HDMI Adapter (EXT-WHDMI)</title>
	<meta name="keywords" content="transmitter receiver, hdmi adapter, source equipment, wireless hdmi, gefen wireless, hdmi, gefen, transmitter, receiver, feet, source, dolby, device, wireless, adapter, audio, devices, video, connect, wall, true, going, cost, inputs, support" />
	<meta name="description" content="One issue many of us come across when setting up our home theaters is that the TV would look great in a particular spot in the room that is not necessarily the best spot for the source equipment. The dilemma is how do you get the video to the TV or projector. Gefen has you covered in this case. Their new wireless HDMI adapter will transmit HDMI audio and video up to 30 feet using Ultra-Wideband technology. But that is going to come at a cost. For that capability Gefen is selling the WDHDMI for $999. Still for some of you that cost is less than the cost of ripping up walls and running physical cables. " />
	<meta name="title" content="HDTV and Home Theater Podcast #365 - Gefen Wireless HDMI Adapter (EXT-WHDMI)" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-365-gefen-wireless-hdmi-adapter-extwhdmi.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1695', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-365-gefen-wireless-hdmi-adapter-extwhdmi.php">HDTV and Home Theater Podcast #365 - Gefen Wireless HDMI Adapter (EXT-WHDMI)</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>March 24, 2009</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=496&category=Front Projection">Front Projection</a></b>, <b><a href="/category.php?id=475&category=HD Video Production">HD Video Production</a></b>, <b><a href="/category.php?id=447&category=PC & Laptop Technology">PC & Laptop Technology</a></b>, <b><a href="/category.php?id=441&category=Wireless HDMI/HDTV">Wireless HDMI/HDTV</a></b>
							</td>
						</tr><tr colspan="2">
...
<div><a href="http://media.libsyn.com/media/hdtvpodcast/HDTV-2009-03-24.mp3">Listen Now - mp3</a></div>
...
<br><br>
<strong><a target="_blank" href="http://www.gefen.com/kvm/dproduct.jsp?prod_id=4318">Gefen Wireless HDMI Adapter (EXT-WHDMI MSRP  $999)</a></strong>
<br><br>
<strong>Features:</strong>
<ul>
    <li>Real-time, visually lossless HD video compression</li>
    <li>Two HDMI inputs and one Component Video / Analog Audio input</li>
    <li>Support for Dolby 5.1 Surround Sound (<strong>No Dolby True HD or DTS MA support</strong>)</li>
    <li>Fully HDMI and HDCP compliant</li>
    <li>Supports HDMI 1.3 Lip Sync features for source devices</li>
    <li>2-ch Audio and PCM @ 32KHz, 44.1KHz, 48KHz supported as well as multichannel compressed 5.1 audio</li>
    <li>IR Blaster and IR Receiver jacks</li>
    <li>Input Selector Switch</li>
    <li>Up to 30 feet line-of-sight wireless operation with 65 Mbps throughput</li>
    <li>Frequency band range: 3.1 - 4.8 GHz</li>
    <li>Resolutions: 480i, 480p, 720p, 1080i and 1080p@24Hz, 25Hz, and 30Hz</li>
</ul>
...
<br><br><br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>March 24, 2009 12:24 AM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1695)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-365-gefen-wireless-hdmi-adapter-extwhdmi.php" type="text/javascript" charset="utf-8"></script>
