...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-361-refresh-rate-and-response-time.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #361 - Refresh Rate and Response Time" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #361 - Refresh Rate and Response Time" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-361-refresh-rate-and-response-time.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="We get a handful of emails every week asking about Refresh Rates and Response Times: what are they? are they different? do I care? While refresh rate applies to any TV technology, response time is something an LCD buyer needs to know about. And with the rapid growth of LCD sales, it looks like just about everyone these days is an LCD buyer. So what do they mean and why do you care? We're glad you asked... " />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1685', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
