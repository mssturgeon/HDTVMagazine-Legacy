...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-365-gefen-wireless-hdmi-adapter-extwhdmi.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV and Home Theater Podcast #365 - Gefen Wireless HDMI Adapter (EXT-WHDMI)" />
...
<head>
	...
	<meta property="og:title" content="HDTV and Home Theater Podcast #365 - Gefen Wireless HDMI Adapter (EXT-WHDMI)" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/podcast/2009/03/hdtv-and-home-theater-podcast-365-gefen-wireless-hdmi-adapter-extwhdmi.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="One issue many of us come across when setting up our home theaters is that the TV would look great in a particular spot in the room that is not necessarily the best spot for the source equipment. The dilemma is how do you get the video to the TV or projector. Gefen has you covered in this case. Their new wireless HDMI adapter will transmit HDMI audio and video up to 30 feet using Ultra-Wideband technology. But that is going to come at a cost. For that capability Gefen is selling the WDHDMI for $999. Still for some of you that cost is less than the cost of ripping up walls and running physical cables. " />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1695', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
