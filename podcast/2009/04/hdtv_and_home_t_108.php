...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1719 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDTV and Home Theater Podcast #371 - Data Robotics Drobo&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2009/04/hdtv-and-home-theater-podcast-371-data-robotics-drobo.php&amp;title=HDTV and Home Theater Podcast #371 - Data Robotics Drobo">
		<span style="display:none">If you listen to our show chances are you have a lot of media stored on your computer. Everything form mp3s to DVDs to family videos and pictures. It probably took you a while to take, scan, rip or download all this stuff and you certainly don't want to lose it since you probably can't recreate it all if you did. What we all need is a good backup strategy. One that works well and does not require much thought beyond the initial setup. That's where the Drobo comes in. The Drobo is a device that will protect your data from loss and is extremely simple to setup and use. </span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1719";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #371 - Data Robotics Drobo" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #371 - Data Robotics Drobo" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #371 - Data Robotics Drobo</title>
	<meta name="keywords" content="data robotics, drobo share, firefly itunes, itunes media, media server, drobo, data, drive, drives, network, computer, library, want, itunes, device, robotics, share, manage, hard, setup, makes, our, droboapps, size, new" />
	...
	<meta name="title" content="HDTV and Home Theater Podcast #371 - Data Robotics Drobo" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2009/04/hdtv-and-home-theater-podcast-371-data-robotics-drobo.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1719', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2009/04/hdtv-and-home-theater-podcast-371-data-robotics-drobo.php">HDTV and Home Theater Podcast #371 - Data Robotics Drobo</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>April 30, 2009</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=478&category=HTPCs & Laptops">HTPCs & Laptops</a></b>
							</td>
						</tr><tr colspan="2">
...
<div><a href="http://media.libsyn.com/media/hdtvpodcast/HDTV-2009-05-01.mp3">Listen Now - mp3</a></div>
...
If you listen to our show chances are you have a lot of media stored on your computer. Everything form mp3s to DVDs to family videos and pictures. It probably took you a while to take, scan, rip or download all this stuff and you certainly don't want to lose it since you probably can't recreate it all if you did. What we all need is a good backup strategy. One that works well and does not require much thought beyond the initial setup. That's where the Drobo comes in. The Drobo is a device that will protect your data from loss and is extremely simple to setup and use.
<br><br>
<strong><a target="_blank" href="http://drobo.com/products/drobo.php">Data Robotics Drobo</a> (<a target="_blank" href="http://www.htguys.com/shop.php?id=B001CZ9ZEE">Buy Now $440</a>)</strong>
<br><br>
...
<tbody><tr>
<td style="width: 115px; background-repeat: repeat-x;"><b>Drobo's Size:</b></td>
<td style="width: 65px; background-repeat: repeat-x;"><b>Width</b></td>
<td style="width: 65px; background-repeat: repeat-x;"><b>Height</b></td>
<td style="width: 65px; background-repeat: repeat-x;"><b>Length</b></td></tr>
<tr>
<td style="width: 65px;">inches</td>
<td style="width: 65px;">6.3</td>
<td style="width: 65px;">6.3</td>
<td style="width: 65px;">10.7</td>
</tr>
<tr>
<td style="width: 65px;">mm</td>
<td style="width: 65px;">152.4</td>
<td style="width: 65px;">160.0</td>
<td style="width: 65px;">271.8</td>
</tr>
</tbody></table>
<br><br>
...
<br><br>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1719)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2009/04/hdtv-and-home-theater-podcast-371-data-robotics-drobo.php" type="text/javascript" charset="utf-8"></script>
