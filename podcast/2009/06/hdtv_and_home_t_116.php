...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1748 AND placement_is_primary = 1";
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/podcast/2009/06/hdtv-and-home-theater-podcast-379-yamaha-rxv565bl-receiver.php&amp;title=HDTV and Home Theater Podcast #379 - Yamaha RX-V565BL Receiver">
		<span style="display:none">An HD picture is only half of the Home Theater experience. To complete it you need a good sound system. On this show we routinely talk about receivers that cost $750 and more which frustrates many listeners who want advanced features without spending a ton of money. The Yamaha RX V565 may be the machine that some of you have been looking for. At $430 its not the most capable machine out there but for some it will be a major step up over what they currently have been listening to. </span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (9) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1748";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV and Home Theater Podcast #379 - Yamaha RX-V565BL Receiver" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV and Home Theater Podcast #379 - Yamaha RX-V565BL Receiver" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV and Home Theater Podcast #379 - Yamaha RX-V565BL Receiver</title>
	<meta name="keywords" content="generation audio, surround sound, next generation, home theater, most receivers, yamaha, sound, receiver, audio, video, good, music, ipod, hdmi, sounded, bluetooth, receivers, our, surround, most, power, dock, system, generation, theater" />
	<meta name="description" content="An HD picture is only half of the Home Theater experience. To complete it you need a good sound system. On this show we routinely talk about receivers that cost $750 and more which frustrates many listeners who want advanced features without spending a ton of money. The Yamaha RX V565 may be the machine that some of you have been looking for. At $430 its not the most capable machine out there but for some it will be a major step up over what they currently have been listening to. " />
	<meta name="title" content="HDTV and Home Theater Podcast #379 - Yamaha RX-V565BL Receiver" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/podcast/2009/06/hdtv-and-home-theater-podcast-379-yamaha-rxv565bl-receiver.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1748', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/podcast/2009/06/hdtv-and-home-theater-podcast-379-yamaha-rxv565bl-receiver.php">HDTV and Home Theater Podcast #379 - Yamaha RX-V565BL Receiver</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>June 25, 2009</b>
...
<div><a href="http://media.libsyn.com/media/hdtvpodcast/HDTV-2009-06-26.mp3">Listen Now - mp3</a></div>
...
An HD picture is only half of the Home Theater experience. To complete it you need a good sound system. On this show we routinely talk about receivers that cost $750 and more which frustrates many listeners who want advanced features without spending a ton of money. The Yamaha RX V565 may be the machine that some of you have been looking for. At $430 its not the most capable machine out there but for some it will be a major step up over what they currently have been listening to.
<br><br>
<strong>Yamaha RX V565 (<a href="http://www.htguys.com/shop.php?id=B001S2RD9K" target="_blank">Buy Now $430</a>)</strong>
<br><br>
<strong>Features:</strong>
<ul>
	<li>Next Generation Audio decoding</li>
    <li>7-channel 630W surround sound (90W x 7)</li>
    <li>1080p-Compatible HDMI 1.3</li>
    <li>Analog video up-conversion to component video</li>
    <li>Bluetooth music streaming using Yamaha YBA-10 Bluetooth Audio Receiver</li>
    <li>Connect an iPod using Yamaha YDS-10SL Universal iPod Dock</li>
</ul><br>
<strong>Initial Impressions:</strong><br>
...
<ul>
    <li><strong>Silent Cinema</strong> - Essentially this is a virtual surround system that works with headphones. It works fairly well. It is definitely better than waking up the kids or the neighbors.</li>
    <li><strong>Virtual CINEMA DSP</strong> - This mode will provide a surround sound experience without the surround sound speakers. We did not try this mode.</li>
    <li><strong>Bluetooth</strong> - The optional YBA-10 Wireless Audio Adapter lets you connect and stream audio from Bluetooth enabled devices like Cell Phones and PDAs. We did not test this feature</li>
    <li><strong>iPod Dock</strong> - Optional dock for connecting your iPod to the receiver.</li>
</ul><br>
...
<br><br>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>June 25, 2009 11:47 PM</b>
			...
			<? if (9 != 7) echo getBoxMoreFromAuthor('The HT Guys', 1748)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/podcast/2009/06/hdtv-and-home-theater-podcast-379-yamaha-rxv565bl-receiver.php" type="text/javascript" charset="utf-8"></script>
