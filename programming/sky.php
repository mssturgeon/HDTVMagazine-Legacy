<?
	require('../global.php');
	$network = 'Sky';
	$network_lc = strtolower($network);
	$provider_id = 36;
	
	require(BASE_DIR .'/programming/satellite_header.php');
...
?>
	...
	<table class="bare" cellpadding="2">
		<tr><td style="font-weight:bold"><?=$network?> Website:</td><td><a href="/cgi-bin/ntlinktrack.cgi?http://www.sky.com/">www.sky.com</a></td></tr>
		<tr><td style="font-weight:bold">Official <?=$network?> HD Page:</td><td><a href="/cgi-bin/ntlinktrack.cgi?http://shop.sky.com/hd">shop.sky.com/hd</a></td></tr>
		<tr><td style="font-weight:bold">Editor's Notes:</td><td>
			We are working on adding additional channels to this page. Stay tuned.
		</td></tr>
	</table><br /><br />
