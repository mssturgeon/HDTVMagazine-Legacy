<?
	require('../global.php');
	$network = 'Bell ExpressVu';
	$network_lc = 'bell-expressvu';
	$provider_id = 7;
...
?>
	...
	<table class="bare" cellpadding="2">
		<tr><td style="font-weight:bold"><?=$network?> Website:</td><td><a href="/cgi-bin/ntlinktrack.cgi?http://www.expressvu.com/">www.expressvu.com</a></td></tr>
		<tr><td style="font-weight:bold">Official <?=$network?> HD Page:</td><td><a href="/cgi-bin/ntlinktrack.cgi?http://www.bell.ca/shopping/PrsShpTv_Dth_HDTV_Landing.page">www.bell.ca/shopping/PrsShpTv_Dth_HDTV_Landing.page</a></td></tr>
	</table><br /><br />
