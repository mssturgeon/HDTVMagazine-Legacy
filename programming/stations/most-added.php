...
<html>
<head>
	<title>HDTV Magazine - Most Added Stations</title>
	<?require(BASE_DIR .'/includes/common_header.php');?>
	<meta name="description" content="HDTV Stations - Most Added">
...
<body>
	...
	<div align="center">
	 	Listed below are the 50 most added stations to user profiles.
	</div>
		...
		<table class="bare" align="center" style="margin-top:20px">
			<tr><td><table class="type1b" align="center">
				...
				<?
					...
					$qry = "SELECT stat.tf_station_num, tf_station_name, count(*) count FROM join_user_station j, tms_dgstatrec stat WHERE j.tf_station_num = stat.tf_station_num AND j.user_id > 0 GROUP BY tf_station_name ORDER BY count DESC LIMIT 50";
					$result = mQuery($qry);
					while ($row = mysql_fetch_assoc($result)) {
						// Since max will always be the first row ...
