...
var lastrssbridgeurl="http://"+window.location.hostname+"/xml/bridge.php"
...
document.write('<div id="'+divId+'" class="'+divClass+'" >Retreiving latest news...</div>')
...
this.source[i]=this.feeditems[i].getElementsByTagName("source")[0].firstChild.nodeValue
}
...
var linktitle='<span class="rsstitle"><a href="'+this.link[this.pointer]+'">'+this.title[this.pointer]+'</a></span>'
var description='<span class="rssdescription">'+this.description[this.pointer]+'</span>'
var feeddate='<span class="rssdate">'+this.pubdate[this.pointer]+'</span>'
var feedsource='<span class="rsssource">'+this.source[this.pointer]+'</span>'
if (this.logicswitch.indexOf("description")==-1) description=""
if (this.logicswitch.indexOf("date")==-1) feeddate=""
if (this.logicswitch.indexOf("source")==-1) feedsource=""
/*
var tickercontent=linktitle+feeddate+description //STRING FOR FEED CONTENTS 
*/
var tickercontent = linktitle+'<br />'+feeddate+' - '+feedsource;
