...
<head>
	<!-- index.php template -->
	<title>HDTV Magazine Columns</title>
	...
	<meta name="description" content="The latest thoughts from the greatest in the industry in our HDTV Columns. Currently featuring columns from The HT Guys (Ara Derderian and Braden Russell) called Newbie&apos;s Corner, a thought provoking daily by Terry Paullin call &quot;Another Opinion&quot; and Ed Milbourn&apos;d &quot;Ed&apos;s View&quot;. Keep up with the HD buzz." />
	<? require(BASE_DIR .'/includes/page_header.php');?>
</head>
<body><div id="<?=$container?>">
	<? include(BASE_DIR .'/includes/body_header-4.php');?>

	<h1>HDTV Magazine Columns</h1>
			...
			<? if ($feed_url != '') {?>
				<div class="item"><span class="corners-top"><span></span></span>
					...
					<ul class="nosquare">
						...
						<li><a target="_blank" href="http://toolbar.google.com/buttons/add?url=http://www.hdtvmagazine.com/columns/toolbar_button.xml">Add to Google Toolbar</a></li>
					</ul>
				<span class="corners-bottom"><span></span></span></div>
			<?}?>
