...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3675 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2010/05/one-installers-opinion-a-half-dozen-reflections-on-a-thousand-theaters.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3675";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download One Installer\'s Opinion - A Half Dozen Reflections on a Thousand Theaters" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="One Installer\'s Opinion - A Half Dozen Reflections on a Thousand Theaters" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="One Installer\'s Opinion - A Half Dozen Reflections on a Thousand Theaters" />
...
The only systems I count are the ones I have designed (hardware), sourced, installed and calibrated myself, which means I have..." />
	<meta name="title" content="One Installer's Opinion - A Half Dozen Reflections on a Thousand Theaters" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="One Installer's Opinion - A Half Dozen Reflections on a Thousand Theaters" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2010/05/one-installers-opinion-a-half-dozen-reflections-on-a-thousand-theaters.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="O.K. Truth is, I don't know EXACTLY how many theatres I've actually done. When I started Front Row Cinema in 1988, general accounting was not the top priority. A few years later the IRS convinced me it should be higher on the list. Since then, two hard disc crashes have also taken a toll on the precision of the count. Still, as of April, 2009, the number of installations could conservatively be pegged at somewhere north of 900. Now add another year and something called &quot;editorial license&quot; (a term journalists hide behind when they want to make stuff up) and I've got to be very close to 1,000 installs, plus or minus.
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3675', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2010/05/one-installers-opinion-a-half-dozen-reflections-on-a-thousand-theaters.php">One Installer's Opinion - A Half Dozen Reflections on a Thousand Theaters</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Terry Paullin</b> on <b>May  6, 2010</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Terry Paullin', 3675)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2010/05/one-installers-opinion-a-half-dozen-reflections-on-a-thousand-theaters.php" type="text/javascript" charset="utf-8"></script>
