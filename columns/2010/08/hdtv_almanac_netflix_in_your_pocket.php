...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3927 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2010/08/hdtv-almanac-netflix-in-your-pocket.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3927";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Almanac - Netflix in Your Pocket" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Almanac - Netflix in Your Pocket" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HDTV Almanac - Netflix in Your Pocket" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Almanac - Netflix in Your Pocket</title>
	<meta name="keywords" content="access streaming, streaming service, free apps, netflix, apple, service, even, streaming, free, apps, computer, access, player, phone" />
	<meta name="description" content="Last spring, I wrote about Netflix demo&amp;#8217;ing its streaming service on a Windows Phone 7 operating system. Now comes word that Netflix is releasing free applications for the Apple iPhone and iPod Touch that will let subscribers access streaming content on these portable devices.

The free apps can access the streaming service across either a WiFi [...]" />
	<meta name="title" content="HDTV Almanac - Netflix in Your Pocket" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HDTV Almanac - Netflix in Your Pocket" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2010/08/hdtv-almanac-netflix-in-your-pocket.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Last spring, I wrote about Netflix demo&amp;#8217;ing its streaming service on a Windows Phone 7 operating system. Now comes word that Netflix is releasing free applications for the Apple iPhone and iPod Touch that will let subscribers access streaming content on these portable devices.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3927', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2010/08/hdtv-almanac-netflix-in-your-pocket.php">HDTV Almanac - Netflix in Your Pocket</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Alfred Poor</b> on <b>August 30, 2010</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=341&category=Internet HD Video">Internet HD Video</a></b>, <b><a href="/category.php?id=373&category=Mobile HDTV">Mobile HDTV</a></b>, <b><a href="/category.php?id=327&category=Service & Repair">Service & Repair</a></b>
							</td>
						</tr><tr colspan="2">
...
The free apps can access the streaming service across either <strong>a WiFi or 3G data connection</strong>. You can even stop in the middle of a movie or TV episode, and then when you come back, it will pick up <strong>right where you left off</strong>. This works even if you restart on another device, such as your home computer. You can download the free apps from <a href="jrhttp://www.itunes.com/appstore/">the Apple iTunes store</a>.</p>
	<p>This announcement is particularly interesting in the light of recent news reports that Apple is negotiating to rent <strong>TV episodes for $.99 each</strong>. The all-you-can-eat Netflix service is available to any subscriber with <strong>an $8.99 monthly subscription </strong>or higher, so the break-even point is just 10 shows a month, no matter whether you watch on your phone, media player, computer, notebook, video game console, or Internet-connected TV or Blu-ray player. Netflix is <strong>expanding its footprint</strong> across the entertainment landscape, and Apple&#8217;s pay-as-you-go model may be <strong>a difficult sell</strong>.
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Alfred Poor</b>, <b>August 30, 2010  6:00 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Alfred Poor', 3927)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2010/08/hdtv-almanac-netflix-in-your-pocket.php" type="text/javascript" charset="utf-8"></script>
