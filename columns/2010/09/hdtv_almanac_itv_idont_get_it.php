...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3940 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2010/09/hdtv-almanac-itv-idont-get-it.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3940";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Almanac - iTV: iDon&rsquo;t Get It" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Almanac - iTV: iDon&rsquo;t Get It" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HDTV Almanac - iTV: iDon&rsquo;t Get It" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Almanac - iTV: iDon&rsquo;t Get It</title>
	<meta name="keywords" content="netflix streaming, monthly subscription, start watching, content itunes, itv, itunes, netflix, apple, don, shows, content, see, least, releases, hulu, watching, subscription, lot, rent, get, here, makes, start, box, watch" />
	<meta name="description" content="The Internet is buzzing with the news about Apple&amp;#8217;s iTV. At the very least, this is a refreshing change from it buzzing with rumors about iTV. We all know that Steve Jobs is the master marketer of our time; he can turn a sow&amp;#8217;s ear into a silk purse just by talking about it. The [...]" />
	<meta name="title" content="HDTV Almanac - iTV: iDon&amp;rsquo;t Get It" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HDTV Almanac - iTV: iDon&amp;rsquo;t Get It" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2010/09/hdtv-almanac-itv-idont-get-it.php" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3940', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2010/09/hdtv-almanac-itv-idont-get-it.php">HDTV Almanac - iTV: iDon&rsquo;t Get It</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Alfred Poor</b> on <b>September  3, 2010</b>
	...
	<p>The<strong> $99 price </strong>for the iTV box makes sense, or at least a whole lot more sense than the price of the original Apple TV that it replaces. But I don&#8217;t see the appeal of <strong>the rental model </strong>for the content. I think that a lot of the viewing public will prefer<strong> the all-you-can-eat terms </strong>of Hulu (with the commercials) or Netflix (with the low monthly subscription) over the Apple offering. Aside from the loyal Apple fans, I&#8217;m not sure <strong>who is going to buy this</strong>. I can&#8217;t see it becoming the same sort of hit that <strong>the iPod or iPhone </strong>were when they were released.
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Alfred Poor</b>, <b>September  3, 2010  6:00 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Alfred Poor', 3940)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2010/09/hdtv-almanac-itv-idont-get-it.php" type="text/javascript" charset="utf-8"></script>
