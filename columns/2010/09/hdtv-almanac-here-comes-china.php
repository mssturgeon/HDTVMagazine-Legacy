...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3953 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2010/09/hdtv-almanac-here-comes-china.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3953";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Almanac - Here Comes China!" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Almanac - Here Comes China!" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HDTV Almanac - Here Comes China!" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Almanac - Here Comes China!</title>
	<meta name="keywords" content="consumer electronics, middle class, china, tvs, consumer, happen, start, much, costs, surplus, hdtvs, terms, know, our, middle, people, shortage, lcd, corning, class, likely, electronics" />
	<meta name="description" content="I know, I know, you&amp;#8217;ve heard that &amp;#8220;sleeping giant&amp;#8221; stuff too much lately. China&amp;#8217;s economy is becoming inexorably tied to that of the U.S., but there may be some ways that you haven&amp;#8217;t considered yet. For example, thanks to cheap manufacturing costs, many of our consumer electronics products are priced at just a fraction of [...]" />
	<meta name="title" content="HDTV Almanac - Here Comes China!" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HDTV Almanac - Here Comes China!" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2010/09/hdtv-almanac-here-comes-china.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="I know, I know, you&amp;#8217;ve heard that &amp;#8220;sleeping giant&amp;#8221; stuff too much lately. China&amp;#8217;s economy is becoming inexorably tied to that of the U.S., but there may be some ways that you haven&amp;#8217;t considered yet. For example, thanks to cheap manufacturing costs, many of our consumer electronics products are priced at just a fraction of [...]" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3953', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2010/09/hdtv-almanac-here-comes-china.php">HDTV Almanac - Here Comes China!</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Alfred Poor</b> on <b>September 10, 2010</b>
			...
			<div id="<?=$container?>" class="<?=$viglink_suppress?>">
				...
				<!--?=$v_buttons?-->
				<p>I know, I know, you&#8217;ve heard that &#8220;<strong>sleeping giant</strong>&#8221; stuff too much lately. China&#8217;s economy is becoming <strong>inexorably tied </strong>to that of the U.S., but there may be some ways that <strong>you haven&#8217;t considered yet</strong>. For example, thanks to cheap manufacturing costs, many of our consumer electronics products are priced at<strong> just a fraction </strong>of what they were a few years ago, including HDTVs. Okay, maybe <strong>that&#8217;s not news </strong>either.</p>
	...
	<p>The U.S. has been in the enviable position of being <strong>in the driver&#8217;s seat</strong>, with our demand defining the features and functions of consumer electronics, especially HDTVs. The picture presented by Corning has me wondering <strong>how much longer </strong>that will remain true.
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Alfred Poor</b>, <b>September 10, 2010  6:00 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Alfred Poor', 3953)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2010/09/hdtv-almanac-here-comes-china.php" type="text/javascript" charset="utf-8"></script>
