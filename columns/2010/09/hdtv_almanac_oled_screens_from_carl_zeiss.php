...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 3947 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2010/09/hdtv-almanac-oled-screens-from-carl-zeiss.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 3947";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Almanac - OLED Screens from Carl Zeiss" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Almanac - OLED Screens from Carl Zeiss" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HDTV Almanac - OLED Screens from Carl Zeiss" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Almanac - OLED Screens from Carl Zeiss</title>
	<meta name="keywords" content="carl eiss, oled displays, company makes, oled, screen, may, samsung, company, eiss, makes, ifa, revealed, goggles, carl, displays" />
	<meta name="description" content="You may recognize &amp;#8220;Carl Zeiss&amp;#8221; as the company that makes excellent optics for cameras and binoculars and telescopes, but the company also makes a head-mounted display system named &amp;#8220;cinemizer&amp;#8220;. At the recent IFA show, the company revealed an upgraded model that uses OLED panels in the goggles to deliver the images.
	Now, the downside is that [...]" />
	<meta name="title" content="HDTV Almanac - OLED Screens from Carl Zeiss" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HDTV Almanac - OLED Screens from Carl Zeiss" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2010/09/hdtv-almanac-oled-screens-from-carl-zeiss.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="You may recognize &amp;#8220;Carl Zeiss&amp;#8221; as the company that makes excellent optics for cameras and binoculars and telescopes, but the company also makes a head-mounted display system named &amp;#8220;cinemizer&amp;#8220;. At the recent IFA show, the company revealed an upgraded model that uses OLED panels in the goggles to deliver the images.
	Now, the downside is that [...]" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3947', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2010/09/hdtv-almanac-oled-screens-from-carl-zeiss.php">HDTV Almanac - OLED Screens from Carl Zeiss</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Alfred Poor</b> on <b>September  7, 2010</b>
	...
	<p>But if you&#8217;re looking to get a big-screen experience from OLED technology this year, this may be <strong>your best bet</strong>. Samsung showed their new 7&#8243; Samsung Galazy Tab tablet device at IFA, and revealed that it will only have <strong>an LCD screen</strong>. After all of Samsung&#8217;s brave talk about<strong> OLED displays</strong>, some may find this disappointing but there are plenty of us who view this news as no surprise. We&#8217;re still<strong> a long way out </strong>from large scale production of OLED displays larger than<strong> a cell phone screen.</strong>
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Alfred Poor</b>, <b>September  7, 2010  6:00 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Alfred Poor', 3947)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2010/09/hdtv-almanac-oled-screens-from-carl-zeiss.php" type="text/javascript" charset="utf-8"></script>
