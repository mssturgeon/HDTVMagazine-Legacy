...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2011/04/one-installers-opinion-this-changes-everything-about-calibration.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="One Installer\'s Opinion - This Changes Everything ... (About Calibration)" />
...
Clearly, not all display devices calibrate equally well. There are several factors that impact the end result..." />
	...
	<meta property="og:title" content="One Installer's Opinion - This Changes Everything ... (About Calibration)" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2011/04/one-installers-opinion-this-changes-everything-about-calibration.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Readers of this magazine have long been about examining the best of audio and video ... ... if not for their own consumption, then just to better understand how various Home Theatre products get to be &quot;the best that they can be&quot;. Regular readers of video product reviews in these pages have come to understand that NO display product can fully realize its potential until it has been calibrated in the environment in which it lives - perhaps your living room.
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4299', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2011/04/one-installers-opinion-this-changes-everything-about-calibration.php">One Installer's Opinion - This Changes Everything ... (About Calibration)</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Terry Paullin</b> on <b>April 14, 2011</b>
			...
			<div id="<?=$container?>" class="<?=$viglink_suppress?>">
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Terry Paullin</b>, <b>April 14, 2011  7:14 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Terry Paullin', 4299)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2011/04/one-installers-opinion-this-changes-everything-about-calibration.php" type="text/javascript" charset="utf-8"></script>
