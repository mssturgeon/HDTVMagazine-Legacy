...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2011/04/one-installers-opinion-3disappointment-chicken-little-is-screaming-and-other-matters.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="One Installer\'s Opinion - 3D..isappointment, Chicken Little is screaming ...and other matters" />
...
Here's where I think we are. The only delivery scheme that has a chance in your living room is..." />
	...
	<meta property="og:title" content="One Installer's Opinion - 3D..isappointment, Chicken Little is screaming ...and other matters" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2011/04/one-installers-opinion-3disappointment-chicken-little-is-screaming-and-other-matters.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="No, this isn't the I-told-ya-so column ... yet. Events have moved much faster than I predicted when I wrote a column on this topic about a year ago, but it seems we are headed for the same forecasted result.  In that column I pointed to lack of standards, lack of content, the glasses nuisance and the problematic usage model in the home as probable deterrents to wide (or any) adoption of 3D in your living room. Press releases received over the past few months from various independent surveys have &quot;leaked&quot; reports of disappointing sales from even the most conservative manufacturers estimates. Last week, an article in reuters.com confirmed &quot;3DTV hasn't caught the imagination of consumers&quot;. Reasons cited later in the article were ... uhh ... lack of standards, lack of content and, yup, those pesky glasses. To make matters even worse, in an almost unbelievably inept marketing move, studios partnered with specific manufacturers to offer &quot;exclusive&quot; content packages - as if wanting to spend an hour and a half with &quot;Coraline&quot; would cause you to buy a Panasonic display over a Samsung, all other features and functions, including price, be damned.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4302', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2011/04/one-installers-opinion-3disappointment-chicken-little-is-screaming-and-other-matters.php">One Installer's Opinion - 3D..isappointment, Chicken Little is screaming ...and other matters</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Terry Paullin</b> on <b>April 26, 2011</b>
			...
			<div id="<?=$container?>" class="<?=$viglink_suppress?>">
				...
				<!--?=$v_buttons?-->
				<p class="editorial">The following article originally appeared in Wide Screen Review (WSR) magazine at the end of 2010 and is being republished courtesy of the author, Terry Paullin.</p><p>No, this isn't the I-told-ya-so column ... yet. Events have moved much faster than I predicted when I wrote a column on this topic about a year ago, but it seems we are headed for the same forecasted result.  In that column I pointed to lack of standards, lack of content, the glasses nuisance and the problematic usage model in the home as probable deterrents to wide (or any) adoption of 3D in your living room. Press releases received over the past few months from various independent surveys have "leaked" reports of disappointing sales from even the most conservative manufacturers estimates. Last week, an article in reuters.com confirmed "3DTV hasn't caught the imagination of consumers". Reasons cited later in the article were ... uhh ... lack of standards, lack of content and, yup, those pesky glasses. To make matters even worse, in an almost unbelievably inept marketing move, studios partnered with specific manufacturers to offer "exclusive" content packages - as if wanting to spend an hour and a half with "Coraline" would cause you to buy a Panasonic display over a Samsung, all other features and functions, including price, be damned.
...
 </p><p>As I write, I'm psychologically packing my bags for the 2011 CES (Consumer Electronics Show). I'm expecting the 3D rhetoric to be as loud as last year in an attempt to breath (more) life into a huge, collective investment. I'm guessing much of the traffic will be re-routed to the booths featuring the latest i-toys. I smell a hint of "5G" in the air.
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Terry Paullin</b>, <b>April 26, 2011  7:50 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Terry Paullin', 4302)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2011/04/one-installers-opinion-3disappointment-chicken-little-is-screaming-and-other-matters.php" type="text/javascript" charset="utf-8"></script>
