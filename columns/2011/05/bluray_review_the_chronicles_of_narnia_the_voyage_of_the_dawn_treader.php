...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 4366 AND placement_is_primary = 1";
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/columns/2011/05/bluray-review-the-chronicles-of-narnia-the-voyage-of-the-dawn-treader.php&amp;title=Blu-ray Review: The Chronicles of Narnia: The Voyage of the Dawn Treader">
		<span style="display:none">4.5 Stars (out of 5) Synopsis With their dour, bookish cousin Eustace (Will Poulter) in tow, the youngest Pevensie offspring -- Lucy (Georgie Henley) and Edmund (Skandar Keynes) -- take an unexpected trip back to Narnia and join noble King...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
<div id="dd_right"><ul>
	...
	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2011/05/bluray-review-the-chronicles-of-narnia-the-voyage-of-the-dawn-treader.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	<!--li class="li_horizontal"><fb:like href="http://www.hdtvmagazine.com/columns/2011/05/bluray-review-the-chronicles-of-narnia-the-voyage-of-the-dawn-treader.php" layout="button_count" show_faces="false" width="100"></fb:like></li-->
...
#			$apture = '<script id="aptureScript" type="text/javascript" src="http://www.apture.com/js/apture.js?siteToken=kwQEuu6" charset="utf-8"></script>';
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 4366";
...
<head>
	...
	<meta name="description" content="4.5 Stars (out of 5) Synopsis With their dour, bookish cousin Eustace (Will Poulter) in tow, the youngest Pevensie offspring -- Lucy (Georgie Henley) and Edmund (Skandar Keynes) -- take an unexpected trip back to Narnia and join noble King..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/columns/2011/05/bluray-review-the-chronicles-of-narnia-the-voyage-of-the-dawn-treader.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4366', 340, 125);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2011/05/bluray-review-the-chronicles-of-narnia-the-voyage-of-the-dawn-treader.php">Blu-ray Review: The Chronicles of Narnia: The Voyage of the Dawn Treader</a></td>
						</tr><tr>
			...
			<div id="<?=$container?>">
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Ed Milbourn</b>, <b>May 31, 2011  7:44 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Ed Milbourn', 4366)?>
...
<!-- FM Medium Rectangle Zone -->
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2011/05/bluray-review-the-chronicles-of-narnia-the-voyage-of-the-dawn-treader.php" type="text/javascript" charset="utf-8"></script>
