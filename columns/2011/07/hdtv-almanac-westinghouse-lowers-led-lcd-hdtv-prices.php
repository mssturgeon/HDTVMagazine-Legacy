...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 4464 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2011/07/hdtv-almanac-westinghouse-lowers-led-lcd-hdtv-prices.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 4464";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Almanac - Westinghouse Lowers LED LCD HDTV Prices" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Almanac - Westinghouse Lowers LED LCD HDTV Prices" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HDTV Almanac - Westinghouse Lowers LED LCD HDTV Prices" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Almanac - Westinghouse Lowers LED LCD HDTV Prices</title>
	<meta name="keywords" content="led backlit, led backlights, led, less, westinghouse, market, manufacturers, line, premium, prices, hdtv, lcd, backlit, feature, new, models, price, sale, most, backlights, features" />
	<meta name="description" content="You can scratch off another &amp;amp;#8220;premium&amp;amp;#8221; feature that no longer carries a premium price. According to the company&amp;amp;#8217;s press release, Westinghouse Digital has announced that it is shipping LCD HDTVs with LED backlights at prices that challenge the traditionally less-expensive cold-cathode fluorescent lamp (CCFL) backlight designs. Its 40&amp;amp;#8243; LD-4070Z is on sale online now at [...]" />
	<meta name="title" content="HDTV Almanac - Westinghouse Lowers LED LCD HDTV Prices" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HDTV Almanac - Westinghouse Lowers LED LCD HDTV Prices" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2011/07/hdtv-almanac-westinghouse-lowers-led-lcd-hdtv-prices.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="You can scratch off another &amp;amp;#8220;premium&amp;amp;#8221; feature that no longer carries a premium price. According to the company&amp;amp;#8217;s press release, Westinghouse Digital has announced that it is shipping LCD HDTVs with LED backlights at prices that challenge the traditionally less-expensive cold-cathode fluorescent lamp (CCFL) backlight designs. Its 40&amp;amp;#8243; LD-4070Z is on sale online now at [...]" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=4464', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2011/07/hdtv-almanac-westinghouse-lowers-led-lcd-hdtv-prices.php">HDTV Almanac - Westinghouse Lowers LED LCD HDTV Prices</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Alfred Poor</b> on <b>July 29, 2011</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=336&category=Digital (DTV) Transition">Digital (DTV) Transition</a></b>, <b><a href="/category.php?id=511&category=LCD HDTVs">LCD HDTVs</a></b>, <b><a href="/category.php?id=503&category=LED (LCD) HDTVs">LED (LCD) HDTVs</a></b>
							</td>
						</tr><tr colspan="2">
	...
	<p>I suspect that it&#8217;s <strong>a whole lot more fun </strong>to be the consumer and not the manufacturer in this market.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Alfred Poor</b>, <b>July 29, 2011  6:00 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Alfred Poor', 4464)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2011/07/hdtv-almanac-westinghouse-lowers-led-lcd-hdtv-prices.php" type="text/javascript" charset="utf-8"></script>
