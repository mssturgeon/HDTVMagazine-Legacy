...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2008/10/eds-view-local-hd-in-indy-lucky-13.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Ed\'s View: Local HD in Indy - Lucky "13"" />
...
It is no secret that the old over-the-air (OTA) TV broadcast business model is in trouble at both the major network and local levels..." />
	...
	<meta property="og:title" content="Ed's View: Local HD in Indy - Lucky &quot;13&quot;" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2008/10/eds-view-local-hd-in-indy-lucky-13.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Actually, it's Indianapolis that's lucky to have WTHR, Channel 13, as one of the premier US leaders in providing local HDTV programming. WTHR is at this time the only Indiana station producing HDTV local news and other local programming in this 25th largest market in the US - in which it has been consistently Number 1. This narration is not to be considered a &quot;commercial&quot; for WTHR, (but it would not be judged an affront if so assumed). Rather it is a salute to all those local digital broadcasting pioneers who have had the foresight to fully embraced the technology and adjust their business plans to exploit all the benefits to their customers that can be provided - including, most specifically, locally produced HDTV programming. 
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1505', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
