...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2008/06/hdtv-almanac-the-games-the-thing.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV Almanac - The Game&rsquo;s the Thing!" />
...
<head>
	...
	<meta property="og:title" content="HDTV Almanac - The Game&amp;rsquo;s the Thing!" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2008/06/hdtv-almanac-the-games-the-thing.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="What drives technology adoption, especially for consumer electronics products? History has shown that pornography is a major (though often unmentioned) force. I suspect that sports comes in a close second. I remember that early color television programming focused on sporting events. Sports also make up a large part of the HDTV programming that&amp;#8217;s available today. [...]" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=2192', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
