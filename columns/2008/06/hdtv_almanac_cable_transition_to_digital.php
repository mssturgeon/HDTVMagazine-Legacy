...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2008/06/hdtv-almanac-cable-transition-to-digital.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV Almanac - Cable Transition to Digital" />
...
<head>
	...
	<meta property="og:title" content="HDTV Almanac - Cable Transition to Digital" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2008/06/hdtv-almanac-cable-transition-to-digital.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="I&amp;#8217;ve been doing my best to spread the word about the details of the upcoming transition to digital-only terrestrial broadcasts of television signals. One of the key points I&amp;#8217;ve try to stress is that if you have cable or satellite service, you will not be affected by the digital changeover when it happens next February [...]" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=2193', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
