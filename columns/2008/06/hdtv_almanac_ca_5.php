...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 2193 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDTV Almanac - Cable Transition to Digital&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/columns/2008/06/hdtv-almanac-cable-transition-to-digital.php&amp;title=HDTV Almanac - Cable Transition to Digital">
		<span style="display:none">I&amp;#8217;ve been doing my best to spread the word about the details of the upcoming transition to digital-only terrestrial broadcasts of television signals. One of the key points I&amp;#8217;ve try to stress is that if you have cable or satellite service, you will not be affected by the digital changeover when it happens next February [...]</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 2193";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Almanac - Cable Transition to Digital" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Almanac - Cable Transition to Digital" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Almanac - Cable Transition to Digital</title>
	<meta name="keywords" content="analog digital, digital service, hdtv almanac, cable subscribers, transition digital, digital, cable, analog, service, affected, hdtv, subscribers, been, signals, stb, switch, terrestrial, almanac, keep, won, lets, box, changeover, transmit, problem" />
	<meta name="description" content="I&amp;#8217;ve been doing my best to spread the word about the details of the upcoming transition to digital-only terrestrial broadcasts of television signals. One of the key points I&amp;#8217;ve try to stress is that if you have cable or satellite service, you will not be affected by the digital changeover when it happens next February [...]" />
	<meta name="title" content="HDTV Almanac - Cable Transition to Digital" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/columns/2008/06/hdtv-almanac-cable-transition-to-digital.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=2193', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2008/06/hdtv-almanac-cable-transition-to-digital.php">HDTV Almanac - Cable Transition to Digital</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Alfred Poor</b> on <b>June 25, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=457&category=Cable HDTV">Cable HDTV</a></b>, <b><a href="/category.php?id=336&category=Digital (DTV) Transition">Digital (DTV) Transition</a></b>, <b><a href="/category.php?id=333&category=Digital Rights Management (DRM)">Digital Rights Management (DRM)</a></b>, <b><a href="/category.php?id=327&category=Service & Repair">Service & Repair</a></b>
							</td>
						</tr><tr colspan="2">
...
<em>Alfred Poor</em></p></blockquote>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Alfred Poor</b>, <b>June 25, 2008  6:00 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Alfred Poor', 2193)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2008/06/hdtv-almanac-cable-transition-to-digital.php" type="text/javascript" charset="utf-8"></script>
