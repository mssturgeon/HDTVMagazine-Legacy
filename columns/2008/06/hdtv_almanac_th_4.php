...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 2192 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDTV Almanac - The Game&rsquo;s the Thing!&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/columns/2008/06/hdtv-almanac-the-games-the-thing.php&amp;title=HDTV Almanac - The Game&amp;rsquo;s the Thing!">
		<span style="display:none">What drives technology adoption, especially for consumer electronics products? History has shown that pornography is a major (though often unmentioned) force. I suspect that sports comes in a close second. I remember that early color television programming focused on sporting events. Sports also make up a large part of the HDTV programming that&amp;#8217;s available today. [...]</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 2192";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Almanac - The Game&rsquo;s the Thing!" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Almanac - The Game&rsquo;s the Thing!" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Almanac - The Game&rsquo;s the Thing!</title>
	<meta name="keywords" content="million hours, visitors watched, live coverage, turn internet, sports, million, internet, coverage, programming, visitors, turn, well, content, watched, start, adoption, part, comes, total, superbowl, close, free, available, make, double" />
	<meta name="description" content="What drives technology adoption, especially for consumer electronics products? History has shown that pornography is a major (though often unmentioned) force. I suspect that sports comes in a close second. I remember that early color television programming focused on sporting events. Sports also make up a large part of the HDTV programming that&amp;#8217;s available today. [...]" />
	<meta name="title" content="HDTV Almanac - The Game&amp;rsquo;s the Thing!" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/columns/2008/06/hdtv-almanac-the-games-the-thing.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=2192', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2008/06/hdtv-almanac-the-games-the-thing.php">HDTV Almanac - The Game&rsquo;s the Thing!</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Alfred Poor</b> on <b>June 26, 2008</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=448&category=PC & Laptop Technology">PC & Laptop Technology</a></b>, <b><a href="/category.php?id=311&category=Programming">Programming</a></b>
							</td>
						</tr><tr colspan="2">
	...
	<p>If the past repeats itself, more people will <strong>turn to the Internet </strong>for sports coverage, and in turn, will start looking at <strong>other content available online </strong>as well. If you have an Internet connection to your television and you get <strong>comfortable </strong>using it for sports, you&#8217;re more likely to start using it for<strong> other programming </strong>. I don&#8217;t expect that sports will turn Internet video into <strong>an overnight success</strong>, but the signs are clearly there that <strong>interest is growing</strong>.
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Alfred Poor</b>, <b>June 26, 2008  6:00 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Alfred Poor', 2192)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2008/06/hdtv-almanac-the-games-the-thing.php" type="text/javascript" charset="utf-8"></script>
