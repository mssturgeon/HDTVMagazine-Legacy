...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 2185 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDTV Almanac - Reading the Tea Leaves&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/columns/2008/07/hdtv-almanac-reading-the-tea-leaves.php&amp;title=HDTV Almanac - Reading the Tea Leaves">
		<span style="display:none">As Costello might say, &amp;#8220;I&amp;#8217;ve got a baaaad feelin&amp;#8217; about this, Abbot.&amp;#8221; We&amp;#8217;ve started the second half of 2008, and the HDTV market forecast is clear as mud.
	Data point: Sony Electronics president Stan Glasgow is quoted as being upbeat about consumer electronics sales for the rest of 2008. At the CEA Executive Summit he said [...]</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 2185";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Almanac - Reading the Tea Leaves" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Almanac - Reading the Tea Leaves" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Almanac - Reading the Tea Leaves</title>
	<meta name="keywords" content="flat panel, data point, think transition, price cuts, going, hdtv, panel, market, sales, people, flat, think, big, year, data, price, point, buy, extra, prices, economic, retailers, being, got, cost" />
	<meta name="description" content="As Costello might say, &amp;#8220;I&amp;#8217;ve got a baaaad feelin&amp;#8217; about this, Abbot.&amp;#8221; We&amp;#8217;ve started the second half of 2008, and the HDTV market forecast is clear as mud.
	...
	<meta name="title" content="HDTV Almanac - Reading the Tea Leaves" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/columns/2008/07/hdtv-almanac-reading-the-tea-leaves.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=2185', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2008/07/hdtv-almanac-reading-the-tea-leaves.php">HDTV Almanac - Reading the Tea Leaves</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Alfred Poor</b> on <b>July  7, 2008</b>
			...
			<div id="<?=$container?>">
				...
				<?=$review_header?>
				<?=$az_image?>
				<p>As Costello might say, &#8220;I&#8217;ve got <strong>a baaaad feelin&#8217; </strong>about this, Abbot.&#8221; We&#8217;ve started the second half of 2008, and the HDTV market forecast is <strong>clear as mud</strong>.</p>
	...
	<p>I believe that<strong> cash will be king </strong>this fall, and that price cuts will show up <strong>early and often</strong>. If you&#8217;ve got the money saved up for a new TV, you&#8217;ll find <strong>some great prices </strong>in time for the first regular season NFL game. And if you can <strong>wait until December</strong>, I think you&#8217;ll see some astounding deals. It will take <strong>an economic miracle </strong>to produce a big growth in flat panel sales this year, and I don&#8217;t think that&#8217;s going to happen.
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Alfred Poor</b>, <b>July  7, 2008  6:00 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Alfred Poor', 2185)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2008/07/hdtv-almanac-reading-the-tea-leaves.php" type="text/javascript" charset="utf-8"></script>
