...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1486 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2008/07/hd-waveform-vertical-and-horizontal-filtering.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1486";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HD Waveform - Vertical and Horizontal Filtering" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HD Waveform - Vertical and Horizontal Filtering" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HD Waveform - Vertical and Horizontal Filtering" />
...
<html>
<head>
	<title>HDTV Magazine - HD Waveform - Vertical and Horizontal Filtering</title>
	<meta name="keywords" content="vertical filtering, single pixel, vertical horizontal, vertical lines, horizontal filtering, vertical, filtering, response, lines, horizontal, pixel, displays, line, crt, burst, detail, screen, hdtv, display, single, test, high, content, video, even" />
...
The first step with horizontal and vertical filtering is..." />
	<meta name="title" content="HD Waveform - Vertical and Horizontal Filtering" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HD Waveform - Vertical and Horizontal Filtering" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2008/07/hd-waveform-vertical-and-horizontal-filtering.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="While rarely mentioned over the decades, vertical filtering, which removes horizontal detail in your image, has been around as long as CRT has and is still used to this day in displays and source scaling. Even with the arrival of DTV in 1998, vertical filtering was commonly used in the video circuits of consumer 1080i HDTV CRT displays. For this article we are looking at vertical or horizontal filtering related to luminance response.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1486', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2008/07/hd-waveform-vertical-and-horizontal-filtering.php">HD Waveform - Vertical and Horizontal Filtering</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Richard Fisher</b> on <b>July 31, 2008</b>
...
<p>Only you can determine the role vertical filtering plays in your system and the content that you watch versus how much money you want to spend to remove the artifact. Please read the <a target="_blank" href="http://www.hdtvmagazine.com/reviews/2008/06/hqv_benchmark_blu-ray_dvd_and_hd_dvd.php">HQV Benchmark review</a> for more details.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Richard Fisher</b>, <b>July 31, 2008  8:16 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Richard Fisher', 1486)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2008/07/hd-waveform-vertical-and-horizontal-filtering.php" type="text/javascript" charset="utf-8"></script>
