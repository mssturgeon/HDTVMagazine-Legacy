...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2008/07/hdtv-almanac-tru2way-to-dominate-cable.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV Almanac - Tru2way to Dominate Cable" />
...
<head>
	...
	<meta property="og:title" content="HDTV Almanac - Tru2way to Dominate Cable" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2008/07/hdtv-almanac-tru2way-to-dominate-cable.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="According to a new report from ABI Research, half of all cable subscribers will use tru2way technology for their cable connection by 2013. Originally named Open Cable Applications Platform (OCAP), tru2way supports interactive television features for cable services. The technology can be built into traditional set top boxes, or can be incorporated directly in television [...]" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=2188', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
