...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/columns/2008/02/another-opinion-the-case-for-outboard-video-processing.php&amp;title=Another Opinion - The Case for Outboard Video Processing">
		<span style="display:none">If you haven't already, marketing types everywhere are saying you probably will - buy a large screen TV in 2008 that is. For our purpose here, let's define large as anything north of a 50&quot; diagonal. With the resurgence of a couple good RPTVs, precipitous price drops in both LCD and Plasma large panels and really good front projector/screen combos in the under $5,000 range, many more of you WILL opt for Big Screen nirvana this year. But will all truly be well in Megapixelville? If all you do is replace the monitor, maybe not so much.

Here's the thing. From the beginning...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1240";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Another Opinion - The Case for Outboard Video Processing" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Another Opinion - The Case for Outboard Video Processing" />
...
<html>
<head>
	<title>HDTV Magazine - Another Opinion - The Case for Outboard Video Processing</title>
	<meta name="keywords" content="video processing, video artifacts, outboard box, fixed pixel, big screen, video, processing, screen, line, may, big, display, outboard, artifacts, resolution, could, front, good, even, been, box, panel, well, thing, set" />
...
Here's the thing. From the beginning..." />
	<meta name="title" content="Another Opinion - The Case for Outboard Video Processing" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/columns/2008/02/another-opinion-the-case-for-outboard-video-processing.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1240', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2008/02/another-opinion-the-case-for-outboard-video-processing.php">Another Opinion - The Case for Outboard Video Processing</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Terry Paullin</b> on <b>February  4, 2008</b>
...
<p>HDTV has changed our standards. Indeed, it will make you more critical of lower resolution images, even if they were on the same size screen that you've been used to. If your favorite programming still includes a steady diet of 480 line video, I suggest you try an outboard box before investing in a big new receiver/pre-pro just to get more HDMI inputs. Even if you are fast becoming an "HD only" person, the dedicated, high quality video processing will make a welcomed visible difference. Don't be afraid of the set-up. There are lots of menu choices on these boxes, but that's a good thing. Basically, it ensures they will work in any situation and on YOUR video monitor. People like DVDO (and others, I'm sure) have excellent tutorials and phone support - they don't like returns either.<br />
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Terry Paullin</b>, <b>February  4, 2008  9:45 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Terry Paullin', 1240)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2008/02/another-opinion-the-case-for-outboard-video-processing.php" type="text/javascript" charset="utf-8"></script>
