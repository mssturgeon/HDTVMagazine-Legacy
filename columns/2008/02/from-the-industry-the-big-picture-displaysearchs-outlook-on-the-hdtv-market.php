...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2008/02/from-the-industry-the-big-picture-displaysearchs-outlook-on-the-hdtv-market.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="From the Industry - The Big Picture: DisplaySearch\'s Outlook on the HDTV Market" />
...
DisplaySearch predicts the cumulative number of HDTVs in the US will..." />
	...
	<meta property="og:title" content="From the Industry - The Big Picture: DisplaySearch's Outlook on the HDTV Market" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2008/02/from-the-industry-the-big-picture-displaysearchs-outlook-on-the-hdtv-market.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="In 2007, the flat panel display industry reached the $101 billion mark, and it is expected to grow to $131 billion by 2012. While there are many display-centric applications on the rise such as notebooks, mobile applications, digital photo frames, home appliances and navigation systems, flat panel HDTVs continue to comprise 50% of all 10-inch and larger LCD panels shipped on an area basis-a segment that on a revenue basis, hit the $33.5 billion mark in 2007, $11 billion more than in 2006.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1280', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
