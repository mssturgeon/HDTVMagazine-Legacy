...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=From the Industry - The Big Picture: DisplaySearch\'s Outlook on the HDTV Market&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/columns/2008/02/from-the-industry-the-big-picture-displaysearchs-outlook-on-the-hdtv-market.php&amp;title=From the Industry - The Big Picture: DisplaySearch's Outlook on the HDTV Market">
		<span style="display:none">In 2007, the flat panel display industry reached the $101 billion mark, and it is expected to grow to $131 billion by 2012. While there are many display-centric applications on the rise such as notebooks, mobile applications, digital photo frames, home appliances and navigation systems, flat panel HDTVs continue to comprise 50% of all 10-inch and larger LCD panels shipped on an area basis-a segment that on a revenue basis, hit the $33.5 billion mark in 2007, $11 billion more than in 2006.

DisplaySearch predicts the cumulative number of HDTVs in the US will...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1280";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download From the Industry - The Big Picture: DisplaySearch\'s Outlook on the HDTV Market" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="From the Industry - The Big Picture: DisplaySearch\'s Outlook on the HDTV Market" />
...
<html>
<head>
	<title>HDTV Magazine - From the Industry - The Big Picture: DisplaySearch's Outlook on the HDTV Market</title>
	<meta name="keywords" content="fpd conference, flat panel, vice president, president marketing, picture quality, displaysearch, tvs, market, lcd, fpd, hdtvs, industry, president, picture, content, products, panel, north, figure, display, flat, billion, conference, vice, larger" />
...
DisplaySearch predicts the cumulative number of HDTVs in the US will..." />
	<meta name="title" content="From the Industry - The Big Picture: DisplaySearch's Outlook on the HDTV Market" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/columns/2008/02/from-the-industry-the-big-picture-displaysearchs-outlook-on-the-hdtv-market.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1280', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2008/02/from-the-industry-the-big-picture-displaysearchs-outlook-on-the-hdtv-market.php">From the Industry - The Big Picture: DisplaySearch's Outlook on the HDTV Market</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Shane Sturgeon</b> on <b>February 28, 2008</b>
			...
			<div id="<?=$container?>">
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Shane Sturgeon</b>, <b>February 28, 2008  7:45 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Shane Sturgeon', 1280)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2008/02/from-the-industry-the-big-picture-displaysearchs-outlook-on-the-hdtv-market.php" type="text/javascript" charset="utf-8"></script>
