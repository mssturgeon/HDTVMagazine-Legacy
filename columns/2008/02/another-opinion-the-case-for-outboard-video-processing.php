...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2008/02/another-opinion-the-case-for-outboard-video-processing.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="Another Opinion - The Case for Outboard Video Processing" />
...
Here's the thing. From the beginning..." />
	...
	<meta property="og:title" content="Another Opinion - The Case for Outboard Video Processing" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2008/02/another-opinion-the-case-for-outboard-video-processing.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="If you haven't already, marketing types everywhere are saying you probably will - buy a large screen TV in 2008 that is. For our purpose here, let's define large as anything north of a 50&quot; diagonal. With the resurgence of a couple good RPTVs, precipitous price drops in both LCD and Plasma large panels and really good front projector/screen combos in the under $5,000 range, many more of you WILL opt for Big Screen nirvana this year. But will all truly be well in Megapixelville? If all you do is replace the monitor, maybe not so much.
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1240', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
