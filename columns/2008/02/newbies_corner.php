...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$res_author = mQuery("SELECT title, channel, amazon_tracking_id, img, bio_short FROM aux_author au, mt_author a WHERE au.author_id = a.author_id AND a.author_name = 'Ara Derderian & Braden Russell'");
	$author = mysql_fetch_assoc($res_author);
	$author_title = ($author['title'] == '') ? '' : "{$author['title']}<br />";
	$author_headshot = ($author['img'] == '') ? '' : '<img src="'. BASE_IMG_HOST .'/images/portraits/'. $author['img'] .'" alt="Ara Derderian & Braden Russell" height="100" width="100"/>';
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Newbie\'s Corner - A Compression Primer&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
EOT;
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1276";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Newbie\'s Corner - A Compression Primer" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Newbie\'s Corner - A Compression Primer" />
...
<html>
<head>
	<title>HDTV Magazine - Newbie's Corner - A Compression Primer</title>
	<meta name="keywords" content="blu ray, high definition, beach ball, audio video, lossy compression, compression, video, mpeg, much, quality, hdtv, blu, ray, content, ball, beach, compress, high, looks, back, really, definition, allows, lossy, used" />
	<meta name="description" content="If you're fairly new to the world of HDTV, one word you've probably heard a few times is 'compression.' Typically it's used in a very negative way, taking the blame for all sorts of picture quality issues. Unfortunately, compression gets a bad wrap most of the time, in fact, compression itself is really a great thing. In a nutshell, compression is exactly what it sounds like: taking something big and making it smaller, compressing it down to a smaller size. It's the thing that allows a full HDTV movie to fit on a Blu-ray disk, or for an HDTV program to be broadcast to your home for your viewing pleasure. Uncompressed high definition content is simply too large to be of any use to us consumers. Compression is the thing that allows you to store and transfer audio and video content that otherwise would be way too big.

Think of a beach ball..." />
	<meta name="title" content="Newbie's Corner - A Compression Primer" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/columns/2008/02/newbies-corner-a-compression-primer.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1276', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2008/02/newbies-corner-a-compression-primer.php">Newbie's Corner - A Compression Primer</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Ara Derderian & Braden Russell</b> on <b>February 26, 2008</b>
...
<p>The bottom line is that compression allows us to watch high definition video in our homes. Without it, a high definition movie would take up terabytes of storage space and would never fit on a Blu-ray or HD DVD disc and could never be saved on your DVR. Forget about even trying to broadcast an HDTV show to your house. So never complain about compression. But feel free to complain about over compression.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Ara Derderian & Braden Russell</b>, <b>February 26, 2008  6:20 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Ara Derderian & Braden Russell', 1276)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2008/02/newbies-corner-a-compression-primer.php" type="text/javascript" charset="utf-8"></script>
