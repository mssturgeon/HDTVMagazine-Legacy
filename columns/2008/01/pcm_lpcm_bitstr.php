...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=Newbie\'s Corner - Aspect Ratio Explained&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/columns/2008/01/newbies-corner-aspect-ratio-explained.php&amp;title=Newbie's Corner - Aspect Ratio Explained">
		<span style="display:none">So you went out and bought yourself a new HDTV. Many of you bought a sound system to go with it. Now you are inundated with all kinds of terms and acronyms. In this series we will go through the jargon associated with your new system. While these articles are aimed at newbies, some experienced readers out there may learn a thing or two as well. Today we start with two topics that come up on our podcast (&lt;a href=&quot;http://www.htguys.com&quot;&gt;HDTV and Home Theater Podcast&lt;/a&gt;) quite frequently....</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
<head>
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/columns/2008/01/newbies-corner-aspect-ratio-explained.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=924', 340, 125);">Add ASIN</a>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							...
							<td id="article_byline">
								by <b>Ara Derderian & Braden Russell</b> on <b>January 29, 2008</b>
...
<p>Other film formats include Todd-AO, 2.2:1 (Oklahoma in 1955), Metroscope, 2:1 (Dirty Dozen), Cinerama, 2.8:1, (How the West was Won 1962), and there are others that that you can find out about by following this link (<a href="http://en.wikipedia.org/wiki/Aspect_ratio_(image)">http://en.wikipedia.org/wiki/Aspect_ratio_(image)</a> ).</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Ara Derderian & Braden Russell</b>, <b>January 29, 2008 10:39 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Ara Derderian & Braden Russell', 924)?>
