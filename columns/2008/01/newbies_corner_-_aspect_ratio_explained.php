...
<head>
	...
	<meta name="keywords" content="aspect ratio, wide screen, aspect ratios, black bars, experienced readers, aspect, ratio, screen, movies, Aspect, wide, movie, Ratio, HDTV, hdtv, units, new, see, ratios, cinematic, bars, black, film, DVDs, dvds" />
	...
	<title>HDTV Magazine Columns - Newbie's Corner - Aspect Ratio Explained</title>
...
<body><div id="body_container">
	<?
		...
		$base_url = strleftback(PHP_SELF, '/') . '/newbies_corner_-_aspect_ratio_explained';
		$print_url = $base_url .'-print.php';
		$save_url = $base_url .'-save.php';
		$title_encoded = rawurlencode(addslashes('Newbie\'s Corner - Aspect Ratio Explained'));
		$email_url = "mailto:?subject=HDTV Magazine: $title_encoded&amp;body=http://www.hdtvmagazine.com/columns/2008/01/newbies_corner_-_aspect_ratio_explained.php";
		if ($author[img] != '' && 10 != 7) {
	...
	<table class="bare" cellpadding="0" cellspacing="0" style="width:100%;">
		<tr>
			...
			<td class="article_title" colspan="2">Newbie's Corner - Aspect Ratio Explained</td>
		</tr><tr>
			<td id="article_byline" nowrap="nowrap">
				...
				<!--span><img src="/images/digg.png" alt="Digg Article" align="absmiddle" /><a target="_blank" href="http://digg.com/submit?url=http://www.hdtvmagazine.com/columns/2008/01/newbies_corner_-_aspect_ratio_explained.php&amp;phase=2">Digg</a></span-->
				<span><img src="/images/newsvine.gif" alt="Add to Newsvine" align="absmiddle" /><a href="javascript:addToNewsvine('http://www.hdtvmagazine.com/columns/2008/01/newbies_corner_-_aspect_ratio_explained.php', '<?=$title_encoded?>')">Newsvine</a></span>
				<span><img src="/images/delicious.gif" alt="Add to Del.icio.us" align="absmiddle" /><a target="_blank" href="http://del.icio.us/post?url=http://www.hdtvmagazine.com/columns/2008/01/newbies_corner_-_aspect_ratio_explained.php&amp;title=<?=$title_encoded?>">Del.icio.us</a></span>
...
<p>Other film formats include Todd-AO, 2.2:1 (Oklahoma in 1955), Metroscope, 2:1 (Dirty Dozen), Cinerama, 2.8:1, (How the West was Won 1962), and there are others that that you can find out about by following this link (<a href="http://en.wikipedia.org/wiki/Aspect_ratio_(image)">http://en.wikipedia.org/wiki/Aspect_ratio_(image)</a> ).</p>
  ...
  <td id="left"><!-- Comments -->
	...
	?>
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2008/01/newbies_corner_-_aspect_ratio_explained.php" type="text/javascript" charset="utf-8"></script>
</div></body>
</html>
