...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2008/01/newbies-corner-aspect-ratio-explained.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 924";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download Newbie\'s Corner - Aspect Ratio Explained" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="Newbie\'s Corner - Aspect Ratio Explained" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="Newbie\'s Corner - Aspect Ratio Explained" />
...
<html>
<head>
	<title>HDTV Magazine - Newbie's Corner - Aspect Ratio Explained</title>
	<meta name="keywords" content="aspect ratio, wide screen, aspect ratios, black bars, experienced readers, aspect, ratio, screen, movies, wide, movie, hdtv, units, new, see, ratios, cinematic, bars, black, film, dvds, talking, podcast, system, still" />
	...
	<meta name="title" content="Newbie's Corner - Aspect Ratio Explained" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="Newbie's Corner - Aspect Ratio Explained" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2008/01/newbies-corner-aspect-ratio-explained.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="So you went out and bought yourself a new HDTV. Many of you bought a sound system to go with it. Now you are inundated with all kinds of terms and acronyms. In this series we will go through the jargon associated with your new system. While these articles are aimed at newbies, some experienced readers out there may learn a thing or two as well. Today we start with two topics that come up on our podcast (&lt;a href=&quot;http://www.htguys.com&quot;&gt;HDTV and Home Theater Podcast&lt;/a&gt;) quite frequently...." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=924', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2008/01/newbies-corner-aspect-ratio-explained.php">Newbie's Corner - Aspect Ratio Explained</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>The HT Guys</b> on <b>January 29, 2008</b>
...
<p>Other film formats include Todd-AO, 2.2:1 (Oklahoma in 1955), Metroscope, 2:1 (Dirty Dozen), Cinerama, 2.8:1, (How the West was Won 1962), and there are others that that you can find out about by following this link (<a href="http://en.wikipedia.org/wiki/Aspect_ratio_(image)">http://en.wikipedia.org/wiki/Aspect_ratio_(image)</a> ).</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>The HT Guys</b>, <b>January 29, 2008 10:39 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('The HT Guys', 924)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2008/01/newbies-corner-aspect-ratio-explained.php" type="text/javascript" charset="utf-8"></script>
