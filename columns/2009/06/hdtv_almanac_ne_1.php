...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1930 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDTV Almanac - New Vizio Sets Add More Internet&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/columns/2009/06/hdtv-almanac-new-vizio-sets-add-more-internet.php&amp;title=HDTV Almanac - New Vizio Sets Add More Internet">
		<span style="display:none">Last week, I got to see prototypes of some of VIZIO&amp;#8217;s new XVT line of LCD 1080p HDTVs. These new models will ship this summer and fall. There will be 47&amp;#8243; and 55&amp;#8243; models with LED backlights that incorporate a local dimming feature for increased contrast, and in addition to these two, a 42&amp;#8243; model [...]</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1930";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Almanac - New Vizio Sets Add More Internet" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Almanac - New Vizio Sets Add More Internet" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Almanac - New Vizio Sets Add More Internet</title>
	<meta name="keywords" content="led backlight, directly internet, motion blur, last week, led backlights, led, via, internet, backlight, xvt, new, sets, ship, model, motion, models, sps, price, performance, increased, frames, much, access, part, last" />
	<meta name="description" content="Last week, I got to see prototypes of some of VIZIO&amp;#8217;s new XVT line of LCD 1080p HDTVs. These new models will ship this summer and fall. There will be 47&amp;#8243; and 55&amp;#8243; models with LED backlights that incorporate a local dimming feature for increased contrast, and in addition to these two, a 42&amp;#8243; model [...]" />
	<meta name="title" content="HDTV Almanac - New Vizio Sets Add More Internet" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/columns/2009/06/hdtv-almanac-new-vizio-sets-add-more-internet.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1930', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2009/06/hdtv-almanac-new-vizio-sets-add-more-internet.php">HDTV Almanac - New Vizio Sets Add More Internet</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Alfred Poor</b> on <b>June 29, 2009</b>
	...
	<p>VIZIO is <strong>stepping up its game </strong>with increased performance and added features while maintaining its <strong>competitive price position</strong>.
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Alfred Poor</b>, <b>June 29, 2009  6:00 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Alfred Poor', 1930)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2009/06/hdtv-almanac-new-vizio-sets-add-more-internet.php" type="text/javascript" charset="utf-8"></script>
