...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=The DIRECTV Plus High Definition DVR &ndash; Year Two&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/columns/2009/01/the-directv-plus-high-definition-dvr-year-two.php&amp;title=The DIRECTV Plus High Definition DVR &amp;ndash; Year Two">
		<span style="display:none">After a jam packed year, the DIRECTV Plus High Definition DVR has become the flagship receiver for a company that has become one of the leaders in high-definition programming. The enthusiast community is stronger than ever, fusing innovation and collaboration in ways that have never been done before. Sit back while we reflect on the things that have made this trip something to remember.

Joining the HR20-700 and the HR20-100 this year are the...</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
Joining the HR20-700 and the HR20-100 this year are the..." />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/columns/2009/01/the-directv-plus-high-definition-dvr-year-two.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1662', 340, 125);">Add ASIN</a>
