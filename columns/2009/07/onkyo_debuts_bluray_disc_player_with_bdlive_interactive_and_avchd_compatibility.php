<?
	...
	# Get category ID
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 2909 AND placement_is_primary = 1";
...
<head>
	...
	<meta name="description" content="Onkyo Debuts Blu-ray Disc Player with BD-Live Interactive and AVCHD Compatibility Upper Saddle River, NJ (7/28/09) -- Onkyo has introduced a new, state-of-the-art, BD-Live interactive Blu-ray Disc Player, model DV-BD507. This full-featured player delivers outstanding high definition 1080p video playback..." />
	<title>HDTV Magazine Columns - Onkyo Debuts Blu-ray Disc Player with BD-Live Interactive and AVCHD Compatibility</title>
	...
	<script type="text/javascript">
		digg_url = 'http://www.hdtvmagazine.com/columns/2009/07/onkyo_debuts_bluray_disc_player_with_bdlive_interactive_and_avchd_compatibility.php';
		digg_skin = 'compact';
		digg_window = 'new';
		digg_title = 'Onkyo Debuts Blu-ray Disc Player with BD-Live Interactive and AVCHD Compatibility';
		digg_bodytext = 'Onkyo Debuts Blu-ray Disc Player with BD-Live Interactive and AVCHD Compatibility Upper Saddle River, NJ (7/28/09) -- Onkyo has introduced a new, state-of-the-art, BD-Live interactive Blu-ray Disc Player, model DV-BD507. This full-featured player delivers outstanding high definition 1080p video playback...';
//		digg_media = '';
...
<body><div id="body_container">
	<?
		...
		$base_url = strleftback(PHP_SELF, '/') . '/onkyo_debuts_bluray_disc_player_with_bdlive_interactive_and_avchd_compatibility';
		$print_url = $base_url .'-print.php';
		$save_url = $base_url .'-save.php';
		$title_encoded = rawurlencode(addslashes('Onkyo Debuts Blu-ray Disc Player with BD-Live Interactive and AVCHD Compatibility'));
		$email_url = "mailto:?subject=HDTV Magazine: $title_encoded&amp;body=http://www.hdtvmagazine.com/columns/2009/07/onkyo_debuts_bluray_disc_player_with_bdlive_interactive_and_avchd_compatibility.php";
		if ($author['img'] != '' && 10 != 7) {
	...
	if (strpos(strtolower($_SERVER['HTTP_USER_AGENT']), "google") === false) {?>
		...
		<table class="bare" cellpadding="0" cellspacing="0" style="width:100%;">
			<tr>
				...
				<td class="article_title" colspan="2">Onkyo Debuts Blu-ray Disc Player with BD-Live Interactive and AVCHD Compatibility</td>
			</tr><tr>
			<td id="article_byline" nowrap="nowrap">
					By <b>Shane Sturgeon</b><br />
					<?=$author_title?>
					Posted on <b>July 28, 2009</b><br />
					...
					<span><img src="http://cdn.stumble-upon.com/images/16x16_su_3d.gif" alt="" align="absmiddle" /><a target="_blank" href="http://www.stumbleupon.com/submit?url=http://www.hdtvmagazine.com/columns/2009/07/onkyo_debuts_bluray_disc_player_with_bdlive_interactive_and_avchd_compatibility.php&title=Onkyo Debuts Blu-ray Disc Player with BD-Live Interactive and AVCHD Compatibility">StumbleUpon</a></span>
					<span><img src="/images/delicious.gif" alt="Add to Del.icio.us" align="absmiddle" /><a target="_blank" href="http://del.icio.us/post?url=http://www.hdtvmagazine.com/columns/2009/07/onkyo_debuts_bluray_disc_player_with_bdlive_interactive_and_avchd_compatibility.php&amp;title=<?=$title_encoded?>">Del.icio.us</a></span>
...
<p>Since 1946 Onkyo has been passionately committed to developing audio products that deliver uncommon performance, quality and value. Bundling proprietary technologies and innovations with other sound-enhancing exclusives, Onkyo continues to created award winning product that are lauded by many of the industry leading audio publications. The company's philosophy is to deliver products that are superbly designed and built to a consistently outstanding standard of excellence. Today, Onkyo is at the forefront of the home theater and digital revolutions. For more information about this and other fine Onkyo products, visit www.onkyousa.com or call 800-229-1687.</p>
	...
	<p class="posted">Posted by <b>Shane Sturgeon</b>, <b>July 28, 2009  2:38 PM</b></p>
  ...
  <td id="left"><!-- Comments -->
	...
	?>
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2009/07/onkyo_debuts_bluray_disc_player_with_bdlive_interactive_and_avchd_compatibility.php" type="text/javascript" charset="utf-8"></script>
</div></body>
</html>
