...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1925 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2009/07/hdtv-almanac-where-is-bluray.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1925";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Almanac - Where is Blu-ray?" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Almanac - Where is Blu-ray?" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HDTV Almanac - Where is Blu-ray?" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Almanac - Where is Blu-ray?</title>
	<meta name="keywords" content="blu ray, standard dvd, dvd player, ray player, ray players, blu, ray, dvd, player, less, players, internet, include, sales, movies, standard, spend, much, figures, today, units, walmart, npd, playstations, believe" />
	<meta name="description" content="I stumbled across this statement on Betanews as I looked around for news about Blu-ray: &amp;#8220;Back in April, Sony President Ryoji Chubachi projected that its Blu-ray Disc format would garner 50 percent of DVD market share by the end of 2008.&amp;#8221;
	So here we are, halfway through 2009, and I&amp;#8217;m wondering where Blu-ray stands. According to [...]" />
	<meta name="title" content="HDTV Almanac - Where is Blu-ray?" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HDTV Almanac - Where is Blu-ray?" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2009/07/hdtv-almanac-where-is-bluray.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="I stumbled across this statement on Betanews as I looked around for news about Blu-ray: &amp;#8220;Back in April, Sony President Ryoji Chubachi projected that its Blu-ray Disc format would garner 50 percent of DVD market share by the end of 2008.&amp;#8221;
	So here we are, halfway through 2009, and I&amp;#8217;m wondering where Blu-ray stands. According to [...]" />
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1925', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2009/07/hdtv-almanac-where-is-bluray.php">HDTV Almanac - Where is Blu-ray?</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Alfred Poor</b> on <b>July  6, 2009</b>
	...
	<p>I continue to believe that Blu-ray has been <strong>fighting the past war</strong>, and is the wrong solution for the next challenge. Yes, Playstations and other devices will help <strong>prop up the Blu-ray sales figures</strong>, but the technology is <strong>too late to catch this wave</strong>, and the standard DVD will remain dominant until the Internet is <strong>ready to replace </strong>the little plastic discs forever.
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Alfred Poor</b>, <b>July  6, 2009  6:00 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Alfred Poor', 1925)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2009/07/hdtv-almanac-where-is-bluray.php" type="text/javascript" charset="utf-8"></script>
