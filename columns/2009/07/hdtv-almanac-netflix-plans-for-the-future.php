...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2009/07/hdtv-almanac-netflix-plans-for-the-future.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV Almanac - Netflix Plans for the Future" />
...
<head>
	...
	<meta property="og:title" content="HDTV Almanac - Netflix Plans for the Future" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2009/07/hdtv-almanac-netflix-plans-for-the-future.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Reed Hastings has seen the future, and there are no polycarbonate discs in his vision. You might find this surprising, given that he&amp;#8217;s the CEO of Netflix. Is there life for Netflix after the DVD? That&amp;#8217;s the question that was explored in an article in the Wall Street Journal last month.
	Hastings co-founded Netflix, and expects [...]" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1926', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
