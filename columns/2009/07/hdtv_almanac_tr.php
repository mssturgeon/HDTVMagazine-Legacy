...
#			$az_main['ProductTypeName'] = $item->ItemAttributes->ProductTypeName;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 1924 AND placement_is_primary = 1";
	...
	if ($row_pg != '') {
		$pg_mlink = '<script language="javascript" type="text/javascript" 	src="http://ah.pricegrabber.com/cb_table.php?masterid='. $row_pg['masterid'] .'&keyword=HDTV Almanac - Trying Harder: Rent-a-TV&dw=1&cobrand_id=718&vw=2&sml=1&rst=1&sblpt=1&slp=1&olt=1&w=100&pgb=1&sbt=1&ssbox=1&ss=0&l=20&spic=1&ssbox=1"></script>';
		$pg_url = $row_pg['url'];
...
<div id="dd_right"><ul>
	<li class="li_vertical">
		<a class="DiggThisButton DiggMedium" rel="external" href="http://digg.com/submit?related=no&amp;url=http://www.hdtvmagazine.com/columns/2009/07/hdtv-almanac-trying-harder-rentatv.php&amp;title=HDTV Almanac - Trying Harder: Rent-a-TV">
		<span style="display:none">It&amp;#8217;s hard to differentiate your company in the car rental business. Once you have a lot full of late model cars at or near major airports, what&amp;#8217;s left? Well, Avis is teaming up with AT&amp;#038;T to offer mobile TV in their cars at vacation destinations in Florida. Avis adds $8.95 a day for the AT&amp;#038;T [...]</span></a>
	</li>
</ul></div>
EOT;
	$h_buttons = <<<EOT
...
EOT;
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 1924";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Almanac - Trying Harder: Rent-a-TV" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Almanac - Trying Harder: Rent-a-TV" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Almanac - Trying Harder: Rent-a-TV</title>
	<meta name="keywords" content="car rental, mobile, network, car, avis, service, people, could, want, another, cars, discovery, system, cruisecast, includes, yup, make, channels, news, channel, sports, rental, long" />
	<meta name="description" content="It&amp;#8217;s hard to differentiate your company in the car rental business. Once you have a lot full of late model cars at or near major airports, what&amp;#8217;s left? Well, Avis is teaming up with AT&amp;#038;T to offer mobile TV in their cars at vacation destinations in Florida. Avis adds $8.95 a day for the AT&amp;#038;T [...]" />
	<meta name="title" content="HDTV Almanac - Trying Harder: Rent-a-TV" />
	...
	<script type="text/javascript">
		...
		function init() {
			document.getElementById("tm_li").innerHTML = getTMButton('http://www.hdtvmagazine.com/columns/2009/07/hdtv-almanac-trying-harder-rentatv.php', 'compact', '<?=$admindata['twitter_username']?>', 'bit.ly');
		}
...
<body onload="init();"><div id="body_container">
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1924', 340, 125);">Add ASIN</a>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2009/07/hdtv-almanac-trying-harder-rentatv.php">HDTV Almanac - Trying Harder: Rent-a-TV</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Alfred Poor</b> on <b>July  7, 2009</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=299&category=Business & Investment">Business & Investment</a></b>, <b><a href="/category.php?id=373&category=Mobile HDTV">Mobile HDTV</a></b>
							</td>
						</tr><tr colspan="2">
	...
	<p>If you want to try out the AT&#038;T CruiseCast, make a reservation with Avis for a car at <strong>Ft. Lauderdale, Miami, Orlando, Tampa or West Palm Beach</strong>. (Yup, another cut-and-paste.) Let me know how it works out for you at <a href="mailtto: alfred@hdtvprofessor.com">alfred@hdtvprofessor.com</a>.
				...
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Alfred Poor</b>, <b>July  7, 2009  6:00 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Alfred Poor', 1924)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2009/07/hdtv-almanac-trying-harder-rentatv.php" type="text/javascript" charset="utf-8"></script>
