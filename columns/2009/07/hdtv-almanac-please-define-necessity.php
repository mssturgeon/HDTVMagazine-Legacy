...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2009/07/hdtv-almanac-please-define-necessity.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="HDTV Almanac - Please Define &ldquo;Necessity&rdquo;" />
...
<head>
	...
	<meta property="og:title" content="HDTV Almanac - Please Define &amp;ldquo;Necessity&amp;rdquo;" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2009/07/hdtv-almanac-please-define-necessity.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="On Tuesday, PriceGrabber put out a press release about its 2009 Consumer Behavior Report: Economic Trends in Consumer Spending. It paints a fairly pessimistic picture; two out of three consumers surveyed have cut back on spending, and 90% indicated that they plan to continue to control their spending even after the economy improves.
	But the item [...]" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=1922', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
