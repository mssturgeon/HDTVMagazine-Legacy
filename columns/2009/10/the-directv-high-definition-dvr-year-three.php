...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2009/10/the-directv-high-definition-dvr-year-three.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	<meta property="og:audio:title" content="The DIRECTV High Definition DVR - Year Three" />
...
<head>
	...
	<meta property="og:title" content="The DIRECTV High Definition DVR - Year Three" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2009/10/the-directv-high-definition-dvr-year-three.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="It's hard to believe how long it has been since the first HR20-700 hit the streets. Three years after the introduction of DIRECTV's flagship receiver in August 2006, it continues to improve.  Even though there hasn't been a new receiver since the HR23 was released last year, DIRECTV continues steady development of the HD DVR platform by adding new features.  One such highly anticipated feature..." />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=3310', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
