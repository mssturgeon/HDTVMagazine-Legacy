...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 5100 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2013/04/hdtv-expert-panasonic-shows-best-plasma-tv-set-the-world-has-ever-seen.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 5100";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Expert - Panasonic Shows Best Plasma TV Set the World has ever Seen" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Expert - Panasonic Shows Best Plasma TV Set the World has ever Seen" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HDTV Expert - Panasonic Shows Best Plasma TV Set the World has ever Seen" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Expert - Panasonic Shows Best Plasma TV Set the World has ever Seen</title>
	<meta name="keywords" content="our plasma, leaving plasma, motion artifacts, statement panasonic, field drive, plasma, panasonic, series, new, pen, panel, technology, display, last, company, our, kuro, business, schiller, set, year, statement, levels, red, ken" />
	<meta name="description" content="Some Asian news organizations published stories earlier this year that Panasonic was leaving the plasma TV&amp;Acirc;&amp;nbsp;business, leaving the plasma panel business, getting out of the TV business entirely, or just getting&amp;Acirc;&amp;nbsp;out of the panel business and buying panels from outside to put into its TV sets.
None of these stories were or are true.
It was one [...]" />
	<meta name="title" content="HDTV Expert - Panasonic Shows Best Plasma TV Set the World has ever Seen" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HDTV Expert - Panasonic Shows Best Plasma TV Set the World has ever Seen" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2013/04/hdtv-expert-panasonic-shows-best-plasma-tv-set-the-world-has-ever-seen.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Some Asian news organizations published stories earlier this year that Panasonic was leaving the plasma TV&amp;Acirc;&amp;nbsp;business, leaving the plasma panel business, getting out of the TV business entirely, or just getting&amp;Acirc;&amp;nbsp;out of the panel business and buying panels from outside to put into its TV sets.
None of these stories were or are true.
It was one [...]" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=5100', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2013/04/hdtv-expert-panasonic-shows-best-plasma-tv-set-the-world-has-ever-seen.php">HDTV Expert - Panasonic Shows Best Plasma TV Set the World has ever Seen</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Ken Werner</b> on <b>April 18, 2013</b>
			...
			<div id="<?=$container?>" class="<?=$viglink_suppress?>">
				...
				<!--?=$v_buttons?-->
				<p>Some Asian news organizations published stories earlier this year that Panasonic was leaving the plasma TV business, leaving the plasma panel business, getting out of the TV business entirely, or just getting out of the panel business and buying panels from outside to put into its TV sets.</p>
...
<p><em>Ken Werner is Principal of Nutmeg Consultants, specializing in the display industry, display manufacturing, display technology, and display applications. You can reach him at ken@hdtvexpert.com.</em></p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Ken Werner</b>, <b>April 18, 2013  3:28 PM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Ken Werner', 5100)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2013/04/hdtv-expert-panasonic-shows-best-plasma-tv-set-the-world-has-ever-seen.php" type="text/javascript" charset="utf-8"></script>
