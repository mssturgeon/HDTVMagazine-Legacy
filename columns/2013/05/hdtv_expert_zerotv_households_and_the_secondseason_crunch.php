...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 5108 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2013/05/hdtv-expert-zerotv-households-and-the-secondseason-crunch.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 5108";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Expert - Zero-TV Households and the Second-Season Crunch" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Expert - Zero-TV Households and the Second-Season Crunch" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HDTV Expert - Zero-TV Households and the Second-Season Crunch" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Expert - Zero-TV Households and the Second-Season Crunch</title>
	<meta name="keywords" content="cable satellite, age total, peaks age, distribution peaks, cable, million, satellite, ’s, netflix, households, display, viewers, total, shows, ero, carter, time, programming, second, hbo, season, year, both, important, several" />
	<meta name="description" content="Network TV shows that are hits in their first season usually do well in the second, which is necessary if they are to become long-term cash cows for the networks that carry them. But not this year.
With very few exceptions the hits of the 2011-2012 season fizzled in 2012-2013. Fox&amp;acirc;��s&amp;Acirc;&amp;nbsp;New Girl&amp;Acirc;&amp;nbsp;fell from 8.4 to 6.16 [...]" />
	<meta name="title" content="HDTV Expert - Zero-TV Households and the Second-Season Crunch" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HDTV Expert - Zero-TV Households and the Second-Season Crunch" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2013/05/hdtv-expert-zerotv-households-and-the-secondseason-crunch.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="Network TV shows that are hits in their first season usually do well in the second, which is necessary if they are to become long-term cash cows for the networks that carry them. But not this year.
With very few exceptions the hits of the 2011-2012 season fizzled in 2012-2013. Fox&amp;acirc;��s&amp;Acirc;&amp;nbsp;New Girl&amp;Acirc;&amp;nbsp;fell from 8.4 to 6.16 [...]" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=5108', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2013/05/hdtv-expert-zerotv-households-and-the-secondseason-crunch.php">HDTV Expert - Zero-TV Households and the Second-Season Crunch</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Ken Werner</b> on <b>May 15, 2013</b>
			...
			<div id="<?=$container?>" class="<?=$viglink_suppress?>">
				...
				<!--?=$v_buttons?-->
				<p>Network TV shows that are hits in their first season usually do well in the second, which is necessary if they are to become long-term cash cows for the networks that carry them. But not this year.</p>
...
<div id="attachment_3157" class="wp-caption alignright" style="width: 214px"><a href="http://www.hdtvexpert.com/?attachment_id=3157" rel="attachment wp-att-3157"><img class="size-medium wp-image-3157" alt="Peter Dinklange in &quot;Game of Thrones,&quot; one of several cable TV series that generate a level of excitement the networks envy." src="http://www.hdtvexpert.com/wp-content/uploads/2013/05/Peter_Dinklage-204x300.jpg" width="204" height="300" /></a><p class="wp-caption-text">Peter Dinklage in &#8220;Game of Thrones&#8221; (HBO). one of several cable TV series that generates a level of excitement the networks envy.</p></div>
...
<p><em>Ken Werner is Principal of Nutmeg Consultants, specializing in the display industry, display manufacturing, display technology, and display applications. You can reach him at ken@hdtvexpert.com.</em></p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Ken Werner</b>, <b>May 15, 2013  4:17 PM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Ken Werner', 5108)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2013/05/hdtv-expert-zerotv-households-and-the-secondseason-crunch.php" type="text/javascript" charset="utf-8"></script>
