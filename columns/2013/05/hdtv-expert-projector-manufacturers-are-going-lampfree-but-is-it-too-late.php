...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 5111 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2013/05/hdtv-expert-projector-manufacturers-are-going-lampfree-but-is-it-too-late.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 5111";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Expert - Projector Manufacturers Are Going Lamp-Free. But Is It Too Late?" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Expert - Projector Manufacturers Are Going Lamp-Free. But Is It Too Late?" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HDTV Expert - Projector Manufacturers Are Going Lamp-Free. But Is It Too Late?" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Expert - Projector Manufacturers Are Going Lamp-Free. But Is It Too Late?</title>
	<meta name="keywords" content="lamp free, laser powered, free projection, powered lcd, image quality, lamp, projectors, projector, lcd, laser, projection, free, ”, led, large, time, much, image, displays, market, even, quality, sony, powered, panasonic" />
	<meta name="description" content="The once-safe market of small to mid-sized classroom and conference room projection continues to cede ground to large LCD displays with each passing month. With lamp-free technology, projector manufacturers have shown they&amp;acirc;��ve finally seen the light. But is it too late?" />
	<meta name="title" content="HDTV Expert - Projector Manufacturers Are Going Lamp-Free. But Is It Too Late?" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HDTV Expert - Projector Manufacturers Are Going Lamp-Free. But Is It Too Late?" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2013/05/hdtv-expert-projector-manufacturers-are-going-lampfree-but-is-it-too-late.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="The once-safe market of small to mid-sized classroom and conference room projection continues to cede ground to large LCD displays with each passing month. With lamp-free technology, projector manufacturers have shown they&amp;acirc;��ve finally seen the light. But is it too late?" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=5111', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2013/05/hdtv-expert-projector-manufacturers-are-going-lampfree-but-is-it-too-late.php">HDTV Expert - Projector Manufacturers Are Going Lamp-Free. But Is It Too Late?</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Pete Putman</b> on <b>May 24, 2013</b>
							</td><td id="article_category">
								Categories: <b><a href="/category.php?id=514&category=Events & Tradeshows">Events & Tradeshows</a></b>, <b><a href="/category.php?id=497&category=Front Projection">Front Projection</a></b>, <b><a href="/category.php?id=511&category=LCD HDTVs">LCD HDTVs</a></b>, <b><a href="/category.php?id=448&category=PC & Laptop Technology">PC & Laptop Technology</a></b>
							</td>
						</tr><tr colspan="2">
			...
			<div id="<?=$container?>" class="<?=$viglink_suppress?>">
				...
				<!--?=$v_buttons?-->
				<p>Last Tuesday, I traveled to QVC Studios in West Chester, PA to check out some of Sony’s newest 2K and 4K projectors. In addition to a pair of high-brightness 4K models, Sony also had its new and yet-unnamed laser-powered 3LCD projector up and running, side-by-side with Panasonic’s PT-RZ470 laser/LED single-chip DLP projector.</p>
...
<p><a href="http://www.display-central.com/free-news/display-daily/projector-manufacturers-are-going-lamp-free-but-is-it-too-late/">This article was originally posted on the Display Daily Web site.</a></p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Pete Putman</b>, <b>May 24, 2013  9:04 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Pete Putman', 5111)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2013/05/hdtv-expert-projector-manufacturers-are-going-lampfree-but-is-it-too-late.php" type="text/javascript" charset="utf-8"></script>
