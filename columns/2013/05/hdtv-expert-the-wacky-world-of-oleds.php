...
EOT;
	...
	$sql = "SELECT placement_category_id FROM mt_placement WHERE placement_entry_id = 5105 AND placement_is_primary = 1";
	if ($debug) echo "$sql\n";
...
EOT;
#	<li class="li_horizontal"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.hdtvmagazine.com/columns/2013/05/hdtv-expert-the-wacky-world-of-oleds.php&amp;layout=button_count&amp;show_faces=false&amp;width=100" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px" allowTransparency="true"></iframe></li>
	...
	switch (10) {
		...
		case 9: # Podcasts
			# Get enclosure info
			$sql = "SELECT enclosure_url, enclosure_type FROM aux_mt_entry WHERE entry_id = 5105";
			$res_enclosure = mQuery($sql);
			$row_enclosure = mysql_fetch_assoc($res_enclosure);
			$enclosure_url = $row_enclosure['enclosure_url'];

			$podcast_chicklets = '<span><a href="http://click.linksynergy.com/fs-bin/stat?id=FK62p2waXuc&amp;offerid=78941&amp;type=3&amp;subid=0&amp;tmpid=1826&amp;RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewPodcast%253Fid%253D73799860%2526partnerId%253D30" target="_blank"><img src="'. BASE_IMG_HOST .'/images/chicklet-itunes.gif" alt="Subscribe to the HDTV and Home Theater Podcast in iTunes" align="absmiddle" height="15" width="80"></a></span>'.
				'<span><a href="<?=$enclosure_url?>"><img src="'. BASE_IMG_HOST .'/images/chicklet-mp3-podcast.gif" alt="Download HDTV Expert - The Wacky World of OLEDs" height="15" width="85"/></a></span>';
			$meta_medium_type = 'audio';
			$link_rel_image_src = 'http://www.htguys.com/storage/thumbnails/3382196-3373802-thumbnail.jpg';
			$meta = <<<EOT
	<meta name="audio_type" content="audio/mpeg" />
	<meta name="audio_title" content="HDTV Expert - The Wacky World of OLEDs" />
	<meta name="audio_artist" content="Ara Derderian &amp; Braden Russell" />
	<meta name="audio_album" content="The HDTV and Home Theater Podcast" />
	<link rel="audio_src" href="$enclosure_url" />
	<meta property="og:audio" content="$enclosure_url" />
	<meta property="og:audio:title" content="HDTV Expert - The Wacky World of OLEDs" />
...
<html>
<head>
	<title>HDTV Magazine - HDTV Expert - The Wacky World of OLEDs</title>
	<meta name="keywords" content="oled tvs, oled displays, stratospheric prices, oled display, inch oled, oled, displays, inch, display, samsung, large, been, prices, panel, manufacturing, reports, get, displaybank, inches, oleds, lcd, real, comedy, curved, tvs" />
	<meta name="description" content="A classic line from vaudeville was &amp;amp;#8220;Dying is easy; comedy is hard.&amp;amp;#8221; Compared to bringing large OLED displays into the mainstream, it now seems that comedy is a piece of cake.
If we ever get large OLEDs right &amp;amp;#8212; that is, if we learn how to print the front plane; use IGZO or graphene or carbon [...]" />
	<meta name="title" content="HDTV Expert - The Wacky World of OLEDs" />
	<meta name="medium_type" content="<?=$meta_medium_type?>" />
	<link rel="image_src" href="<?=$link_rel_image_src?>" />

	<meta property="og:title" content="HDTV Expert - The Wacky World of OLEDs" />
	<meta property="og:type" content="<?=$og_type?>" />
	<meta property="og:url" content="http://www.hdtvmagazine.com/columns/2013/05/hdtv-expert-the-wacky-world-of-oleds.php" />
	<meta property="og:image" content="<?=$link_rel_image_src?>" />
	<meta property="og:description" content="A classic line from vaudeville was &amp;amp;#8220;Dying is easy; comedy is hard.&amp;amp;#8221; Compared to bringing large OLED displays into the mainstream, it now seems that comedy is a piece of cake.
If we ever get large OLEDs right &amp;amp;#8212; that is, if we learn how to print the front plane; use IGZO or graphene or carbon [...]" />
		...
		<td id="left">
			<? if(access(ACCESS_ADMIN)) {?>
				<div class="important"><span class="corners-top"><span></span></span>
					...
					<a href="javascript:popOpen('/admin/asin-edit.php?entry_id=5105', 400, 200);">Link Products</a>
				<span class="corners-bottom"><span></span></span></div>
			<? }?>
				...
				<tr>
					...
					<td>
						<table class="bare" cellspacing="0" style="width:100%"><tr>
							<td id="article_title" colspan="2"><a href="http://www.hdtvmagazine.com/columns/2013/05/hdtv-expert-the-wacky-world-of-oleds.php">HDTV Expert - The Wacky World of OLEDs</a></td>
						</tr><tr>
							<td id="article_byline">
								by <b>Ken Werner</b> on <b>May  3, 2013</b>
			...
			<div id="<?=$container?>" class="<?=$viglink_suppress?>">
				...
				<!--?=$v_buttons?-->
				<p>A classic line from vaudeville was &#8220;Dying is easy; comedy is hard.&#8221; Compared to bringing large OLED displays into the mainstream, it now seems that comedy is a piece of cake.</p>
...
<p>OLED TV isn&#8217;t dead. It&#8217;s just harder than comedy.</p>
				<?=$pg_mlink?>
				<p class="posted">
					Posted by <b>Ken Werner</b>, <b>May  3, 2013  8:24 AM</b>
			...
			<? if (10 != 7) echo getBoxMoreFromAuthor('Ken Werner', 5105)?>
	...
	<script src="http://feeds.feedburner.com/~s/<?=$feed_name?>?i=http://www.hdtvmagazine.com/columns/2013/05/hdtv-expert-the-wacky-world-of-oleds.php" type="text/javascript" charset="utf-8"></script>
